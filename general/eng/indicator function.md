...
{@{The indicator function of _A_}@} is {@{the [Iverson bracket](Iverson%20bracket.md) of the property of belonging to _A_}@}; that is, {@{$$\mathbf {1} _{A}(x)=[x\in A].$$}@} For example, {@{the [Dirichlet function](Dirichlet%20function.md)}@} is {@{the indicator function of the [rational numbers](rational%20number.md) as a subset of the [real numbers](real%20number.md)}@}. <!--SR:!2025-03-23,62,310!2025-03-21,60,310!2025-03-15,55,310!2025-03-16,56,310!2025-03-03,42,290-->
