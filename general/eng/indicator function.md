...
{@{The term "[characteristic function](characteristic%20function%20(probability%20theory).md)"}@} has {@{an unrelated meaning in [classic probability theory](probability%20theory.md)}@}. For this reason, {@{[traditional probabilists](list%20of%20mathematical%20probabilists.md)}@} use {@{the term __indicator function__ for the function defined here almost exclusively}@}, while {@{mathematicians in other fields}@} are more likely to use {@{the term _characteristic function_<sup>[\[a\]](#^ref-a)</sup> to describe the function that indicates membership in a set}@}. <!--SR:!2026-01-17,294,330!2028-09-25,1057,350!2028-11-29,1109,350!2028-01-19,838,330!2028-06-05,898,330!2025-12-26,5,356-->
...
__[Mean](mean.md)__ <br/> ::@:: &emsp;&emsp; $\operatorname {E} (\mathbf {1} _{A}(\omega ))=\operatorname {P} (A)$ \(also called "Fundamental Bridge"\). <!--SR:!2029-03-25,1202,350!2026-01-04,283,330-->
