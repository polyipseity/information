...
{@{The term "[characteristic function](characteristic%20function%20(probability%20theory).md)"}@} has {@{an unrelated meaning in [classic probability theory](probability%20theory.md)}@}. For this reason, {@{[traditional probabilists](list%20of%20mathematical%20probabilists.md)}@} use {@{the term __indicator function__ for the function defined here almost exclusively}@}, while {@{mathematicians in other fields}@} are more likely to use {@{the term _characteristic function_<sup>[\[a\]](#^ref-a)</sup> to describe the function that indicates membership in a set}@}. <!--SR:!2029-09-21,1343,350!2028-09-25,1057,350!2028-11-29,1109,350!2028-01-19,838,330!2028-06-05,898,330!2026-02-11,25,376-->
