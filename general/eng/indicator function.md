...
- This article is about {@{the 0-1 indicator function}@}. For {@{the 0-infinity indicator function}@}, see {@{[characteristic function \(convex analysis\)](characteristic%20function%20(convex%20analysis).md)}@}. <!--SR:!2025-01-05,4,270!2025-01-05,4,270!2025-01-05,4,270-->
...
- [Kronecker delta](Kronecker%20delta.md), ::@:: a function that can be viewed as an indicator for the [identity relation](equality%20(mathematics).md) <!--SR:!2025-01-05,4,270!2025-01-04,3,250-->
...
1. a. The [Greek letter](Greek%20alphabet.md) _χ_ appears because ::@:: it is the initial letter of the Greek word χαρακτήρ, which is the ultimate origin of the word _characteristic_. <a id="^ref-a"></a>^ref-a <!--SR:!2025-01-05,4,270!2025-01-05,4,270-->
2. b. The set of all indicator functions on _X_ can be {@{identified with  ${\mathcal {P} }(X)$, the [power set](power%20set.md) of _X_}@}. Consequently, {@{both sets are sometimes denoted by  $2^{X}$}@}. This is a special case {@{\( $Y=\{0,1\}=2$\) of the notation  $Y^{X}$ for the set of all functions  $f:X\to Y$}@}. <a id="^ref-b"></a>^ref-b <!--SR:!2025-01-05,4,270!2025-01-05,4,270!2025-01-05,4,270-->
