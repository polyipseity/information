...
For a contrasting example, if {@{_n_ = 9}@}, then $\lambda (n)=\varphi (n)=6$ and $\varphi (\lambda (n))=2$. There are {@{two primitive _λ_-roots modulo 9}@}, namely {@{2 and 5}@}, each of which is {@{congruent to the fifth power of the other}@}. They are also {@{both primitive $\varphi$-roots modulo 9}@}. <!--SR:!2028-03-15,909,341!2026-02-14,326,341!2028-02-28,897,341!2027-08-06,736,341!2027-06-27,645,321-->
