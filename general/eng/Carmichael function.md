...
>
> {@{Carmichael _λ_ function: _λ_\(_n_\) for 1 ≤ _n_ ≤ 1000}@} \(compared to {@{Euler _φ_ function}@}\) <!--SR:!2027-04-07,615,321!2028-07-16,884,290-->
...
For {@{_n_ = _p_, a prime}@}, Theorem 1 is {@{equivalent to Fermat's little theorem}@}: {@{$$a^{p-1}\equiv 1{\pmod {p} }\qquad {\text{for all } }a{\text{ coprime to } }p.$$}@} <!--SR:!2030-03-01,1488,361!2029-04-07,1139,341-->
