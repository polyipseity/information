...
For {@{all numbers _N_ and all but _o_\(_N_\)<sup>[\[8\]](#^ref-8)</sup> positive integers _n_ ≤ _N_ \(a "prevailing" majority\)}@}: {@{$$\lambda (n)={\frac {n}{(\ln n)^{\ln \ln \ln n+A+o(1)} } }$$}@} with {@{the constant<sup>[\[7\]](#^ref-7)</sup> $$A:=-1+\sum _{p\in \mathbb {P} }{\frac {\ln p}{(p-1)^{2} } }\approx 0.2269688$$}@} <!--SR:!fsrs,2030-05-13T10:01:25.065Z,1438,1438.48630471,1.42996969,2,10,0,0,2026-06-05T10:01:25.065Z!fsrs,2027-07-05T00:00:00.000Z,299,299.16293132,8.98945847,2,9,0,0,2026-09-09T00:00:00.000Z!fsrs,2030-03-21T00:00:00.000Z,1273,1272.58272393,3.43119979,2,10,0,0,2026-09-25T00:00:00.000Z-->
