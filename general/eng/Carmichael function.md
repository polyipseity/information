...
In this section, {@{an [integer](integer.md) $n$ is divisible by a nonzero integer $m$}@} if {@{there exists an integer $k$ such that $n=km$}@}. This is written as {@{$$m\mid n.$$}@} <!--SR:!2025-01-12,17,301!2025-01-12,17,301!2025-03-21,69,321-->
...
- LoL\(_n_\) \> ⁠4/5⁠ ::@:: ⇔ _λ_\(_n_\) \> _n_<sup>⁠4/5⁠</sup>. <!--SR:!2025-03-22,70,321!2025-01-12,17,301-->
