...
For {@{_n_ = _p_, a prime}@}, Theorem 1 is {@{equivalent to Fermat's little theorem: $$a^{p-1}\equiv 1{\pmod {p} }\qquad {\text{for all } }a{\text{ coprime to } }p.$$}@} <!--SR:!2030-03-01,1488,361!2026-02-23,333,341-->
