...
>   - proof / conclusion ::@:: The above shows $q_i^{\lambda (n) + s_i} \equiv q_i^{s_i} \pmod n$ for all $q_i$, so their product $a^r$ has $a^{\lambda(n) + r} \equiv a^r \pmod n$. QED. <!--SR:!2025-10-07,77,281!2025-08-23,165,270-->
