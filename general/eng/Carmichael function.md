...
In this section, {@{an [integer](integer.md) $n$ is divisible by a nonzero integer $m$}@} if {@{there exists an integer $k$ such that $n=km$}@}. This is written as {@{$$m\mid n.$$}@} <!--SR:!2026-02-15,326,341!2028-08-20,1014,341!2030-01-31,1463,361-->
