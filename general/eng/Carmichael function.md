...
For {@{any sequence _n_<sub>1</sub> \< _n_<sub>2</sub> \< _n_<sub>3</sub> \< ⋯ of positive integers, any constant 0 \< _c_ \< ⁠1/ln 2⁠, and any sufficiently large _i_}@}:<sup>[\[10\]](#^ref-10)</sup><sup>[\[11\]](#^ref-11)</sup> {@{$$\lambda (n_{i})>\left(\ln n_{i}\right)^{c\ln \ln \ln n_{i} }.$$}@} <!--SR:!2025-01-20,19,261!2025-01-21,12,210-->
...
The set of values of the Carmichael function has {@{counting function<sup>[\[12\]](#^ref-12)</sup> $${\frac {x}{(\ln x)^{\eta +o(1)} } },$$}@} where {@{$$\eta =1-{\frac {1+\ln \ln 2}{\ln 2} }\approx 0.08607$$}@} <!--SR:!2025-01-13,13,241!2025-01-12,3,190-->

## use in cryptography

The Carmichael function is {@{important in [cryptography](cryptography.md)}@} due to {@{its use in the [RSA encryption algorithm](RSA%20(cryptosystem).md)}@}. <!--SR:!2025-01-10,15,290!2025-03-04,54,310-->
