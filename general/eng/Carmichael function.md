...
For {@{all positive integers _a_ and _b_}@} it holds that <p> {@{$\lambda (\mathrm {lcm} (a,b))=\mathrm {lcm} (\lambda (a),\lambda (b))$}@}. <p> This is {@{an immediate consequence of the recurrence for the Carmichael function}@}. <!--SR:!2028-03-03,900,341!2029-02-24,1107,341!2027-01-12,550,310-->
