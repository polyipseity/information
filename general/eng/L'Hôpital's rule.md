...
__{@{L'Hôpital's}@} rule__, also known as __{@{Bernoulli's}@} rule__, is {@{a [theorem](theorem.md) used for evaluating [limits](limit%20of%20a%20function.md) of [indeterminate forms](indeterminate%20form.md) from [derivatives](derivative.md)}@}. <!--SR:!2027-07-05,1007,340!2032-04-08,2347,340!2029-03-28,1526,360-->
...
> 4. {@{If $c$ is a finite endpoint of $I$, the limits can be also be [one-sided limits](one-sided%20limit.md) $x\to{}c^+$ or $x\to{}c^-$.}@} <!--SR:!fsrs,2032-03-30T00:00:00.000Z,2068,2067.75772668,2.48061549,2,10,0,0,2026-08-01T00:00:00.000Z!2027-06-17,797,260!2027-10-25,1084,340!2026-11-25,839,340-->
...
<!--pytextgen generate section="948f"--><!-- The following content is generated at 2026-01-26T12:06:20.555486+08:00. Any edits will be overridden! -->
...
- $0\cdot\infty$→::@::←$\infty-\infty$ <!--SR:!2028-11-06,1192,290!fsrs,2033-02-04T00:00:00.000Z,2399,2398.9921666,1,2,10,0,0,2026-07-12T00:00:00.000Z-->
- $\infty-\infty$→::@::←$0^0$ <!--SR:!fsrs,2030-03-14T00:00:00.000Z,1345,1344.9576083,4.98215312,2,10,0,0,2026-07-08T00:00:00.000Z!2027-08-11,776,270-->
- $0^0$→::@::←$1^\infty$ <!--SR:!2027-01-05,790,310!2029-02-19,1305,310-->
- $1^\infty$→::@::←$\infty^0$ <!--SR:!2027-07-26,511,230!2028-06-19,856,270-->
- $\infty^0$→::@::←_(end)_ <!--SR:!2027-06-20,1009,350!fsrs,2028-09-11T01:56:08.989Z,821,821.15724103,2.98092302,2,9,0,0,2026-06-13T01:56:08.989Z-->
...
- $0^0$:@:$\lim_{x\to{c} }f(x)=0^+,\lim_{x\to{c} }g(x)=0$ <!--SR:!fsrs,2028-10-08T00:00:00.000Z,717,717.27447055,2.98092302,2,9,0,0,2026-10-22T00:00:00.000Z-->
...
- $\lim_{x\to{c} }f(x)^{g(x)}=\exp\lim_{x\to{c} }\frac{g(x)}{1/\ln{f(x)} }$:@:$0^0$, $\infty^0$ <!--SR:!2029-10-09,1417,290-->
