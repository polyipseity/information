...
Technically, shutdown occurs {@{if [average revenue](total%20revenue.md) is below [average variable cost](average%20variable%20cost.md) at the profit-maximizing positive level of output}@}. {@{Producing anything}@} would {@{not generate enough revenue to offset the associated variable costs}@}; {@{producing some output}@} would {@{add further costs in excess of revenues to the costs inevitably being incurred \(the [fixed costs](fixed%20cost.md)\)}@}. By {@{not producing, the firm loses only the fixed costs}@}. <!--SR:!2025-02-16,16,290!2025-02-15,15,290!2025-02-15,15,290!2025-02-10,10,270!2025-02-16,16,290!2025-02-14,14,290-->
