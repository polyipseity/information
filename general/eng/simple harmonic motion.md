...
> - {@{$c=x_0-\frac{v_0}\omega{}i$ is the initial [phase space](phase%20space.md) position}@}
> - {@{$A=|c|$ is the [amplitude](amplitude.md)}@}
> - {@{$\phi=\arg{c}$ is the initial [phase](phase%20(waves).md)}@} <!--SR:!2025-10-13,255,276!2030-01-15,1761,376!2029-08-24,1646,376!2026-09-23,728,336!2026-01-08,514,316!2029-05-29,1576,376!2027-04-05,852,336-->
...
>     - intermediate variables: {@{$\hat{n}$ is the [unit vector](unit%20vector.md) of $\vec{\tau}$ and $\theta$ is the pendulum angle from equilibrium}@} <!--SR:!2025-10-17,452,296!2025-12-05,495,316!2028-12-10,1352,378!2027-05-30,949,358!2029-12-28,1722,390-->
