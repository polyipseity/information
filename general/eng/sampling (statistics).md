...
Non-sampling errors are other errors which can impact final survey estimates, caused by problems in data collection, processing, or sample design. Such errors may include {@{over-coverage, under-coverage}@}, {@{measurement error, processing error, participation bias, etc.}@}: <!--SR:!2028-06-08,913,290-->
