...
Traugott's resolvent is {@{stronger than Murray's}@}.<sup>[\[12\]](#^ref-12)</sup><sup>:&hairsp;395&hairsp;</sup> Moreover, it {@{does not introduce new binary junctors}@}, thus avoiding {@{a tendency towards clausal form in repeated resolution}@}. However, formulas may {@{grow longer when a small $p$ is replaced multiple times with a larger $G[{\textit {true} }]$ and/or $G[{\textit {false} }]$}@}.<sup>[\[12\]](#^ref-12)</sup><sup>:&hairsp;398&hairsp;</sup> <!--SR:!2025-09-12,58,310!2025-09-13,59,310!2025-08-31,46,290!2025-09-08,54,310-->
