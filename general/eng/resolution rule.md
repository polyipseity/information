...
For {@{first-order predicate logic}@}, {@{Murray's rule}@} is generalized to {@{allow distinct, but unifiable, subformulas $p_{1}$ and $p_{2}$ of $F$ and $G$}@}, respectively. If $\phi$ is {@{the most general unifier of $p_{1}$ and $p_{2}$}@}, then the generalized resolvent is {@{$F\phi [{\textit {true} }]\lor G\phi [{\textit {false} }]$}@}. While {@{the rule remains sound if a more special substitution $\phi$ is used}@}, no such rule applications are {@{needed to achieve completeness}@}.<sup>\[_[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation%20needed)_\]</sup> <!--SR:!2025-09-10,56,310!2025-09-20,65,310!2025-08-28,43,290!2025-09-21,66,310!2025-09-17,63,310!2025-09-14,60,310!2025-09-13,59,310-->
