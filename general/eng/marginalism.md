...
When {@{the goods and services are continuously divisible in the [limiting case](limiting%20case%20(mathematics).md)}@}: {@{$$MRS_{AB}={\frac {1}{MRS_{BA} } }$$}@} and the marginal rate of substitution is {@{the slope of the [indifference curve](indifference%20curve.md) (multiplied by $-1$)}@}. <!--SR:!2025-09-05,262,330!2025-01-07,81,327!2025-08-23,239,327-->
