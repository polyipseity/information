...
An individual will {@{typically be able to [partially order](partially%20ordered%20set.md) the potential uses of a good or service}@}. If {@{there is [scarcity](scarcity.md)}@}, then {@{a rational agent will satisfy wants of highest possible priority}@}, so that {@{no want is avoidably sacrificed to satisfy a want of _lower_ priority}@}. In {@{the absence of complementarity across the uses}@}, this will imply that {@{the priority of use of any additional amount will be lower than the priority of the established uses}@}, as in this famous example: <!--SR:!2025-10-29,309,347!2026-01-03,361,347!2027-08-27,797,330!2025-11-04,312,330!2025-11-08,316,330!2025-07-29,230,327-->
