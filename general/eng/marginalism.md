...
Neoclassical economics usually {@{supplements or supplants discussion of marginal utility with [indifference curves](indifference%20curve.md)}@}, which were originally {@{derived as the [level curves](level%20set.md) of utility functions}@},<sup>[\[9\]](#^ref-9)</sup> or {@{can be produced without presumption of quantification}@},<sup>[\[4\]](#^ref-4)</sup> but {@{are often simply treated as axiomatic}@}. In {@{the absence of complementarity of goods or services}@}, diminishing marginal utility implies {@{[convexity](convex%20function.md) of indifference curves}@},<sup>[\[4\]](#^ref-4)</sup><sup>[\[9\]](#^ref-9)</sup> although {@{such convexity would also follow from [quasiconcavity](quasiconvex%20function.md) of the utility function}@}. (To understand the above, consider {@{the resulting indifference curves of two goods, each when considered individually has diminishing marginal utility}@}.) <!--SR:!2030-02-09,1546,367!2027-12-12,910,347!2025-11-23,331,347!2026-01-08,366,347!2028-02-23,951,347!2027-05-19,719,327!2028-05-23,966,307!2026-08-03,457,307-->
