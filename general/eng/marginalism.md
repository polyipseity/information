...
Neoclassical economics usually assumes that {@{marginal changes are [infinitesimals](infinitesimal.md) or [limits](limit%20(mathematics).md)}@}. Although {@{this assumption makes the analysis less robust}@}, it {@{increases tractability}@}. One is therefore often {@{told that "marginal" is synonymous with "very small"}@}, though {@{in more general analysis this may not be operationally true}@} and {@{would not in any case be literally true}@}. Frequently, economic analysis concerns {@{the marginal values associated with a change of one unit of a resource}@}, because {@{decisions are often made in terms of units}@}; marginalism seeks to {@{explain unit prices in terms of such marginal values}@}. <!--SR:!2024-12-23,68,310!2025-08-26,252,327!2024-12-27,72,327!2025-09-06,263,330!2025-10-06,291,347!2025-01-07,81,327!2025-03-25,133,310!2025-10-04,289,347!2024-12-27,72,327-->
