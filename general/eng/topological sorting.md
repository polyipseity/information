...
>     {@{mark <i>n</i> with a permanent mark}@}
>     {@{add <i>n</i> to head of <i>L</i>}@}
> </pre> <!--SR:!2030-09-23,1686,374!2026-05-17,428,379!2027-04-30,618,331!2031-08-16,1967,391!2031-08-23,1972,391!2026-05-13,424,379!2030-07-26,1640,378!2027-05-28,685,338!2031-03-12,1840,391!2026-06-18,455,379!2031-11-08,2027,391!2026-06-10,448,379!2026-06-21,457,379!2026-05-12,423,379-->

{@{Each node _n_}@} gets {@{_prepended_ to the output list L only after considering all other nodes that depend on _n_ \(all descendants of _n_ in the graph\)}@}. Specifically, when {@{the algorithm adds node _n_}@}, we are guaranteed that {@{all nodes that depend on _n_ are already in the output list L}@}: they were {@{added to L either by the recursive call to visit\(\) that ended before the call to visit _n_, or by a call to visit\(\) that started even before the call to visit _n_}@}. Since {@{each edge and node is visited once}@}, {@{the algorithm runs in linear time}@}. {@{This depth-first-search-based algorithm}@} is {@{the one described by [Cormen et al. \(2001\)](#^ref-3)}@};<sup>[\[3\]](#^ref-3)</sup> it seems to {@{have been first described}@} {@{in print by Tarjan in 1976}@}.<sup>[\[4\]](#^ref-4)</sup> <!--SR:!2031-01-02,1769,378!2031-12-31,2076,391!2026-05-29,438,379!2031-04-11,1848,378!2026-06-07,446,379!2026-05-14,425,379!2031-04-17,1853,378!2026-12-05,542,319!2027-12-25,857,351!2031-02-25,1815,378!2027-11-17,830,351-->
...
>       - {@{_d_\[_u_\] ← _d_\[_v_\] + _w_}@},
>       - {@{_p_\[_u_\] ← _v_}@}. <!--SR:!2026-05-16,427,379!2031-10-26,2014,391!2030-12-27,1764,378!2031-11-15,2034,391!2031-07-28,1950,391!2030-08-30,1653,379!2030-10-13,1705,378!2032-01-27,2096,391!2031-01-22,1785,378!2026-06-02,441,379!2032-01-14,2083,391-->
