...
{@{A specific example of a pullback}@} is given by the {@{graph of a function}@}. Suppose that {@{$f\colon X\to Y$ is a function}@}. {@{The _graph_ of _f_}@} is {@{the set $$\Gamma _{f}=\{(x,f(x))\colon x\in X\}\subseteq X\times Y.$$}@} The graph can be reformulated as {@{the pullback of _f_ and the identity function on _Y_}@}. By definition, this pullback is {@{$$X\times _{f,Y,1_{Y} }Y=\{(x,y)\colon f(x)=1_{Y}(y)\}=\{(x,y)\colon f(x)=y\}\subseteq X\times Y,$$}@} and this {@{equals $\Gamma _{f}$}@}. <!--SR:!2025-04-26,67,310!2025-04-16,58,310!2025-04-14,57,310!2025-04-21,63,310!2025-04-20,62,310!2025-04-14,57,310!2025-04-20,62,310!2025-03-30,44,290-->
...
- There is {@{a natural isomorphism \(_A_<!-- markdown separator -->×<sub>_C_</sub>_B_\)×<sub>_B_</sub> _D_ ≅ _A_<!-- markdown separator -->×<sub>_C_</sub>_D_}@}. Explicitly, this means:
  ...
  - then the pullback of _f_ and _gh_ is given by _rt_ : _Q_ → _A_ and _u_ : _Q_ → _D_. <!--SR:!2025-04-17,59,310!2025-04-26,67,310!2025-05-06,68,270!2025-04-14,46,250!2025-04-15,58,310!2025-04-25,66,310!2025-04-01,46,290!2025-03-30,42,290!2025-05-11,71,290!2025-04-25,66,310!2025-04-19,61,310!2025-04-14,57,310!2025-06-19,92,270-->
