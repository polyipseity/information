...
- There is {@{a natural isomorphism \(_A_<!-- markdown separator -->×<sub>_C_</sub>_B_\)×<sub>_B_</sub> _D_ ≅ _A_<!-- markdown separator -->×<sub>_C_</sub>_D_}@}. Explicitly, this means:
    ...
    - then the pullback of _f_ and _gh_ is given by _rt_ : _Q_ → _A_ and _u_ : _Q_ → _D_. <!--SR:!2028-01-04,678,270-->
...
- {@{Any category with pullbacks and products}@} {@{has equalizers}@}. <!--SR:!2029-06-02,1232,350!2030-02-26,1374,310-->
