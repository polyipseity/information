...
Because of {@{this example}@}, in {@{a general category}@} {@{the pullback of a morphism _f_ and a [monomorphism](monomorphism.md) _g_}@} can be thought of as {@{the "preimage" under _f_ of the [subobject](subobject.md) specified by _g_}@}. Similarly, {@{pullbacks of two monomorphisms}@} can be thought of as {@{the "intersection" of the two subobjects}@}. <!--SR:!2025-12-26,255,330!2025-12-09,241,330!2027-02-13,546,310!2025-09-24,162,270!2025-12-28,255,330!2026-07-04,353,290-->
...
- {@{[Monomorphisms](monomorphism.md)}@} are {@{stable under pullback}@}: if {@{the arrow _f_ in the diagram is monic}@}, then so is {@{the arrow _p_<sub>2</sub>}@}. Similarly, if {@{_g_ is monic, then so is _p_<sub>1</sub>}@}.<sup>[\[3\]](#^ref-3)</sup> \(annotation: {@{_p_<sub>2</sub> and _p_<sub>1</sub>}@} are {@{respectively arrows opposite to _f_ or _g_ in the commutative diagram}@}.\) <!--SR:!2025-10-31,92,374!2025-10-31,92,374!2025-10-31,92,374!2025-10-30,91,374!2025-11-01,93,374!2025-10-29,90,374!2025-10-29,90,374-->
