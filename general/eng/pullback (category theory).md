...
- [Isomorphisms](isomorphism.md) ::@:: are also stable, and hence, for example, _X_ ×<sub>_X_</sub> _Y_ ≅ _Y_ for any map _Y_ → _X_ \(where the implied map _X_ → _X_ is the identity\). <!--SR:!2026-01-11,267,330!2026-02-16,246,270-->
