...
- {@{[Isomorphisms](isomorphism.md)}@} are {@{also stable}@}, and hence, for example, {@{_X_ ×<sub>_X_</sub> _Y_ ≅ _Y_ for any map _Y_ → _X_}@} \(where {@{the implied map _X_ → _X_ is the identity}@}\). <!--SR:!2025-11-03,95,374!2025-11-02,94,374!2025-11-03,95,374!2027-02-26,482,394-->
