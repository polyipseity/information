...
{@{A similar approach for the line integral path shown in the right of the right figure}@} results in {@{${\frac {\partial }{\partial y} }\varphi (x,y)=Q(x,y)$}@} so {@{$$\mathbf {v} =P(x,y)\mathbf {i} +Q(x,y)\mathbf {j} ={\frac {\partial \varphi }{\partial x} }\mathbf {i} +{\frac {\partial \varphi }{\partial y} }\mathbf {j} =\nabla \varphi$$}@} is proved for {@{the 2-dimensional [Cartesian coordinate system](Cartesian%20coordinate%20system.md)}@}. This proof method can be {@{straightforwardly expanded to a higher dimensional orthogonal coordinate system}@} \(e.g., {@{a 3-dimensional [spherical coordinate system](spherical%20coordinate%20system.md)}@}\) so {@{the converse statement is proved}@}. Another proof is {@{found [here](gradient%20theorem.md) \(annotation: [gradient theorem](gradient%20theorem.md)\) as the converse of the gradient theorem}@}. <!--SR:!2025-07-09,4,321!2025-07-09,4,321!2025-07-09,4,321!2025-07-09,4,321!2025-07-09,4,321!2025-07-09,4,321!2025-07-09,4,321!2025-07-09,4,321-->
