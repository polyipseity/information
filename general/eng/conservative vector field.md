...
Then $\mathbf {v}$ has {@{zero curl everywhere in $U$}@} \({@{$\nabla \times \mathbf {v} \equiv \mathbf {0}$ at everywhere in $U$}@}\), i.e., {@{$\mathbf {v}$ is irrotational}@}. However, {@{the [circulation](circulation%20(physics).md) of $\mathbf {v}$}@} {@{around the [unit circle](unit%20circle.md) in the $xy$-plane is $2\pi$}@}; in {@{[polar coordinates](polar%20coordinates.md)}@}, {@{$\mathbf {v} =\mathbf {e} _{\phi }/r$}@}, so {@{the integral over the unit circle}@} is {@{$$\oint _{C}\mathbf {v} \cdot \mathbf {e} _{\phi }~d{\phi }=2\pi .$$}@} <!--SR:!2026-07-15,292,330!2026-07-03,282,330!2026-04-30,230,330!2026-09-24,353,350!2028-05-05,780,330!2026-09-04,336,350!2026-07-15,292,330!2026-07-14,291,330!2026-09-18,348,350-->
