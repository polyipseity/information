...
Then $\mathbf {v}$ has {@{zero curl everywhere in $U$}@} \({@{$\nabla \times \mathbf {v} \equiv \mathbf {0}$ at everywhere in $U$}@}\), i.e., {@{$\mathbf {v}$ is irrotational}@}. However, {@{the [circulation](circulation%20(physics).md) of $\mathbf {v}$}@} {@{around the [unit circle](unit%20circle.md) in the $xy$-plane is $2\pi$}@}; in {@{[polar coordinates](polar%20coordinates.md)}@}, {@{$\mathbf {v} =\mathbf {e} _{\phi }/r$}@}, so {@{the integral over the unit circle}@} is {@{$$\oint _{C}\mathbf {v} \cdot \mathbf {e} _{\phi }~d{\phi }=2\pi .$$}@} <!--SR:!2026-07-15,292,330!2026-07-03,282,330!2026-04-30,230,330!2025-10-06,76,330!2026-03-17,182,310!2026-09-04,336,350!2026-07-15,292,330!2026-07-14,291,330!2026-09-18,348,350-->
...
>   - __E__, {@{electric field strength}@} <!--SR:!2026-06-29,279,330!2026-08-26,327,350!2026-09-07,339,350!2026-08-29,330,350!2026-09-18,348,350!2026-09-05,337,350!2026-09-10,341,350!2026-09-07,337,350!2025-10-06,76,330!2026-07-10,288,330-->
