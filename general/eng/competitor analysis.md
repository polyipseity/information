...
Competitor analysis can be done {@{anytime as needed}@}. For example, it can expose holes in existing products during {@{idea screening}@}, or determine suitable prices during {@{commercialization}@}.
