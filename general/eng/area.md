...
- rectangle ::@:: Every rectangle $R$ is in $M$ and a rectangle $R$ with width $w$ and height $h$ has area $a(R) = wh$. <!--SR:!2026-11-02,753,330!2026-04-07,17,327-->
...
- subtraction ::@:: If two sets $S$ and $T$ are in $M$ with $S \subseteq T$, then $T \setminus S$ is in $M$ and $a(T \setminus S) = a(T) - a(S)$. <!--SR:!2027-01-31,801,310!2026-04-07,17,327-->
- union and intersection ::@:: If two sets $S$ and $T$ are in $M$, then their union $S \cup T$ and their intersection $S \cap T$ are in $M$ and $a(S \cup T) = a(S) + a(T) - a(S \cap T).$ <!--SR:!2029-03-02,1269,310!2026-04-07,17,327-->
