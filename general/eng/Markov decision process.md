...
- $R_{a}(s,s')$ is ::@:: $1$ if the pole is up after the transition, zero otherwise. Therefore, this function only depend on $s'$ in this specific case. <!--SR:!2025-08-06,179,312!2025-02-21,58,310-->
...
{@{The method of Lagrange multipliers}@} applies to CMDPs. {@{Many Lagrangian-based algorithms}@} have been developed. (annotation: An example is {@{the natural policy gradient primal-dual method}@}.) <!--SR:!2025-02-16,51,309!2025-03-09,71,329!2025-07-15,151,309-->
...
- a function _G_: Φ → α which ::@:: generates the output at each time step. (annotation: Note that the function only depends on the current state, not the current input.) <!--SR:!2025-02-22,59,312!2025-09-01,199,312-->
...
Other than {@{the rewards}@}, a Markov decision process $(S,A,P)$ can be {@{understood in terms of [Category theory](category%20theory.md)}@}. Namely, let {@{${\mathcal {A} }$ denote the [free monoid](free%20monoid.md) with generating set _A_}@}. Let {@{__Dist__ denote the [Kleisli category](Kleisli%20category.md) of the [Giry monad](http://ncatlab.org/nlab/show/Giry+monad)}@}. Then {@{a functor ${\mathcal {A} }\to \mathbf {Dist}$}@} encodes {@{both the set _S_ of states and the probability function _P_}@}. (annotation: Thus, {@{$(\mathcal A, F: \mathcal A \to \mathbf{Dist})$ may be used to represent $(S, A, P)$}@} instead.) (TODO: What is this abstract nonsense?) <!--SR:!2025-03-12,74,329!2025-03-08,71,329!2025-03-09,71,329!2025-03-01,45,269!2025-02-16,51,309!2025-03-10,72,329!2025-07-10,148,309-->
