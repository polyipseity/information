...
{@{[Reinforcement learning](reinforcement%20learning.md)}@} is {@{an interdisciplinary area of [machine learning](machine%20learning.md) and [optimal control](optimal%20control.md)}@} that has, {@{as main objective, finding an approximately optimal policy}@} for {@{MDPs where transition probabilities and rewards are unknown}@}.<sup>[\[18\]](#^ref-18)</sup> <!--SR:!2030-08-20,1644,369!2030-06-11,1588,369!2030-10-18,1692,369!2026-08-12,135,422-->
