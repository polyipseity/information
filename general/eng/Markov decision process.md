...
- $S$ is ::@:: the set of ordered tuples $(\theta ,{\dot {\theta } },x,{\dot {x} })\subset \mathbb {R} ^{4}$ given by pole angle, angular velocity, position of the cart and its speed. <!--SR:!2025-02-22,59,312!2025-02-22,59,312-->
- $A$ is ::@:: $\{-1,1\}$, corresponding to applying a force on the left \(right\) on the cart. <!--SR:!2025-02-28,64,312!2025-02-22,59,312-->
- $P_{a}(s,s')$ is ::@:: the transition of the system, which in this case is going to be deterministic and driven by the laws of mechanics. <!--SR:!2025-02-22,59,312!2025-03-04,67,312-->
- $R_{a}(s,s')$ is ::@:: $1$ if the pole is up after the transition, zero otherwise. Therefore, this function only depend on $s'$ in this specific case. <!--SR:!2025-02-08,44,292!2025-02-21,58,310-->
...
{@{Constrained Markov decision processes \(CMDPS\)}@} are {@{extensions to Markov decision process \(MDPs\)}@}. There are {@{three fundamental differences}@} between MDPs and CMDPs.<sup>[\[14\]](#^ref-14)</sup> <!--SR:!2024-12-28,17,309!2025-03-07,70,329!2025-02-14,49,309-->
...
- a [computable function](computable%20function.md) _A_ which ::@:: after each time step _t_ generates _p_\(_t_ + 1\) from _p_\(_t_\), the current input, and the current state, and (annotation: This makes the automata "learn" from an input.) <!--SR:!2025-01-17,27,272!2025-02-04,41,292-->
...
| {@{transition probability $P_{a}(s,s')$}@} | {@{transition probability $p_{ss'}(a)$}@} |                                  | <!--SR:!2024-12-28,17,309!2024-12-28,17,309!2024-12-28,17,309!2024-12-28,17,309!2024-12-28,17,309!2024-12-28,17,309!2025-03-08,71,329!2025-03-01,65,329!2024-12-28,17,309!2024-12-28,17,309!2025-03-03,67,329!2024-12-28,17,309!2024-12-28,17,309!2025-03-01,65,329-->
...
- [Bellman equation](Bellman%20equation.md) for ::@:: applications to economics. <!--SR:!2025-02-22,59,312!2025-02-22,59,312-->
