...
> - inputs: {@{$\vec{F}_i$ is the [force](force.md) on the $i$-th particle. $\vec{r}_i$ is the [position](position%20(geometry).md) of the $i$-th particle.}@} <!--SR:!2027-07-09,856,290!2026-03-17,536,270!2027-11-09,1108,350!2026-05-04,597,310!2027-07-25,946,330-->

## examples

For {@{[central forces](central%20force.md) in the form of $F \propto r^n$}@}, {@{the virial theorem}@} simplifies to {@{$\langle K_\mathrm{total} \rangle = \frac{n + 1}2 \langle U \rangle$}@}. Particularly, for {@{[gravity](gravitational%20potential.md) and [electrostatic force](Coulomb's%20law.md), for which $n = -2$}@}, {@{$\langle K_\mathrm{total} \rangle = -\frac12 \langle U \rangle$}@}. <!--SR:!2026-09-11,434,257!2030-09-21,1761,297!2026-08-13,167,315!2027-01-24,317,355!2026-03-17,72,335-->
