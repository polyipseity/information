...
>
> An example of {@{series [RLC circuit](RLC%20circuit.md)}@} and respective {@{__phasor diagram__ for a specific _ω_}@}. {@{The arrows in the upper diagram}@} are {@{phasors}@}, drawn in {@{a phasor diagram \([complex plane](complex%20plane.md) without axis shown\)}@}, which must not be {@{confused with the arrows in the lower diagram}@}, which are {@{the reference polarity for the [voltages](voltage.md)}@} and {@{the reference direction for the [current](electric%20current.md)}@}. <!--SR:!2026-06-18,246,330!2026-06-30,255,330!2025-10-24,63,310!2026-06-29,255,330!2026-06-15,243,330!2026-06-30,255,330!2026-05-28,227,330!2026-04-13,178,310!2026-06-06,236,330-->
...
__Ohm's law for resistors__ <p> ::@:: A [resistor](resistor.md) has no time delays and therefore doesn't change the phase of a signal therefore _V_ = _IR_ remains valid. <!--SR:!2025-10-24,63,310!2026-06-27,253,330-->
