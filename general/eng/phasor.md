...
With {@{phasors}@}, {@{the techniques for solving [DC](direct%20current.md) circuits}@} can be {@{applied to solve linear AC circuits}@}.<sup>[\[a\]](#^ref-a)</sup> <!--SR:!2026-06-29,255,330!2025-10-19,59,310!2025-10-27,66,310-->
...
{@{Frequency modulation}@} is {@{a similar representation}@} except that {@{the modulating phasors are not in phase with the carrier}@}. In this case {@{the vector sum of the modulating phasors}@} is {@{shifted 90° from the carrier phase}@}. {@{Strictly}@}, {@{frequency modulation representation}@} requires {@{additional small modulation phasors at $2f_{m},3f_{m}$ etc}@}, but for {@{most practical purposes}@} these are {@{ignored because their effect is very small}@}. <!--SR:!2026-06-14,242,330!2025-10-26,65,310!2025-10-19,59,310!2026-06-30,255,330!2025-10-26,65,310!2026-05-30,229,330!2025-10-19,59,310!2026-06-13,241,330!2026-06-21,248,330!2026-06-26,252,330-->
