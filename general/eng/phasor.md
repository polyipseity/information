...
>
> An example of {@{series [RLC circuit](RLC%20circuit.md)}@} and respective {@{__phasor diagram__ for a specific _ω_}@}. {@{The arrows in the upper diagram}@} are {@{phasors}@}, drawn in {@{a phasor diagram \([complex plane](complex%20plane.md) without axis shown\)}@}, which must not be {@{confused with the arrows in the lower diagram}@}, which are {@{the reference polarity for the [voltages](voltage.md)}@} and {@{the reference direction for the [current](electric%20current.md)}@}. <!--SR:!2026-06-18,246,330!2026-06-30,255,330!2026-07-27,276,330!2026-06-29,255,330!2026-06-15,243,330!2026-06-30,255,330!2026-05-28,227,330!2028-05-23,757,330!2026-06-06,236,330-->
...
- $\arctan \left({\frac {A_{1}\sin \theta _{1}+A_{2}\sin \theta _{2} }{A_{1}\cos \theta _{1}+A_{2}\cos \theta _{2} } }\right)$, ::@:: if $A_{1}\cos \theta _{1}+A_{2}\cos \theta _{2}>0$; <!--SR:!2028-05-30,764,330!2026-06-13,241,330-->
- $\pi +\arctan \left({\frac {A_{1}\sin \theta _{1}+A_{2}\sin \theta _{2} }{A_{1}\cos \theta _{1}+A_{2}\cos \theta _{2} } }\right)$, ::@:: if $A_{1}\cos \theta _{1}+A_{2}\cos \theta _{2}<0$. <!--SR:!2028-06-22,787,330!2026-06-22,249,330-->

or, via {@{the [law of cosines](law%20of%20cosines.md) on the [complex plane](complex%20plane.md)}@} \(or {@{the [trigonometric identity for angle differences](trigonometric%20identity.md#angle%20sum%20and%20difference%20identities)}@}\): {@{$$A_{3}^{2}=A_{1}^{2}+A_{2}^{2}-2A_{1}A_{2}\cos(180^{\circ }-\Delta \theta )=A_{1}^{2}+A_{2}^{2}+2A_{1}A_{2}\cos(\Delta \theta ),$$}@} where {@{$\Delta \theta =\theta _{1}-\theta _{2}$}@}. <!--SR:!2026-07-05,259,330!2026-06-24,251,330!2028-06-21,786,330!2026-06-14,242,330-->
...
- Main article: ::@:: [Phasor measurement unit](phasor%20measurement%20unit.md) <!--SR:!2026-08-01,280,330!2028-07-24,819,330-->
...
>
> A: {@{phasor representation of amplitude modulation}@}, B: {@{alternate representation of amplitude modulation}@}, C: {@{phasor representation of frequency modulation}@}, D: {@{alternate representation of frequency modulation}@} <!--SR:!2027-09-18,533,310!2026-06-09,238,330!2027-01-06,385,310!2026-06-22,249,330!2026-08-15,291,330-->
