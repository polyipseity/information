...
In {@{the phasor shorthand notation}@}, {@{the differential equation reduces}@} to: {@{$$i\omega V_{\text{c} }+{\frac {1}{RC} }V_{\text{c} }={\frac {1}{RC} }V_{\text{s} }.$$}@} <!--SR:!2025-08-20,14,290!2025-08-22,16,290!2025-08-20,14,290-->
