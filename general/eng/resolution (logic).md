...
The above may also be written as: \(annotation: {@{form using implications}@}\) {@{$${\frac {(\neg a_{1}\land \neg a_{2}\land \cdots )\rightarrow c,\quad c\rightarrow (b_{1}\lor b_{2}\lor \cdots )}{(\neg a_{1}\land \neg a_{2}\land \cdots )\rightarrow (b_{1}\lor b_{2}\lor \cdots )} }$$}@} <!--SR:!2026-05-20,251,330!2029-05-09,1097,350-->

Or {@{schematically}@} as: {@{$${\frac {\Gamma _{1}\cup \left\{\ell \right\}\,\,\,\,\Gamma _{2}\cup \left\{ {\overline {\ell } }\right\} }{\Gamma _{1}\cup \Gamma _{2} } }|\ell |$$}@} <!--SR:!2028-08-04,812,330!2026-05-30,258,330-->
...
- $|\ell |$ ::@:: is the resolved atom or pivot. <!--SR:!2026-06-02,261,330!2029-06-09,1122,350-->
...
- $[b/x]$ ::@:: is the most general unifier of the resolved literals. <!--SR:!2026-06-17,273,330!2029-06-04,1117,350-->
...
To understand {@{how resolution works}@}, consider {@{the following example syllogism of [term logic](term%20logic.md)}@}: <!--SR:!2026-05-28,257,330!2029-06-02,1116,350-->
...
- Discard {@{the unified predicates}@}, and combine {@{the remaining ones from the two clauses into a new clause}@}, also {@{joined by the "∨" operator}@}. <!--SR:!2026-06-30,283,330!2026-06-05,263,330!2026-07-02,285,330!2029-04-06,1071,350!2026-07-07,288,330!2029-03-05,1040,350!2029-05-11,1096,350!2026-05-19,250,330!2026-06-20,275,330!2026-07-13,294,330!2026-07-06,288,330!2026-05-24,254,330-->

To {@{apply this rule to the above example}@}, we find {@{the predicate _P_ occurs in negated form}@} <!--SR:!2029-05-26,1111,350!2026-06-12,269,330-->
