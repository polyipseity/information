...
When the two clauses {@{contain more than one pair of complementary literals}@}, the resolution rule can be {@{applied \(independently\) for each such pair}@}; however, the result is {@{always a [tautology](tautology%20(logic).md)}@}. <!--SR:!2026-06-20,276,330!2029-07-31,1160,350!2029-07-24,1153,350-->
...
- The literal $P(x)$ ::@:: is the left resolved literal, <!--SR:!2026-06-18,274,330!fsrs,2029-09-03T14:27:10.949Z,1179,1179.41935434,1,2,9,0,0,2026-06-12T14:27:10.949Z-->
- The literal $\neg P(b)$ ::@:: is the right resolved literal, <!--SR:!2026-06-20,276,330!fsrs,2029-09-11T03:25:43.350Z,1184,1183.64577796,1,2,9,0,0,2026-06-15T03:25:43.350Z-->
...
in the second clause. _X_ is {@{an unbound variable}@}, while {@{_a_ is a bound value \(term\)}@}. {@{Unifying the two produces}@} the substitution \(annotation: {@{_X_ ↦ _a_}@}\) <!--SR:!2026-06-19,274,330!2026-06-26,280,330!2029-07-02,1140,350!2029-08-03,1163,350-->

&emsp; _X_ ↦ _a_

Discarding {@{the unified predicates}@}, and {@{applying this substitution to the remaining predicates}@} \({@{just _Q_\(_X_\)}@}, in this case\), produces the conclusion: \(annotation: {@{_Q_\(_a_\)}@}\) <!--SR:!2029-08-24,1181,350!2026-07-08,290,330!2026-06-19,275,330!2026-06-24,278,330-->
...
- Murray's rule introduced 3 new disjunction symbols: in \(5\), \(6\), and \(7\), ::@:: while Traugott's rule did not introduce any new symbol; in this sense, Traugott's intermediate formulas resemble the user's style more closely than Murray's. <!--SR:!2029-08-21,1180,350!2026-06-19,275,330-->
- Due to the latter issue, Traugott's rule can take advantage of the implication in assumption \(4\), using as $p$ the [non-atomic formula](atomic%20formula.md) $a\rightarrow e$ in step \(12\). ::@:: Using Murray's rules, the semantically equivalent formula $e\lor \lnot a\lor \lnot a$ was obtained as \(7\), however, it could not be used as $p$ due to its syntactic form. <!--SR:!2026-06-22,276,330!2029-07-30,1159,350-->

### non-clausal resolution in first-order logic

For {@{first-order predicate logic}@}, {@{Murray's rule}@} is generalized to {@{allow distinct, but unifiable, subformulas $p_{1}$ and $p_{2}$ of $F$ and $G$}@}, respectively. If $\phi$ is {@{the most general unifier of $p_{1}$ and $p_{2}$}@}, then the generalized resolvent is {@{$F\phi [{\textit {true} }]\lor G\phi [{\textit {false} }]$}@}. While {@{the rule remains sound if a more special substitution $\phi$ is used}@}, no such rule applications are {@{needed to achieve completeness}@}.<sup>\[_[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation%20needed)_\]</sup> <!--SR:!2029-06-03,1116,350!2026-07-01,284,330!2028-03-16,755,330!2026-07-05,287,330!2026-06-18,274,330!2029-08-14,1173,350!2029-08-11,1171,350-->
