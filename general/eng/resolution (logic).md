...
{@{Traugott's resolvent}@} is {@{stronger than Murray's}@}.<sup>[\[12\]](#^ref-12)</sup><sup>:&hairsp;395&hairsp;</sup> Moreover, it does not {@{introduce new binary junctors}@}, thus avoiding {@{a tendency towards clausal form in repeated resolution}@}. However, formulas may {@{grow longer}@} when {@{a small $p$ is replaced multiple times with a larger $G[{\textit {true} }]$ and/or $G[{\textit {false} }]$}@}.<sup>[\[12\]](#^ref-12)</sup><sup>:&hairsp;398&hairsp;</sup> <!--SR:!2026-05-24,254,330!2026-05-30,259,330!2026-03-07,188,310!2028-02-25,730,330!2027-06-22,523,402!2027-06-28,527,402-->
