...
- [Rankine](Rankine%20scale.md):@:from [Celsius](Celsius.md): x °C ≘ (x + 273.15) × 9/5 °R, to [Celsius](Celsius.md): x °R ≘ (x − 491.67) × 5/9 °C <!--SR:!2027-02-28,329,150-->
...
- from [Fahrenheit](Fahrenheit.md): x °F ≘ (x + 459.67) °R, to [Fahrenheit](Fahrenheit.md): x °R ≘ (x − 459.67) °F:@:[Rankine](Rankine%20scale.md) <!--SR:!2032-07-04,2338,330-->
