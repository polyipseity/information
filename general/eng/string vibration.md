...
> where
>
> - [string](string%20(structure).md) properties: {@{$T$ is [tension](tension%20(mechanics).md) and $\mu$ is [linear mass density](linear%20density.md), i.e. [mass](mass.md) per unit [length](length.md)}@} <!--SR:!2025-12-28,462,270!2026-10-23,745,330-->
...
> - [wave](wave.md) properties: {@{$A$ is [amplitude](amplitude.md), $k$ is [angular wavenumber](wavenumber.md), $\omega$ is [angular frequency](angular%20frequency.md), $\phi$ is phase offset}@} <!--SR:!2026-02-19,280,230!2027-12-07,1129,350!2027-07-23,866,290!2025-06-06,359,290-->
