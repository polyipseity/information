...
One way to implement this is, after creating a cluster for each observation, construct {@{a [distance matrix](distance%20matrix.md) of all clusters}@}, where the number in {@{the _i_-th row and _j_-th column is the [distance](distance.md) between the _i_-th and _j_-th clusters}@}. Use the matrix to identify {@{the pair of clusters with the least distance}@}. After merging {@{the pair of clusters}@}, {@{the distance matrix}@} should decrease {@{in dimension by one in both axes}@}. Update {@{the distances to the new merged cluster from other untouched clusters}@}. Repeat this until you have {@{only one cluster left}@}. An optimization is that since {@{distance is symmetric}@}, we can use {@{a lower [triangular matrix](triangular%20matrix.md) to store the distances}@}. <!--SR:!2032-03-26,2157,315!fsrs,2032-07-08T00:00:00.000Z,2185,2184.6608043,1,2,10,0,0,2026-07-15T00:00:00.000Z!2030-04-16,1613,315!2033-03-03,2475,335!2029-10-28,1546,335!2027-04-16,415,386!2027-04-16,416,386!2026-08-24,87,371!fsrs,2028-01-09T00:00:00.000Z,503,502.58921891,1,2,7,0,0,2026-08-24T00:00:00.000Z!2026-08-25,88,371-->
