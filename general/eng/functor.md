...
>
> {@{Functor $F$ must preserve the composition of morphisms $g$ and $f$}@} <!--SR:!2029-10-02,1277,357!2031-01-20,1752,377-->
...
There are {@{many constructions in mathematics that would be functors}@} but for the fact that they {@{"turn morphisms around" and "reverse composition"}@}. We then define {@{a __contravariant functor__ _F_ from _C_ to _D_}@} as a mapping that <!--SR:!2030-04-03,1506,366!2028-08-21,1008,346!2030-11-25,1706,377-->
