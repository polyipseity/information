...
> - exponentiation ::@:: $\lim_{x \to p} {f(x)}^{g(x)} = \lim_{x \to p} f(x)^{\lim_{x \to p} g(x)}\qquad(\lim_{x \to p} f(x) > 0 \text{ or } (\lim_{x \to p} f(x) = 0, 0 < \lim_{x \to p} g(x) < +\infty))$  (If only [real](real%20number.md) $x$ is considered, the base, if it approaches 0, must approach it from the positive.) <!--SR:!2025-05-25,322,250!2025-01-14,235,344-->

#### determinate forms

- see: [extended real number line](extended%20real%20number%20line.md), [indeterminate form](indeterminate%20form.md)

When the limit on the right of the equation does not exist but are in the following determinate forms, {@{it can still be determined by the following rules}@}. In other cases, the limit on the left exists, but {@{the limit on the right is in [indeterminate form](indeterminate%20form.md) that does not allow direct calculation, in which case [L'Hôpital's rule](L'Hôpital's%20rule.md) may be used to determinate the limit}@}. <!--SR:!2026-07-30,689,330!2026-02-01,545,310-->
...
> - {@{$q^{-\infty} = \begin{cases} \infty & \text{if } 0 < q < 1 \\ 0 & \text{if } q > 1 \end{cases}$}@} <!--SR:!2025-09-26,458,310!2025-11-05,511,310!2025-06-14,391,290!2026-02-14,565,290!2025-01-27,275,290!2025-09-11,445,330-->
