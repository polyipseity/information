...
- An [epimorphism](epimorphism.md) ::@:: may be labeled with a $\twoheadrightarrow$. <!--SR:!2025-04-21,59,310!2025-03-05,20,250-->
- An [isomorphism](isomorphism.md) ::@:: may be labeled with a ${\overset {\sim }{\rightarrow } }$. <!--SR:!2025-02-22,16,290!2025-02-22,16,290-->
- The dashed arrow ::@:: typically represents the claim that the indicated morphism exists \(whenever the rest of the diagram holds\); the arrow may be optionally labeled as $\exists$. <!--SR:!2025-02-22,16,290!2025-04-23,60,310-->
...
Note that {@{a diagram may be non-commutative}@}, i.e., {@{the composition of different paths in the diagram may not give the same result}@}. <!--SR:!2025-02-22,16,290!2025-04-26,63,310-->

## examples

### example 1

In {@{the left diagram, which expresses the [first isomorphism theorem](isomorphism%20theorems.md#first%20isomorphism%20theorem)}@}, {@{commutativity of the triangle}@} means that {@{$f={\tilde {f} }\circ \pi$}@}. In the right diagram, {@{commutativity of the square}@} means {@{$h\circ f=k\circ g$}@}. <!--SR:!2025-04-23,61,310!2025-04-24,62,310!2025-04-08,46,290!2025-02-22,16,290!2025-02-22,16,290-->
...
- a node ::@:: for every object in the index category, <!--SR:!2025-02-22,16,290!2025-04-24,61,310-->
...
Conversely, given {@{a commutative diagram}@}, it {@{defines a poset category}@}, where: {@{(annotation: objects, morphisms, uniqueness)}@} <!--SR:!2025-04-15,54,310!2025-04-25,63,310!2025-02-22,16,290-->
...
However, {@{not every diagram commutes \(the notion of diagram strictly generalizes commutative diagram\)}@}. As a simple example, the diagram of {@{a single object with an endomorphism \($f\colon X\to X$\)}@}, or {@{with two parallel arrows \($\bullet \rightrightarrows \bullet$, that is, $f,g\colon X\to Y$, sometimes called the [free quiver](free%20quiver.md)\), as used in the definition of [equalizer](equaliser%20(mathematics).md)}@} {@{need not commute}@}. Further, {@{diagrams may be messy or impossible to draw}@}, when {@{the number of objects or morphisms is large \(or even infinite\)}@}. <!--SR:!2025-04-25,62,310!2025-02-22,16,290!2025-02-22,16,290!2025-04-22,60,310!2025-04-08,46,290!2025-02-22,16,290-->
