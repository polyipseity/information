...
>
> {@{Eye pattern}@} of {@{a 125 Mbit/s MLT-3 signal}@} <!--SR:!2025-11-28,63,310!2025-11-19,56,310!2025-11-27,63,310-->

### PAM

The eye pattern of {@{a [PAM](pulse-amplitude%20modulation.md) \(annotation: pulse-amplitude modulation\) signal}@} should consist of {@{N clearly distinct levels}@} \(depending on {@{the PAM order}@}, for example {@{PAM-4 should have four levels and PAM-3 should have three}@}\). {@{The overall shape}@} should be {@{symmetric about the horizontal axis}@} and {@{the spacing of all levels}@} should be {@{uniform}@}. <!--SR:!2025-11-27,63,310!2025-11-25,61,310!2025-11-30,65,310!2025-11-29,64,310!2025-11-29,64,310!2025-11-19,56,310!2025-11-20,57,310!2025-11-24,60,310-->
