...
>
> {@{Eye pattern}@} of {@{eight million UIs \(unit intervals\)}@} of {@{a 1.25 Gbit/s signal}@} <!--SR:!2025-11-21,58,310!2025-11-21,58,310!2025-09-26,16,290!2025-09-25,15,290-->
...
- Main article: ::@:: [Phase-shift keying](phase-shift%20keying.md) <!--SR:!2025-11-17,54,310!2025-09-26,16,290-->
...
>
> {@{Eye pattern}@} of {@{the same system}@} with {@{multipath interference \(MI\) effects added}@} <!--SR:!2025-09-26,16,290!2025-09-25,15,290!2025-09-26,16,290!2025-11-17,54,310!2025-09-26,16,290!2025-09-25,15,290!2025-09-26,16,290-->

## channel effects

{@{Many properties of a [channel](communication%20channel.md)}@} can be seen in {@{the eye pattern}@}. <!--SR:!2025-11-19,56,310!2025-11-20,57,310-->

### emphasis

{@{[Emphasis](emphasis%20(telecommunications).md)}@} applied to a signal produces {@{an additional level for each value of the signal}@} which is {@{higher \(for pre-emphasis\) or lower \(for de-emphasis\) than the nominal value}@}. <!--SR:!2025-11-20,57,310!2025-09-26,16,290!2025-09-25,15,290-->

{@{The eye pattern for a signal with emphasis}@} may be mistaken for that of {@{a PAM signal}@} at first glance, however {@{closer inspection}@} reveals {@{some key differences}@}. Most notably, {@{an emphasized signal}@} has {@{a limited set of legal transitions}@}: <!--SR:!2025-09-25,15,290!2025-09-26,16,290!2025-09-26,16,290!2025-11-18,55,310!2025-11-19,56,310!2025-11-18,55,310-->

- Strong state to corresponding weak state ::@:: \(1-1 or 0-0 bit pattern\) <!--SR:!2025-11-17,54,310!2025-09-26,16,290-->
- Strong state to opposite strong state ::@:: \(second transition of a 1-0-1 or 0-1-0 bit pattern\) <!--SR:!2025-11-17,54,310!2025-09-26,16,290-->
- Weak state to opposite strong state ::@:: \(second transition of a 1-1-0 or 0-0-1 bit pattern\) <!--SR:!2025-11-21,58,310!2025-09-25,15,290-->

{@{An emphasized signal}@} will never {@{transition from a weak state to the corresponding strong state}@}, {@{a weak state to another weak state}@}, or {@{remain in the same strong state for more than one UI}@}. {@{A PAM signal}@} also normally {@{has equally spaced levels}@} while {@{emphasized levels}@} are normally {@{closer to the nominal signal level}@}. <!--SR:!2025-11-21,58,310!2025-09-26,16,290!2025-09-26,16,290!2025-09-26,16,290!2025-09-26,16,290!2025-09-26,16,290!2025-09-26,16,290!2025-09-26,16,290-->
...
>
> {@{Eye pattern}@} of {@{a 1.25 Gbit/s NRZ signal}@} with {@{a four-inch stub}@} <!--SR:!2025-11-21,58,310!2025-09-25,15,290!2025-09-25,15,290!2025-09-25,15,290-->

## measurements

There are {@{many measurements}@} that can be {@{obtained from an eye diagram}@}:<sup>[\[4\]](#^ref-4)</sup> \(annotation: 2 items: {@{amplitude measurements, time measurements}@}\) <!--SR:!2025-11-20,57,310!2025-09-26,16,290!2025-11-17,54,310-->
...
> - Eye overshoot/undershoot ::@:: [distortion](distortion.md) due to interruptions in the signal path <!--SR:!2025-11-21,58,310!2025-09-25,15,290-->
> - Eye width ::@:: Timing synchronization and [jitter](jitter.md) effects <!--SR:!2025-09-25,15,290!2025-09-25,15,290-->
> - Eye closure ::@:: Intersymbol interference, additive noise <!--SR:!2025-11-20,57,310!2025-11-19,56,310-->
