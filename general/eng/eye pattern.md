...
>
> {@{Eye pattern}@} of {@{eight million UIs \(unit intervals\)}@} of {@{a 1.25 Gbit/s signal}@} <!--SR:!2025-11-21,58,310!2025-11-21,58,310!2025-09-26,16,290!2025-11-23,59,310-->
...
The eye pattern of {@{a [NRZ](non-return-to-zero.md) \(annotation: non-return-to-zero\) signal}@} should consist of {@{two clearly distinct levels with smooth transitions between them}@}. <!--SR:!2025-11-27,63,310!2025-11-23,59,310-->
...
>
> {@{Eye pattern}@} of {@{a PAM-3 signal}@} \({@{[100BASE-T1](100BASE-T1.md#100BASE-T1) automotive Ethernet}@}\) <!--SR:!2025-11-26,62,310!2025-09-26,16,290!2025-11-24,60,310!2025-11-25,61,310-->
...
>
> {@{Eye pattern}@} of {@{the same system}@} with {@{multipath interference \(MI\) effects added}@} <!--SR:!2025-09-26,16,290!2025-11-23,59,310!2025-09-26,16,290!2025-11-17,54,310!2025-09-26,16,290!2025-11-23,59,310!2025-09-26,16,290-->
...
{@{[Emphasis](emphasis%20(telecommunications).md)}@} applied to a signal produces {@{an additional level for each value of the signal}@} which is {@{higher \(for pre-emphasis\) or lower \(for de-emphasis\) than the nominal value}@}. <!--SR:!2025-11-20,57,310!2025-09-26,16,290!2025-11-26,62,310-->

{@{The eye pattern for a signal with emphasis}@} may be mistaken for that of {@{a PAM signal}@} at first glance, however {@{closer inspection}@} reveals {@{some key differences}@}. Most notably, {@{an emphasized signal}@} has {@{a limited set of legal transitions}@}: <!--SR:!2025-11-25,61,310!2025-09-26,16,290!2025-09-26,16,290!2025-11-18,55,310!2025-11-19,56,310!2025-11-18,55,310-->
...
>
> {@{Eye pattern}@} of {@{a 1.25 Gbit/s NRZ signal}@} with {@{a four-inch stub}@} <!--SR:!2025-11-21,58,310!2025-11-25,61,310!2025-11-25,61,310!2025-11-23,59,310-->
...
> __flashcards__
>
> - Eye opening \(height, peak to peak\) ::@:: Additive [noise](noise.md) in the signal <!--SR:!2025-11-24,60,310!2025-11-27,63,310-->
> - Eye overshoot/undershoot ::@:: [distortion](distortion.md) due to interruptions in the signal path <!--SR:!2025-11-21,58,310!2025-11-23,59,310-->
> - Eye width ::@:: Timing synchronization and [jitter](jitter.md) effects <!--SR:!2025-11-24,60,310!2025-11-23,59,310-->
