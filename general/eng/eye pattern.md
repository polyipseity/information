...
>
> {@{Eye pattern}@} of {@{a PAM-3 signal}@} \({@{[100BASE-T1](100BASE-T1.md#100BASE-T1) automotive Ethernet}@}\) <!--SR:!2026-08-21,268,330!2025-11-29,64,310!2026-08-10,259,330!2026-08-19,267,330-->
...
{@{[Emphasis](emphasis%20(telecommunications).md)}@} applied to a signal produces {@{an additional level for each value of the signal}@} which is {@{higher \(for pre-emphasis\) or lower \(for de-emphasis\) than the nominal value}@}. <!--SR:!2026-07-28,250,330!2025-11-28,63,310!2026-08-25,272,330-->
