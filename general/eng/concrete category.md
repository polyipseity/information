...
5. It follows from the previous example that {@{the opposite of any concretizable category _C_ is again concretizable}@}, since if {@{_U_ is a faithful functor _C_ → __Set__}@} then {@{_C_<sup>op</sup> may be equipped with the composite _C_<sup>op</sup> → __Set__<sup>op</sup> → __Set__}@}. <!--SR:!2027-07-10,645,324!2028-01-08,822,330!2026-02-20,316,344-->
