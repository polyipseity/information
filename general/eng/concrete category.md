...
For example, if {@{_S_ and _T_ are two different topologies on the same set _X_}@}, then {@{\(_X_, _S_\) and \(_X_, _T_\) are distinct objects in the category __Top__ of topological spaces and continuous maps}@}, but {@{mapped to the same set _X_ by the forgetful functor __Top__ → __Set__}@}. Moreover, {@{the identity morphism \(_X_, _S_\) → \(_X_, _S_\) and the identity morphism \(_X_, _T_\) → \(_X_, _T_\)}@} are {@{considered distinct morphisms in __Top__}@}, but {@{they have the same underlying function, namely the identity function on _X_}@}. <!--SR:!2027-10-10,776,344!2026-03-24,341,344!2026-03-19,338,344!2028-07-08,909,330!2026-03-24,341,344!2026-02-19,25,372-->
