...
In [mathematics](mathematics.md), an {@{__ellipse__}@} is {@{a [plane curve](plane%20curve.md) surrounding two [focal points](focus%20(geometry).md), such that for all points on the curve, the sum of the two distances to the focal points is a constant}@}. The elongation of an ellipse is measured by {@{its [eccentricity](eccntricity%20(mathematics).md) $e$, a number ranging from $e = 0$ (the [limiting case](limiting%20case%20(mathematics).md) of a [circle](circle.md)) to $e = 1$ (the limiting case of infinite elongation, no longer an ellipse but a [parabola](parabola.md))}@}. <!--SR:!2025-08-23,310,330!2025-03-13,130,270!2027-02-04,701,330-->
