...
In {@{[statistics](statistics.md)}@}, {@{the __method of moments__}@} is {@{a method of [estimation](estimation.md) of population [parameters](statistical%20parameter.md)}@}. The same principle is used to {@{derive higher moments like skewness and kurtosis}@}. <!--SR:!2025-02-16,37,290!2025-01-16,16,290!2025-01-12,12,270!2025-01-16,16,290-->
...
The method of moments was introduced by {@{[Pafnuty Chebyshev](Pafnuty%20Chebyshev.md) in 1887}@} in {@{the proof of the [central limit theorem](central%20limit%20theorem.md)}@}. The idea of {@{matching empirical moments of a distribution to the population moments}@} dates back {@{at least to [Karl Pearson](Karl%20Pearson.md)}@}.<sup>[\[1\]](#^ref-1)</sup> <!--SR:!2025-02-01,24,250!2025-02-07,28,270!2025-01-16,16,290!2025-01-11,11,270-->
