...
In {@{[theoretical physics](theoretical%20physics.md)}@}, {@{wavenumber}@} is defined as {@{the number of [radians](radian.md) per unit distance}@}. It is sometimes called {@{__angular wavenumber__ (symbol $k$)}@}: <!--SR:!2031-09-20,2125,330-->
