...
> where
>
> - {@{$\lambda$}@} is {@{[wavelength](wavelength.md), typically in [centimeters](centimetre.md) \(cm\)}@} <!--SR:!2027-04-30,927,330!2027-12-08,1128,350!2025-12-09,18,325-->

In {@{[theoretical physics](theoretical%20physics.md)}@}, {@{wavenumber}@} is defined as {@{the number of [radians](radian.md) per unit distance}@}. It is sometimes called {@{__angular wavenumber__ (symbol $k$)}@}: <!--SR:!2031-09-20,2125,330!2025-12-10,4,312!2025-12-10,4,312!2025-12-10,4,312-->
