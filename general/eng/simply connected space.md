...
>
> {@{A [sphere](sphere.md) is simply connected}@} because {@{every loop can be contracted \(on the surface\) to a point}@}. <!--SR:!2025-09-15,61,310!2025-09-10,57,310!2026-04-29,234,330-->
...
{@{A universal cover of any \(suitable\) space $X$}@} is {@{a simply connected space which maps to $X$ via a [covering map](covering%20map.md)}@}. <!--SR:!2025-09-10,57,310!2026-04-24,229,330-->
