...
{@{A topological space $X$ is simply connected}@} if and only if {@{$X$ is path-connected}@} and {@{the [fundamental group](fundamental%20group.md) of $X$ at each point is trivial}@}, i.e. {@{consists only of the [identity element](identity%20element.md)}@}. Similarly, {@{$X$ is simply connected}@} if and only if for {@{all points $x,y\in X$}@}, {@{the set of [morphisms](morphism.md) $\operatorname {Hom} _{\Pi (X)}(x,y)$ in the [fundamental groupoid](fundamental%20groupoid.md) of $X$}@} has {@{only one element}@}.<sup>[\[2\]](#^ref-2)</sup> <!--SR:!2025-09-21,66,310!2026-05-04,238,330!2026-05-24,255,330!2026-06-11,268,330!2026-05-12,245,330!2026-06-03,262,330!2026-06-06,264,330!2026-04-23,228,330-->
