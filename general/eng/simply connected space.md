...
- {@{The [Riemann mapping theorem](Riemann%20mapping%20theorem.md)}@} states that {@{any non-empty open simply connected subset of $\mathbb {C}$ \(except for $\mathbb {C}$ itself\)}@} is {@{[conformally equivalent](conformal%20map.md) \(annotation: exists a function that locally preserves angles, but not necessarily lengths\) to the [unit disk](unit%20disk.md)}@}. <!--SR:!2026-06-03,262,330!2026-04-21,211,310!2026-06-06,264,330!2026-06-17,273,330!2026-05-29,258,330!2026-05-13,246,330!2026-06-20,276,330!2026-06-12,269,330!2026-06-21,276,330!2027-06-17,484,390-->
