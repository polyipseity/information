...
__Balance sheet substantiation__ is {@{the [accounting](accounting.md) process conducted by [businesses](business.md) on a regular basis}@} to {@{confirm that the balances held in the primary accounting [system of record](system%20of%20record.md)}@} \(e.g. {@{[SAP](SAP%20ERP.md), [Oracle](Oracle%20Database.md), other ERP system's General Ledger}@}\) are {@{reconciled \(in balance with\)}@} with {@{the balance and transaction records held in the same or supporting sub-systems}@}. <!--SR:!2026-08-03,503,310!2028-01-28,816,290!2026-04-23,136,410!2026-03-07,91,390!2026-06-06,141,410-->
