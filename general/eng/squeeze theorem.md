...
aliases:
  ...
  - squeeze theorem
tags:
  - flashcard/active/general/eng/squeeze_theorem
  - language/in/English
---
...
> 2. If {@{$\lim_{x\to{}a}l(x)=\lim_{x\to{}a}u(x)=L$, and $l(x)\le{f(x)}\le{u(x)}$ for all $x\in{I}$ except possibly at $a$}@}, then {@{$\lim_{x\to{}a}f(x)=L$. (The limits become one-sided if $a$ is an endpoint of $I$.)}@} <!--SR:!2026-12-17,697,270!fsrs,2033-01-30T00:00:00.000Z,2350,2349.817283,1.98030797,2,10,0,0,2026-08-25T00:00:00.000Z-->
