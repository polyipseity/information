...
Applying {@{the recursive formula to calculate $X(n\Delta _{t},m\Delta _{f})$}@}: {@{$$X(n\Delta _{t},m\Delta _{f})=X((n-1)\Delta _{t},m\Delta _{f})-x((n-Q-1)\Delta _{t})e^{-{\frac {j2\pi (n-Q-1)m}{N} } }\Delta _{t}+x((n+Q)\Delta _{t})e^{-{\frac {j2\pi (n+Q)m}{N} } }\Delta _{t}$$}@} \(annotation: The motivation is {@{we can incrementally calculate the results for the current window reusing the results from the previous window}@}. Intuitively, the above equation {@{drops the contribution from the discarded time signal value and adds the contribution from the newly included time signal value}@}.\) <!--SR:!2026-09-12,346,349!2027-05-25,475,309!2026-08-08,315,349!2027-11-27,668,330-->
