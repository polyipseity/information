...
Other examples: {@{$$w(t)=\exp(\sigma -t^{2})$$}@} Normally we call {@{$exp(\sigma -t^{2})$ a [Gaussian function](Gaussian%20function.md) or Gabor function}@}. When we use it, the short-time Fourier transform is called {@{the "Gabor transform"}@}. <!--SR:!2025-07-01,4,289!2025-07-01,4,289!2025-07-01,4,289-->
