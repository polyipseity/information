...
One can consider {@{the STFT for varying window size}@} as {@{a two-dimensional domain \(time and frequency\)}@}, as illustrated in the example below, which can be {@{calculated by varying the window size}@}. However, this is {@{no longer a strictly time-frequency representation}@} – the kernel is {@{not constant over the entire signal}@}. <!--SR:!2026-07-18,302,349!2026-06-23,277,330!2026-08-12,319,349!2026-08-26,332,349!2026-09-09,343,349-->
