...
{@{An alternative definition}@} that is {@{valid only in the vicinity of τ}@}, {@{the inverse transform}@} is: {@{$$x(t)={\frac {1}{w(t-\tau )} }{\frac {1}{2\pi } }\int _{-\infty }^{\infty }X(\tau ,\omega )e^{+i\omega t}\,d\omega .$$}@} <!--SR:!2026-08-19,326,349!2026-08-29,334,349!2026-08-09,316,349!2027-04-07,444,309-->
