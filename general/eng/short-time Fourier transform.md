...
{@{These _N/2_ coefficients}@} represent {@{the frequencies 0 to _f_<sub>s</sub>/2 \(Nyquist\)}@} and {@{two consecutive coefficients}@} are spaced apart by {@{_f_<sub>s</sub>/<!-- markdown separator -->_N_ Hz}@}. <!--SR:!2026-09-05,340,349!2026-06-09,266,330!2026-09-08,343,349!2026-07-26,308,349-->
...
Converting into {@{the discrete form}@}: {@{$$t=n\Delta _{t},f=m\Delta _{f},\tau =p\Delta _{t}$$}@} <br/> {@{$$X(n\Delta _{t},m\Delta _{f})=\sum _{-\infty }^{\infty }w((n-p)\Delta _{t})x(p\Delta _{t})e^{-j2\pi pm\Delta _{t}\Delta _{f} }\Delta _{t}$$}@} <!--SR:!2026-06-13,270,330!2028-05-07,744,349!2026-07-31,238,381-->
...
- a. \(annotation: FFT size\) <!-- flashcard ID: 0e8fbcf9-7fc2-461e-8620-d7db321c6dbc -->::@:: $\Delta _{t}\Delta _{f}={\tfrac {1}{N} }$, where $N$ is an integer <!--SR:!2029-06-10,1123,350!2026-06-12,269,330-->
