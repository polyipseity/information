...
See also {@{the [modified discrete cosine transform](modified%20discrete%20cosine%20transform.md) \(MDCT\)}@}, which is also {@{a Fourier-related transform that uses overlapping windows}@}. <!--SR:!2026-08-22,329,349!2026-09-15,348,349-->

#### sliding DFT

If {@{only a small number of ω are desired}@}, or if {@{the STFT is desired to be evaluated for every shift _m_ of the window}@}, then {@{the STFT may be more efficiently evaluated}@} using a {@{[sliding DFT](sliding%20DFT.md) algorithm}@}.<sup>[\[2\]](#^ref-2)</sup> <!--SR:!2026-08-24,330,349!2026-08-22,329,349!fsrs,2029-08-02T11:18:37.408Z,1154,1153.64404968,1,2,9,0,0,2026-06-05T11:18:37.408Z!fsrs,2029-08-05T11:17:43.578Z,1157,1156.51559272,1,2,9,0,0,2026-06-05T11:17:43.578Z-->
...
- d. \(annotation: window function constraint\) ::@:: Only for implementing the [rectangular-STFT](Rectangular%20mask%20short-time%20Fourier%20transform.md) <!--SR:!2026-08-24,329,349!2026-08-22,329,349-->
