...
One can consider {@{the STFT for varying window size}@} as {@{a two-dimensional domain \(time and frequency\)}@}, as illustrated in the example below, which can be {@{calculated by varying the window size}@}. However, this is {@{no longer a strictly time-frequency representation}@} – the kernel is {@{not constant over the entire signal}@}. <!--SR:!2026-07-18,302,349!fsrs,2029-10-15T00:00:00.000Z,1210,1210.28222352,1,2,9,0,0,2026-06-23T00:00:00.000Z!2026-08-12,319,349!2026-08-26,332,349!2026-09-09,343,349-->
