...
With the above additional assumptions, the PageRank algorithm is modified as follows: {@{The incoming PageRank scores}@} are {@{multiplied by $d$}@}, and {@{$(1 - d) / N$}@} is {@{added to the PageRank of a page per iteration}@}. Mathematically, {@{$$\operatorname{PR}_t(p) = \frac {1 - d} N + d \sum_{r \in B(p)} \frac {\operatorname{PR}_{t - 1}(r)} {L(r)} \,.$$}@} The equation using {@{vectors and matrices}@} is: {@{$$\mathbf{R}_t = \begin{bmatrix} \frac {1 - d} N \\ \stackrel {\vdots} {\scriptstyle \times N} \end{bmatrix} + d \mathbf{M} \mathbf{R}_{t - 1}$$}@} <!--SR:!2031-11-29,2076,330!2026-11-26,569,270!2028-11-02,1218,330!2027-12-28,916,290!2026-08-01,74,359!2026-08-25,98,379!2026-08-23,96,379-->
