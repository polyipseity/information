...
1. conditions <!-- flashcard ID: 966534dc-acbf-4b1b-a0b1-acf81b151ca0 -->::@:: Let $g: [a, b] \to I, f: I \to \mathbb{R}$. $I \subseteq \mathbb{R}$ is a real [interval](interval%20(mathematics).md). $f$ is [continuous](continuous%20function.md). $g$ is [differentiable](differentiable%20function.md) and $g'$ is [integrable](integral.md). <!--SR:!fsrs,2031-08-05T00:00:00.000Z,1833,1833.26101173,1,2,10,0,0,2026-07-29T00:00:00.000Z!fsrs,2033-10-04T00:00:00.000Z,2532,2531.6720225,1,2,10,0,0,2026-10-29T00:00:00.000Z-->
2. result ::@:: $$\int_a^b \! f(g(x)) \cdot g'(x) \,\mathrm{d}x = \int_{g(a)}^{g(b)} \! f(u) \,\mathrm{d}u$$ <!--SR:!2028-11-09,1324,350!fsrs,2034-04-30T00:00:00.000Z,2765,2765.34506881,1,2,10,0,0,2026-10-04T00:00:00.000Z-->

### statement for indefinite integrals

1. conditions <!-- flashcard ID: 0f7756e3-85b4-48d0-a619-7d8062b916e1 -->::@:: Let $g: [a, b] \to I, f: I \to \mathbb{R}$. $I \subseteq \mathbb{R}$ is a real [interval](interval%20(mathematics).md). $f$ is [continuous](continuous%20function.md). $g$ is [differentiable](differentiable%20function.md) and $g'$ is [integrable](integral.md). <!--SR:!2031-03-05,1770,294!2029-10-21,1375,314-->
2. result ::@:: $$\int \! f(g(x)) \cdot g'(x) \,\mathrm{d}x = \int \! f(u) \,\mathrm{d}u \qquad u := g(x), x \in [a, b]$$ <!--SR:!2030-10-25,1829,330!fsrs,2032-09-19T00:00:00.000Z,2231,2231.21382539,1,2,10,0,0,2026-08-11T00:00:00.000Z-->
