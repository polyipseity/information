...
- {@{[Adaptive equalizer](adaptive%20equalizer.md)}@}: is typically {@{a linear equalizer or a DFE}@}. It {@{updates the equalizer parameters \(such as the filter coefficients\)}@} as {@{it processes the data}@}. Typically, it uses {@{the MSE cost function}@}; it assumes that it {@{makes the correct symbol decisions}@}, and uses {@{its estimate of the symbols to compute e}@}, which is defined above. <!--SR:!fsrs,2029-08-29T00:00:00.000Z,1126,1126.27892251,1,2,9,0,0,2026-07-30T00:00:00.000Z!2026-08-08,262,330!2026-08-20,272,330!2026-08-24,275,330!2026-08-21,272,330!2026-09-11,288,330!2026-08-23,274,330-->
