...
- {@{Linear equalizer}@}: {@{processes the incoming signal}@} with {@{a linear filter}@}
  ...
  - {@{[Zero-forcing equalizer](zero-forcing%20equalizer.md)}@}: {@{approximates the inverse of the channel}@} with {@{a linear filter}@}. <!--SR:!2026-08-21,272,330!2025-11-27,67,310!2026-08-11,264,330!2025-11-27,67,310!2026-07-07,237,330!2026-08-25,276,330!2026-07-23,250,330!2026-07-17,245,330!2025-11-27,67,310-->
...
- {@{[Adaptive equalizer](adaptive%20equalizer.md)}@}: is typically {@{a linear equalizer or a DFE}@}. It {@{updates the equalizer parameters \(such as the filter coefficients\)}@} as {@{it processes the data}@}. Typically, it uses {@{the MSE cost function}@}; it assumes that it {@{makes the correct symbol decisions}@}, and uses {@{its estimate of the symbols to compute e}@}, which is defined above. <!--SR:!2026-07-29,255,330!2026-08-08,262,330!2026-08-20,272,330!2026-08-24,275,330!2026-08-21,272,330!2025-11-27,67,310!2026-08-23,274,330-->
