...
A number of different luminosity classes are distinguished, as listed in the table below. The [luminosity](luminosity.md) {@{generally decreases with increasing Roman numerals}@}.
