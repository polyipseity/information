...
It is easy to see that {@{$S(0)$}@} is {@{the multiplicative [right identity](identity%20element.md)}@}: {@{$$a\cdot S(0)=a+(a\cdot 0)=a+0=a \,.$$}@} <!--SR:!2030-04-01,1597,365!2026-05-05,139,402!2026-04-26,131,402-->
...
Therefore, by {@{the induction axiom}@} {@{$S(0)$}@} is {@{the multiplicative left identity of all natural numbers}@}. Moreover, it can be shown that {@{multiplication}@} is {@{commutative and [distributes over](distributive%20property.md) addition}@}: {@{$$a\cdot (b+c)=(a\cdot b)+(a\cdot c) \,.$$}@} <!--SR:!2030-04-12,1604,365!2029-05-05,1320,350!2026-04-29,134,402!2027-02-27,378,402!2026-05-13,129,404!2026-05-16,132,404-->
...
Thus, {@{the structure (__N__, +, ·, 1, 0, ≤)}@} is {@{an [ordered semiring](ordered%20ring.md)}@}; because there is no {@{natural number between 0 and 1, it is a discrete ordered semiring}@}. <!--SR:!2028-03-03,915,305!2027-02-08,392,210!2026-07-11,140,406-->
...
Thus, by {@{the strong induction principle}@}, for {@{every _n_ ∈ __N__, _n_ ∉ _X_}@}. Thus, {@{_X_ ∩ __N__ = ∅}@}, which {@{[contradicts](contradiction.md) _X_ being a nonempty subset of __N__}@}. Thus {@{_X_ has a least element}@}. <!--SR:!2027-12-07,778,285!2028-01-14,946,345!2028-01-03,659,416!2026-03-28,132,396!2026-03-27,131,396-->
