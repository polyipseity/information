...
Therefore, by {@{the induction axiom}@} {@{$S(0)$}@} is {@{the multiplicative left identity of all natural numbers}@}. Moreover, it can be shown that {@{multiplication}@} is {@{commutative and [distributes over](distributive%20property.md) addition}@}: {@{$$a\cdot (b+c)=(a\cdot b)+(a\cdot c) \,.$$}@} <!--SR:!2030-04-12,1604,365!2029-05-05,1320,350!2026-04-29,134,402!2026-02-14,71,382!2026-05-13,129,404!2026-05-16,132,404-->
