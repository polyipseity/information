...
It is easy to see that {@{$S(0)$}@} is {@{the multiplicative [right identity](identity%20element.md)}@}: {@{$$a\cdot S(0)=a+(a\cdot 0)=a+0=a \,.$$}@} <!--SR:!2030-04-01,1597,365!2025-12-17,26,382!2026-04-26,131,402-->
