...
It is easy to see that {@{$S(0)$}@} is {@{the multiplicative [right identity](identity%20element.md)}@}: {@{$$a\cdot S(0)=a+(a\cdot 0)=a+0=a \,.$$}@} <!--SR:!2030-04-01,1597,365!2026-05-05,139,402!2028-04-18,719,422-->
...
Therefore, by {@{the induction axiom}@} {@{$S(0)$}@} is {@{the multiplicative left identity of all natural numbers}@}. Moreover, it can be shown that {@{multiplication}@} is {@{commutative and [distributes over](distributive%20property.md) addition}@}: {@{$$a\cdot (b+c)=(a\cdot b)+(a\cdot c) \,.$$}@} <!--SR:!2030-04-12,1604,365!2029-05-05,1320,350!2028-04-27,728,422!2027-02-27,378,402!2026-05-13,129,404!2026-05-16,132,404-->
