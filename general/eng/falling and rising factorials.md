...
Finally, {@{[duplication](multiplication%20theorem.md) and [multiplication formulas](multiplication%20theorem.md)}@} for {@{the falling and rising factorials}@} provide {@{the next relations}@}: \(annotation: 4 items: {@{multiplication formula for falling factorial, multiplication formula for rising factorial}@}, {@{multiplication formula for rising factorial in its base, duplication formula for rising factorial}@}\) <!--SR:!2028-05-29,941,330!2027-12-06,624,409!2026-03-25,119,389!2026-03-28,121,389!2026-05-11,120,392-->
