...
{@{The normalization factor multiplying the DFT and IDFT (here $1$ and $\frac 1 N$) and the signs of the exponents}@} are {@{the most common [conventions](sign%20convention.md)}@}. The only actual requirements of these conventions are that {@{the DFT and IDFT have opposite-sign exponents and that the product of their normalization factors be $\frac 1 N$}@}. {@{An uncommon normalization of $\sqrt{\frac 1 N}$ for both the DFT and IDFT}@} makes {@{the transform-pair unitary}@}. <!--SR:!2025-07-19,267,330!2028-10-07,1182,350!2025-08-20,291,330!2026-10-16,587,310!2026-05-04,463,310-->
