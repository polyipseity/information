...
> - intuition of the convolution theorem for discrete Fourier transform (DFT) ::@:: Discrete Fourier transform (DFT) makes (or requires) the signal in both the time and frequency domains discrete and periodic. The intuition for DFT is similar to that for DTFT. Simply repeat the chain of reasoning, but with periodic discrete signals in mind. Note that the above reasoning becomes mathematically rigorous for the DFT case. <!--SR:!2025-11-07,351,367!2028-03-07,1020,367-->
