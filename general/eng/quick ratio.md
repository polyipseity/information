...
The quick ratio is {@{similar to the [current ratio](current%20ratio.md)}@}, but it provides {@{a more conservative assessment of the liquidity position of a firm as it excludes [inventory](inventory.md)}@},<sup>[\[1\]](#^ref-1)</sup> which it {@{does not consider as sufficiently liquid}@}. <!--SR:!2028-04-11,1005,350!2028-02-06,884,330-->
