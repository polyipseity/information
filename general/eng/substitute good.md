...
{@{Two goods}@} are {@{__net substitutes__}@} when {@{the demand for good X increases when the price of good Y increases}@} and {@{the utility derived from the substitute remains constant}@}.<sup>[\[10\]](#^ref-10)</sup> <!--SR:!2028-12-05,1151,350-->
