...
The __triple-alpha process__ is {@{a set of [nuclear fusion](nuclear%20fusion.md) reactions by which three [helium-4](helium-4.md) nuclei ([alpha particles](alpha%20particle.md)) are transformed into [carbon](carbon.md)}@}.

## triple-alpha process in stars

[Helium](helium.md) {@{accumulates in the [cores](stellar%20core.md) of stars}@} as a result of {@{the [proton–proton chain reaction](proton–proton%20chain.md) and the [carbon–nitrogen–oxygen cycle](CNO%20cycle.md)}@}.
...
As a side effect of the process, {@{some carbon nuclei fuse with additional helium to produce a stable isotope of oxygen and energy (in the form of 1 gamma ray)}@} when {@{the temperature rises above 2×10<sup>8</sup> K}@}, called {@{[_alpha capture_](alpha%20process.md)}@}:

1. [alpha capture](alpha%20process.md) ::@:: $${}_{\phantom{0}6}^{12}\mathrm{C} + {}_2^4\mathrm{He} \rightarrow {}_{\phantom{0}8}^{16}\mathrm{O} + \gamma \quad (+7.162\mathrm{\ MeV})$$
    - [alpha capture](alpha%20process.md) / energy release ::@:: +7.162 MeV

Nuclear fusion reactions of {@{helium with hydrogen produces [lithium-5](isotopes%20of%20lithium.md#lithium-5)}@}, which also is {@{highly unstable, and decays back into smaller nuclei with a half-life of 3.7×10<sup>−22</sup> s}@}.
