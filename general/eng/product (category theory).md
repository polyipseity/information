...
- In the [category of modules](category%20of%20modules.md) over some ring $R$, the product ::@:: is the Cartesian product with addition defined componentwise and distributive multiplication. <!--SR:!2025-01-28,12,270!2025-01-25,5,250-->
...
- In the category of [semi-abelian monoids](trace%20monoid.md), the product ::@:: is given by the [history monoid](history%20monoid.md). <!--SR:!2025-01-28,12,270!2025-01-25,5,250-->
- In the category of [Banach spaces](Banach%20spaces.md) and [short maps](short%20map.md), the product ::@:: carries the [_l_<sup>∞</sup>](l-infinity.md) norm.<sup>[\[2\]](#^ref-2)</sup> <!--SR:!2025-01-25,5,250!2025-02-01,16,290-->
- A [partially ordered set](partially%20ordered%20set.md) can be treated as a category, using the order relation as the morphisms. In this case the products and [coproducts](coproduct.md) ::@:: correspond to greatest lower bounds \([meets](meet%20(mathematics).md)\) and least upper bounds \([joins](join%20(mathematics).md)\). <!--SR:!2025-01-28,12,270!2025-01-25,5,250-->
