...
The product is denoted {@{$\prod _{i\in I}X_{i}$}@}. If {@{$I=\{1,\ldots ,n\}$}@}, then it is denoted {@{$X_{1}\times \cdots \times X_{n}$}@} and the product of morphisms is denoted {@{$\langle f_{1},\ldots ,f_{n}\rangle$}@}. <!--SR:!2028-10-30,1078,350!2028-11-05,1082,350!2027-12-28,812,330!2029-06-15,1250,350-->
...
- [Categorical pullback](categorical%20pullback.md) – ::@:: Most general completion of a commutative square given two morphisms with same codomain <!--SR:!2028-05-02,841,290!fsrs,2031-05-27T00:00:00.000Z,1724,1723.77050618,1,2,10,0,0,2026-09-06T00:00:00.000Z-->
