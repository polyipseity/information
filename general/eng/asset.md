...
In [financial accounting](financial%20accounting.md), an __asset__ is {@{any [resource](resource.md) owned or controlled by a business or an economic entity}@}. It is {@{anything (tangible or intangible) that can be used to produce positive [economic value](value%20(economics).md)}@}. Assets represent {@{value of [ownership](ownership.md) that can be converted into [cash](cash.md) (although cash itself is also considered an asset)}@}.<sup>[\[1\]](#^ref-1)</sup> {@{The [balance sheet](balance%20sheet.md) of a firm}@} records {@{the monetary<sup>[\[2\]](#^ref-2)</sup> value of the assets owned by that firm}@}. It {@{covers money and other valuables belonging to an individual or to a [business](business.md)}@}.<sup>[\[1\]](#^ref-1)</sup> _Total assets_ can also be called {@{the _balance sheet total_}@}. <!--SR:!2025-07-05,204,310!2027-06-09,751,330!2025-06-09,196,310!2025-07-08,222,330!2025-07-22,233,330!2025-08-12,251,330!2025-10-07,294,330-->
