...
>
> - $\log\left(b^x\right) = x \log b \qquad (b \in \mathbb{R}^+, x \in \mathbb{R})$ ::@:: <br/> __counterexample__: $b = -i, x = 2$ <br/> __fix__: $\log(b^x) = x \log b \pmod{2\pi i} \qquad (\log(*) \text{ is single-valued})$ <!--SR:!2025-06-11,76,235!2025-05-22,64,235-->
