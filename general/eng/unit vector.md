...
- (annotation: $\boldsymbol {\hat \varphi}$, Cartesian basis) ::@:: $${\boldsymbol {\hat {\varphi } } }=-\sin \varphi \mathbf {\hat {x} } +\cos \varphi \mathbf {\hat {y} }$$ (annotation: memorize the effect of $\varphi$, and then the effect of $\theta$; the latter of which is null, as in cylindrical coordinates) <!--SR:!2025-12-01,217,319!2025-05-12,68,319-->
...
- (annotation: $\frac {\partial \mathbf {\hat r} } {\partial \varphi}$) ::@:: $${\frac {\partial \mathbf {\hat {r} } }{\partial \varphi } }=-\sin \theta \sin \varphi \mathbf {\hat {x} } +\sin \theta \cos \varphi \mathbf {\hat {y} } =\sin \theta {\boldsymbol {\hat {\varphi } } }$$ (annotation: $\boldsymbol {\hat \varphi}$ modulated by the polar angle $\theta$) <!--SR:!2025-05-29,73,279!2025-05-25,70,279-->
- (annotation: $\frac {\partial \mathbf {\hat r} } {\partial \theta}$) ::@:: $${\frac {\partial \mathbf {\hat {r} } }{\partial \theta } }=\cos \theta \cos \varphi \mathbf {\hat {x} } +\cos \theta \sin \varphi \mathbf {\hat {y} } -\sin \theta \mathbf {\hat {z} } ={\boldsymbol {\hat {\theta } } }$$ <!--SR:!2025-05-25,70,279!2025-05-12,68,319-->
- (annotation: $\frac {\partial \boldsymbol {\hat \theta} } {\partial \varphi}$) ::@:: $${\frac {\partial {\boldsymbol {\hat {\theta } } } }{\partial \varphi } }=-\cos \theta \sin \varphi \mathbf {\hat {x} } +\cos \theta \cos \varphi \mathbf {\hat {y} } =\cos \theta {\boldsymbol {\hat {\varphi } } }$$ (annotation: $\boldsymbol {\hat \varphi}$ modulated by the polar angle $\theta$) <!--SR:!2025-05-29,73,279!2025-07-03,93,279-->
...
- (annotation: $\frac {\partial \boldsymbol {\hat \varphi} } {\partial \varphi}$) ::@:: $${\frac {\partial {\boldsymbol {\hat {\varphi } } } }{\partial \varphi } }=-\cos \varphi \mathbf {\hat {x} } -\sin \varphi \mathbf {\hat {y} } =-\sin \theta \mathbf {\hat {r} } -\cos \theta {\boldsymbol {\hat {\theta } } }$$ (annotation: the derivative vector is in the plane formed by $\mathbf {\hat r}$ and $\boldsymbol {\hat \theta}$) <!--SR:!2025-08-05,107,259!2025-05-25,70,279-->
...
| {@{Possible angular deviation relative to some axis/line}@}                                                         | {@{$\mathbf {\hat {e} } _{\angle }$}@}                                                                                                                                                                    | {@{!["200px"](../../archives/Wikimedia%20Commons/Angular%20unit%20vector.svg)}@} <p> Unit vector at {@{acute deviation angle _φ_ \(including 0 or _π_/2 rad\) relative to a principal direction}@}.                                                                                                                                                                                                                                                                                                                      | <!--SR:!2025-05-17,73,319!2025-05-15,71,319!2025-05-10,66,310!2025-05-13,69,319!2025-08-06,129,299!2025-05-13,69,319!2025-05-17,73,319!2025-05-14,70,319!2025-05-12,68,319!2025-06-29,92,279!2025-05-15,71,319!2025-10-17,172,279!2025-05-13,69,319!2025-05-16,72,319!2025-07-24,118,299!2025-05-14,71,319!2025-05-12,68,319!2025-05-17,73,319!2025-05-15,71,319!2025-05-14,71,319!2025-05-12,69,319!2025-05-15,71,319!2025-05-16,73,319-->
