...
In {@{[mathematics](mathematics.md)}@}, {@{a __unit vector__}@} in {@{a [normed vector space](normed%20vector%20space.md) is a [vector](vector%20(mathematics%20and%20physics).md) \(often a [spatial vector](vector%20(geometry).md)\) of [length](norm%20(mathematics).md) 1}@}. A unit vector is often denoted by {@{a lowercase letter with a [circumflex](circumflex.md), or "hat"}@}, as in {@{${\hat {\mathbf {v} } }$ \(pronounced "v-hat"\)}@}. {@{The term _normalized vector_}@} is sometimes {@{used as a synonym for _unit vector_}@}. <!--SR:!2030-07-05,1536,359!2030-05-02,1490,359!2030-03-25,1460,359!2030-06-25,1526,359!2030-07-02,1533,359!2030-06-20,1521,359!2030-05-20,1506,359-->
...
{@{The proof \(annotation: that a normalized nonzero vector has unit length\)}@} is the following: {@{$$\|\mathbf {\hat {u} } \|={\sqrt { {\frac {u_{1} }{\sqrt {u_{1}^{2}+...+u_{n}^{2} } } }^{2}+...+{\frac {u_{n} }{\sqrt {u_{1}^{2}+...+u_{n}^{2} } } }^{2} } }={\sqrt {\frac {u_{1}^{2}+...+u_{n}^{2} }{u_{1}^{2}+...+u_{n}^{2} } } }={\sqrt {1} }=1$$}@} <!--SR:!2030-03-09,1446,359!fsrs,2028-11-05T00:00:00.000Z,763,763.30968033,1,2,8,0,0,2026-10-04T00:00:00.000Z-->
...
- ${\boldsymbol {\hat {\rho } } }$ \(also designated $\mathbf {\hat {e} }$ or ${\boldsymbol {\hat {s} } }$\), ::@:: representing the direction along which the distance of the point from the axis of symmetry is measured; <!--SR:!2030-05-16,1503,359!2030-06-03,1517,359-->
- ${\boldsymbol {\hat {\varphi } } }$, ::@:: representing the direction of the motion that would be observed if the point were rotating counterclockwise about the [symmetry axis](symmetry%20axis.md); <!--SR:!2030-06-24,1525,359!2030-02-24,1436,359-->
...
- (annotation: $\boldsymbol {\hat \rho}$, Cartesian basis) ::@:: $${\boldsymbol {\hat {\rho } } }=\cos(\varphi )\mathbf {\hat {x} } +\sin(\varphi )\mathbf {\hat {y} }$$ <!--SR:!2030-02-16,1430,359!2030-05-12,1499,359-->
- (annotation: $\boldsymbol {\hat \varphi}$, Cartesian basis) ::@:: $${\boldsymbol {\hat {\varphi } } }=-\sin(\varphi )\mathbf {\hat {x} } +\cos(\varphi )\mathbf {\hat {y} }$$ <!--SR:!2029-03-01,1068,339!2029-01-20,1037,339-->
- (annotation: $\boldsymbol {\hat z}$, Cartesian basis) ::@:: $$\mathbf {\hat {z} } =\mathbf {\hat {z} } .$$ <!--SR:!2030-01-10,1396,354!2030-06-27,1528,359-->

{@{The vectors ${\boldsymbol {\hat {\rho } } }$ and ${\boldsymbol {\hat {\varphi } } }$}@} are {@{functions of $\varphi$, and are _not_ constant in direction}@}. When {@{differentiating or integrating in cylindrical coordinates}@}, {@{these unit vectors themselves must also be operated on}@}. {@{The derivatives with respect to $\varphi$}@} are: <!--SR:!2030-03-27,1461,359!2030-01-31,1415,359!2030-05-28,1513,359!2030-03-21,1456,359!2030-01-04,1394,359-->
...
- (annotation: $\frac {\partial \boldsymbol {\hat \varphi} } {\partial \varphi}$) ::@:: $${\frac {\partial {\boldsymbol {\hat {\varphi } } } }{\partial \varphi } }=-\cos \varphi \mathbf {\hat {x} } -\sin \varphi \mathbf {\hat {y} } =-{\boldsymbol {\hat {\rho } } }$$ <!--SR:!2029-02-09,1051,339!fsrs,2030-05-05T00:00:00.000Z,1395,1394.79813906,1.5300312,2,10,0,0,2026-07-10T00:00:00.000Z-->
...
- (annotation: $\boldsymbol {\hat \theta}$, Cartesian basis) ::@:: $${\boldsymbol {\hat {\theta } } }=\cos \theta \cos \varphi \mathbf {\hat {x} } +\cos \theta \sin \varphi \mathbf {\hat {y} } -\sin \theta \mathbf {\hat {z} }$$ (annotation: memorize the effect of $\varphi$, and then the effect of $\theta$) <!--SR:!fsrs,2029-02-06T00:36:18.804Z,976,976.16992833,3.5312613,2,9,0,0,2026-06-06T00:36:18.804Z!fsrs,2029-07-12T00:00:00.000Z,1077,1077.05771806,3.5312613,2,9,0,0,2026-07-31T00:00:00.000Z-->
...
{@{The spherical unit vectors}@} depend on {@{both $\varphi$ and $\theta$}@}, and hence there are {@{5 possible non-zero derivatives}@}. For a more complete description, see {@{[Jacobian matrix and determinant](Jacobian%20matrix%20and%20determinant.md)}@}. The non-zero derivatives are: <!--SR:!2030-06-10,1524,359!2030-05-06,1495,359!2030-05-28,1512,359!2030-05-01,1489,359-->
...
- (annotation: $\frac {\partial \boldsymbol {\hat \theta} } {\partial \varphi}$) ::@:: $${\frac {\partial {\boldsymbol {\hat {\theta } } } }{\partial \varphi } }=-\cos \theta \sin \varphi \mathbf {\hat {x} } +\cos \theta \cos \varphi \mathbf {\hat {y} } =\cos \theta {\boldsymbol {\hat {\varphi } } }$$ (annotation: $\boldsymbol {\hat \varphi}$ modulated by the polar angle $\theta$) <!--SR:!2027-06-23,555,279!fsrs,2030-04-12T00:00:00.000Z,1378,1378.27036221,1.5300312,2,10,0,0,2026-07-04T00:00:00.000Z-->
- (annotation: $\frac {\partial \boldsymbol {\hat \theta} } {\partial \theta}$) ::@:: $${\frac {\partial {\boldsymbol {\hat {\theta } } } }{\partial \theta } }=-\sin \theta \cos \varphi \mathbf {\hat {x} } -\sin \theta \sin \varphi \mathbf {\hat {y} } -\cos \theta \mathbf {\hat {z} } =-\mathbf {\hat {r} }$$ <!--SR:!2028-01-14,691,279!fsrs,2030-02-23T00:00:00.000Z,1345,1345.13550274,1.5300312,2,9,0,0,2026-06-19T00:00:00.000Z-->
- (annotation: $\frac {\partial \boldsymbol {\hat \varphi} } {\partial \varphi}$) ::@:: $${\frac {\partial {\boldsymbol {\hat {\varphi } } } }{\partial \varphi } }=-\cos \varphi \mathbf {\hat {x} } -\sin \varphi \mathbf {\hat {y} } =-\sin \theta \mathbf {\hat {r} } -\cos \theta {\boldsymbol {\hat {\theta } } }$$ (annotation: the derivative vector is in the plane formed by $\mathbf {\hat r}$ and $\boldsymbol {\hat \theta}$) <!--SR:!2029-03-02,1023,279!2027-05-28,539,279-->

### general unit vectors

- Main article: ::@:: [Orthogonal coordinates](orthogonal%20coordinates.md) <!--SR:!2028-03-20,873,339!2030-02-21,1434,359-->

Common themes of unit vectors occur {@{throughout [physics](physics.md) and [geometry](geometry.md)}@}:<sup>[\[4\]](#^ref-4)</sup> <!--SR:!2030-05-11,1498,359-->
...
>     - Tangent vector to a curve/flux line / Nomenclature ::@:: $\mathbf {\hat {t} }$ <!--SR:!fsrs,2027-11-28T00:00:00.000Z,434,434.00191259,1,2,8,0,0,2026-09-20T00:00:00.000Z!fsrs,2028-10-08T00:00:00.000Z,740,739.81467051,1,2,8,0,0,2026-09-29T00:00:00.000Z-->
>     - Tangent vector to a curve/flux line / Diagram ::@:: !["200px"](../../archives/Wikimedia%20Commons/Tangent%20normal%20binormal%20unit%20vectors.svg) <p> !["200px"](../../archives/Wikimedia%20Commons/Polar%20coord%20unit%20vectors%20and%20normal.svg) <p> A normal vector $\mathbf {\hat {n} }$ to the plane containing and defined by the radial position vector $r\mathbf {\hat {r} }$ and angular tangential direction of rotation $\theta {\boldsymbol {\hat {\theta } } }$ is necessary so that the vector equations of angular motion hold. <!--SR:!fsrs,2028-09-21T00:00:00.000Z,726,725.66338141,1,2,8,0,0,2026-09-26T00:00:00.000Z!fsrs,2028-02-24T00:00:00.000Z,552,552.195452,1,2,8,0,0,2026-08-21T00:00:00.000Z-->
> - Normal to a surface tangent plane/plane containing radial position component and angular tangential component
>     - Normal to a surface tangent plane/plane containing radial position component and angular tangential component / Nomenclature ::@:: $\mathbf {\hat {n} }$ <p> In terms of [polar coordinates](spherical%20coordinate%20system.md); <br/> $\mathbf {\hat {n} } =\mathbf {\hat {r} } \times {\boldsymbol {\hat {\theta } } }$ <!--SR:!fsrs,2028-09-26T00:00:00.000Z,730,730.38507953,1,2,8,0,0,2026-09-27T00:00:00.000Z!fsrs,2027-12-06T00:00:00.000Z,440,439.99899934,1,2,8,0,0,2026-09-22T00:00:00.000Z-->
> - Binormal vector to tangent and normal
>     - Binormal vector to tangent and normal / Nomenclature ::@:: $\mathbf {\hat {b} } =\mathbf {\hat {t} } \times \mathbf {\hat {n} }$<sup>[\[5\]](#^ref-5)</sup> <!--SR:!fsrs,2028-11-05T00:00:00.000Z,763,763.30968033,1,2,8,0,0,2026-10-04T00:00:00.000Z!fsrs,2028-10-02T00:00:00.000Z,735,735.10222202,1,2,8,0,0,2026-09-28T00:00:00.000Z-->
> - Parallel to some axis/line
>     - Parallel to some axis/line / Nomenclature ::@:: $\mathbf {\hat {e} } _{\parallel }$ <!--SR:!fsrs,2028-11-05T00:00:00.000Z,763,763.30968033,1,2,8,0,0,2026-10-04T00:00:00.000Z!fsrs,2028-10-25T00:00:00.000Z,754,753.92506728,1,2,8,0,0,2026-10-02T00:00:00.000Z-->
...
>     - Perpendicular to some axis/line in some radial direction / Nomenclature ::@:: $\mathbf {\hat {e} } _{\bot }$ <!--SR:!fsrs,2028-11-05T00:00:00.000Z,763,763.30968033,1,2,8,0,0,2026-10-04T00:00:00.000Z!fsrs,2027-11-20T00:00:00.000Z,428,427.99440451,1,2,8,0,0,2026-09-18T00:00:00.000Z-->
...
By extension, {@{a __right quaternion__}@} is {@{a real multiple of a right versor}@}. <!--SR:!2028-07-16,958,339!2030-05-24,1509,359-->
