...
- (annotation: $\boldsymbol {\hat \theta}$, Cartesian basis) ::@:: $${\boldsymbol {\hat {\theta } } }=\cos \theta \cos \varphi \mathbf {\hat {x} } +\cos \theta \sin \varphi \mathbf {\hat {y} } -\sin \theta \mathbf {\hat {z} }$$ (annotation: memorize the effect of $\varphi$, and then the effect of $\theta$) <!--SR:!fsrs,2029-02-06T00:36:18.804Z,976,976.16992833,3.5312613,2,9,0,0,2026-06-06T00:36:18.804Z!2026-07-30,332,259-->
