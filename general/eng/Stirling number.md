...
{@{Stirling numbers of the second kind}@} express {@{the reverse relations}@}: {@{$$\ x^{n}\ =\ \sum _{k=0}^{n}\ S(n,k)\ (x)_{k}{\ }$$ and $$\ x^{n}\ =\ \sum _{k=0}^{n}\ (-1)^{n-k}\ S(n,k)\ x^{(k)}~.$$}@} <!--SR:!2025-07-20,200,310!2025-01-04,48,290!2025-04-03,107,290-->
