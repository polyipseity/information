...
>
> Given {@{a [real](real%20number.md) closed [interval](interval%20(mathematics).md) $I = [a, b]$ and a [continuous function](continuous%20function.md) $f: I \to \mathbb{R}$}@}, there exists {@{$l, u \in I$}@} such that {@{$$f(l) \le f(x) \le f(u) \qquad \forall x \in I \,.$$}@} <!--SR:!2028-10-07,863,321!2027-01-23,354,357!2027-01-28,358,357-->
