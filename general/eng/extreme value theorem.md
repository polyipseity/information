...
>
> Given {@{a [real](real%20number.md) closed [interval](interval%20(mathematics).md) $I = [a, b]$ and a [continuous function](continuous%20function.md) $f: I \to \mathbb{R}$}@}, there exists {@{$l, u \in I$}@} such that {@{$$f(l) \le f(x) \le f(u) \qquad \forall x \in I \,.$$}@} <!--SR:!2026-05-26,206,301!2026-02-03,75,337!2026-02-04,76,337-->
