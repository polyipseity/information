...
4. \(annotation: KCL\) ::@:: For each unknown voltage, form an equation based on Kirchhoff's Current Law \(i.e. add together all currents leaving from the node and mark the sum equal to zero\). The current between two nodes is equal to the voltage of the node where the current exits minus the voltage of the node where the current enters the node, both divided by the resistance between the two nodes. <!--SR:!2028-07-06,931,346!2026-03-27,289,330-->
...
>
> {@{Basic example circuit}@} with {@{one unknown voltage, V<sub>1</sub>}@}. <!--SR:!2028-05-22,895,346!2029-07-06,1224,350!2026-03-01,5,362-->
