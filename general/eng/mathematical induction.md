...
This states {@{a general formula for the sum of the natural numbers less than or equal to a given number}@}; in fact {@{an infinite sequence of statements}@}: {@{$0={\tfrac {(0)(0+1)}{2} }$, $0+1={\tfrac {(1)(1+1)}{2} }$, $0+1+2={\tfrac {(2)(2+1)}{2} }$, etc.}@} <!--SR:!2027-11-10,805,330!2028-10-09,1134,350!2025-09-03,5,356-->
...
_Conclusion_ ::@:: The proposition $P(n)$ holds for all natural numbers $n$.  Q.E.D. <!--SR:!2025-09-07,255,330!2028-10-02,1128,350-->
