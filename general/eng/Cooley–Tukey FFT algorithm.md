...
{@{Radix-2 DIT}@} first computes {@{the DFTs of the even-indexed inputs $(x_{2m}=x_{0},x_{2},\ldots ,x_{N-2})$}@} and of {@{the odd-indexed inputs $(x_{2m+1}=x_{1},x_{3},\ldots ,x_{N-1})$}@}, and then combines {@{those two results to produce the DFT of the whole sequence}@}. This idea can then be {@{performed [recursively](recursion.md)}@} to reduce {@{the overall runtime to O\(_N_ log _N_\)}@}. {@{This simplified form}@} assumes that _N_ is {@{a [power of two](power%20of%20two.md)}@}; since {@{the number of sample points _N_}@} can usually be {@{chosen freely by the application}@} \(e.g. by changing {@{the sample rate or window, zero-padding, etcetera}@}\), this is often {@{not an important restriction}@}. <!--SR:!2025-11-18,16,290!2025-11-17,15,290!2025-11-18,16,290!2025-11-18,16,290!2025-11-17,15,290!2025-11-17,15,290!2025-11-17,15,290!2025-11-18,16,290!2025-11-17,15,290!2025-11-17,15,290!2026-01-12,57,310!2025-11-17,15,290-->
...
>
> {@{The basic step}@} of the Cooley–Tukey FFT for {@{general factorizations}@} can be viewed as re-interpreting {@{a 1d DFT as something like a 2d DFT}@}. {@{The 1d input array of length _N_ = _N_<sub>1</sub>_N_<sub>2</sub>}@} is reinterpreted as {@{a 2d _N_<sub>1</sub>×<!-- markdown separator -->_N_<sub>2</sub> matrix stored in [column-major order](column-major%20order.md)}@}. One performs {@{smaller 1d DFTs along the _N_<sub>2</sub> direction}@} \(the {@{non-contiguous}@} direction\), then multiplies by {@{phase factors \(twiddle factors\)}@}, and finally performs {@{1d DFTs along the _N_<sub>1</sub> direction}@}. {@{The transposition step}@} can be performed in {@{the middle, as shown here, or at the beginning or end}@}. This is done {@{recursively for the smaller transforms}@}. <!--SR:!2025-11-17,15,290!2025-11-18,16,290!2025-11-17,15,290!2025-11-18,16,290!2025-11-17,15,290!2026-01-11,56,310!2025-11-17,15,290!2026-01-10,55,310!2025-11-17,15,290!2025-11-18,16,290!2025-11-17,15,290!2025-11-17,15,290!2025-11-18,16,290-->

More generally, {@{Cooley–Tukey algorithms}@} recursively {@{re-express a DFT of a composite size _N_ = _N_<sub>1</sub>_N_<sub>2</sub>}@} as:<sup>[\[10\]](#^ref-10)</sup> <!--SR:!2025-11-17,15,290!2026-01-13,58,310-->
