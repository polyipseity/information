...
3. The remaining node is {@{the root node and the tree is complete}@}. <!--SR:!2025-10-30,257,330!2027-11-13,774,330!2025-10-17,250,330!2025-10-11,244,330!2028-09-06,1071,350!2025-11-29,282,330!2025-10-23,255,330!2025-12-08,290,330-->
...
{@{Many variations of Huffman coding}@} exist,<sup>[\[8\]](#^ref-8)</sup> some of which {@{use a Huffman-like algorithm}@}, and others of which {@{find optimal prefix codes \(while, for example, putting different restrictions on the output\)}@}. Note that, {@{in the latter case}@}, the method {@{need not be Huffman-like, and, indeed, need not even be [polynomial time](time%20complexity.md#polynomial%20time)}@}. <!--SR:!2025-10-26,254,330!2025-10-02,237,330!2028-09-05,1070,350!2025-12-12,293,330!2028-08-27,1063,350-->
