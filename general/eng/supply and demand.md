...
If {@{supply or demand is a function of other variables besides price}@}, it may be {@{represented by a family of curves \(with a change in the other variables constituting a shift between curves\)}@} or by {@{a surface in a higher dimensional space}@}. <!--SR:!2025-09-16,240,330!2027-11-24,837,330!2025-09-11,23,373-->
...
{@{Partial equilibrium analysis}@} examines {@{the effects of policy action in creating equilibrium only in that particular sector or market which is directly affected}@}, ignoring {@{its effect in any other market or industry assuming that they being small will have little impact if any}@}. <!--SR:!2025-09-13,237,330!2027-07-10,729,330!2027-06-16,712,330-->
