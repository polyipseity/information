...
2. the constant-[elasticity](elasticity%20(economics).md) demand function (also called [isoelastic](isoelastic%20function.md) or log-log or loglinear demand function), ::@:: e.g., the smooth curve $$Q(P)=3P^{-2}$$ which can be rewritten as $$\log Q(P)=\log 3-2\log P \,.$$ <!--SR:!2025-06-26,172,310!2025-01-18,54,310-->
