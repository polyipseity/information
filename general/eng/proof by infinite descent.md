...
{@{The earliest uses}@} of the method of infinite descent appear in {@{[Euclid's _Elements_](Euclid's%20Elements.md)}@}. A typical example is {@{Proposition 31 of Book 7}@}, in which {@{[Euclid](Euclid.md) proves that every composite integer is divided \(in Euclid's terminology "measured"\) by some prime number}@}. <!--SR:!2028-09-21,1144,350!2027-08-11,674,270-->
