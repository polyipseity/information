...
Each row represents {@{an actual class while each column represents a predicted class}@}. {@{The reverse}@} is {@{less common but also possible}@}, and both are {@{found in the literature}@}. <!--SR:!2028-08-31,1053,290-->
