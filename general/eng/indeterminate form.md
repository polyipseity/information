...
- $x$:@:$\sin{x}$, $\arcsin{x}$, $\sinh{x}$, $\tan{x}$, $\arctan{x}$, $\ln(1+x)$, $e^x-1$ <!--SR:!2025-08-21,224,190-->
- $\frac{x^2}2$:@:$1-\cos{x}$, $\cosh{x}-1$ <!--SR:!2025-08-20,150,250-->
