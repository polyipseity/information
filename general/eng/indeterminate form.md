...
- $1-\cos{x}$:@:$\frac{x^2}2$ <!--SR:!fsrs,2034-07-26T00:00:00.000Z,2901,2900.56918297,1,2,11,0,0,2026-08-16T00:00:00.000Z-->
- $\cosh{x}-1$:@:$\frac{x^2}2$ <!--SR:!2032-04-04,2282,330-->
- $a^x-1$:@:$x\ln{a}$ <!--SR:!2026-12-03,827,330-->
- $e^x-1$:@:$x$ <!--SR:!2027-10-11,1096,350-->
- $(1+x)^a-1$:@:$ax$ <!--SR:!fsrs,2031-07-18T00:00:00.000Z,1821,1820.85981252,3.98153807,2,10,0,0,2026-07-23T00:00:00.000Z-->
...
- $x\ln{a}$:@:$a^x-1$ <!--SR:!fsrs,2028-02-09T00:00:00.000Z,534,533.91073566,4.98215312,2,8,0,0,2026-08-24T00:00:00.000Z-->
- $ax$:@:$(1+x)^a-1$ <!--SR:!2032-12-16,2394,310-->

<!--/pytextgen-->

#### x→∞

To {@{derive the equivalent infinitesimals}@} when {@{$x \to \pm\infty$}@}, {@{replace all $x$ with $\frac 1 x$}@} in {@{the [equivalent infinitesimals when $x \to 0^\pm$](#x→0)}@} \({@{$x \to +\infty$}@} becomes {@{$x \to 0^+$}@}, {@{$x \to -\infty$ becomes $x \to 0^-$}@}\). <!--SR:!2029-08-13,1460,364!2027-01-12,409,373!2026-12-21,392,373!2027-01-20,416,373!2026-12-22,393,373!2026-12-21,392,373!2027-01-21,417,373-->
