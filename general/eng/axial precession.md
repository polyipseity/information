...
In particular, for [Earth](Earth.md), axial precession can refer to {@{the gradual shift in the orientation of Earth's axis of rotation in a cycle of approximately 26&nbsp;000 years}@}. The orientation shift follows {@{a circle in the westward direction (clockwise as seen from the north)}@}. The term "precession" only refers to {@{the largest part of the gradual motion}@}; other changes in the alignment of Earth's axis—{@{[nutation](astronomical%20nutation.md) and [polar motion](polar%20motion.md)—are much smaller in magnitude}@}. <!--SR:!2031-06-29,1909,330!2026-07-07,512,310!2027-11-22,914,330!2029-04-24,1360,350-->
