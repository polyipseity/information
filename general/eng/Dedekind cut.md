...
- For {@{the American record producer known professionally as Dedekind Cut}@}, see {@{[Fred Warmsley](Fred%20Warmsley.md)}@}. <!--SR:!2025-03-06,56,310!2025-05-06,96,290-->
...
3. downward closure ::@:: If $x,y\in \mathbb {Q}$, $x<y$, and $y\in A$, then $x\in A$. \($A$ is "closed downwards".\) <!--SR:!2025-03-16,64,310!2025-03-19,67,310-->
4. no greatest element ::@:: If $x\in A$, then there exists a $y\in A$ such that $y>x$. \($A$ does not contain a greatest element.\) <!--SR:!2025-03-07,57,310!2025-02-28,48,290-->

By {@{omitting the first two requirements (annotation: non-emptyness of both $A$ and $B$)}@}, we {@{formally obtain the [extended real number line](extended%20real%20number%20line.md)}@}. <!--SR:!2025-03-19,67,310!2025-02-08,32,270-->
...
{@{A typical Dedekind cut of the [rational numbers](rational%20number.md) $\mathbb {Q}$}@} is given by {@{the partition $(A,B)$ with <p> $A=\{a\in \mathbb {Q} :a^{2}<2{\text{ or } }a<0\},$ <br/> $B=\{b\in \mathbb {Q} :b^{2}\geq 2{\text{ and } }b\geq 0\}.$}@}<sup>[\[4\]](#^ref-4)</sup> <!--SR:!2025-03-07,57,310!2025-03-17,65,310-->
...
In the general case of {@{an arbitrary linearly ordered set _X_}@}, a __cut__ is {@{a pair $(A,B)$ such that $A\cup B=X$ and $a\in A$, $b\in B$ imply $a<b$}@}. Some authors {@{add the requirement that both _A_ and _B_ are nonempty}@}.<sup>[\[5\]](#^ref-5)</sup> <!--SR:!2025-05-11,102,290!2025-03-13,62,310!2025-03-19,67,310-->
