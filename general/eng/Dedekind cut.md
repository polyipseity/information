...
It is {@{more symmetrical to use the \(_A_, _B_\) notation for Dedekind cuts}@}, but {@{each of _A_ and _B_ does determine the other}@}. It can be {@{a simplification, in terms of notation if nothing more}@}, to {@{concentrate on one "half" — say, the lower one}@} — and {@{call any downward-closed set _A_ without greatest element a "Dedekind cut"}@}. <!--SR:!2025-11-07,246,330!2025-11-01,241,330!2025-11-23,257,330!2025-03-12,61,310!2025-03-12,61,310-->
...
If {@{neither _A_ has a maximum, nor _B_ has a minimum}@}, {@{the cut is called a __gap__}@}. {@{A linearly ordered set endowed with the order topology is compact}@} {@{if and only if it has no gap}@}.<sup>[\[6\]](#^ref-6)</sup> <!--SR:!2025-03-12,61,310!2025-03-12,61,310!2025-11-28,262,330!2025-03-12,61,310-->
