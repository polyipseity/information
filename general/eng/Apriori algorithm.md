...
Candidate generation {@{spawns a large numbers of subsets, which is costly for computation}@}. Its bottom-up exploration nature means {@{finding any subset $S$ requires finding all its $2^{\lvert S \rvert} - 1$ proper subsets, including the [empty set](empty%20set.md), first}@}. <!--SR:!2025-06-19,382,364!2028-12-12,1363,364-->
