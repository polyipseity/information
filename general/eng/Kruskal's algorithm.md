...
>             {@{UNION(FIND-SET(u), FIND-SET(v))}@}
>     {@{<b>return</b> F}@}
> </pre> <!--SR:!2025-10-26,259,330!2025-08-09,192,310!2025-11-11,272,330!2025-02-17,67,310!2025-02-17,66,310!2025-11-12,273,330!2025-10-22,256,330!2025-02-16,66,310!2025-02-17,66,310-->
...
Finally, {@{other variants of a parallel implementation of Kruskal's algorithm}@} have been explored. Examples include {@{a scheme that uses helper threads to remove edges that are definitely not part of the MST in the background}@},<sup>[\[8\]](#^ref-8)</sup> and a variant which {@{runs the sequential algorithm on _p_ subgraphs, then merges those subgraphs until only one, the final MST, remains}@}.<sup>[\[9\]](#^ref-9)</sup> <!--SR:!2025-02-16,66,310!2025-11-10,272,330!2025-10-10,246,330-->
