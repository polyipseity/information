...
The following code is implemented with {@{a [disjoint-set data structure](disjoint-set%20data%20structure.md)}@}. It represents {@{the forest _F_ as a set of undirected edges}@}, and {@{uses the disjoint-set data structure to efficiently determine whether two vertices are part of the same tree}@}. <!--SR:!2025-11-05,266,330!2027-10-11,801,330!2026-12-23,556,310-->
...
We show that {@{the following proposition ___P___ is true by [induction](mathematical%20induction.md)}@}: If {@{_F_ is the set of edges chosen at any stage of the algorithm}@}, then {@{there is some minimum spanning tree that contains _F_ and none of the edges rejected by the algorithm}@}. <!--SR:!2025-12-07,293,330!2027-10-20,808,330!2025-11-13,274,330-->
