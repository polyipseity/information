...
We show that {@{the following proposition ___P___ is true by [induction](mathematical%20induction.md)}@}: If {@{_F_ is the set of edges chosen at any stage of the algorithm}@}, then there is {@{some minimum spanning tree}@} that {@{contains _F_ and none of the edges rejected by the algorithm}@}. <!--SR:!2025-12-07,293,330!2027-10-20,808,330!2028-05-08,907,330!2025-11-11,5,354-->
