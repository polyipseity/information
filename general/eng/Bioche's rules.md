...
The integrand in {@{$$\int {\frac {dt}{\sin t} }$$}@} has {@{the same symmetries as the one in example 1}@}, so we use {@{the same substitution $u=\cos t$}@}. So {@{$${\frac {dt}{\sin t} }=-{\frac {du}{\sin ^{2}t} }=-{\frac {du}{\ 1-\cos ^{2}t} }.$$}@} This transforms the integral into {@{$$\int -{\frac {du}{1-u^{2} } },$$}@} which can be {@{integrated using partial fractions}@}, since {@{${\frac {1}{1-u^{2} } }={\frac {1}{2} }\left({\frac {1}{1+u} }+{\frac {1}{1-u} }\right)$}@}. The result is that {@{$$\int {\frac {dt}{\sin t} }=-{\frac {1}{2} }\ln {\frac {1+\cos t}{1-\cos t} }+c.$$}@} <!--SR:!2026-11-26,401,369!2026-12-04,408,369!2026-10-19,370,369!fsrs,2029-12-10T00:00:00.000Z,1252,1252.13338894,1,2,9,0,0,2026-07-07T00:00:00.000Z!fsrs,2030-02-25T00:00:00.000Z,1309,1308.66035919,1,2,9,0,0,2026-07-27T00:00:00.000Z!2026-11-07,385,369!2026-10-18,369,369!fsrs,2030-03-24T00:00:00.000Z,1329,1328.76280435,1,2,9,0,0,2026-08-03T00:00:00.000Z-->
