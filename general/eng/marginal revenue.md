...
{@{[Profit maximization](profit%20maximization.md) occurs}@} at {@{the point where marginal revenue (MR) equals [marginal cost](marginal%20cost.md) (MC)}@}. If {@{$MR>MC$ then a profit-maximizing firm will increase output to generate more profit}@}, while if {@{$MR<MC$ then the firm will decrease output to gain additional profit}@}. Thus the firm will {@{choose the profit-maximizing level of output for which $MR=MC$}@}.<sup>[\[11\]](#^ref-11)</sup> <!--SR:!2029-02-22,1221,357!2025-12-16,309,337!2025-10-23,266,337!2025-10-22,263,337!2025-11-19,287,337-->
