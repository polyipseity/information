...
{@{The default order of the table}@} is {@{reverse colex order by $\pi$}@}, which is the same as {@{colex order by $l$}@}. {@{Lex order by $\pi$}@} is the same as {@{lex order by $r$}@}. <!--SR:!2025-12-17,297,332!2027-01-28,473,252!2025-12-15,295,332!2025-10-02,5,348!2025-10-02,5,348-->
