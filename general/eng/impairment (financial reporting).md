...
{@{An investment is recognized as impaired}@} when {@{there is no longer reasonable assurance that the [future cash flows](cash%20flow.md) associated with it will be collected either in their entirety or when due}@}. Entities look for {@{evidence of situations that would indicate impairment}@}. Such triggering events include when the entity<sup>[\[11\]](#^ref-11)</sup> – <!--SR:!2029-07-28,1291,350!2028-07-13,868,290!2029-08-28,1322,350-->

- \(annotation: difficulties\) ::@:: is experiencing notable financial difficulties, <!--SR:!2029-06-29,1272,350!2029-08-10,1304,350-->
