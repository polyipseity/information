...
The market supply curve can be translated into {@{an equation}@}. For {@{a factor j}@} for example the market supply function is {@{$$S_{j}=S^{j}(p,r)$$}@} where {@{$S_{j}=\sum _{k=1}^{j}S_{jk}$ and $S^{j}(p,r)=\sum _{k=1}^{j}S^{jk}(p,r)$ for all p \> 0 and r \> 0}@}. <!--SR:!2025-10-25,262,330!2025-07-27,188,310!2025-11-18,283,330!2026-06-22,386,290-->
