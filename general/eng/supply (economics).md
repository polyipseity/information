...
__Number of suppliers:__ ::@:: The market supply curve is the horizontal summation of the individual supply curves. As more firms enter the industry, the market supply curve will shift out, driving down prices. <!--SR:!2025-01-20,46,290!2025-07-14,176,310-->
...
The market supply curve can be translated into {@{an equation}@}. For {@{a factor j}@} for example the market supply function is {@{$$S_{j}=S^{j}(p,r)$$}@} where {@{$S_{j}=\sum _{k=1}^{j}S_{jk}$ and $S^{j}(p,r)=\sum _{k=1}^{j}S^{jk}(p,r)$ for all p \> 0 and r \> 0}@}. <!--SR:!2025-02-05,62,310!2025-01-20,46,290!2025-02-08,65,310!2025-06-01,133,290-->
