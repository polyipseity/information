...
The {@{__Vogt–Russell theorem__}@} states that {@{the structure of a [star](star.md), in hydrostatic and thermal equilibrium with all energy derived from nuclear reactions}@}, is {@{uniquely determined by its mass and the distribution of chemical elements throughout its interior}@}.<sup>[\[1\]](#^ref-1)</sup> Although referred to as a theorem, the Vogt–Russell theorem has {@{never been formally proved}@}. The theorem is named after {@{astronomers [Heinrich Vogt](Heinrich%20Vogt%20(astronomer).md) and [Henry Norris Russell](Henry%20Norris%20Russell.md), who devised it independently}@}. <!--SR:!2031-02-08,1814,330!2027-08-07,728,290!2029-01-22,1274,350!2027-07-31,770,290!2026-12-24,393,362-->

The law ignores {@{the effect of [rotation](rotation.md)}@}. <!--SR:!2028-12-27,1255,350-->

For example, {@{a possible luminosity homology relation}@} is: {@{$$L \propto M^3 \mu^4$$, where $L$ is the [luminosity](luminosity.md), $M$ is the [mass](mass.md) and $\mu$ is the mean [molecular weight](molecular%20mass.md)}@}.<sup>[\[2\]](#^ref-2)</sup> <!--SR:!2027-06-01,784,330!2030-07-03,1571,310-->
