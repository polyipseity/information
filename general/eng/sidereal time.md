...
For [retrograde rotation](prograde%20motion.md), the formula has {@{the sign of $1$ negated}@}: {@{$$\text{number of sidereal days per orbital period} = \text{number of solar days per orbital period} - 1$$}@}. Equivalently in terms of length, the formula has {@{the operator sign in the denominator negated}@}: {@{$$\begin{aligned} \text{length of sidereal day} & = \frac {\text{length of solar day} } {1 - \frac {\text{length of solar day} } {\text{orbital period} } } \\ \text{length of solar day} & = \frac {\text{length of sidereal day} } {1 + \frac {\text{length of sidereal day} } {\text{orbital period} } } \end{aligned}$$}@}. <!--SR:!2025-05-26,252,330!2025-05-19,246,330!2025-06-06,261,330!2026-07-23,478,270-->
