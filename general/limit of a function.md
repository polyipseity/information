...
> - {{$q^{-\infty} = \begin{cases} \infty & \text{if } 0 < q < 1 \\ 0 & \text{if } q > 1 \end{cases}$}} <!--SR:!2024-06-24,148,310!2024-02-06,44,290!2024-02-05,39,270!2024-03-01,56,270!2024-04-27,95,290!2024-02-14,50,310-->
