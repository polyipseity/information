...
> - {{$q^{-\infty} = \begin{cases} \infty & \text{if } 0 < q < 1 \\ 0 & \text{if } q > 1 \end{cases}$}} <!--SR:!2024-01-28,37,290!2023-12-24,12,270!2023-12-28,12,250!2024-01-05,16,250!2024-01-23,33,290!2023-12-26,13,290-->
