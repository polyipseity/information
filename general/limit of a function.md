...
The function {{$$f(x) = \begin{cases} 1 & x \ge 0 \\ -1 & x < 0 \end{cases}$$}} has a limit at every nonzero $x$. It has no limit at $0$. <!--SR:!2024-06-01,65,344-->

#### limits at only one point

The functions {{$$f(x) = \begin{cases} x & x\text{ rational} \\ 0 & x\text{ irrational} \end{cases}$$ and $$f(x) = \begin{cases} \lvert x \rvert & x\text{ rational} \\ 0 & x\text{ irrational} \end{cases}$$}} both have a limit at $x = 0$ and equals $0$, but not anywhere else. <!--SR:!2024-05-31,60,324-->
