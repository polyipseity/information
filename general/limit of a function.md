...
> - {{$\lim_{x \to p} {f(x)}^{g(x)} = \lim_{x \to p} f(x)^{\lim_{x \to p} g(x)}\qquad(\lim_{x \to p} f(x) > 0 \text{ or } (\lim_{x \to p} f(x) = 0, \lim_{x \to p} g(x) > 0))$}} <!--SR:!2024-03-07,68,310!2024-02-25,59,310!2024-02-17,52,310!2024-02-20,55,310!2024-01-24,31,270!2024-02-29,52,250-->
...
> - {{$q^{-\infty} = \begin{cases} \infty & \text{if } 0 < q < 1 \\ 0 & \text{if } q > 1 \end{cases}$}} <!--SR:!2024-01-28,37,290!2024-02-06,44,290!2024-02-05,39,270!2024-03-01,56,270!2024-01-23,33,290!2024-02-14,50,310-->
