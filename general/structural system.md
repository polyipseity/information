...
The structural system of a high-rise building should support {{vertical loads such as gravity and foundation settlement, and also lateral loads such as earthquake, wind}}, latter of which, {{lateral loads, are especially important for tall buildings}}. Otherwise, tall buildings may {{slide (horizontal translation) or overturn (rotation about the base)}}. Generally the higher up, {{the larger the load}}. <!--SR:!2024-05-17,3,250!2024-05-18,4,275!2024-05-18,4,275!2024-05-18,4,270-->
...
The structural system affects {{the load distribution}}. For example, a {{structural steel undergoing overturning due to wind}} would experience {{tension at the wind-facing side and compression on the other side}}. A {{reinforced concrete (concrete with steel bars)}} would experience the same thing, but {{steel bars bear most of the tension while concrete bears most of the compression and the heavy vertical loading}}. <!--SR:!2024-05-18,4,275!2024-05-18,4,275!2024-05-18,4,275!2024-05-17,3,255!2024-05-17,3,255-->

We can {{quantify}} overturning. The {{lateral stiffness}} of a building is defined as {{the force divided by the horizontal displacement at the building top, and has a unit of kN/mm}}, somewhat similar to {{[elastic modulus](elastic%20modulus.md)}}. The aim is to {{increase the lateral stiffness, which involves making the building stiff and strong}}. <!--SR:!2024-05-18,4,275!2024-05-18,4,275!2024-05-17,3,255!2024-05-18,4,275!2024-05-18,4,275-->
...
- _(begin)_→:::←[braced frame](braced%20frame.md) <!--SR:!2024-05-17,3,250!2024-05-18,4,275-->
- [braced frame](braced%20frame.md)→:::←[hinged frame](hinged%20frame.md) <!--SR:!2024-05-15,1,235!2024-05-17,3,255-->
- [hinged frame](hinged%20frame.md)→:::←[outrigger](#outrigger) <!--SR:!2024-05-15,1,235!2024-05-17,3,255-->
- [outrigger](#outrigger)→:::←[rigid frame](rigid%20frame.md) <!--SR:!2024-05-18,4,275!2024-05-17,3,255-->
- [rigid frame](rigid%20frame.md)→:::←[shear-walled frame](#sheared-walled%20frame): [rigid frame](rigid%20frame.md) + [shear wall](shear%20wall.md) <!--SR:!2024-05-17,3,255!2024-05-17,3,255-->
- [shear-walled frame](#sheared-walled%20frame): [rigid frame](rigid%20frame.md) + [shear wall](shear%20wall.md)→:::←_(end)_ <!--SR:!2024-05-18,4,275!2024-05-17,3,255-->
...
Outriggers can {{reduce the overturning moment in the core by transferring some moment to columns outside the core}}. <!--SR:!2024-05-17,3,255-->
...
- [buttress](buttress.md)→:::←[diagrid](diagrid.md) <!--SR:!2024-05-15,1,235!2024-05-18,4,275-->
- [diagrid](diagrid.md)→:::←[exoskeleton](exoskeleton.md) <!--SR:!2024-05-17,3,255!2024-05-18,4,275-->
- [exoskeleton](exoskeleton.md)→:::←[space truss](space%20frame.md) <!--SR:!2024-05-17,3,255!2024-05-17,3,255-->
- [space truss](space%20frame.md)→:::←[superframe](superframe.md) <!--SR:!2024-05-18,4,275!2024-05-18,4,275-->
- [superframe](superframe.md)→:::←[tube](tube%20(structure).md) <!--SR:!2024-05-18,4,275!2024-05-17,3,255-->
