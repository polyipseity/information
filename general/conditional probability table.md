...
This gives us the table of conditional of probabilities of _y_ given _x_, with {{the row headers being the conditional probabilities and the column headers being the variable conditioned on (mnemonic: ↙)}}: <!--SR:!2024-12-18,112,250-->
...
With more than {{one conditioning variable or output variable}}, {{the table headers simply become all possible combinations of the multiple variables}}. <!--SR:!2024-10-31,94,290!2025-04-11,212,310-->
