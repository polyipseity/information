...
1. _(begin)_→:::←[adiabatic process](adiabatic%20process.md): $Q = 0$
...
5. [isoenthalpic process](isoenthalpic%20process.md): $\Delta H = 0$→:::←[isoentropic process](isoentropic%20process.md): [reversible](reversible%20process%20(thermodynamics).md) [adiabatic process](adiabatic%20process.md)
6. [isoentropic process](isoentropic%20process.md): [reversible](reversible%20process%20(thermodynamics).md) [adiabatic process](adiabatic%20process.md)→:::←[isothermal process](isothermal%20process.md): $\Delta T = 0$
