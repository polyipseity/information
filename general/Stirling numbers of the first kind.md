...
- a finite sum identity involving [Bell numbers](Bell%20number.md) ::: $$\sum_{j = 0}^n \binom n j k^{n - j} B_{j} = \sum_{i = 0}^k \left[k \atop i\right] (-1)^{k - i} B_{n+i} = \sum_{i = 0}^k s(k, i) B_{n + i}$$ <!--SR:!2024-11-24,12,231!2024-11-30,23,271-->
