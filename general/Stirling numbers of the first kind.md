...
Therefore if {@{$p$ is prime}@}, then: {@{$$p\ |\left[{p \atop k}\right] \text{ for } 1<k<p \,.$$}@} <!--SR:!2025-01-03,49,290!2024-12-31,18,250-->
...
- a finite sum identity involving [Bell numbers](Bell%20number.md) ::@:: $$\sum_{j = 0}^n \binom n j k^{n - j} B_{j} = \sum_{i = 0}^k \left[k \atop i\right] (-1)^{k - i} B_{n+i} = \sum_{i = 0}^k s(k, i) B_{n + i}$$ <!--SR:!2024-12-21,12,191!2025-01-16,34,251-->
