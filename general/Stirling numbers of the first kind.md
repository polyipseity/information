...
- reversed increment by binomial coefficient ::: $$\left[{n \atop m}\right]=\sum _{k=m}^{n}(-1)^{k-m}{\binom {k}{m} }\left[{n+1 \atop k+1}\right]$$ <!--SR:!2024-11-09,8,279!2024-11-02,4,299-->
...
- increment by summing up to _k_ ::: $$\left[{n + k +1 \atop n}\right]=\sum _{j=0}^{k}(n+j)\left[{n+j \atop j}\right]$$ <!--SR:!2024-11-09,8,279!2024-11-02,4,299-->
