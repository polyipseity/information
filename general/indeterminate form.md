...
To derive the equivalent infinitesimals when $x \to \infty$, {{replace all $x$ with $\frac 1 x$ in the [equivalent infinitesimals when $x \to 0$](#x→0)}}. <!--SR:!2024-03-25,4,304-->
