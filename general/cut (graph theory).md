...
In {{a [flow network](flow%20network.md)}}, {{an __s–t cut__}} is {{a cut that requires the [_source_](glossary%20of%20graph%20theory.md#direction) and the [_sink_](glossary%20of%20graph%20theory.md#direction) to be in different subsets}}, and its _cut-set_ only consists of {{edges going from the source's side to the sink's side}}. {{The _capacity_ of an s–t cut}} is defined as {{the sum of the capacity of each edge in the _cut-set_}}. <!--SR:!2024-11-18,17,290!2024-11-18,17,290!2024-11-10,10,270!2024-11-18,17,290!2024-11-18,17,290!2024-11-18,17,290-->
...
{{A cut is _minimum_}} if {{the size or weight of the cut is not larger than the size of any other cut}}. The illustration on the right shows {{a minimum cut: the size of this cut is 2}}, and {{there is no cut of size 1 because the graph is [bridgeless](bridge%20(graph%20theory).md)}}. <!--SR:!2024-11-18,17,290!2024-11-18,17,290!2024-11-18,17,290!2024-11-10,10,270-->
