...
In another variation of nim, besides {{removing any number of objects from a single heap}}, one is {{permitted to remove the same number of objects from each heap}}. <!--SR:!2024-11-02,16,301!2024-12-13,46,301-->
