...
>   - [oscillator](oscillation.md) properties: {{$k$ is the [spring constant](Hooke's%20law.md) and $m$ is the [mass](mass.md), $c$ is the _viscous damping coefficient_, and $F(t)$ is the driving [force](force.md)}} <!--SR:!2025-11-28,489,312!2024-10-31,235,332!2024-10-13,202,312-->
...
> - sine variant: {{all $\cos$ in the main expression are replaced by $\sin$ and $\varphi = \arccos \zeta$}} <!--SR:!2025-01-25,222,232!2024-12-07,218,292!2025-01-01,282,332!2024-09-28,173,272!2025-02-02,241,252!2024-09-26,192,312-->

<!-- markdownlint MD028 -->

> [!tip] tips
>
> - why $\cos(\omega t + \varphi)$ increases (for negative $\zeta$, decreases) initially ::: One may note that initially, $\cos(\omega t + \varphi)$ increases (decreases) while $e^{-\lambda t}$ decreases (increases). These effects cancel out to give a [derivative](derivative.md) of 0 at $t = 0$, matching the given initial values. <!--SR:!2024-10-18,222,336!2025-03-03,275,348-->
