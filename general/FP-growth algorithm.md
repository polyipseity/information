...
By ordering the items in each transaction by descending support, the FP-tree stores frequent prefixes {{close to the tree root, enabling high compression of the set of transactions}}. The height of the FP-tree is {{the maximum number of frequent items in a transaction considering all transactions}}. (Note that the height of a FP-tree with the root node only is {{0, not 1}}.) <!--SR:!2024-08-27,92,290!2024-12-16,173,310!2025-04-18,284,348-->
