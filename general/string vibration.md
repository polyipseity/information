...
aliases:
  ...
  - string waves
tags:
  - flashcard/general/string_vibration
  - language/in/English
---
...
> where
>
> - [string](string%20(structure).md) properties: {{$T$ is [tension](tension%20(mechanics).md) and $\mu$ is [linear mass density](linear%20density.md), i.e. [mass](mass.md) per unit [length](length.md)}} <!--SR:!2024-09-22,172,270!2024-10-04,226,330-->
...
> - [wave](wave.md) properties: {{$A$ is [amplitude](amplitude.md), $k$ is [angular wavenumber](wavenumber.md), $\omega$ is [angular frequency](angular%20frequency.md), $\phi$ is phase offset}} <!--SR:!2025-01-14,239,250!2024-11-03,248,330!2025-03-09,298,290!2025-06-06,359,290-->
