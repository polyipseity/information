...
{@{Perfect substitutes}@} refer to {@{a pair of goods with uses identical to one another}@}.<sup>[\[6\]](#^ref-6)</sup> In that case, {@{the [utility](utility.md) of a combination of the two goods}@} is {@{an increasing function of the sum of the quantity of each good}@}. That is, {@{the more the consumer can consume \(in total quantity\)}@}, {@{the higher level of utility will be achieved}@}, see figure 3. <!--SR:!2024-12-03,16,290!2024-12-04,17,310!2024-12-01,14,290!2024-11-26,10,270!2024-12-02,15,290!2024-12-02,15,290-->
