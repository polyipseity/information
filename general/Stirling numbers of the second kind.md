...
If {{$n\geq 2$ and $1\leq k\leq n-1$}}, then {{$${\frac {1}{2} }(k^{2}+k+2)k^{n-k-1}-1\leq \left\{ {n \atop k}\right\}\leq {\frac {1}{2} }{n \choose k}k^{n-k}$$}} <sup>[\[12\]](#^ref-12)</sup> <!--SR:!2024-11-14,13,270!2024-11-22,15,230-->
