...
> 3. {{If needed, combine the above conclusions from both sides. Strictness of [extremum](maximum%20and%20minimum.md) at $c$ is preserved if and only if both sides are [strict local maxima](maximum%20and%20minimum.md) or both sides are [strict local minima](maximum%20and%20minimum.md).}} <!--SR:!2024-06-16,123,259!2024-04-03,83,279!2024-08-31,197,319-->
...
> 3. {{If needed, combine the above conclusions from both sides. Strictness of [extremum](maximum%20and%20minimum.md) at $c$ is preserved if and only if both sides are [strict local maxima](maximum%20and%20minimum.md) or both sides are [strict local minima](maximum%20and%20minimum.md).}} <!--SR:!2024-04-04,71,239!2024-04-02,82,279!2024-03-29,46,329-->

<!-- markdownlint MD028 -->

> [!example] examples
>
> - $f(x):=\begin{cases}e^{-\frac1{x^2} }&\text{if }x\ne0\\0&\text{if }x=0\end{cases},c=0$ :: [Strict local minimum](maximum%20and%20minimum.md) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-06-13,148,319-->
> - $f(x):=-x^{2n+1}\text{ for }n\in\mathbb{N}^+,c=0$ :: Decreasing (actually, weakly decreasing) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-04-24,97,279-->
> - $f(x):=x^{2n+1}\text{ for }n\in\mathbb{N}^+,c=0$ :: Increasing (actually, weakly increasing) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-05-19,116,292-->
> - $f(x):=x^\frac{2n+1}2,n\in\mathbb{N}_0,c=0$ :: [Right-sided strict local minimum](maximum%20and%20minimum.md) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-05-26,110,259-->
> - $f(x):=-x^{2n}\text{ for }n\in\mathbb{N}^+,c=0$ :: [Strict local maximum](maximum%20and%20minimum.md) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-06-17,137,299-->
> - $f(x):=\begin{cases}\lvert{x}\rvert\left(2+\sin{\frac1x}\right)&\text{if }\ne0\\0&\text{if }x=0\end{cases},c=0$ :: Inconclusive by the two-sided test because no suitable $\epsilon$ exist and inconclusive by the one-sided test because the one-sided [derivaties](derivative.md) do not exist. Actual is [strict local minimum](maximum%20and%20minimum.md). <!--SR:!2024-07-03,151,299-->
> - $f(x):=x^{2n}\text{ for }n\in\mathbb{N}^+,c=0$ :: [Strict local minimum](maximum%20and%20minimum.md) by the two-sided and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-07-30,183,314-->
> - $f(x):=\lvert{x}\rvert,c=0$ :: [Strict local minimum](maximum%20and%20minimum.md) by the two-sided or one-sided test. <!--SR:!2024-06-24,143,299-->
> - $f(x):=x^\frac13,c=0$ :: Increasing (actually, strictly increasing) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) do not exist. <!--SR:!2024-06-12,113,274-->
> - $f(x):=\begin{cases}x^2\sin{\frac1x}&\text{if }x\ne0\\0&\text{if }x=0\end{cases},c=0$ :: Inconclusive by the two-sided test because no suitable $\epsilon$ exist and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are both 0. Actual is neither [local extremum](maximum%20and%20minimum.md) nor [inflection point](inflection%20point.md). <!--SR:!2024-11-09,248,319-->
> - $f(x):=x^\frac{2n+3}3,n\in\mathbb{N}^+,c=0$ :: Increasing (actually, weakly increasing) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-06-09,133,299-->
> - $f(x):=\begin{cases}\lvert{x}\rvert\left(2+x\sin{\frac1x}\right)&\text{if }x\ne0\\0&\text{if }x=0\end{cases},c=0$ :: Inconclusive by the two-sided test because no suitable $\epsilon$ exist and [strict local minimum](maximum%20and%20minimum.md) by the one-sided test. <!--SR:!2024-04-20,68,254-->
> - $f(x):=x^\frac{2n}3,n\in\mathbb{N}^+,c=0$ :: [Strict local minimum](maximum%20and%20minimum.md) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0 or do not exist. <!--SR:!2024-06-05,128,294-->
> - $f(x):=\frac16\lvert{x}\rvert{}x^2,c=0$ :: [Strict local minimum](maximum%20and%20minimum.md) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-05-24,122,299-->
...
The _second derivative test_ is {{a special case of $n=2$ in the [higher-order derivative test](#higher-order%20derivative%20test)}}. The same applies for the _one-sided second derivative test_. <!--SR:!2024-11-21,277,339-->
...
> - $f(x):=x^{2n}\text{ for }n\in\mathbb{N}^+,c=0$ :: [Strict local minimum](maximum%20and%20minimum.md) and weakly (strictly when $n = 1$) [convex](convex%20function.md). <!--SR:!2024-06-07,130,290-->
...
> - $f(x):=x\lvert{x}\rvert,c=0$ :: Inconclusive by the two-sided test and [stationary rising inflection point](maximum%20and%20minimum.md) and not local [extremum](maximum%20and%20minimumm.md) by the one-sided test. <!--SR:!2024-03-19,72,279-->
> - $f(x):=x^{2n+1}\text{ for }n\in\mathbb{N}^+,c=0$ :: [Stationary rising inflection point](inflection%20point.md) and not local [extremum](maximum%20and%20minimumm.md). <!--SR:!2024-03-31,80,272-->
> - $f(x):=\begin{cases}e^{-\frac1{x^2} }&\text{if }x\ne0\\0&\text{if }x=0\end{cases},c=0$ :: Inconclusive because $\forall{n\in\mathbb{N}^+}\,f^{(n)}(0)=0$. Actual is [strict local minimum](maximum%20and%20minimum.md). <!--SR:!2024-11-13,272,339-->
> - $f(x):=x^\frac{2n+1}2,n\in\mathbb{N}_0,c=0$ :: Inconclusive because no $d\in\mathbb{N}^+$ such that $f^{(d)}(0)$ exists and $f^{(d)}(0)\ne0$. Actual is [right-sided strict local minimum](maximum%20and%20minimum.md). <!--SR:!2024-04-30,102,279-->
