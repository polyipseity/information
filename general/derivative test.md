...
> - $f(x):=-x^{2n+1}\text{ for }n\in\mathbb{N}^+,c=0$ :: Decreasing (actually, weakly decreasing) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2024-10-11,122,259-->
