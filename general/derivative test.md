...
> - $f(x):=x^\frac{2n+1}2,n\in\mathbb{N}_0,c=0$ :: [Right-sided strict local minimum](maximum%20and%20minimum.md) by the two-sided test and inconclusive by the one-sided test because the one-sided [derivatives](derivative.md) are 0. <!--SR:!2025-03-06,284,259-->
