...
- {{root-mean-square speed $v_\mathrm{rms}$}}: {{$v_\mathrm{rms} = \sqrt{\frac32}v_p=\sqrt{\frac{3kT}m} = \sqrt{\frac{3RT}M} \left( \text{evaluate } \sqrt{\int_0^\infty v^2 f(v) \,\mathrm{d}v} \right)$}} <!--SR:!2023-12-24,12,270!2024-01-03,18,250!2023-12-21,12,270!2024-01-01,16,250!2023-12-28,16,290!2024-01-29,40,290-->
