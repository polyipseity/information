...
> - conditions: {{requires [kinetic theory of gases](kinetic%20theory%20of%20gases.md), which applies to [ideal gases](ideal%20gas.md) and approximates [real gases](real%20gas.md)}} <!--SR:!2023-12-21,2,238!2023-12-21,3,258!2023-12-22,4,278!2023-12-22,4,278!2023-12-22,4,278-->
...
- {{root-mean-square speed $v_\mathrm{rms}$}}: {{$v_\mathrm{rms} = \sqrt{\frac32}v_p=\sqrt{\frac{3kT}m} = \sqrt{\frac{3RT}M} \left( \text{evaluate } \sqrt{\int_0^\infty v^2 f(v) \,\mathrm{d}v} \right)$}} <!--SR:!2023-12-24,12,270!2024-01-03,18,250!2023-12-21,12,270!2024-01-01,16,250!2023-12-28,16,290!2023-12-20,11,270-->
