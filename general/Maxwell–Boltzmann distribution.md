...
- most probable speed $v_p$ ::: $v_p = \sqrt{\frac{2kT}m} = \sqrt{\frac{2RT}M} \left( \text{solve for } v \text{ in } \frac{\mathrm{d}f(v)}{\mathrm{d}v} = 0 \right)$ <!--SR:!2025-05-30,359,290!2024-06-26,136,270-->
