...
- {{root-mean-square speed $v_\mathrm{rms}$}}: {{$v_\mathrm{rms} = \sqrt{\frac32}v_p=\sqrt{\frac{3kT}m} = \sqrt{\frac{3RT}M} \left( \text{evaluate } \sqrt{\int_0^\infty v^2 f(v) \,\mathrm{d}v} \right)$}} <!--SR:!2024-05-22,119,290!2024-03-03,60,270!2024-06-05,124,290!2024-06-26,136,270!2024-02-29,63,310!2024-04-04,48,270-->
