...
- cathode for [zinc chloride](zinc%20chloride.md) [electrolyte](electrolyte.md) ::: ZnCl<sub>2</sub>(aq) + 2MnO<sub>2</sub>(s) + H<sub>2</sub>O(l) + 2e<sup>-</sup> → Zn(OH)<sub>2</sub>(s) + Mn<sub>2</sub>O<sub>3</sub>(s) + 2Cl<sup>-</sup>(aq) <!--SR:!2024-09-27,42,150!2024-08-18,97,252-->
