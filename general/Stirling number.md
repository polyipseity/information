...
- increment with fixed _k_ by binomial coefficients ::: $$\left[{n+1 \atop k+1}\right]=\sum _{j=k}^{n}\left[{n \atop j}\right]{\binom {j}{k} }$$ <p> vs. <p> $$\left\{ {n+1 \atop k+1}\right\}=\sum _{j=k}^{n}{\binom {n}{j} }\left\{ {j \atop k}\right\}$$ <!--SR:!2024-10-30,3,250!2024-10-31,4,270-->
- increment with fixed _k_ by combinatorial arguments ::: $$\left[{\begin{matrix}n+1\\k+1\end{matrix} }\right]=\sum _{j=k}^{n}{\frac {n!}{j!} }\left[{j \atop k}\right]$$ <p> vs. <p> $$\left\{ {n+1 \atop k+1}\right\}=\sum _{j=k}^{n}(k+1)^{n-j}\left\{ {j \atop k}\right\}$$ <!--SR:!2024-10-30,3,250!2024-10-30,3,250-->
...
- partition then choose partitions ::: $$\left[{n \atop l+m}\right]{\binom {l+m}{l} }=\sum _{k}{\binom {n}{k} }\left[{k \atop l}\right]\left[{n-k \atop m}\right]$$ <p> vs. <p> $$\left\{ {n \atop l+m}\right\}{\binom {l+m}{l} }=\sum _{k}{\binom {n}{k} }\left\{ {k \atop l}\right\}\left\{ {n-k \atop m}\right\}$$ <!--SR:!2024-10-28,1,230!2024-10-30,3,250-->
- asymptote for fixed _n_ ::: $$\left[{n+k \atop k}\right]{\underset {k\to \infty }{\sim } }{\frac {k^{2n} }{2^{n}n!} }.$$ <p> vs. <p> $$\left\{ {n+k \atop k}\right\}{\underset {k\to \infty }{\sim } }{\frac {k^{2n} }{2^{n}n!} }$$ <!--SR:!2024-10-30,3,250!2024-10-31,4,270-->
