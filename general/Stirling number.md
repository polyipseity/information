...
{@{Stirling numbers of the second kind}@} express {@{the reverse relations}@}: {@{$$\ x^{n}\ =\ \sum _{k=0}^{n}\ S(n,k)\ (x)_{k}{\ }$$ and $$\ x^{n}\ =\ \sum _{k=0}^{n}\ (-1)^{n-k}\ S(n,k)\ x^{(k)}~.$$}@} <!--SR:!2025-01-01,49,290!2025-01-04,48,290!2025-04-03,107,290-->
...
- symmetric formulae ::@:: $$\left[{n \atop k}\right]=\sum _{j=n}^{2n-k}(-1)^{j-k}{\binom {2n-k}{j} }{\binom {j-1}{k-1} }\left\{ {j-k \atop j-n}\right\}$$ and $$\left\{ {n \atop k}\right\}=\sum _{j=n}^{2n-k}(-1)^{j-k}{\binom {2n-k}{j} }{\binom {j-1}{k-1} }\left[{j-k \atop j-n}\right]$$ <!--SR:!2024-12-25,8,150!2025-02-16,73,270-->
