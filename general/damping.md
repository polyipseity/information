...
>   - initial properties: {{$A$ is the initial [amplitude](amplitude.md) and $\nu = v_0 + \lambda A \approx v_0$ is approximately the initial [velocity](velocity.md) $v_0$}} <!--SR:!2024-11-22,256,330!2024-11-10,207,270!2024-06-07,112,290!2024-12-25,237,270!2024-06-21,114,250!2024-08-10,141,263-->
...
>   - initial properties: {{$c_+ = \frac{\omega + \lambda}{2 \omega} x_0 + \frac1{2 \omega} v_0, c_- = \frac{\omega - \lambda}{2 \omega} x_0 - \frac1{2 \omega} v_0$ from the initial [displacement](displacement%20(geometry).md) $x_0$ and the initial [velocity](velocity.md) $v_0$; the $c_-$ term is negligible for large [time](time.md) $t$}} <!--SR:!2024-08-13,176,310!2024-12-08,237,290!2024-10-10,185,270!2024-07-02,144,310!2024-09-30,158,230!2024-06-10,27,203-->
