...
> __undamped__
>
> When $\zeta = 0$, {{this is equivalent to [simple harmonic motion](simple%20harmonic%20motion.md)}}. {{This is rare in the natural world due to [dissipation](dissipation.md)}}. <!--SR:!2024-01-11,17,290-->
...
>     - initial properties: {{$A$ is the initial [amplitude](amplitude.md) and $\varphi = \operatorname{atan2}\left(-\frac{v_0+\lambda A}\omega, A\right) \approx \operatorname{atan2}\left(-\frac{v_0}\omega, A\right)$ is the initial phase}} <!--SR:!2024-01-06,12,270!2024-01-04,10,270!2024-01-05,11,270!2023-12-31,7,250!2024-01-06,12,270-->
