...
>   - [oscillator](oscillation.md) properties: {{$k$ is the [spring constant](Hooke's%20law.md) and $m$ is the [mass](mass.md), and $c$ is the _viscous damping coefficient_}} <!--SR:!2024-02-11,37,290!2024-03-17,66,310!2024-02-12,39,290-->
...
>   - initial properties: {{$A$ is the initial [amplitude](amplitude.md) and $\nu = v_0 + \lambda A \approx v_0$ is approximately the initial [velocity](velocity.md) $v_0$}} <!--SR:!2024-03-11,60,310!2024-01-31,29,270!2024-02-16,39,290!2024-02-04,33,270!2024-02-28,45,250!2024-03-22,54,263-->
...
>   - initial properties: {{$c_+ = \frac{\omega + \lambda}{2 \omega} x_0 + \frac1{2 \omega} v_0, c_- = \frac{\omega - \lambda}{2 \omega} x_0 - \frac1{2 \omega} v_0$ from the initial [displacement](displacement%20(geometry).md) $x_0$ and the initial [velocity](velocity.md) $v_0$; the $c_-$ term is negligible for large [time](time.md) $t$}} <!--SR:!2024-02-19,44,290!2024-04-14,82,290!2024-01-29,26,270!2024-02-09,36,290!2024-02-16,31,230!2024-02-02,22,263-->
