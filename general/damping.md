...
The [ordinary differential equation](ordinary%20differential%20equation.md) for damped harmonic oscillator can be derived from {{[Newton's second law](Newton's%20laws%20of%20motion.md#second%20law), [Hooke's law](Hooke's%20law.md), and a _viscous damping coefficient_}}: <!--SR:!2024-01-10,16,290-->
...
>     - [oscillator](oscillation.md) properties: {{$k$ is the [spring constant](Hooke's%20law.md) and $m$ is the [mass](mass.md), and $c$ is the _viscous damping coefficient_}} <!--SR:!2024-01-05,11,270!2024-01-11,17,290!2024-01-04,10,270-->
...
> __undamped__
>
> When $\zeta = 0$, {{this is equivalent to [simple harmonic motion](simple%20harmonic%20motion.md)}}. {{This is rare in the natural world due to [dissipation](dissipation.md)}}. <!--SR:!2024-01-11,17,290!2024-01-01,4,283-->
...
>     - initial properties: {{$A$ is the initial [amplitude](amplitude.md) and $\nu = v_0 + \lambda A \approx v_0$ is approximately the initial [velocity](velocity.md) $v_0$}} <!--SR:!2024-01-10,16,290!2024-01-02,9,250!2024-01-08,14,290!2024-01-02,9,250!2024-01-14,14,230!2024-01-08,8,263-->
...
> {{$$Q = \frac{1}{2 \zeta}$$}}
> - where
>.    - {{$Q$ is the [_Q_ factor](Q%20factor.md) of an [oscillator](osccillation.md) with damping ratio $\zeta$}} <!--SR:!2024-01-01,4,283!2024-01-01,4,283-->
...
>
> - where
>     - {{$\lambda$ is the decay rate of an [oscillator](oscillation.md) with natural frequency $\omega_n$ and damping ratio $\zeta$}} <!--SR:!2024-01-01,4,283!2024-01-01,4,283--> 
