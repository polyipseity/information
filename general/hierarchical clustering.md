...
table = (
  ...
  (R"centroid linkage clustering", R"UPGMC, unweighted centroid clustering", R"$\lVert \mu_A - \mu_B \rVert^2$, where $\mu_*$ is the [centroid](centroid.md) of the cluster $*$", R"Squaring the distance is optional. Centroid linkage clustering does not preserve well small clusters that are merged into large clusters."),
...
<!--pytextgen generate section="84ba"--><!-- The following content is generated at 2024-04-12T02:14:26.131695+08:00. Any edits will be overridden! -->
...
> | centroid linkage clustering | UPGMC, unweighted centroid clustering | $\lVert \mu_A - \mu_B \rVert^2$, where $\mu_*$ is the [centroid](centroid.md) of the cluster $*$ | {{Squaring the distance is optional. Centroid linkage clustering does not preserve well small clusters that are merged into large clusters.}} |
