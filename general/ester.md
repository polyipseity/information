...
In alkaline [hydrolysis](hydrolysis.md), esters {{are attacked by [nucleophilic](nucleophile.md) [hydroxide](hydroxide.md) to give [carboxylates](carboxylate.md) and [alcohols](alcohol.md) in [basic](base%20(chemistry).md) conditions}}. {{Heating (under [reflux](reflux.md))}} is used to speed up the reaction. Carboxylates can then be {{[protonated](protonation.md) by increasing the [acidity](pH.md) like adding dilute [acids](acid.md)}}. It is the basis of {{[saponification](saponification.md)}}. <!--SR:!2025-02-08,193,196!2027-04-10,1057,336!2026-10-13,733,340!2024-11-09,223,340-->
