...
The strategy is {{decomposing both expressions using [the definition of conditional probability](conditional%20probability.md#Kolmogorov%20definition) and perform basic algebraic manipulation}}. Assuming {{$P(C) > 0$ and $P(B, C) > 0$}}: <!--SR:!2024-07-03,15,290!2024-08-21,50,310-->
