...
These coefficients satisfy {@{a number of analogous properties to those for the [Stirling numbers of the first kind](Stirling%20numbers%20of%20the%20first%20kind.md)}@} as well as {@{recurrence relations and functional equations related to the _f_-harmonic numbers}@},<sup>[\[12\]](#^ref-12)</sup> {@{$$F_{n}^{(r)}(t):=\sum _{k\leq n}{\frac {t^{k} }{f(k)^{r} } }\,.$$}@} <!--SR:!2024-12-27,45,290!2025-02-01,63,250!2025-03-09,78,230-->
