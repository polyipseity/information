...
The falling factorial can be {{extended to [real](real%20number.md) values of $x$ using the [gamma function](gamma%20function.md)}} provided {{$x$ and $x+n$ are real numbers that are not negative integers}}: {{$$(x)_{n}={\frac {\Gamma (x+1)}{\Gamma (x-n+1)} }\ ,$$}} and so can the rising factorial: {{$$x^{(n)}={\frac {\Gamma (x+n)}{\Gamma (x)} }\ .$$}} <!--SR:!2024-11-12,15,290!2024-11-12,15,290!2024-11-10,13,270!2024-12-22,43,290-->
