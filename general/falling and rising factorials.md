...
- multiplication formula for rising factorial in its base ::@:: $$(ax+b)^{(n)}=x^{n}\prod _{j=0}^{n-1}\left(a+{\frac {b+j}{x} }\right),{\text{for } }n\in \mathbb {\mathbb N}$$ (Annotation: Split $x^n$ into $n$ $x$ and multiply each of it into each $\left(a + \frac {b + j} x \right)$ to get $(ax + b + j)$.) <!--SR:!2025-03-01,84,270!2024-12-15,36,270-->
