...
> 4. {{If $c$ is a finite endpoint of $I$, the limits can be also be [one-sided limits](one-sided%20limit.md) $x\to{}c^+$ or $x\to{}c^-$.}} <!--SR:!2024-11-09,223,280!2025-04-11,308,260!2027-10-25,1084,340!2026-11-25,839,340-->
...
- $\infty-\infty$→:::←$0^0$ <!--SR:!2025-02-25,213,230!2024-11-14,68,230-->
- $0^0$→:::←$1^\infty$ <!--SR:!2024-11-06,255,310!2025-07-25,421,310-->
- $1^\infty$→:::←$\infty^0$ <!--SR:!2025-04-15,187,250!2024-12-03,44,270-->
