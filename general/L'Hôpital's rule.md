...
> 4. {{If $c$ is a finite endpoint of $I$, the limits can be also be [one-sided limits](one-sided%20limit.md) $x\to{}c^+$ or $x\to{}c^-$.}} <!--SR:!2024-11-09,223,280!2025-04-11,308,260!2024-11-05,245,320!2026-11-25,839,340-->
