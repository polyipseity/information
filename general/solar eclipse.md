...
The [Sun](Sun.md)'s distance from [Earth](Earth.md) is {{about 400 times the [Moon](Moon.md)'s [distance](lunar%20distance.md), and the Sun's [diameter](diameter.md) is also about 400 times the Moon's [diameter](diameter.md)}}. Because these ratios are approximately the same, {{the Sun and the Moon as seen from Earth appear to be approximately the same size: about 0.5 [degree of arc](degree%20(angle).md) in [angular measure](angular%20diameter.md)}}. <!--SR:!2024-09-11,52,290!2024-12-29,127,290-->
