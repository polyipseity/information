...
The two main determinants of the position of the PPF at any given time are {{the state of [technology](technology.md) and management expertise (which are reflected in the available [production functions](production%20function.md)) and the available quantities of [factors of production](factors%20of%20production.md) (materials, direct labor, and factory overhead)}}. <!--SR:!2024-10-07,9,250-->
...
>
> figure 4: {{frontier points that violate allocative efficiency}} <!--SR:!2024-10-10,12,270!2024-10-07,9,250-->
