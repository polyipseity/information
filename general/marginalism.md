...
Neoclassical economics usually {@{supplements or supplants discussion of marginal utility with [indifference curves](indifference%20curve.md)}@}, which were originally {@{derived as the [level curves](level%20set.md) of utility functions}@},<sup>[\[9\]](#^ref-9)</sup> or {@{can be produced without presumption of quantification}@},<sup>[\[4\]](#^ref-4)</sup> but {@{are often simply treated as axiomatic}@}. In {@{the absence of complementarity of goods or services}@}, diminishing marginal utility implies {@{[convexity](convex%20function.md) of indifference curves}@},<sup>[\[4\]](#^ref-4)</sup><sup>[\[9\]](#^ref-9)</sup> although {@{such convexity would also follow from [quasiconcavity](quasiconvex%20function.md) of the utility function}@}. (To understand the above, consider {@{the resulting indifference curves of two goods, each when considered individually has diminishing marginal utility}@}.) <!--SR:!2024-12-27,72,327!2024-11-26,47,307!2024-12-27,72,327!2025-01-07,81,327!2024-12-19,64,327!2024-12-11,56,307!2025-01-31,83,287!2024-12-04,49,307-->
