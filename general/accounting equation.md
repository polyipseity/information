...
- the equation in its simplest form ::: $A=L+E$ (i.e. ${\text{Assets} }={\text{Liabilities} }+{\text{Equity} }$) <sup>[\[1\]](#^ref-1)</sup><sup>[\[2\]](#^ref-2)</sup> <!--SR:!2024-10-05,13,290!2024-10-08,16,290-->
...
Every [accounting](accounting.md) [transaction](financial%20transaction.md) {{affects at least one element of the equation, but always balances (it is at least _one_ element, not two elements, of equation because of transactions between accounts of the same type)}}. <!--SR:!2024-10-07,15,290-->
