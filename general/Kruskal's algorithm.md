...
- [Michael T. Goodrich](Michael%20T.%20Goodrich.md) and [Roberto Tamassia](Roberto%20Tamassia.md). _Data Structures and Algorithms in Java_, Fourth Edition. John Wiley & Sons, Inc., 2006. [ISBN](ISBN.md) [0-471-73884-0](https://en.wikipedia.org/wiki/Special%3ABookSources/0-471-73884-0). Section 13.7.1: Kruskal's Algorithm, pp. 632..
