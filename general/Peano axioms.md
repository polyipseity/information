...
Similarly, [multiplication](multiplication.md) is {{a function mapping two natural numbers to another one}}. Given {{addition}}, it is defined recursively as: {{$${\begin{aligned}a\cdot 0&=0,\\a\cdot S(b)&=a+(a\cdot b).\end{aligned} }$$}}. <!--SR:!2024-09-13,4,285!2024-09-13,4,285!2024-09-13,4,285-->

It is easy to see that $S(0)$ is {{the multiplicative [right identity](identity%20element.md): $$a\cdot S(0)=a+(a\cdot 0)=a+0=a$$}}. <!--SR:!2024-09-13,4,285-->
...
- multiplication left identity / induction ::: If $S(0)$ is the left identity of $a$ (that is $S(0)\cdot a=a$), then $S(0)$ is also the left identity of $S(a)$: $S(0)\cdot S(a)=S(0)+S(0)\cdot a=S(0)+a=a+S(0)=S(a+0)=S(a)$, using commutativity of addition. <!--SR:!2024-09-20,8,265!2024-09-13,4,282-->
...
{{The usual [total order](total%20order.md) relation ≤ on natural numbers}} can be defined as follows, assuming 0 is a natural number: {{For all _a_, _b_ ∈ __N__, _a_ ≤ _b_ if and only if there exists some _c_ ∈ __N__ such that _a_ + _c_ = _b_}}. <!--SR:!2024-09-18,6,265!2024-09-13,4,285-->

This relation is {{stable under addition and multiplication}}: for $a,b,c\in \mathbb {N}$, if _a_ ≤ _b_, then: <!--SR:!2024-09-13,4,285-->

- _a_ + _c_ ≤ _b_ + _c_, and
- _a_ · _c_ ≤ _b_ · _c_.

Thus, {{the structure (__N__, +, ·, 1, 0, ≤)}} is {{an [ordered semiring](ordered%20ring.md); because there is no natural number between 0 and 1, it is a discrete ordered semiring}}. <!--SR:!2024-09-13,4,285!2024-09-17,5,250-->

The axiom of induction is {{sometimes stated in the following form that uses a stronger hypothesis, making use of the order relation "≤"}}: <!--SR:!2024-09-13,4,285-->
...
- proving the naturals are well-ordered / base case ::: Let a nonempty _X_ ⊆ __N__ be given and assume _X_ has no least element. Because 0 is the least element of __N__, it must be that 0 ∉ _X_. <!--SR:!2024-09-23,11,285!2024-09-13,4,270-->
