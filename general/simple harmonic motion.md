...
>   - [oscillator](oscillation.md) properties: {{$\omega = \sqrt{\frac{k}m}$ is the [angular frequency](angular%20frequency.md), $k$ is the [spring constant](Hooke's%20law.md), and $m$ is the [mass](mass.md)}} <!--SR:!2024-09-16,190,329!2026-12-04,825,349!2025-05-30,416,369-->
...
> - {{$\phi=\arg{c}$ is the initial [phase](phase%20(waves).md)}} <!--SR:!2025-04-30,441,330!2024-09-13,185,270!2025-01-31,301,270!2024-10-05,251,340!2024-11-25,291,340!2024-12-16,308,340!2024-10-21,264,340!2025-02-17,313,300!2025-11-14,491,300-->
...
> - {{$c=x_0-\frac{v_0}\omega{}i$ is the initial [phase space](phase%20space.md) position}}
> - {{$A=|c|$ is the [amplitude](amplitude.md)}}
> - {{$\phi=\arg{c}$ is the initial [phase](phase%20(waves).md)}} <!--SR:!2024-10-31,177,296!2025-03-21,360,356!2025-02-20,337,356!2024-09-25,217,336!2026-01-08,514,316!2025-02-03,323,356!2024-12-04,254,336-->
...
>     - intermediate variables: {{$\hat{n}$ is the [unit vector](unit%20vector.md) of $\vec{\tau}$ and $\theta$ is the pendulum angle from equilibrium}} <!--SR:!2024-09-21,180,296!2024-12-08,258,336!2025-02-07,296,358!2025-01-14,278,358!2024-11-10,216,350-->
...
>     - intermediate variables: {{$\hat{n}$ is the [unit vector](unit%20vector.md) of $\vec{\tau}$ and $\theta$ is the pendulum angle from equilibrium}} <!--SR:!2025-10-17,452,296!2025-12-05,495,316!2025-03-29,358,378!2024-10-23,209,338!2025-04-11,339,370-->
