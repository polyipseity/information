...
- [linear](#^linear)→:::←[nonhomogeneous](#^nonhomogeneous)/inhomogeneous <!--SR:!2026-07-30,742,330!2024-07-30,210,310-->
...
- solution :: Substitute $y\overset{\mathrm{def} }=ux$, then [separate the variables](separation%20of%20variables.md), then integrate. <!--SR:!2024-10-16,265,320-->
...
- form :: $\frac{\mathrm{d}^2y}{\mathrm{d}x^2}=F(y)$, where $F$ is an [integrable](integral.md) [function](function%20(mathematics).md). <!--SR:!2024-08-12,222,320-->
- solution :: Multiply by $2\frac{\mathrm{d}y}{\mathrm{d}x}$, then substitute $2\frac{\mathrm{d}y}{\mathrm{d}x}\frac{\mathrm{d}^2y}{\mathrm{d}x^2}=\frac{\mathrm{d} }{\mathrm{d}x}\!\left(\frac{\mathrm{d}y}{\mathrm{d}x}\right)^2$, then integrate twice. <!--SR:!2024-08-13,223,320-->
