...
{{A [dividend discount model](dividend%20discount%20model.md) (DDM)}} may also be used to {{value a company's [stock](stock.md) price}} based on the theory that {{its stock is worth the sum of all of its future dividend payments, discounted back to their present value}}.<sup>[\[8\]](#^ref-8)</sup> In other words, it is used to {{value stocks based on the [net present value](net%20present%20value.md) of the future [dividends](dividend.md)}}. <!--SR:!2024-10-07,15,290!2024-10-06,14,290!2024-10-06,14,290!2024-10-01,9,270-->
