...
_Base case_ ::@:: Show that the statement holds for the smallest natural number _n_ = 0. _P_(0) is clearly true: $0={\tfrac {0(0+1)}{2} }$. <!--SR:!2024-12-26,58,310!2024-12-03,38,290-->
...
In practice, proofs by induction are often {@{structured differently, depending on the exact nature of the property to be proven}@}. All variants of induction are {@{special cases of [transfinite induction](transfinite%20induction.md)}@}; see [below](#transfinite%20induction). <!--SR:!2024-12-03,38,290!2024-12-26,58,310-->
