...
The induction step {{must be proved for all values of _n_}}. To illustrate this, {{Joel E. Cohen}} proposed the following argument, which purports to {{prove by mathematical induction that [all horses are of the same color](all%20horses%20are%20the%20same%20color.md)}}:<sup>[\[23\]](#^ref-23)</sup> <!--SR:!2024-12-26,58,310!2024-11-21,26,270!2024-12-28,60,310-->
