...
To assure ourselves, we can {{verify that the above solution satisfies the original inhomogeneous differential equation (using the second expression above to make the proof shorter)}}: <!--SR:!2024-03-04,49,310-->
