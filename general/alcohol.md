...
Due to [hydrogen bonding](hydrogen%20bond.md), alcohols have {@{higher [boiling points](boiling%20point.md) and [melting points](melting%20point.md) than comparable [alkanes](alkane.md)}@}. <!--SR:!2029-12-11,1862,330-->

### density

Most alcohols are {@{less [dense](density.md) than [water](water.md). Alcohols with multiple [hydroxyl groups](hydroxyl%20group.md) are more dense than water}@}. <!--SR:!2028-08-26,1428,290-->

### solubility

{@{[Methanol](methanol.md), [ethanol](ethanol.md), and [propanol](propanol.md)}@} are [miscible](miscibility.md) with water in all proportions, while {@{[butanol](butanol.md) is moderately water soluble}@}. <!--SR:!2025-12-22,693,310!2024-11-27,141,270-->

## chemical properties

### dehydration

Alcohols {@{react with strong [acids](acid.md) like concentrated [sulfuric acid](sulfuric%20acid.md) with heating to produce [alkenes](alkene.md)}@}. It obeys {@{[Zaitsev's rule](Zaitsev's%20rule.md), which states that the most stable alkene, which is usually the most substituted (more [hydrogen](hydrogen.md) is substituted on the [carbon](carbon.md)–carbon [double bond](double%20bond.md)), is formed}@}. <!--SR:!2026-07-29,705,240!2025-02-04,112,200-->
...
- [dehydration](#dehydration)→::@::←[nucleophilic substitution](#nucleophilic%20substitution) <!--SR:!2025-02-23,153,195!2025-01-23,164,280-->
- [nucleophilic substitution](#nucleophilic%20substitution)→::@::←[oxidation](#oxidation) <!--SR:!2026-02-28,571,275!2024-11-24,14,130-->
