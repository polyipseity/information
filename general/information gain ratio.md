...
Information gain ratio {{makes [decision tree learning](decision%20tree%20learning.md) avoid splitting on attributes with many possible values}}.

## disadvantages

Attributes with many possible values {{will never be considered over those with much lower ones}}.
