...
>   - strictly monotone/strictly monotonic/strictly increasing/strictly decreasing ::: $x < y \implies f(x) \le f(y)$; $x < y \implies f(x) \ge f(y)$ <!--SR:!2024-04-07,53,310!2024-05-08,61,337-->
...
>   - not increasing/not decreasing ::: not _increasing_/not _decreasing_ (simply adds to the worst terminology ever) <!--SR:!2024-04-17,61,310!2024-03-09,15,317-->
