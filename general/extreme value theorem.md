...
>
> {{Given a [real](real%20number.md) closed [interval](interval%20(mathematics).md) $I=[a,b]$ and a [continuous function](continuous%20function.md) $f:I\to\mathbb{R}$, there exists $c,d\in{I}$ such that $f(c)\le{f(x)}\le{f(d)}\quad\forall{x}\in{I}$.}} <!--SR:!2023-12-01,4,270-->
