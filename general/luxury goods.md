...
Some articles in the [microeconomics](microeconomics.md) discipline use {@{the term _superior good_ as an alternative to an _inferior good_}@}, thus {@{making "superior goods" and "normal goods" synonymous}@}. Where this is done, {@{a product making up an increasing share of spending under income increases}@} is {@{often called an _ultra-superior good_}@}.<!-- <sup>\[_[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation%20needed)_\]</sup> -->
