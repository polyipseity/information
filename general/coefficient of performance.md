...
>
> - where
>   - {{$Q$ is the useful [heat](heat.md) absorbed (positive) or dissipated (negative) by the system, and $W > 0$ is the net [work](work%20(physics).md) put into the system (as opposed to the conventional "done by the system")}} <!--SR:!2026-04-04,634,330!2024-10-18,231,330-->
...
>
> - where
>   - {{$Q_C > 0$ and $Q_H < 0$ are respectively [heat](heat.md) absorbed and dissipated by the system, and $W > 0$ is the net [work](work%20(physics).md) put into the system (as opposed to the conventional "done by the system")}} <!--SR:!2025-07-15,376,290!2026-03-22,563,310-->
