...
>
> - where
>   - [state variables](state%20variable.md): {{$U$ is the [internal energy](internal%20energy.md), $p$ is the [pressure](pressure.md), and $V$ is the [volume](volume.md)}} <!--SR:!2024-02-16,50,334!2024-04-03,88,354-->
