...
- __2026‑02‑22 consolidation:__ this file is a stub; the full continuous‑learning guidance lives under the corresponding heading in `SKILL.md`.  It was added to align with the new cross‑skill structure.

---

If you wish to extend or summarise those notes, copy relevant items from `SKILL.md` into this file or add a pointer here for clarity.
