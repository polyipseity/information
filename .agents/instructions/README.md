...
| `submodule-*.instructions.md` | Submodule guardrails (see submodule-specific AGENTS.md) | `self/arts/**`, `self/capture the flag/**`, `self/ledger/**`, `self/passwords/**`, `self/polyipseity/**`, `private/**`, `scripts/pytextgen/**`, `scripts/pyarchivist/**` |
