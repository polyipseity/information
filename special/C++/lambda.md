...
If the capture-default is `=`, subsequent simple captures {@{must begin with `&`. Since C++17, `*this` is also allowed. Since C++20, `this` is also allowed}@}. <!--SR:!2025-03-05,43,190-->
