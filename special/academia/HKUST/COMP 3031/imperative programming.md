...
Scala lets programmers write code that {@{looks like traditional _imperative_ languages}@} while still {@{benefiting from the safety and abstraction mechanisms of a modern language}@}. The core ideas are simple: {@{variables, mutable state, loops and control flow}@} can be expressed {@{directly in the language}@} or modelled with {@{higher‑order functions}@}. <!--SR:!2026-03-31,66,310!2026-03-31,66,310!2026-03-30,65,310!2026-03-29,64,310!2026-11-08,239,330-->
...
> ```
>
> In Scala, {@{every expression}@} evaluates {@{to a value}@}. For {@{a `while` loop}@}, it always evaluates to {@{the `Unit` value `()`}@}. <!--SR:!2026-03-29,64,310!2026-11-27,255,330!2026-03-24,59,310!2026-11-28,251,330!2026-03-26,61,310-->
...
> ```
<!--SR:!2026-03-24,59,310!2026-04-01,67,310!2026-12-02,254,330-->
...
{@{The simulation}@} is driven by {@{an agenda of delayed actions}@}. {@{The abstract `Simulation` trait}@} supplies {@{the core API}@}: <!--SR:!2026-03-27,62,310!2026-03-28,63,310!2026-11-28,251,330!2026-10-29,230,330-->
...
> }
> ```
<!--SR:!2026-11-28,251,330!2026-03-29,64,310!2026-11-14,244,330!2026-03-24,59,310-->
