...
- COMP 3031
  - COMP 3031 / exercise 4 ::@:: Implement GCD, List primitives (`map`, `foldLeft`), and memory CAS in a small expression language using the given `Expr` AST. <!--SR:!2026-07-04,154,436!2026-07-14,161,436-->
    ...
    - COMP 3031 / exercise 4 / `BinOp` instances ::@:: Shorthands for binary ops. <p> - `minus(e1, e2) = BinOp(Minus, e1, e2)` <br/> - `plus(e1, e2) = BinOp(Plus, e1, e2)` <br/> - `leq(e1, e2) = BinOp(LessEq, e1, e2)`: returns `1` if `e1 <= e2`, else `0` <br/> - `times(e1, e2) = BinOp(Times, e1, e2)` <br/> - `modulo(e1, e2) = BinOp(Modulo, e1, e2)` <!--SR:!2026-06-29,149,436!2026-07-13,160,436-->
