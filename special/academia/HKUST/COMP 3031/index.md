...
- COMP 3031
  - COMP 3031 / exercise 4 ::@:: Implement GCD, List primitives (`map`, `foldLeft`), and memory CAS in a small expression language using the given `Expr` AST. <!--SR:!2026-07-04,154,436!2026-07-14,161,436-->
    - COMP 3031 / exercise 4 / `Expr` ::@:: Core syntax for expressions and binary ops. <p> - __`Expr`__: `Constant`, `Name`, `BinOp`, `IfNonzero`, `Call`, `Fun` <br/> - __`Expr`__ (lists): `Cons`, `EmptyList`, `Match` <br/> - __`Expr`__ (memory): `Read`, `Write` <!--SR:!2026-06-27,147,436!2026-07-15,162,436-->
