...
- COMP 3031
  ...
  - COMP 3031 / lab 0
    ...
    - COMP 3031 / lab 0 / test ::@:: In a terminal inside the project, start sbt and then run `~test` to enable watch mode; every file save automatically re‑runs tests. For targeted testing use `testOnly org.example.*Slow org.example.MyTest1`. <!--SR:!2025-11-16,20,364!2025-11-04,6,324-->
