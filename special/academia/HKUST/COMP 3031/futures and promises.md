...
> ```
>
> Assuming {@{_no exceptions_ are thrown before returning `p.future`}@}, the `Promise` is {@{completed exactly once}@}; subsequent calls to {@{`trySuccess` or `tryFailure` are ignored}@} after {@{the first call to either `trySuccess` or `tryFailure`}@}, guaranteeing {@{a single result}@}; note {@{the similar methods `success` and `failure`}@} {@{_throws_ for subsequent calls}@} instead. <!--SR:!2026-01-19,15,290!2026-03-17,58,310!2026-03-15,56,310!2026-01-19,15,290!2026-01-20,16,290!2026-03-15,56,310!2026-01-19,15,290!2026-01-22,4,317!2026-01-22,4,317!2026-01-22,4,317-->

Assuming {@{_no exceptions_ are thrown before returning `p.future`}@}, the `Promise` is {@{completed exactly once}@}; subsequent calls to {@{`trySuccess` or `tryFailure` are ignored}@} after {@{the first call to either `trySuccess` or `tryFailure`}@}, guaranteeing {@{a single result}@}; note {@{the similar methods `success` and `failure`}@} {@{_throws_ for subsequent calls}@} instead. <!--SR:!2026-01-20,16,290!2026-01-19,15,290!2026-01-19,15,290!2026-03-16,57,310!2026-03-13,54,310!2026-03-16,57,310!2026-01-22,4,317-->
