...
A list can be {@{either `Nil` or an element cons-ed onto another list (`x :: xs`)}@}. To prove {@{a property $P(\texttt{xs})$ for all lists}@}, we show: <!--SR:!fsrs,2029-12-25T00:00:00.000Z,1176,1176.0199518,1,2,9,0,0,2026-10-06T00:00:00.000Z!2026-10-15,274,330-->
...
Let us prove {@{the associativity law}@} for lists: {@{`(xs ::: ys) ::: zs = xs ::: (ys ::: zs)`}@}. {@{The definition of `:::`}@} is: <!--SR:!2026-11-03,290,330!fsrs,2029-11-03T00:00:00.000Z,1134,1133.95119242,1,2,9,0,0,2026-09-26T00:00:00.000Z!2026-10-15,274,330-->
