...
To {@{prove `xs ::: Nil = xs`}@}, the proof {@{proceeds similarly}@}. {@{The base case is trivial}@} because {@{`Nil ::: Nil` reduces directly to `Nil`}@}. In {@{the inductive step}@} we need {@{two equations}@}: one from {@{the definition of `:::` applied to `x :: xs`}@} and one from {@{the induction hypothesis that `xs ::: Nil = xs`}@}. Thus, {@{_two_ equations}@} are needed. <!--SR:!2026-10-06,268,330!2026-10-09,268,330!2026-10-25,282,330!2026-10-14,273,330!2026-11-05,291,330!2026-10-04,266,330!fsrs,2029-11-27T00:00:00.000Z,1153,1153.10014712,1,2,9,0,0,2026-10-01T00:00:00.000Z!fsrs,2029-08-27T00:00:00.000Z,1080,1080.08717202,1,2,9,0,0,2026-09-12T00:00:00.000Z!2026-10-31,287,330-->
