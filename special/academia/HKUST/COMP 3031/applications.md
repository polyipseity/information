...
{@{The query}@} that extracts {@{titles of books}@} with an author whose {@{name starts with "Bird"}@} can be expressed using higher‑order functions as: <!--SR:!2025-11-12,16,290!2025-11-12,16,290!2025-11-11,15,290-->
