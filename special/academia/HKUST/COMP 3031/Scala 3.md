...
{@{The types of `val`s in a class}@} \(and {@{method `def`s}@} are considered as {@{`val`s of the function type}@}\) are {@{covariant}@}. Then, {@{recursively evaluate the variance}@} of {@{the _inner types_ in types with type parameters}@}, e.g. {@{`T[X]`}@} where {@{`T[X]` has a known variance}@} and {@{the variance of `X` needs to be evaluated}@}. \(Note that {@{function types such as `X => Y`}@} are considered as {@{`Function1[X, Y]`}@}, so they are also {@{types with type parameters}@}.\) To {@{evaluate `X`}@}, inspect {@{the variance of the type parameter in the _definition_ of `T`}@}. If {@{`U` is invariant \(`U`\)}@}, then {@{`X` is invariant}@}. If {@{`U` is covariant \(`+U`\)}@}, then {@{`X` has the _same_ variance as `T[X]`}@}. If {@{`U` is contravariant \(`-U`\)}@}, then {@{`X` has the _opposite_ variance as `T[X]`}@}. {@{Recursively repeat this process}@} until {@{there are no more unevaluated inner types}@}. <!--SR:!2026-08-26,224,475!2026-08-08,207,475!2026-08-18,217,475!2026-08-17,216,475!2026-08-17,216,475!fsrs,2029-07-02T00:00:00.000Z,1060,1060.1427594,1,2,9,0,0,2026-08-07T00:00:00.000Z!2026-08-15,214,475!2026-08-27,225,475!2026-08-26,224,475!2026-08-13,212,475!2026-08-13,212,475!2026-08-29,227,475!2026-08-08,207,475!2026-08-26,224,475!2026-08-14,213,475!2026-08-12,211,475!2026-08-07,206,475!2026-08-09,208,475!2026-08-08,207,475!2026-08-19,217,475!fsrs,2029-07-02T00:00:00.000Z,1060,1060.1427594,1,2,9,0,0,2026-08-07T00:00:00.000Z!2026-08-24,222,475-->
