...
Finally, compare {@{the _possible variance_ a _type_ can have versus its _actual variance_}@}. For {@{types that are not type parameters of `A`}@}, we can {@{simply ignore them}@}. For {@{types that are type parameters of `A`}@}, check if {@{the type parameter variance is compatible with the possible variance}@}: {@{_possibly_ invariant type}@} is compatible with {@{invariant type parameters}@}, {@{_possibly_ covariant type}@} is compatible with {@{invariant or covariant type parameters}@}, and {@{_possibly_ contravariant type}@} is compatible with {@{invariant or contravariant type parameters}@}. <!--SR:!2026-05-15,131,455!2026-01-13,35,455!2026-01-12,34,455!2026-01-12,34,455!2026-01-12,34,455!2026-01-13,35,455!2026-01-14,36,455!2026-01-14,36,455!2026-01-13,35,455!2026-01-13,35,455!2026-01-13,35,455-->
