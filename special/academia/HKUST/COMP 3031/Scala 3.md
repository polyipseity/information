...
Finally, compare {@{the _possible variance_ a _type_ can have versus its _actual variance_}@}. For {@{types that are not type parameters of `A`}@}, we can {@{simply ignore them}@}. For {@{types that are type parameters of `A`}@}, check if {@{the type parameter variance is compatible with the possible variance}@}: {@{_possibly_ invariant type}@} is compatible with {@{invariant type parameters}@}, {@{_possibly_ covariant type}@} is compatible with {@{invariant or covariant type parameters}@}, and {@{_possibly_ contravariant type}@} is compatible with {@{invariant or contravariant type parameters}@}. <!--SR:!2028-07-27,804,475!2026-08-15,214,475!2026-08-06,205,475!2026-08-08,207,475!2026-08-11,210,475!2026-08-12,211,475!2026-08-20,218,475!2026-08-24,222,475!2026-08-16,215,475!2026-08-18,217,475!2026-08-13,212,475-->
