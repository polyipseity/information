...
> ```
>
> {@{Typical `sequence` implementations for other containers}@} follow {@{the same pattern}@}. For example, {@{`sequence` for the structure `List[_]`}@} is a function that converts {@{a `List[F[A]]` into `F[List[A]]`}@} for some {@{applicative type constructor `F[_]`}@}. <!--SR:!2026-12-21,268,330!2026-12-15,263,330!2026-09-28,193,310!2026-12-19,267,330!2027-01-10,285,330!2026-11-20,249,330!2026-11-24,252,330!fsrs,2028-06-16T00:00:00.000Z,684,684.3807954,1,2,8,0,0,2026-08-02T00:00:00.000Z!2027-01-05,276,330-->
