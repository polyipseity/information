...
- monkey patch ::@:: Powerful and dynamic. Can break code and debugging. <!--SR:!2026-02-13,76,329!2026-01-30,64,329-->
...
- functional context ::@:: Normally, values and types infer types but not values, e.g. inferring type parameters. With `using`, types are used to infer values. Those values provide "context". <!--SR:!2026-02-13,76,329!2026-01-27,61,329-->

### higher-order functions

When {@{a method}@} needs to {@{operate over arbitrary types}@} – for example, {@{a generic `sort`}@} – {@{the natural solution}@} is to {@{type parameterise it}@}: <!--SR:!2026-02-13,76,329!2026-02-13,76,329!2026-01-30,64,329!2026-02-02,67,329!2026-02-01,66,329-->
...
> ```
<!--SR:!2026-02-13,76,329!2026-02-01,66,329!2026-02-07,71,329!2026-01-30,64,329!2026-01-31,65,329-->
...
> ```
<!--SR:!2026-01-30,64,329!2026-01-27,61,329!2026-02-13,76,329!2026-01-28,62,329!2026-02-06,70,329!2026-01-29,63,329-->
...
> ```
<!--SR:!2026-02-05,69,329!2026-01-29,63,329!2026-02-13,76,329!2026-01-28,62,329-->
...
Now {@{callers}@} need not {@{supply it explicitly \(though it could if it chooses to\)}@}; {@{the compiler}@} searches for {@{an implicit `Ordering[T]` in scope}@} and {@{supplies it automatically}@}. {@{Calling it}@} becomes {@{simpler}@}: <!--SR:!2026-01-21,56,310!2026-01-22,57,310!2026-02-13,76,329!2026-01-27,61,329!2026-02-05,69,329!2026-02-13,76,329!2026-01-29,63,329-->
...
When calling {@{such a method}@}, you may {@{supply the argument explicitly}@} via {@{another `using` clause}@}: <!--SR:!2026-02-13,76,329!2026-02-02,67,329!2026-02-02,67,329-->
...
Alternatively, {@{separate `using` clauses}@} can be {@{chained}@}. {@{`using` clauses}@} can also be {@{interleaved with ordinary parameter lists}@}, allowing {@{a mix of implicit and explicit arguments}@}: <!--SR:!2026-02-07,71,329!2026-01-30,64,329!2026-01-31,65,329!2026-02-02,67,329!2026-02-13,76,329-->
...
> ```
<!--SR:!2026-01-23,58,310!2026-01-28,62,329!2026-02-13,76,329!2026-02-06,70,329!2026-02-05,69,329-->

{@{Anonymous `using` clauses}@} let a method declare {@{an implicit parameter without naming it}@}; the compiler will still {@{supply and forward that instance to other methods automatically}@}. For example, <!--SR:!2026-02-13,76,329!2026-01-29,63,329!2026-01-30,64,329-->
...
> ```
>
> Intuitively, this may be interpreted as {@{`T` "satisfying" the trait `Ordering`}@}, i.e. having {@{a defined ordering}@}. <!--SR:!2025-11-30,18,328!2025-11-30,18,329!2025-11-30,18,327!2025-11-30,18,327!2026-02-13,76,329!2026-02-13,76,329-->
...
More generally, {@{any definition `def f[T : {U1, ..., Un}](ps) : R`}@} \({@{_deprecated_ syntax}@}: {@{`def f[T : U1 : ... : Un](ps) : R`}@}\) is expanded to {@{`def f[T](ps)(using U1[T], ..., Un[T]) : R`}@}. {@{This transformation}@} makes {@{context bounds a convenient shorthand}@} for {@{implicit parameters without altering the generated code}@}. <!--SR:!2026-01-30,64,329!2026-01-23,58,310!2026-02-13,76,329!2026-01-28,62,329!2026-01-31,65,329!2025-11-30,18,328!2026-02-14,77,348-->

## `given`

Scala 3 introduces {@{_`given` instances_}@} – {@{values}@} that can be {@{automatically supplied for implicit parameters}@}: <!--SR:!2026-02-13,76,329!2026-02-06,70,329!2026-02-13,76,329-->
...
> ```
<!--SR:!2026-02-13,76,329!2026-02-05,69,329!2026-01-30,64,329-->

{@{Anonymous instances}@} can be {@{declared without a name}@}; the compiler will {@{generate a name}@}: <!--SR:!2026-02-01,66,329!2026-02-02,67,329!2026-02-13,76,329-->
...
> ```
<!--SR:!2026-02-13,76,329!2026-01-27,61,329-->

{@{`summon`}@} simply uses {@{`using` in its implementation}@}; it is {@{defined as}@}: <!--SR:!2026-02-13,76,329!2026-02-01,66,329!2026-02-13,76,329-->
...
> ```
<!--SR:!2026-02-13,76,329!2026-01-30,64,329!2026-01-28,62,329-->

### importing `given`s

There are {@{three forms of import}@} to {@{import `given`s}@}: \(annotation: 3 items: {@{by name, by type, by wildcard}@}\) <!--SR:!2026-01-27,61,329!2026-02-06,70,329!2026-02-13,76,329-->

- by name ::@:: `import scala.math.Ordering.Int` <!--SR:!2026-01-22,57,310!2026-02-13,76,329-->
...
- by wildcard ::@:: via a blanket wildcard, e.g. `import scala.math.given` <!--SR:!2026-01-31,65,329!2026-02-13,76,329-->
...
> ```
>
> {@{An `Ordering[List[A]]` exists}@} only when {@{an `Ordering[A]` is available}@}. <!--SR:!2025-11-30,18,330!2025-11-30,18,330!2025-11-30,18,328!2025-11-30,18,328!2025-11-30,18,327!2026-02-16,79,347-->
...
When {@{a method}@} requires {@{an instance that depends on another instance}@}, {@{the compiler}@} {@{resolves them recursively}@}. For example: <!--SR:!2026-02-13,76,329!2026-02-13,76,329!2026-02-01,66,329!2026-02-06,70,329-->
...
> ```
>
> {@{The compiler}@} first finds {@{`Ordering[List[Int]]`}@}, then finds {@{`Ordering[Int]`}@}, and finally {@{builds them in reverse order}@} and {@{supplies it to `sort`}@}. <!--SR:!2025-11-30,18,327!2025-11-30,18,327!2026-02-15,78,347!2026-02-16,79,347!2026-02-06,70,329!2026-02-13,76,329!2026-02-07,71,329!2026-01-29,63,329!2025-11-30,18,328-->

For {@{another example}@} of {@{recursive `given` resolution}@}, {@{pairs}@} can be {@{ordered lexicographically}@} if {@{both components are orderable}@}: <!--SR:!2026-02-05,69,329!2026-01-27,61,329!2026-01-22,57,310!2026-02-13,76,329!2026-01-31,65,329-->
...
When a method expects {@{an implicit of type `T` \(e.g. `Ordering[Int]` in the above example\)}@}, the compiler looks for {@{a _`given` instance_ that}@}: \(annotation: 2 items: {@{compatible, visible}@}\) <!--SR:!2026-01-31,65,329!2026-02-13,76,329!2026-02-07,71,329-->

- compatible ::@:: Has a compatible type. <!--SR:!2026-02-01,66,329!2026-01-27,61,329-->
- visibility ::@:: Is visible in the current scope (lexical, imports, parameters) or defined in a companion object associated with `T`. <!--SR:!2026-01-23,58,310!2026-02-13,76,329-->
...
- lexical scope ::@:: Visible `given` instances in the lexical scope, including inherited, imported and defined instances. <!--SR:!2026-01-27,61,329!2026-02-13,76,329-->
...
- enclosing objects ::@:: For inner classes, outer enclosing objects. <!--SR:!2026-02-13,76,329!2026-01-31,65,329-->
...
> ```
<!--SR:!2026-02-02,67,329!2026-02-13,76,329-->
...
{@{A type class}@} can be {@{implemented for a data type}@} without {@{modifying its definition}@}. For example, {@{a rational number type}@}: <!--SR:!2026-01-31,65,329!2026-02-13,76,329!2026-01-28,62,329!2026-01-28,62,329-->
...
{@{Haskell}@} treats {@{type classes}@} as {@{a first-class feature of the language}@}.  {@{The standard library}@} defines {@{an `Ordering` data type}@} ({@{`data Ordering = LT | EQ | GT`}@}) and declares {@{the class}@} <!--SR:!2026-02-13,76,329!2026-02-07,71,329!2026-02-13,76,329!2026-01-31,65,329!2026-02-13,76,329!2026-02-05,69,329!2026-01-20,55,310-->
...
> ```
>
> {@{`class Ord`}@} specifies {@{how values of any type `a` can be compared}@}. <!--SR:!2025-11-30,18,330!2026-02-17,80,350!2025-11-30,18,330!2025-11-30,18,330!2025-11-30,18,330!2026-02-17,80,350-->
...
{@{The syntax in Rust}@} is {@{slightly different}@} but {@{the concept}@} remains {@{the same}@}—defining {@{a set of operations}@} that can be {@{implemented for many distinct types}@}. <!--SR:!2026-02-07,71,329!2026-01-20,55,310!2026-01-22,57,310!2026-02-02,67,329!2026-02-13,76,329!2026-02-07,71,329-->

{@{Other functional and dependently-typed languages}@} are moving {@{toward a similar approach}@}.  {@{Agda, Lean, and soon OCaml}@} provide {@{general _contextual parameters_ or equivalent mechanisms}@} that allow {@{programmers to encode type-class-like behaviour}@} in a manner analogous to {@{Scala's `given` instances}@}.  {@{These systems}@} combine the expressiveness of {@{Haskell's type classes with Scala-style contextual resolution}@}, enabling {@{conditional polymorphism across a wide range of types}@}. <!--SR:!2026-01-31,65,329!2026-02-13,76,329!2026-01-22,57,310!2026-01-23,58,310!2026-02-13,76,329!2026-02-13,76,329!2026-01-27,61,329!2026-02-13,76,329!2026-02-01,66,329-->
