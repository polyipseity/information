...
> ```
<!--SR:!2025-11-29,17,309!2026-02-01,66,329!2025-11-28,16,309!2026-01-30,64,329!2026-01-31,65,329-->

However, {@{sorting}@} requires {@{an ordering relation `<`}@}, which {@{does not exist for all types}@}.  {@{The resolution}@} is to {@{_parameterise with an ordering_ rather than just a type}@}. <!--SR:!2026-01-22,57,310!2025-11-28,16,309!2025-11-28,16,309!2026-02-02,67,329!2025-11-28,16,309-->
...
> ```
<!--SR:!2026-01-30,64,329!2026-01-27,61,329!2025-11-29,17,309!2026-01-28,62,329!2025-11-28,16,309!2026-01-29,63,329-->
...
> ```
<!--SR:!2025-11-28,16,309!2026-01-29,63,329!2025-11-29,17,309!2026-01-28,62,329-->

## `using`

To {@{reduce boilerplate}@} {@{the `ord` argument}@} can be declared {@{_implicit_ via a `using` clause}@}: <!--SR:!2026-02-01,66,329!2026-01-28,62,329!2025-11-28,16,309-->
...
Now {@{callers}@} need not {@{supply it explicitly \(though it could if it chooses to\)}@}; {@{the compiler}@} searches for {@{an implicit `Ordering[T]` in scope}@} and {@{supplies it automatically}@}. {@{Calling it}@} becomes {@{simpler}@}: <!--SR:!2026-01-21,56,310!2026-01-22,57,310!2025-11-29,17,309!2026-01-27,61,329!2025-11-28,16,309!2025-11-29,17,309!2026-01-29,63,329-->
...
> ```
>
> The compiler also infers {@{the type argument `T` from the argument list}@}. If {@{a single obvious value exists for a type}@}, the compiler may even infer {@{that _term_ itself (e.g., `Ordering.Int`)}@}. <!--SR:!2025-11-30,18,327!2025-11-30,18,327!2025-11-30,18,327!2025-11-28,16,309!2025-11-28,16,309!2025-11-28,16,309!2025-11-28,16,309!2026-02-02,67,329!2026-01-29,63,329!2026-01-21,56,310-->
...
{@{The syntax for `using` clauses}@} is {@{flexible}@}. {@{A single clause}@} may contain {@{multiple parameters}@}: <!--SR:!2026-01-22,57,310!2025-11-28,16,309!2026-02-01,66,329!2025-11-29,17,309-->
...
> f(10)(using a, b)
> ```
<!--SR:!2025-11-28,16,309!2026-01-22,57,310!2026-01-30,64,329!2026-01-30,64,329-->

Alternatively, {@{separate `using` clauses}@} can be {@{chained}@}. {@{`using` clauses}@} can also be {@{interleaved with ordinary parameter lists}@}, allowing {@{a mix of implicit and explicit arguments}@}: <!--SR:!2025-11-28,16,309!2026-01-30,64,329!2026-01-31,65,329!2026-02-02,67,329!2025-11-29,17,309-->
...
> ```
<!--SR:!2026-01-23,58,310!2026-01-28,62,329!2025-11-29,17,309!2025-11-28,16,309!2025-11-28,16,309-->
...
This is equivalent to explicitly {@{passing a named `ord` through every call that needs an `Ordering` implicitly}@}, but keeps the body of `sort` {@{free from boilerplate}@} and shows that {@{the implicit context can propagate transparently}@} even when the method itself {@{never directly references the parameter}@}. <!--SR:!2026-01-22,57,310!2025-11-28,16,309!2026-01-23,58,310!2026-02-02,67,329-->

### context bound

{@{A shorthand}@} for declaring {@{an implicit parameter}@} is {@{the _context bound_}@}, which {@{expands to a `using` clause under the hood}@}: <!--SR:!2025-11-28,16,309!2026-02-01,66,329!2026-02-02,67,329!2026-01-31,65,329-->
...
> ```
<!--SR:!2025-11-29,17,309!2025-11-28,16,309!2026-01-30,64,329-->
...
> ```
<!--SR:!2026-01-31,65,329!2025-11-28,16,309!2026-01-23,58,310-->
...
There are {@{three forms of import}@} to {@{import `given`s}@}: \(annotation: 3 items: {@{by name, by type, by wildcard}@}\) <!--SR:!2026-01-27,61,329!2025-11-28,16,309!2025-11-29,17,309-->
...
Since {@{the actual names of `given` instances}@} are {@{irrelevant to resolution}@}, {@{importing by type}@} is {@{preferred}@} because it explicitly {@{states which implicit instance you intend to use}@}. <!--SR:!2025-11-28,16,309!2025-11-28,16,309!2025-11-28,16,309!2026-01-31,65,329!2026-01-29,63,329-->
...
When {@{a method}@} requires {@{an instance that depends on another instance}@}, {@{the compiler}@} {@{resolves them recursively}@}. For example: <!--SR:!2025-11-29,17,309!2025-11-29,17,309!2026-02-01,66,329!2025-11-28,16,309-->
...
> ```
>
> {@{The compiler}@} first finds {@{`Ordering[List[Int]]`}@}, then finds {@{`Ordering[Int]`}@}, and finally {@{builds them in reverse order}@} and {@{supplies it to `sort`}@}. <!--SR:!2025-11-30,18,327!2025-11-30,18,327!2025-11-29,17,327!2025-11-29,17,327!2025-11-28,16,309!2025-11-29,17,309!2025-11-28,16,309!2026-01-29,63,329!2025-11-30,18,328-->

For {@{another example}@} of {@{recursive `given` resolution}@}, {@{pairs}@} can be {@{ordered lexicographically}@} if {@{both components are orderable}@}: <!--SR:!2025-11-28,16,309!2026-01-27,61,329!2026-01-22,57,310!2025-11-29,17,309!2026-01-31,65,329-->
...
> ```
>
> This enables {@{sorting of address records}@} represented as {@{`(Int, String)`}@} by {@{zip code and street name}@}. <!--SR:!2025-11-30,18,327!2025-11-30,18,327!2025-11-30,18,327!2025-11-28,16,309!2026-01-31,65,329!2026-01-30,64,329!2025-11-28,16,328!2025-11-30,18,328-->

## context inference

When a method expects {@{an implicit of type `T` \(e.g. `Ordering[Int]` in the above example\)}@}, the compiler looks for {@{a _`given` instance_ that}@}: \(annotation: 2 items: {@{compatible, visible}@}\) <!--SR:!2026-01-31,65,329!2025-11-29,17,309!2025-11-28,16,309-->
...
{@{This mechanism}@} allows {@{libraries}@} to provide {@{default behaviours}@} that can be {@{overridden locally without changing every call site}@}. <!--SR:!2025-11-28,16,309!2025-11-28,16,309!2026-01-28,62,329!2026-01-28,62,329-->
...
- specificity: lexical scope ::@:: A definition that is in a closer lexical scope is more specific; or <!--SR:!2025-11-28,16,309!2026-01-27,61,329-->
...
{@{A `given` instance}@} supplies {@{the implementation for a concrete type}@}: <!--SR:!2025-11-28,16,309!2026-01-28,62,329-->
...
> ```
>
> {@{The compiler}@} resolves {@{the appropriate `Ordering[A]` at compile time}@}. <!--SR:!2025-11-28,16,309!2026-01-22,57,310!2025-11-28,16,309!2026-02-01,66,329-->
...
{@{A type-class trait}@} may declare {@{_extension methods_}@} that become {@{available when an instance is in scope}@}: <!--SR:!2026-01-31,65,329!2026-01-29,63,329!2025-11-28,16,309-->
...
>     def >=(y: A)  = compare(x, y) >= 0
> ```
<!--SR:!2025-11-28,16,309!2025-11-28,16,309!2026-02-02,67,329-->
...
{@{Haskell}@} treats {@{type classes}@} as {@{a first-class feature of the language}@}.  {@{The standard library}@} defines {@{an `Ordering` data type}@} ({@{`data Ordering = LT | EQ | GT`}@}) and declares {@{the class}@} <!--SR:!2025-11-29,17,309!2025-11-28,16,309!2025-11-29,17,309!2026-01-31,65,329!2025-11-29,17,309!2025-11-28,16,309!2026-01-20,55,310-->
...
{@{Modern systems such as Rust}@} have adopted {@{an analogous construct}@}: the language offers {@{_traits_}@}, which are {@{essentially type classes}@}. {@{A typical Rust trait}@} that {@{mirrors `Ord`}@} looks like: <!--SR:!2025-11-28,16,309!2026-01-31,65,329!2026-01-08,43,290!2025-11-29,17,309!2026-01-29,63,329!2025-11-29,17,309-->
...
{@{The syntax in Rust}@} is {@{slightly different}@} but {@{the concept}@} remains {@{the same}@}—defining {@{a set of operations}@} that can be {@{implemented for many distinct types}@}. <!--SR:!2025-11-28,16,309!2026-01-20,55,310!2026-01-22,57,310!2026-02-02,67,329!2025-11-29,17,309!2025-11-28,16,309-->
