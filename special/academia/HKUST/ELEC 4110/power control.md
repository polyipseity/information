...
{@{Cellular systems}@} still {@{use simple power control}@} because they require {@{two‑way real‑time communication}@} and cannot yet {@{support more sophisticated adaptive bit loading}@}. {@{Non-real-time traffic such as Wi-Fi}@}, by contrast, can {@{afford slower adaptation}@}, which opens the door to {@{more energy-efficient schemes}@}. <!--SR:!2026-11-23,239,330!2026-11-11,228,330!2027-01-07,276,330!2026-12-07,251,330!2026-12-07,251,330!2026-11-12,229,330!2027-02-18,294,330-->
