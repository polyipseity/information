...
{@{The optimality of a demodulator}@} holds {@{only within the assumed receiver structure \(e.g. matched filter for LTI filters\)}@}. {@{Altering the signal space or receiver architecture}@} can yield {@{different, potentially better performance for multilevel schemes}@}. <!--SR:!2027-01-25,315,345!2026-03-22,77,344!2026-12-13,281,345!2027-02-24,341,345-->
