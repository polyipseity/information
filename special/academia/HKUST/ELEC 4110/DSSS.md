...
A {@{spread‑spectrum system}@} relies on the {@{statistical properties of its pseudorandom noise (PN) codes}@}. <!--SR:!2026-04-08,67,310!2026-04-02,61,310-->  
...
Moreover, because {@{each finger provides an independent measurement of the same bit}@}, {@{combining (e.g., maximal ratio combining or equal‑gain combining)}@} improves the {@{slope of the BER curve}@}: the {@{diversity order equals the number of fingers $L$}@}. <!--SR:!2026-04-18,76,330!2026-04-02,61,310!2026-04-02,61,310!2026-04-18,76,330-->
