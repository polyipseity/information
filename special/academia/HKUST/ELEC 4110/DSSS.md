...
The {@{_correlation_ function}@} quantifies {@{how similar two sequences are as one is shifted relative to the other}@}: {@{$$R_{xy}(\tau)=\sum_n x[n]\,y^*[n-\tau]$$}@} When {@{the two sequences are identical}@}, this reduces to the {@{_auto‑correlation_ of a single sequence $c[n]$}@}: {@{$$R_{cc}(\tau)=\sum_n c[n]\,c^*[n-\tau].$$}@} <!--SR:!2027-01-16,285,330!2027-01-17,285,330!fsrs,2029-05-09T00:00:00.000Z,940,939.7520123,1,2,9,0,0,2026-10-12T00:00:00.000Z!2027-01-26,293,330!2027-04-11,347,350!2027-01-10,280,330-->
