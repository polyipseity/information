...
- bandwidth
  ...
  - bandwidth / in practice ::@:: In practice, if a _baseband_ signal is band-limited to $B$&nbsp;Hz, then sampling at any rate greater than $2B$ samples per second guarantees perfect reconstruction (Nyquist–Shannon).
- Fourier transform
