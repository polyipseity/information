...
- [transfer function](../../../../general/transfer%20function.md) ::@:: It of a system, sub-system, or component is a mathematical function that models the system's output for each possible input. It is widely used in electronic engineering tools like circuit simulators and control systems. <!--SR:!fsrs,2028-08-09T00:00:00.000Z,773,772.6769129,1,2,8,0,0,2026-06-28T00:00:00.000Z!fsrs,2028-08-27T00:00:00.000Z,787,786.69562815,1,2,8,0,0,2026-07-02T00:00:00.000Z-->
  - transfer function / continuous-time LTI systems ::@:: For [continuous-time](../../../../general/continuous-time.md#continuous%20time) input signal $x(t)$ and output $y(t)$, dividing the Laplace transform of the output, $Y(s)={\mathcal {L} }\left\{y(t)\right\}$, by the Laplace transform of the input, $X(s)={\mathcal {L} }\left\{x(t)\right\}$, yields the system's transfer function $H(s)$: $$H(s)={\frac {Y(s)}{X(s)} }={\frac { {\mathcal {L} }\left\{y(t)\right\} }{ {\mathcal {L} }\left\{x(t)\right\} } }$$ which can be rearranged as: $$Y(s)=H(s)\;X(s)\,.$$ <!--SR:!2026-07-10,153,427!2026-07-02,146,427-->
...
- [decibel watt](../../../../general/decibel%20watt.md) (dBW) ::@:: It is a unit for the measurement of the strength of a signal expressed in decibels relative to one watt. It is used because of its capability to express both very large and very small values of power in a short range of number. <!--SR:!2026-07-10,153,427!2026-07-07,150,427-->
  - decibel watt / examples ::@:: 1 milliwatt = −30 dBW, 1 watt = 0 dBW, 10 watts = 10 dBW, 100 watts = 20 dBW, and 1,000,000 W = 60 dBW <!--SR:!2026-07-02,146,427!fsrs,2028-08-09T00:00:00.000Z,773,772.6769129,1,2,8,0,0,2026-06-28T00:00:00.000Z-->
...
- check
  ...
  - report
    - missing marks (+5) ::@:: The TA missed adding 5 marks. <!--SR:!2026-07-10,153,427!2026-07-02,146,427-->
