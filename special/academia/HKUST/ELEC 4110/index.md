...
- [signal-to-noise ratio](../../../../general/signal-to-noise%20ratio.md) \(SNR, S/N\) ::@:: It is a measure used in science and engineering that compares the level of a desired signal to the level of background noise. SNR is defined as the ratio of signal power to noise power, often expressed in decibels. <!--SR:!2026-02-06,85,369!2026-02-16,93,369-->
  ...
  - signal-to-noise ratio / quantization ::@:: Under common assumptions—input is a sinusoid, noise uniformly distributed over $[-\Delta/2,\;\Delta/2]$—the SNR improves roughly $6.02\,\text{dB}$ per added bit: $$\text{SNR}_{\text{dB} } \approx 6.02\,n + C$$ where $n$ is bits per sample and $C$ depends on the signal shape \(for sine wave, $C = 20 \log_{10}\left(\sqrt{3 / 2}\right) \approx 1.761$\). <p> This rule of thumb guides how many bits are needed for a target audio or communication quality. Note real signals like speech have different dynamic ranges, so the actual SNR may deviate from this simple estimate. <!--SR:!2026-01-09,61,349!2026-06-23,185,349-->
...
- bandwidth
  ...
  - bandwidth / in practice ::@:: In practice, if a _baseband_ signal is band-limited to $B$&nbsp;Hz, then sampling at any rate greater than $2B$ samples per second guarantees perfect reconstruction (Nyquist–Shannon). <!--SR:!2025-12-26,5,388!2025-12-26,5,388-->
- Fourier transform
...
- status: online
- [matched filter](../../../../general/matched%20filter.md) ::@:: The output of the __matched filter__ is given by correlating a known delayed signal, or _template_, with an unknown signal to detect the presence of the template in the unknown signal. This is equivalent to convolving the unknown signal with a conjugated time-reversed version of the template. <!--SR:!2026-01-03,25,402!2026-01-03,25,402-->
  - matched filter / optimality ::@:: The matched filter is the optimal linear filter for maximizing the signal-to-noise ratio \(SNR\) in the presence of additive stochastic noise. <!--SR:!2026-01-05,27,402!2026-01-05,27,402-->
- ELEC 4110
  - ELEC 4110 / [binary modulation](binary%20modulation.md)
...
- [decibel watt](../../../../general/decibel%20watt.md) (dBW) ::@:: It is a unit for the measurement of the strength of a signal expressed in decibels relative to one watt. It is used because of its capability to express both very large and very small values of power in a short range of number. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
  - decibel watt / examples ::@:: 1 milliwatt = −30 dBW, 1 watt = 0 dBW, 10 watts = 10 dBW, 100 watts = 20 dBW, and 1,000,000 W = 60 dBW <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
  - decibel watt / formulas ::@:: $${\text{Power in dBW} }=10\log _{10}{\frac {\text{Power} }{1\mathrm {W} } }$$ and also $${\text{Power in W} }=10^{\frac {\text{Power in dBW} }{10} }$$ Compare dBW to [dBm](../../../../general/dBm.md), which is referenced to one milliwatt \(0.001 W\). <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
- [dBm](../../../../general/dBm.md) ::@:: It is a unit of power level expressed using a logarithmic decibel (dB) scale respective to one milliwatt (mW). It is commonly used by radio, microwave and fiber-optical communication technicians & engineers to measure the power of system transmissions on a log scale, which can express both very large and very small values in a short form. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
  - dBm / vs. dBW ::@:: dBW is a similar unit measured relative to one watt (1000 mW) rather than a milliwatt. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
  - dBm / formulas ::@:: To express an arbitrary power _P_ in mW as _x_ in dBm, the following expression may be used: $${\begin{aligned}x&=10\log _{10}{\frac {P}{1~{\text{mW} } } }\end{aligned} }$$ Conversely, to express an arbitrary power level _x_ in dBm, as _P_ in mW: $${\begin{aligned}P&=1~{\text{mW} }\cdot 10^{ {x}/{10} }\end{aligned} }$$ <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
...
- [error correction code](../../../../general/error%20correction%20code.md) (ECC) ::@:: It is a technique used for controlling errors in data transmission over unreliable or noisy communication channels. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
  - error correction code / names ::@:: channel coding, error correction code (ECC), forward error correction (FEC) <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
- [path loss](../../../../general/path%20loss.md) ::@:: It is the reduction in power density (attenuation) of an electromagnetic wave as it propagates through space. <!--SR:!2025-12-25,4,367!2025-12-26,5,387-->
  - path loss / loss exponent ::@:: In the study of wireless communications, path loss can be represented by the path loss exponent, whose value is normally in the range of 2 to 4 (where 2 is for propagation in free space, 4 is for relatively lossy environments and for the case of full specular reflection from the earth surface—the so-called flat earth model). In some environments, such as buildings, stadiums and other indoor environments, the path loss exponent can reach values in the range of 4 to 6. On the other hand, a tunnel may act as a waveguide, resulting in a path loss exponent less than 2. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
    - path loss / loss exponent / formula ::@:: Path loss is usually expressed in [dB](../../../../general/decibel.md). In its simplest form, the path loss can be calculated using the formula $$L=10n\log _{10}(d)+C$$ where $L$ is the path loss in decibels, $n$ is the path loss exponent, $d$ is the distance between the transmitter and the receiver, usually measured in meters, and $C$ is a constant which accounts for system losses. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
  - path loss / radio engineer formula ::@:: Radio and antenna engineers use the following simplified formula \(derived from the [Friis Transmission Formula](../../../../general/Friis%20transmission%20equation.md)\) for the signal path loss between the feed points of two [isotropic](../../../../general/isotropic.md) antennas in free space: Path loss in [dB](../../../../general/decibel.md): $$L=20\log _{10}\left({\frac {4\pi d}{\lambda } }\right)$$ where $L$ is the path loss in decibels, $\lambda$ is the wavelength and $d$ is the transmitter-receiver distance in the same units as the wavelength. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
- ELEC 4110
  - ELEC 4110 / [multipath propagation](multipath%20propagation.md)
...
- report
  - Fourier transform (-5) ::@:: Did not apply the table correctly when finding the FT of $e^{\lvert t \rvert} \cos(2t)$. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
  - M-QAM / details (-3) ::@:: Probably missing some details, one of them being not labeling the constellation diagram using Gray code. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
  - M-QAM / coverage (-2) ::@:: The last subquestion is about finding coverage, which was unexpected given the syllabus, but still managed to guess 3 marks. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
- check
  - datetime
  ...
  - report
    - missing marks (+5) ::@:: The TA missed adding 5 marks. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
    - binary modulation / matched filter (+5) ::@:: The correct matched filter is $s_1^*(T - t) - s_2^*(T - t)$, which is what I wrote, and the lecture slides simplify it to $s_1(T - t) - s_2(T - t)$ because the signals are real. The TA was not familiar enough so thought the conjugated version is incorrect. <!--SR:!2025-12-26,5,387!2025-12-25,4,367-->
...
- ELEC 4110
  - ELEC 4110 / final examination
    - ELEC 4110 / final examination / question type ::@:: - _Multiple‑choice & True/False_: Broad coverage of many chapters. <br/> - _Long questions_: Standard assignment‑style problems. Scenario‑based analyses (e.g., link budget, extending coverage, required diversity order). Each long question may have multiple parts. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
    - ELEC 4110 / final examination / resources provided ::@:: Q-function table. Fourier transform table. Key formulas (except union bound) supplied in the paper. A4 double-sided handwritten cheatsheet allowed. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
    - ELEC 4110 / final examination / timing & difficulty ::@:: - Sufficient time to finish all questions; no time‑pressure issues. <br/> - Balanced difficulty: not too easy (avoids uniformly high scores), not too hard (avoids many zeros). <br/> - Scoring is relative ("scaling") – grades reflect true knowledge gaps, not careless errors. <!--SR:!2025-12-26,5,387!2025-12-26,5,387-->
    - ELEC 4110 / final examination / expectations & support ::@:: Students encouraged to use remaining weeks to address gaps highlighted by midterm distribution. TA/Instructor available for clarification; schedule via email first. <!--SR:!2025-12-25,4,367!2025-12-26,5,387-->
