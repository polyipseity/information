...
- [sample mean](../../../../general/sample%20mean%20and%20covariance.md)
  - sample mean / equation ::@:: Given _N_ samples of a random variable _X_, its _sample mean_ is: $$\overline X = \frac 1 N \sum_{k = 1}^N X_k \,.$$ <!--SR:!2028-02-01,674,421!2026-04-05,128,401-->
...
- stochastic process
  ...
  - stochastic process / autocorrelation ::@:: Its autocorrelation is $$R_X(t_1,t_2)=\mathbb{E}\{X(t_1)X^*(t_2)\} \,.$$  Some definitions conjugate the first variable instead. (annotation: __this course__: Conjugate the second variable.) <!--SR:!2028-01-25,667,421!2026-03-30,123,401-->
