...
- upper multiple Riemann sum for partition $Z_N=(Q_\ell)$ ::@:: The upper sum is $S_+(Z_N,f)=\sum_{\ell=1}^N \operatorname{Vol}(Q_\ell)\sup_{z\in Q_\ell}f(z)$. <!--SR:!fsrs,2027-05-07T00:00:00.000Z,300,300.01984473,1,2,7,0,0,2026-07-11T00:00:00.000Z!2026-07-15,65,310-->
...
- region for $P[X^2\le Y]$ ::@:: If $(X,Y)$ has joint density on $[0,1]^2$, then the event $\{X^2\le Y\}$ corresponds to the region $A=\{(x,y):0\le x\le1,\ x^2\le y\le1\}$. <!--SR:!fsrs,2027-04-26T00:00:00.000Z,291,291.42724554,1,2,7,0,0,2026-07-09T00:00:00.000Z!2026-07-15,65,310-->
...
- sweep interpretation for variable-bound regions ::@:: A variable-bound integral computes one slice of the region at a time and then sweeps those slice-contributions across the outer variable; probabilistically, this is the standard way to turn a curved event region into a formula. <!--SR:!fsrs,2027-04-26T00:00:00.000Z,291,291.42724554,1,2,7,0,0,2026-07-09T00:00:00.000Z!2026-07-15,65,310-->
