...
- sigma-algebra generated by $X$ / definition ::@:: For a real random variable $X$, the sigma-algebra generated by $X$ is $\sigma(X)=\{X^{-1}(B):B\in\mathcal B(\mathbb R)\}$. <!--SR:!fsrs,2026-07-11T00:00:00.000Z,8,8.2956,1,2,1,0,0,2026-07-03T00:00:00.000Z!fsrs,2026-07-11T00:00:00.000Z,8,8.2956,1,2,1,0,0,2026-07-03T00:00:00.000Z-->
...
- law of a random variable / definition as pushforward measure ::@:: If $X\colon(\Omega,\mathcal{F},P)\to(S,\mathcal{S})$ is measurable, its law is the probability measure $P_X$ on $(S,\mathcal{S})$ defined by $P_X[B]=P[X^{-1}(B)]$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-20,66,323!2026-07-16,62,323-->
...
- non-injective transformation idea ::@:: When the transformation $g$ is not one-to-one, the density of $Y=g(X)$ is obtained by summing the contributions from all preimage branches that yield the same value of $y$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-15,61,323!2026-07-29,73,323-->
