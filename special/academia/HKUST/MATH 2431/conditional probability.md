...
- Bayes' theorem / why the denominator equals total evidence probability ::@:: In Bayes' theorem, the denominator $\sum_j P[B_j]P[A\mid B_j]$ is exactly $P[A]$ from the law of total probability, so it normalizes the reweighted hypotheses into genuine posterior probabilities. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-08-06,64,310!fsrs,2027-05-16T00:00:00.000Z,304,304.30256839,1,2,7,0,0,2026-07-16T00:00:00.000Z-->
