...
- conditional probability / overview ::@:: Conditional probability $P[A\mid B]$ reweights probabilities when we know $B$ has occurred, keeping the same sample space $\Omega$ and $\sigma$-algebra $\mathcal{F}$ and only changing the measure to $P[\cdot\mid B]$; it leads to the multiplication rule, the law of total probability, and Bayes' theorem. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!fsrs,2027-04-24T00:00:00.000Z,287,287.11697064,1,2,7,0,0,2026-07-11T00:00:00.000Z!2026-07-13,58,310-->
...
- why the conditioning event must satisfy $P[B]>0$ ::@:: In the elementary definition $P[A\mid B]=P[A\cap B]/P[B]$, the denominator must be positive; conditioning on a zero-probability event is not handled by this ratio formula. <!--SR:!fsrs,2027-04-24T00:00:00.000Z,287,287.11697064,1,2,7,0,0,2026-07-11T00:00:00.000Z!fsrs,2027-04-13T00:00:00.000Z,278,278.46760619,1,2,7,0,0,2026-07-09T00:00:00.000Z-->
- conditional probability / mutually exclusive events ::@:: If $A \cap B = \emptyset$ and $P[B] > 0$, then $P[A\mid B] = 0$; once we know $B$ occurs, $A$ is impossible. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-18,62,310!fsrs,2027-04-28T00:00:00.000Z,291,291.42724554,1,2,7,0,0,2026-07-11T00:00:00.000Z-->
