...
- fundamental theorem of calculus / why differentiability of $g$ alone is not enough ::@:: A differentiable function can have a derivative that is not Riemann-integrable, for example because the derivative is unbounded or too badly behaved; so FTC II in the Riemann setting needs the extra hypothesis that $g'$ itself is Riemann-integrable. <!--SR:!fsrs,2027-04-21T00:00:00.000Z,287,287.11697064,1,2,7,0,0,2026-07-08T00:00:00.000Z!2026-07-10,63,310-->
...
- shrinking interval integral $\int_a^{a+\delta} f(x)\,dx$ ::@:: If $f\colon\mathbb{R}\to[0,\infty)$ is piecewise continuous and improperly Riemann-integrable, then $\lim_{\delta\downarrow0}\int_a^{a+\delta} f(x)\,dx=0$ for every $a\in\mathbb{R}$. <!--SR:!2026-07-17,67,310!2026-07-10,60,310-->
- proof when $f$ is continuous at $a$ / estimate ::@:: If $|f(x)-f(a)|<1$ near $a$, then $0\le\int_a^{a+\delta} f(x)\,dx\le\int_a^{a+\delta}|f(a)|\,dx+\int_a^{a+\delta}|f(x)-f(a)|\,dx<(|f(a)|+1)\delta$, so the integral tends to $0$ as $\delta\downarrow0$. <!--SR:!2026-07-16,66,310!2026-07-10,63,310-->
