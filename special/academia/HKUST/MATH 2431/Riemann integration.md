...
- linear subspace property of $R([a,b])$ ::@:: If $f,g\in R([a,b])$ and $\alpha,\beta\in\mathbb{R}$, then $\alpha f+\beta g\in R([a,b])$; in particular, $R([a,b])$ is a linear subspace of $B([a,b])$. <!--SR:!fsrs,2027-04-13T00:00:00.000Z,283,282.79716409,1,2,7,0,0,2026-07-04T00:00:00.000Z!2026-07-15,65,310-->
...
- quotient counterexample with $f(x)\equiv1$ and $g(x)=x$ for $x\neq0$, $g(0)=1$ ::@:: Both $f$ and $g$ are Riemann-integrable and $g$ never vanishes, but $f/g$ equals $1/x$ for $x\neq0$ and is unbounded near $0$, so it is not Riemann-integrable on $[-1,1]$. Thus Riemann-integrable functions are not closed under arbitrary division. <!--SR:!2026-07-15,65,310!fsrs,2027-04-05T00:00:00.000Z,274,274.1280869,1,2,7,0,0,2026-07-05T00:00:00.000Z-->
