...
- shrinking interval integral $\int_a^{a+\delta} f(x)\,dx$ ::@:: If $f\colon\mathbb{R}\to[0,\infty)$ is piecewise continuous and improperly Riemann-integrable, then $\lim_{\delta\downarrow0}\int_a^{a+\delta} f(x)\,dx=0$ for every $a\in\mathbb{R}$. <!--SR:!2026-07-17,67,310!fsrs,2027-05-07T00:00:00.000Z,300,300.01984473,1,2,7,0,0,2026-07-11T00:00:00.000Z-->
