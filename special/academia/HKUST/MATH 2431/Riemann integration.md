...
- closure of $R([a,b])$ under $|f|$ and $fg$ ::@:: If $f,g\in R([a,b])$, then $|f|$ and $fg$ are also Riemann-integrable. <!--SR:!fsrs,2027-05-09T00:00:00.000Z,304,304.30256839,1,2,7,0,0,2026-07-09T00:00:00.000Z!2026-07-14,64,310-->
...
- why integrability still gives point probability $0$ ::@:: Even if a density blows up near a point, integrability forces the probability of a shrinking interval around that point to go to $0$, so a single point cannot carry positive mass in a continuous density model. <!--SR:!2026-07-14,64,310!2026-07-15,65,310-->
