...
- Riemann integration / overview ::@:: In this course, Riemann integration is the one-dimensional integration framework used to justify probability densities, interval probabilities, and improper integrals over tails or near singular endpoints. <!--SR:!2026-04-12,4,270!2026-04-12,4,270-->
...
- proof when $f$ is not continuous at $a$ / squeezing step ::@:: After fixing $0<\delta<1/N$ and choosing $n$ with $1/n<\delta$, nonnegativity gives $0\le\int_{a+1/n}^{a+\delta} f(x)\,dx\le\int_{a+1/n}^{a+1/N} f(x)\,dx<\eta$; letting $n\to\infty$ yields $0\le\int_a^{a+\delta} f(x)\,dx\le\eta$, so the limit is $0$. <!--SR:!2026-04-12,4,270!2026-04-12,4,270-->
