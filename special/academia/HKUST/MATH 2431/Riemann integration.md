...
- proof when $f$ is not continuous at $a$ / Cauchy step ::@:: If the improper integral $\int_a^b f(x)\,dx$ exists, then the truncated integrals $\int_{a+1/n}^b f(x)\,dx$ form a Cauchy sequence, so for every $\eta>0$ there is $N$ with $\int_{a+1/n}^{a+1/N} f(x)\,dx<\eta$ for all $n\ge N$. <!--SR:!2026-07-11,64,310!2026-07-05,55,310-->
