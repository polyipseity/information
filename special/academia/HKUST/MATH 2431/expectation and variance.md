...
- Cantelli derivation: Derive $P(X-E[X]\ge a)\le\operatorname{Var}(X)/(\operatorname{Var}(X)+a^2)$. ::@:: Let $Y=X-E[X]$. For $t\ge0$, apply Markov to $(Y+t)^2$: $P(Y\ge a)\le\frac{\operatorname{Var}+t^2}{(a+t)^2}$. Minimise over $t\ge0$ to get $t=\operatorname{Var}/a$; substitute back.
