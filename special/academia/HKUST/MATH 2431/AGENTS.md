...
- When defining $X_n=\alpha X_{n-1}+\sigma Z_n$, give $X_0$<!-- markdown separator -->'s full distribution (e.g. $X_0\sim N(0,\sigma^2/(1-\alpha^2))$ independent of $\{Z_n\}$) — not just "$X_0$ independent of $\{Z_n\}$."
