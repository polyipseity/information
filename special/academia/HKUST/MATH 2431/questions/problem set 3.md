...
> - (c) Now the host opens {@{one of the two unchosen doors uniformly at random}@}, and it {@{happens to reveal a goat}@}. Condition {@{on this event}@}. If the car is {@{behind your original door, the event occurs with probability $1$}@}; if the car is {@{behind either other door}@}, the event occurs with {@{probability $1/2$ because the host might reveal the car instead}@}. Hence {@{posterior weights are proportional to $1/3,1/6,1/6$}@}, so after {@{normalization, staying has probability $1/2$ and switching has probability $1/2$}@}. Therefore {@{switching and staying are equally good in the random-host variant}@}. <!--SR:!2026-05-17,16,290!2026-07-16,61,310!2026-07-13,58,310!2026-07-12,57,310!2026-05-17,16,290!2026-07-14,59,310!2026-05-17,16,290!2026-05-17,16,290!2026-07-10,55,310!2026-05-17,16,290!2026-07-17,62,310!2026-05-17,16,290!2026-07-14,59,310!2026-07-09,54,310!2026-07-11,56,310!2026-07-11,56,310!2026-07-15,60,310!2026-05-17,16,290!2026-07-09,54,310!2026-05-17,16,290!2026-05-17,16,290!2026-07-12,57,310!2026-05-17,16,290!2026-07-12,57,310!2026-05-17,16,290-->
...
> - (d) Condition on {@{the total kicks}@}. Given {@{$N=n$, goals follow a binomial law}@}, so {@{$P(G=k\mid N=n)=\binom{n}{k}p^k(1-p)^{n-k}$}@} and therefore {@{$P(G=k)=\sum_{n=k}^{\infty}\binom{n}{k}p^k(1-p)^{n-k}\dfrac{\lambda^n e^{-\lambda}}{n!}$}@}. Pull out {@{factors independent of $n-k$ and reindex by $m=n-k$}@} to get {@{$P(G=k)=e^{-\lambda}\dfrac{(\lambda p)^k}{k!}\sum_{m=0}^{\infty}\dfrac{(\lambda(1-p))^m}{m!}=e^{-\lambda p}\dfrac{(\lambda p)^k}{k!}$}@}. So {@{Poisson thinning}@} keeps {@{a Poisson distribution and scales the mean from $\lambda$ to $\lambda p$}@}. <!--SR:!2026-07-11,56,310!2026-07-14,59,310!2026-07-18,63,310!2026-07-09,54,310!2026-07-11,56,310!2026-05-17,16,290!2026-07-13,58,310!2026-07-11,56,310!2026-07-16,61,310!2026-07-10,55,310!2026-07-10,55,310!2026-07-13,58,310!2026-07-13,58,310!2026-05-17,16,290!2026-05-17,16,290!2026-07-13,58,310!2026-07-10,55,310!2026-07-18,63,310!2026-07-15,60,310!2026-07-13,58,310!2026-05-17,16,290!2026-07-17,62,310!2026-07-15,60,310-->
