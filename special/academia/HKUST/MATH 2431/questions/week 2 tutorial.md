...
>
> Solution: Although {@{complements are closed}@} (finite $\leftrightarrow$ cofinite), a sigma-algebra also requires {@{countable-union closure}@}: each singleton {@{$\{n\}$}@} is in $\mathcal{F}$, but their union {@{$\bigcup_{n\ge1}\{n\}=\mathbb{N}$}@} is {@{neither finite nor cofinite in $\mathbb{Z}$}@}, so {@{$\mathcal{F}$ is not a sigma-algebra}@}. <!--SR:!2026-08-08,67,310!2026-08-04,63,310!2026-08-06,65,310!2026-08-02,61,310!2026-08-06,65,310!2026-08-06,65,310-->
