...
>
> Solution: Although {@{complements are closed}@} (finite $\leftrightarrow$ cofinite), a sigma-algebra also requires {@{countable-union closure}@}: each singleton {@{$\{n\}$}@} is in $\mathcal{F}$, but their union {@{$\bigcup_{n\ge1}\{n\}=\mathbb{N}$}@} is {@{neither finite nor cofinite in $\mathbb{Z}$}@}, so {@{$\mathcal{F}$ is not a sigma-algebra}@}. <!--SR:!2026-08-08,67,310!2026-08-04,63,310!2026-08-06,65,310!fsrs,2027-06-03T00:00:00.000Z,304,304.30256839,1,2,7,0,0,2026-08-03T00:00:00.000Z!2026-08-06,65,310!2026-08-06,65,310-->
