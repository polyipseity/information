...
>
> Solution: For a line use {@{all permutations of 5 distinct people}@} giving {@{$5!=120$}@}; for a circle identify rotations as equivalent, {@{fix one anchor person}@} to quotient rotations, and count remaining arrangements as {@{$(5-1)!=4!=24$}@}. <!--SR:!2026-05-19,16,290!2026-05-18,15,290!2026-05-19,16,290!2026-05-18,15,290-->
...
>
> Solution: Although {@{complements are closed}@} (finite $\leftrightarrow$ cofinite), a sigma-algebra also requires {@{countable-union closure}@}: each singleton {@{$\{n\}$}@} is in $\mathcal{F}$, but their union {@{$\bigcup_{n\ge1}\{n\}=\mathbb{N}$}@} is {@{neither finite nor cofinite in $\mathbb{Z}$}@}, so {@{$\mathcal{F}$ is not a sigma-algebra}@}. <!--SR:!2026-05-19,16,290!2026-05-19,16,290!2026-05-19,16,290!2026-05-19,16,290!2026-05-19,16,290!2026-05-19,16,290-->
