...
> - (b) It is {@{sometimes still possible when $\lambda<0$}@}. Take {@{$\Omega=\{0,1\}$, $\mathcal{F}=\mathcal{P}(\Omega)$, $P_2(\{0\})=P_2(\{1\})=1/2$}@}, and choose any {@{$\varepsilon\in(0,1/(2|\lambda|)]$}@}. Define {@{$P_1(\{0\})=1/2+\varepsilon$ and $P_1(\{1\})=1/2-\varepsilon$}@}. Then {@{$Q_\lambda(\{0\})=1/2+\lambda\varepsilon$ and $Q_\lambda(\{1\})=1/2-\lambda\varepsilon$}@}, and since {@{$|\lambda|\varepsilon\le1/2$}@}, both numbers lie in {@{$[0,1]$}@}. Thus {@{$Q_\lambda$ is again a probability measure even though $\lambda<0$ and $P_1\neq P_2$}@}.
> - (c) Both are {@{always cumulative distribution functions}@}. For {@{$G_1=\tfrac12(F_1+F_2)$}@}, all CDF axioms are preserved by {@{taking an average of two nondecreasing right-continuous functions with limits $0$ and $1$ at $\pm\infty$}@}. For {@{$G_2=\sqrt{F_1F_2}$}@}, note that {@{$F_1F_2$ is nondecreasing because both factors take values in $[0,1]$ and are nondecreasing}@}; then {@{right continuity and the limits at $\pm\infty$ are preserved by multiplication and by the continuous map $x\mapsto\sqrt{x}$ on $[0,1]$}@}. Hence {@{$G_1$ and $G_2$ are CDFs}@}.
> - (d) The correct choice is {@{sometimes but not always}@}. For a positive example, let {@{$F_1=\Phi$ be the standard normal CDF and set $F_2=\Phi^2$}@}; since {@{the map $u\mapsto u^2$ is increasing on $[0,1]$}@}, {@{$F_2$ is a CDF}@}, and then {@{$G_3=F_2/F_1=\Phi$}@}, which is a CDF. For a negative example, take {@{$F_2=F_1$}@}; then {@{$G_3\equiv1$}@}, which is {@{not a CDF because its limit at $-\infty$ is $1$ instead of $0$}@}. So {@{$F_2/F_1$ can be a CDF in some cases, but it need not be one}@}. <!--SR:!2026-05-15,17,302!2026-05-19,17,302!2026-05-15,17,302!2026-05-19,17,302!2026-05-16,14,290!2026-05-16,14,290!2026-05-19,17,302!2026-05-15,17,302!2026-05-19,17,302!2026-05-17,15,290!2026-05-19,17,302!2026-05-14,16,290!2026-05-15,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-17,15,290!2026-05-15,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-16,14,290!2026-05-19,17,302!2026-05-15,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-15,17,302!2026-05-19,17,302-->
...
> Solution:
>
> - (a) No. If {@{$g(Y)$ were discrete}@}, there would exist some {@{$k\in\mathbb{R}$ with $P(g(Y)=k)>0$}@}. But since {@{$g$ is bijective, the event $\{g(Y)=k\}$ is exactly $\{Y=g^{-1}(k)\}$}@}, and {@{a continuously distributed random variable assigns probability $0$ to every singleton}@}. Hence {@{$P(g(Y)=k)=P(Y=g^{-1}(k))=0$}@}, a contradiction. So {@{$g(Y)$ cannot be discrete}@}.
> - (b) First integrate the density of $Y$: {@{$F_Y(y)=0$ for $y\le0$, while for $y>0$ one has $F_Y(y)=\int_0^y\frac{3}{(1+t)^4}\,dt=1-\frac{1}{(1+y)^3}$}@}. Since {@{$Z=(1+Y)^{-1}$ and $Y>0$ imply $0<Z\le1$}@}, the CDF of $Z$ is {@{$F_Z(z)=0$ for $z\le0$ and $F_Z(z)=1$ for $z\ge1$}@}. For {@{$0<z<1$}@}, {@{the monotone transformation $Z\le z\iff Y\ge z^{-1}-1$ gives $F_Z(z)=P(Y\ge z^{-1}-1)=1-F_Y(z^{-1}-1)=z^3$}@}. Therefore {@{$F_Z(z)=z^3$ on $(0,1)$}@}, and differentiating yields {@{the density $f_Z(z)=3z^2\mathbf{1}_{(0,1)}(z)$}@}.
> - (c) The event {@{$\{U\ge1\}$ splits according to the two branches of the definition of $U$}@}. On the branch {@{$Y\le1$}@}, the inequality {@{$3Y\ge1$ is equivalent to $Y\ge1/3$}@}; on the branch {@{$Y>1$}@}, the inequality {@{$Y/3\ge1$ is equivalent to $Y\ge3$}@}. So {@{$\{U\ge1\}=\{1/3\le Y\le1\}\cup\{Y\ge3\}$}@}. Using {@{$F_Y(y)=1-(1+y)^{-3}$}@}, we get {@{$P(1/3\le Y\le1)=F_Y(1)-F_Y(1/3)=\frac78-\frac{37}{64}=\frac{19}{64}$}@} and {@{$P(Y\ge3)=1-F_Y(3)=\frac{1}{64}$}@}. Hence {@{$P(U\ge1)=\frac{19}{64}+\frac{1}{64}=\frac{5}{16}$}@}. <!--SR:!2026-05-18,16,290!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-18,16,290!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-19,17,302!2026-05-15,17,302!2026-05-19,17,302!2026-05-17,15,290!2026-05-19,17,302!2026-05-17,15,290!2026-05-15,17,302!2026-05-15,17,302!2026-05-18,16,290!2026-05-19,17,302-->
