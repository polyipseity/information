...
> - (c) Here {@{the unscaled density already integrates to $1$ on $(0,\infty)$ because $\int_0^\infty e^{-x}dx=1$, so the correct normalizing constant is $c=1$}@}. <!--SR:!2026-05-18,17,307!2026-07-10,56,310!2026-07-25,69,321!2026-05-18,17,307!2026-07-25,69,321-->
