...
>
> Solution: {@{True}@}. This is {@{the triangle inequality for the $L^2$ norm}@}, which follows from {@{Cauchy-Schwarz: $$\|X+Y\|^2=\mathbb E[(X+Y)^2]=\mathbb E[X^2]+2\mathbb E[XY]+\mathbb E[Y^2]\le\|X\|^2+2\|X\|\|Y\|+\|Y\|^2=(\|X\|+\|Y\|)^2,$$}@} and taking {@{square roots yields $\|X+Y\|\le\|X\|+\|Y\|$}@}.
