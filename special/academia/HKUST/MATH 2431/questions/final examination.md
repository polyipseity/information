...
> (a) Let $X,Y\overset{\text{i.i.d.}}{\sim}\mathcal E(\lambda)$ (exponential with rate $\lambda>0$). Define $U=\frac{X}{X+Y}$ and $V=X+Y$.
>
> - Find $f_U$, $f_V$, $F_V$, and the joint density $f_{U,V}$.
