...
> - (b) Let {@{$C_N=\bigcap_{i=1}^N A_i$}@}. Then {@{the decreasing-limit relation $C_N\downarrow\bigcap_{i=1}^{\infty}A_i$ lets continuity from above give $P(\bigcap_{i=1}^{\infty}A_i)=1$}@}. Equivalently, one can use {@{de Morgan on complements}@}: since {@{$P(A_i^c)=0$}@}, countable subadditivity {@{yields $P((\bigcap_i A_i)^c)=P(\bigcup_i A_i^c)\le\sum_iP(A_i^c)=0$}@}. <!--SR:!2026-05-15,16,300!2026-05-13,14,290!2026-05-14,15,300!2026-05-16,17,300!2026-05-13,14,290!2026-05-16,17,300-->
...
>
> Solution: Let $U$ be the {@{number of new balls used in the first sample of size 3}@} so that $P(U=u)=\dfrac{\binom{9}{u}\binom{6}{3-u}}{\binom{15}{3}}$ for $u=0,1,2,3$. Conditional on $U=u$, the second sample is all new with probability {@{$\dfrac{\binom{9-u}{3}}{\binom{15}{3}}$}@} because {@{only $9-u$ unused new balls remain available}@}. Therefore, by {@{conditioning and total probability}@}, {@{$P(\text{second sample all new})=\sum_{u=0}^3\frac{\binom{9}{u}\binom{6}{3-u}}{\binom{15}{3}}\cdot\frac{\binom{9-u}{3}}{\binom{15}{3}}\approx0.0893$}@}. <!--SR:!2026-05-15,16,300!2026-05-16,17,300!2026-05-15,16,300!2026-05-15,16,300!2026-05-14,15,300-->
