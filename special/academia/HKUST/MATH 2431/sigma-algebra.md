...
- die events A even B prime ::@:: For $\Omega = \{1,\ldots,6\}$ and $\mathcal{F} = \mathcal{P}(\Omega)$, let $A = \{2,4,6\}$ (even) and $B = \{2,3,5\}$ (prime); then $A \cap B = \{2\}$, $A \cup B = \{2,3,4,5,6\}$, illustrating that "A or B" is non-exclusive while still an event. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-18,65,310!2026-07-05,55,310-->
