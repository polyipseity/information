...
- proof via compatibility classes / conclusion ::@:: Since $H\in\delta(\mathcal{E})$ was arbitrary, any two elements of $\delta(\mathcal{E})$ have their intersection in $\delta(\mathcal{E})$. So $\delta(\mathcal{E})$ is both a Dynkin system and a pi-system, hence a sigma-algebra; together with $\delta(\mathcal{E})\subseteq\sigma(\mathcal{E})$, this gives $\delta(\mathcal{E})=\sigma(\mathcal{E})$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-06,56,310!2026-06-16,39,290-->
...
- two-pi-system extension / proof pattern ::@:: The proof is symmetric: first fix a generator from the second family and upgrade the first variable from $\mathcal{E}_1$ to $\sigma(\mathcal{E}_1)$; then fix an arbitrary set from $\sigma(\mathcal{E}_1)$ and upgrade the second variable from $\mathcal{E}_2$ to $\sigma(\mathcal{E}_2)$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-06-16,39,290!2026-07-13,62,310-->
