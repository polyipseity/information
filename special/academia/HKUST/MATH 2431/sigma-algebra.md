...
- measurable space ::@:: A measurable space is a pair $(\Omega,\mathcal{F})$ consisting of a set and a sigma-algebra on it; it is the structure on which one later defines probability measures and random variables. <!-- check: ignore-line[two_sided_calc_warning]: conceptual -->
