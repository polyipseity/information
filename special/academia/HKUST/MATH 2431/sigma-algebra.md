...
- violation S3 ::@:: $\mathcal{F}_4 = \{\emptyset, \{1\}, \{2\}, \{1,3\}, \{2,3\}, \Omega\}$ fails (S3) because $\{1\} \cup \{2\} = \{1,2\} \notin \mathcal{F}_4$; a $\sigma$-algebra must contain countable unions of its sets. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-19,66,310!2026-07-04,54,310-->
...
- special case $\delta(\varnothing)$ ::@:: If $\mathcal{E}=\varnothing$, then $\delta(\varnothing)=\{\varnothing,\Omega\}$, the smallest Dynkin system on $\Omega$. <!--SR:!2026-07-04,54,310!2026-07-19,67,310-->
- relation between $\delta(\mathcal{E})$ and $\sigma(\mathcal{E})$ ::@:: Every operation allowed in a Dynkin system is also allowed in a sigma-algebra, but not conversely, so any set obtainable from $\mathcal{E}$ by Dynkin-system operations is also obtainable by sigma-algebra operations; hence $\delta(\mathcal{E})\subseteq\sigma(\mathcal{E})$. <!--SR:!2026-07-04,54,310!2026-07-18,65,310-->
