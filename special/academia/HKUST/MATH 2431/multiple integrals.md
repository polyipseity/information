...
- calculate $\int_{[0,1]\times[2,3]\times[1,4]} \cos(x_1)x_2\exp(x_2x_3)\,d^3x$ with brief steps ::@:: (1) Integrate in $x_3$: $\cos(x_1)x_2\left[\frac1{x_2}e^{x_2x_3}\right]_{1}^{4}=\cos(x_1)(e^{4x_2}-e^{x_2})$. <br/> (2) Integrate in $x_2$: $\cos(x_1)\left[\frac14 e^{4x_2}-e^{x_2}\right]_{2}^{3}$. <br/> (3) Integrate in $x_1$: $\int_0^1\cos(x_1)\,dx_1=[\sin(x_1)]_0^1$, giving $\left(\frac14 e^8(e^4-1)-(e-1)e^2\right)\sin(1)$. <!--SR:!fsrs,2027-04-05T00:00:00.000Z,274,274.1280869,1,2,7,0,0,2026-07-05T00:00:00.000Z!2026-07-07,57,310-->
