...
- volume of $Q=\prod_{j=1}^n[a_j,b_j]$ with 1D comparison ::@:: The volume is $\operatorname{Vol}(Q)=\prod_{j=1}^n (b_j-a_j)$; it plays the role that length $b-a$ plays in one dimension, measuring how much $n$-dimensional space the rectangular region occupies. <!--SR:!2026-07-04,54,310!2026-07-16,66,310-->
- lower multiple Riemann sum for partition $Z_N=(Q_\ell)$ ::@:: The lower sum is $S_-(Z_N,f)=\sum_{\ell=1}^N \operatorname{Vol}(Q_\ell)\inf_{z\in Q_\ell}f(z)$. <!--SR:!2026-07-14,64,310!2026-07-04,54,310-->
...
- geometric meaning of $\int f(x_1,x_2)\,d^2x$ for nonnegative $f$ ::@:: The double integral over a rectangle is the volume under the surface $z=f(x_1,x_2)$ above that base rectangle. <!--SR:!2026-07-17,67,310!2026-07-04,54,310-->
...
- calculate $\int_{[0,1]\times[2,3]\times[1,4]} \cos(x_1)x_2\exp(x_2x_3)\,d^3x$ with brief steps ::@:: (1) Integrate in $x_3$: $\cos(x_1)x_2\left[\frac1{x_2}e^{x_2x_3}\right]_{1}^{4}=\cos(x_1)(e^{4x_2}-e^{x_2})$. <br/> (2) Integrate in $x_2$: $\cos(x_1)\left[\frac14 e^{4x_2}-e^{x_2}\right]_{2}^{3}$. <br/> (3) Integrate in $x_1$: $\int_0^1\cos(x_1)\,dx_1=[\sin(x_1)]_0^1$, giving $\left(\frac14 e^8(e^4-1)-(e-1)e^2\right)\sin(1)$. <!--SR:!2026-07-04,54,310!2026-07-07,57,310-->
