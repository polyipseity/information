...
- monotonicity ::@:: Every cumulative distribution function is nondecreasing: if $x \le y$, then $(-\infty,x] \subseteq (-\infty,y]$, so monotonicity of probability gives $F(x) \le F(y)$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-26,72,327!2026-08-08,85,350-->
...
- mixed distribution ::@:: A mixed distribution has both an atomic part and an absolutely continuous part, so it is neither purely discrete nor purely continuous in the density sense. <!--SR:!fsrs,2027-06-14T00:00:00.000Z,330,329.81882824,1,2,7,0,0,2026-07-19T00:00:00.000Z!2026-07-26,72,327-->
