...
- core equivalence in the concrete proof ::@:: The heart of the construction is $F^{-1}(u)\le x \iff u\le F(x)$. The left side asks whether the generalized inverse sends the uniform level $u$ to a point at or before $x$, while the right side asks whether the graph of $F$ has already reached height $u$ by the time one gets to $x$. These are the same event viewed from the $x$-axis and the $u$-axis respectively. <!--SR:!2026-04-12,4,316!2026-04-12,4,316-->
