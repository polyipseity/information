...
- interval probabilities from a CDF ::@:: If $F_P(x)=P(( -\infty,x])$, then for every $a<b$ one has $P((a,b])=F_P(b)-F_P(a)$; so a CDF already determines the probabilities of the basic half-open intervals. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-08-09,86,354!fsrs,2027-08-16T00:00:00.000Z,383,382.69075203,1,2,7,0,0,2026-07-29T00:00:00.000Z-->
...
- Lebesgue-Stieltjes theorem (unified statement) ::@:: A function $F\colon\mathbb{R}\to\mathbb{R}$ is the cumulative distribution function of a unique probability measure on $(\mathbb{R},\mathcal{B}(\mathbb{R}))$ if and only if $F$ is nondecreasing, right-continuous, with $\lim_{x\to-\infty}F(x)=0$ and $\lim_{x\to\infty}F(x)=1$. In other words, these four structural properties are not merely necessary; together they completely characterize real-valued probability laws. <!--SR:!fsrs,2027-11-28T00:00:00.000Z,476,475.9271608,1,2,7,0,0,2026-08-09T00:00:00.000Z!2026-08-09,86,356-->
- why uniqueness holds via half-lines ::@:: If two probability measures have the same cumulative distribution function, then they agree on every left half-line $(-\infty,b]$ because both assign that set probability $F(b)$. Those half-lines form a pi-system generating $\mathcal{B}(\mathbb{R})$, so the pi-lambda theorem extends equality from that generator to all Borel sets. <!--SR:!2026-08-09,86,356!2026-08-09,86,356-->
...
- how jumps and flat parts are encoded by the pseudoinverse ::@:: If $F$ jumps at a point $x$, then a whole interval of uniform input levels is sent to that single point, creating an atom. If $F$ is flat on an interval, then there is no mass in the interior of that interval, so the generalized inverse sends the plateau level to the left endpoint instead of distributing mass across the interior. <!--SR:!2026-08-09,86,356!2026-08-09,86,356-->
...
- why the pushforward definition is legitimate ::@:: The map $T=F^{-1}$ is measurable because it is monotone, so every Borel target set has a measurable preimage. Preimages preserve the empty set, the whole space, and countable unions, and disjoint target sets have disjoint preimages. Therefore the assignment $A\mapsto\lambda_{(0,1)}(T^{-1}(A))$ is a bona fide probability measure. <!--SR:!fsrs,2027-11-28T00:00:00.000Z,476,475.9271608,1,2,7,0,0,2026-08-09T00:00:00.000Z!2026-08-09,86,356-->
- why the abstract proof computes only half-lines ::@:: The goal is not to evaluate $P[A]$ for every Borel set directly. Instead, one computes $P(( -\infty,x])$ on the generating family of left half-lines, because once the correct cumulative distribution function is known there, the generator argument identifies the whole measure. <!--SR:!2026-08-09,86,356!2026-08-09,86,356-->
- key identity in the pushforward proof ::@:: For each $x$, the preimage of the half-line is $T^{-1}(( -\infty,x])=\{u\in(0,1):F^{-1}(u)\le x\}$. Using the pseudoinverse equivalence $F^{-1}(u)\le x \iff u\le F(x)$, this becomes $(0,F(x)]\cap(0,1)$. So the target-space question is reduced to the simple interval of uniform input levels already reached by height $F(x)$. <!--SR:!2026-08-09,86,356!fsrs,2027-11-28T00:00:00.000Z,476,475.9271608,1,2,7,0,0,2026-08-09T00:00:00.000Z-->
- why the pushforward measure has cumulative distribution function $F$ ::@:: Applying Lebesgue measure to the previous preimage gives $P(( -\infty,x])=\lambda_{(0,1)}((0,F(x)]\cap(0,1))=F(x)$. Thus the transported measure has exactly the target cumulative distribution function. <!--SR:!2026-08-09,86,356!2026-08-09,86,356-->
