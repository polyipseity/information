...
- equality of distributions via cumulative distribution functions ::@:: For probability measures on $(\mathbb{R},\mathcal{B}(\mathbb{R}))$, one has $P=Q$ if and only if $F_P(x)=F_Q(x)$ for every $x$, because the left half-lines $(-\infty,x]$ form a generating pi-system. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-08-03,80,344!2026-08-02,79,344-->
