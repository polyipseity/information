...
- interval probabilities from a CDF ::@:: If $F_P(x)=P(( -\infty,x])$, then for every $a<b$ one has $P((a,b])=F_P(b)-F_P(a)$; so a CDF already determines the probabilities of the basic half-open intervals. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-08-09,86,354!2026-07-28,74,327-->
...
- why the Cantor distribution has no atoms ::@:: A single Cantor point corresponds to one infinite sequence of left/right choices; the probability of matching its first $n$ digits is $2^{-n}$, so the probability of the full infinite path is $0$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-28,74,327!fsrs,2027-06-14T00:00:00.000Z,330,329.81882824,1,2,7,0,0,2026-07-19T00:00:00.000Z-->
