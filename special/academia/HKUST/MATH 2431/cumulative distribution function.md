...
- limits at infinity ::@:: Every cumulative distribution function satisfies $\lim_{x\to-\infty}F(x)=0$ and $\lim_{x\to\infty}F(x)=1$, because the half-lines $(-\infty,x]$ decrease to $\varnothing$ on the left and increase to $\mathbb{R}$ on the right. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-08-07,84,350!fsrs,2027-09-15T00:00:00.000Z,410,410.22837316,1,2,7,0,0,2026-08-01T00:00:00.000Z-->
