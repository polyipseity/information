...
- centered Cauchy distribution ::@:: In the centered case $m=0$, the Cauchy density is $f(x)=\dfrac{a}{\pi(a^2+x^2)}$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-06-17,38,290!2026-07-17,65,310-->
