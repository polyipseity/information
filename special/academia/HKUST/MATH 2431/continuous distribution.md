...
- memoryless property ::@:: If $X\sim \mathrm{E}(\lambda)$ and $s,t\ge 0$, then $P[X>s+t\mid X>s]=P[X>t]$; surviving up to time $s$ does not change the distribution of the remaining waiting time. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-29,77,335!2026-07-12,62,318-->
