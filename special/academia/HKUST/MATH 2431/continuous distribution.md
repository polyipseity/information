...
- why the minibus examples motivate densities ::@:: Both minibus models follow the same two-step idea: first assign probabilities to intervals in a fine partition, then let the mesh size go to $0$. In that limit the discrete weighted sum becomes an integral $\int f(x)\,dx$, and the function $f$ records how those interval weights were distributed. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-26,74,335!fsrs,2027-05-15T00:00:00.000Z,309,309.31093549,1,2,7,0,0,2026-07-10T00:00:00.000Z-->
