...
- why a density may exceed $1$ ::@:: A density may be larger than $1$ because only its integral must equal $1$; pointwise values describe concentration, not direct probabilities. <!--SR:!2026-07-23,71,335!2026-07-19,68,318-->
...
- exponential versus geometric memorylessness ::@:: The exponential distribution is the continuous analogue of the geometric distribution because both are characterized by a memoryless property. <!--SR:!2026-07-20,68,318!2026-07-19,68,318-->
...
- normal distribution ::@:: The normal distribution $\mathrm{N}(\mu,\sigma^2)$ has density $f(x)=\dfrac{1}{\sqrt{2\pi\sigma^2}}\exp\!\left(-\dfrac{(x-\mu)^2}{2\sigma^2}\right)$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-19,68,318!fsrs,2027-05-02T00:00:00.000Z,296,295.72812302,1,2,7,0,0,2026-07-10T00:00:00.000Z-->
