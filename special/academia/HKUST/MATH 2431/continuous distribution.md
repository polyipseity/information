...
- interval endpoints do not matter ::@:: For a continuous distribution and $a < b$, one has $P[[a,b]] = P[(a,b]] = P[(a,b)] = \int_a^b f(x)\,dx$, because adding or removing finitely many endpoints changes probability by $0$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-07-30,77,335!2026-07-14,64,318-->
