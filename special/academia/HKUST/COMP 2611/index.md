...
- [method of complements](../../../../general/method%20of%20complements.md) ::@:: It is a technique to encode a symmetric range of positive and negative integers in a way that they can use the same algorithm (or mechanism) for addition throughout the whole range. <!--SR:!2027-11-14,784,440!2025-10-02,136,420-->
...
- arithmetic logic unit
  ...
  - arithmetic logic unit / functions
    ...
    - arithmetic logic unit / functions / addition ::@:: Use full-adders. Two common ways to add multiple-bit numbers are _ripple carry_ and _carry lookahead_. <!--SR:!2025-09-23,138,420!2027-11-08,778,440-->
