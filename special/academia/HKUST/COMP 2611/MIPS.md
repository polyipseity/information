...
For {@{assembly instructions that store multi-byte data}@}, it {@{uses the endianness of the underlying machine, so that you do not need to worry about endianness when defining data}@}. <!--SR:!2026-08-30,413,383!fsrs,2031-11-25T00:00:00.000Z,1923,1922.9461018,1,2,10,0,0,2026-08-20T00:00:00.000Z-->
...
- set on greater than or equal to ::@:: `sge $d, $s, $t`: `$d = $s >= $t`; implemented by `slt $at, $s, $t; xori $d, $at, 1;` <!--SR:!2026-09-03,381,381!fsrs,2031-05-25T00:00:00.000Z,1763,1762.51909974,1,2,10,0,0,2026-07-27T00:00:00.000Z-->
