...
- multiply unsigned ::@:: `multu $s, $t`: `$HI:$LO = $s * $t;`, unsigned; note the register placeholder `$d` is unused <!--SR:!2026-05-29,339,355!2026-05-21,331,355-->
  ...
  - multiply unsigned / overflow ::@:: Overflow is not possible if you consider `$HI:$LO` together. \(__this course__: No overflow occurs if every bit of `$HI` is 0.\) <!--SR:!2026-12-12,490,401!2025-08-15,100,381-->
...
- shift left logical ::@:: `sll $d, $t, h`: `$d = $t << h;`, padded by 0 <!--SR:!2026-06-15,356,355!2026-01-04,217,335-->
  - shift left logical / arithmetic ::@:: Assuming _no overflow_, it has the same effect as multiplying a _signed_/_unsigned_ integer by 2<sup>_h_</sup>. <!--SR:!2025-08-13,98,381!2026-12-19,497,401-->
...
{@{An _interrupt_, _exception_, or _trap_}@} is {@{a request for the processor to interrupt currently executing code \(when permitted\), so that the event can be processed in a timely manner}@}. MIPS {@{supports interrupts}@}. <!--SR:!2025-08-11,101,381!2027-01-08,517,401!2025-08-14,99,381-->
