...
- add single ::@:: `add.s $fd, $fs, $ft`: `$fd = $fs + $ft;` <!--SR:!2027-10-18,696,424!2025-11-23,128,404-->
...
- negate single ::@:: `neg.s $fd, $fs`: `$fd = -$fs;` <!--SR:!2027-10-20,698,424!2025-11-22,127,404-->
