...
- move ::@:: `mov $d, $s`: `$d = $s;`; implemented by `or $d, $zero, $s;` <!--SR:!2025-08-13,98,381!2026-12-21,497,401-->
...
- set on greater than ::@:: `sgt $d, $s, $t`: `$d = $s > $t;`; implemented by `slt $d, $t, $s;` <!--SR:!2026-12-28,504,401!2025-08-12,102,381-->
...
{@{An _interrupt_, _exception_, or _trap_}@} is {@{a request for the processor to interrupt currently executing code \(when permitted\), so that the event can be processed in a timely manner}@}. MIPS {@{supports interrupts}@}. <!--SR:!2027-01-23,530,401!2027-01-08,517,401!2025-08-14,99,381-->
