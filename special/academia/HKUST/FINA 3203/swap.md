...
- _Maturity (swap tenor)_ ::@:: – the last payment date, denoted $T_m$. <!--SR:!2026-02-26,39,290!2026-01-19,15,290-->
- _Payment frequencies_ ::@:: – the floating leg usually follows money‑market conventions (e.g., quarterly 3‑month LIBOR); the fixed leg often uses a corporate‑bond convention (e.g., semi‑annual). <!--SR:!2026-03-14,55,310!2026-01-20,16,290-->
