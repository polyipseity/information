...
3. Would your strategy in Scenario&nbsp;2 change if the quotation format were reversed, showing units of foreign currency per one U.S. dollar \(for example, 0.7&nbsp;USD/GBP\)? ::@:: Now USD is the underlying \(_base_ currency\). GBP is the price \(_quote_ currency\). Long the currency forward instead.
