...
- `random.randint(a, b)` ::: Requires importing `random` first by `import random`. Returns a random `int` _N_ such that _a_ ≤ _N_ ≤ _b_. If _a_ > _b_, then raises a `ValueError`. <!--SR:!2024-10-22,5,357!2024-10-20,3,337-->
...
ISOM 2020 note: {{`+=`, `-=`, `*=`, `/=`, etc.}} are {{not taught and should NOT be used in exercises or exams}}. <!--SR:!2024-10-22,5,357!2024-10-22,5,357-->
