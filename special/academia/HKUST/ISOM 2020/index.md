...
- [basics](basics.md)
  ...
  - [§ variable](basics.md#variable)
    - [basics § variable](basics.md#variable) / note ::: In a quiz question, they use the word "save", which means storing a value to a variable. Also, `+=`, `-=`, `*=`, `/=`, etc. are not taught and should NOT be used in exercises or exams. <!--SR:!2024-10-31,40,292!2024-10-27,36,292-->
