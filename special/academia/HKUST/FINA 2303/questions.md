...
>
> - solution: {@{2}@}
> - explanation: {@{Its net working capital \(NWC\) is smaller. Note that the term _insolvency_ describes liquidity, so long-term debt is ignored.}@}
...
>
> - solution: {@{3}@}
> - probability: {@{The 95% confidence interval is \[–15.72%, 29.72%\], so there is an about 5% probability that the future return lies outside this interval. However, this "outside" probability is split evenly between lower than and higher than the interval.}@}
