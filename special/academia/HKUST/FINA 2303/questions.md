...
> 2. No
>
> - solution: {@{1/2}@} <!--SR:!2029-07-25,1263,350-->
...
> 2. No
>
> - solution: {@{1/2}@} <!--SR:!2029-11-15,1345,350-->
...
> 4. 1.1026
>
> - solution: {@{3}@} <!--SR:!2028-07-28,842,290-->
...
> - annotation: What if you do not have enough money right now? In that case, you should {@{still choose the same option, but you borrow money from the bank instead}@}. <!--SR:!2029-06-03,1221,373!2029-03-17,1159,373!2030-02-04,1425,373-->
...
> 3. they are the same
>
> - solution: {@{1}@} <!--SR:!fsrs,2032-09-14T00:00:00.000Z,2166,2166.08190138,1,2,10,0,0,2026-10-10T00:00:00.000Z-->
...
> 4. \$1 million
>
> - solution: {@{2}@} <!--SR:!fsrs,2032-03-10T00:00:00.000Z,2021,2020.70412769,1,2,10,0,0,2026-08-28T00:00:00.000Z-->
...
>
> - solution: {@{1}@}
> - explanation: {@{Model A's EAA is about -84.1392442. Model B's EAA is about -87.6190476.}@} <!--SR:!fsrs,2032-10-24T00:00:00.000Z,2194,2194.18434604,1,2,10,0,0,2026-10-22T00:00:00.000Z!fsrs,2032-10-13T00:00:00.000Z,2186,2186.16037489,1,2,10,0,0,2026-10-19T00:00:00.000Z-->
...
>
> - solution: {@{2}@}
> - explanation: {@{Its net working capital \(NWC\) is smaller. Note that the term _insolvency_ describes liquidity, so long-term debt is ignored.}@} <!--SR:!fsrs,2032-10-19T00:00:00.000Z,2190,2190.17281116,1,2,10,0,0,2026-10-21T00:00:00.000Z!fsrs,2032-11-03T00:00:00.000Z,2202,2202.20400893,1,2,10,0,0,2026-10-24T00:00:00.000Z-->
...
> 2. no
>
> - solution: {@{2}@} <!--SR:!fsrs,2032-11-29T00:00:00.000Z,2222,2222.23508615,1,2,10,0,0,2026-10-30T00:00:00.000Z-->
...
> 2. no
>
> - solution: {@{1}@} <!--SR:!fsrs,2032-12-09T00:00:00.000Z,2230,2230.24019752,1,2,10,0,0,2026-11-01T00:00:00.000Z-->
...
> 2. no
>
> - solution: {@{2}@} <!--SR:!fsrs,2032-10-03T00:00:00.000Z,2178,2178.13207453,1,2,10,0,0,2026-10-17T00:00:00.000Z-->
...
> 4. 15&nbsp;531
>
> - solution: {@{4}@} <!--SR:!2027-02-19,534,399-->
...
> 2. decreased cash
>
> - solution: {@{1}@} <!--SR:!2027-06-17,663,419-->
...
>
> - solution: {@{2}@} <!--SR:!fsrs,2031-10-05T00:00:00.000Z,1890,1890.20135798,1,2,10,0,0,2026-08-02T00:00:00.000Z-->
...
> 4. 80&nbsp;000
>
> - solution: {@{1}@} <!--SR:!2027-08-06,704,418-->
...
> 5. \$1&nbsp;070&nbsp;000
>
> - solution: {@{5}@} <!--SR:!2027-08-22,710,429-->
...
> Q2. A \$1000 par value 5% bond is trading to yield 4%. Which of the following is likely to be the bond's market price?
>
> ---
>
> 1. \$900
...
> Q3. A currently 20-year bond with a coupon rate of 12% paid semi-annually was sold at a price of \$1&nbsp;171.59 2 years ago. Its par value is \$1&nbsp;000. Assume YTM remains constant.
>
> What is its YTM?
>
> ---
...
> Q4. A currently 20-year bond with a coupon rate of 12% paid semi-annually was sold at a price of \$1&nbsp;171.59 2 years ago. Its par value is \$1&nbsp;000. Assume YTM remains constant.
>
> What would be the current market price compared to the price 2 years ago?
>
> ---
>
> 1. no change
...
> Q5. Consider two bonds, each pays semi-annual coupons and has 4% coupon rate. Bond A has 5 years to maturity and Bond B has 8 years until maturity. Both currently have a yield to maturity of 4%.
>
> If market interest rate increases from 4% to 5%, then
>
> ---
>
> 1. price of bond A will increase more than bond B's in %
> 2. price of bond A will increase less than bond B's in %
...
> Q6. Consider the following three bonds.
>
> - bond A: coupon rate of 3%, 5 years to maturity
> - bond B: coupon rate of 5%, 10 years to maturity
> - bond C: coupon rate of 3%, 20 years to maturity
>
> Which bond is the most risky?
>
> ---
>
> 1. bond A
...
> Q1. Given that investments with equivalent risk to firm X's stock have an expected return of 10%, what should your required return of investing in this stock be?
>
> ---
>
> 1. &gt;10%
...
> Q2. Suppose you expect firm X to pay an annual dividend of 3 dollars per share in the coming year. You also expect its shares to trade for 107 dollars per share at the end of the year. Suppose investments with equivalent risk to firm X's stock have an expected return of 10%.
>
> Suppose the stock is now trading at 104 dollars, will you buy the stock?
>
> ---
>
> 1. yes
...
> Q3. Does stock valuation depend on the investor's holding period?
>
> ---
>
> 1. yes
...
> ---
>
> What is the expected capital gain of this stock?
>
> 1. 5%
> 2. 10%
> 3. 15%
...
> Q2. A company usually earns 15% from its investment. The company expects its earnings per share to be 3 dollars, and will pay a dividend of 1.20 dollars per share in the coming year. What is the company's growth rate?
>
> ---
>
> 1. 3%
...
> Q3. Firm ABC used to pay out all its earnings as dividends. Now it plans to cut its dividend payout rate to 50% and use the retained earnings to expand its business. Assuming that the return on its investments in new business is 10%. Firm ABC expects the earning will be \$4 next year. Its cost of capital is 10%. What will happen to the stock price after the dividend payout policy is changed?
>
> ---
>
> 1. decrease
...
>
> What is the expected dividend per share to be paid out by the firm in year 4?
>
> ---
>
> 1. \$3.58
...
>
> - solution: {@{3}@}
> - explanation: {@{$$2 \cdot 1.3^3 \cdot 1.06 = \$4.65764$$}@} <!--SR:!2028-06-01,899,458!2027-10-10,661,432-->

<!-- markdownlint MD028 -->

> Q2. A company plans to pay total dividends of 6 million dollars this year. Its earnings growth rate is 8% per year and its equity cost of capital is 20%. Suppose the company now decides to pay out dividends of 3 million dollars and uses the remaining 3 million cash to repurchase its shares at the end of this year.
>
> How will the new policy affect the company's shareholders' wealth?
>
> ---
>
> 1. decrease
...
> Q3. \(poll\) Suppose you face the following two lotteries. Which will you prefer?
>
> - lottery 1: get 100 dollars for sure
> - lottery 2: get 200 or 0 dollars with equal probability
>
> Note the expected payoff of Lottery 2 is \$100.
>
> ---
>
> 1. lottery 1
...
> Q4. If a stock does not pay dividends, the annual return can be directly computed as its price appreciation over the year.
>
> ---
>
> 1. yes
...
> Q5. Consider a stock with the following three annual returns in year 1, 2 and 3: 10%, 8%, and −4%.
>
> Suppose your friend plans to invest in this stock for the next year, and assume probabilities of having 10%, 8%, and −4% returns in the coming year are equal.
>
> What should you use to compute the expected return?
>
> ---
>
> 1. arithmetic average annual return
...
> Q1. Given the variance of a stock's returns is 0.0129 \(129%<sup>2</sup>\), can you be 95% confident that this portfolio will not lose more than 20% of its value next year?
>
> ---
>
> 1. yes
> 2. no
>
> - solution: {@{1}@} <!--SR:!2028-05-18,887,458-->

<!-- markdownlint MD028 -->

> Q2. Given the mean and the variance of a stock's returns are 7%, and 129%<sup>2</sup>, respectively, on average, once in how many years should you expect to see that you will lose more than 15.72% from the stock?
>
> ---
>
> 1. 6.25 years
...
> Q3. Is there a clear relationship between the volatility and returns for individual stocks?
>
> ---
>
> 1. yes
...
> Q4. What type of risk is risk of theft?
>
> ---
>
> 1. independent risk
...
> Q5. Which of the following risks of a stock are likely to be firm-specific, diversifiable risks?
>
> ---
>
...
> Q6. \(figure: A plot of volatility of portfolio \(standard deviation\) against number of stocks. There are 3 lines. The blue line is a horizontal line at 30%. The red line starts from 30% and decreases, approaching 15% increasingly slowly. The green line starts from 30% and decreases faster than the red line, approaching 0% increasingly slowly.\)
>
> The three lines represent the volatility of three portfolios consisting of different type of firms.
>
> The portfolio represented by the <u>blue</u> line most likely includes which kind of firms?
>
> ---
>
...
> Q7. The risk premium for diversifiable risk is zero.  So investors for holding firm-specific risk will earn a risk-free rate only.
>
> ---
>
> 1. yes
...
> Q2. Does U Firm have any systematic risk?
>
> |                                   | S firm | U firm |
> | --------------------------------- | ------:| ------:|
> | volatility \(standard deviation\) | 30%    | 30%    |
...
> Q3. What is the risk that will command a risk premium?
>
> ---
>
> 1. independent risk
...
> Q4. Combining stocks of different industries in the same portfolio will reduce more volatility than combining stocks of the same industry.
>
> ---
>
> 1. yes
...
> Q5. Suppose we hold a portfolio with $\operatorname{SD}(R_p) = 40\%$. We want to add a stock to the portfolio and are choosing between two stocks with the same expected return. The percentage of the new stock in the portfolio would be 10%. Both stocks are fairly priced.
>
> |                                       | Stock A | Stock B |
> | ------------------------------------- |:-------:|:-------:|
...
> Q6. What risk can be eliminated through diversification?
>
> ---
>
> 1. all risk
...
> Q7. \(figure: A plot of volatility of portfolio \(standard deviation\) against number of stocks. There are 3 lines. The blue line is a horizontal line at 10%. The black line starts from 10% and decreases, approaching ~6.2% increasingly slowly. The red line starts from 10% and decreases faster than the black line, approaching 0% increasingly slowly.\)
>
> The three lines represent the volatility of three portfolios consisting of different type of firms.
>
> The portfolio represented by the __<u>black</u>__ line most likely includes stocks with correlation of?
>
> ---
>
> 1. ρ = −1
...
> Q8. Standard deviation is a valid measure of risk for well-diversified portfolios.
>
> ---
>
> 1. yes
...
> Q9. What is the beta of a risk-free asset?
>
> ---
>
> 1. −1
...
> Q2. Which security should have higher risk premium?
>
...
> Q3. Which security should have higher expected return?
>
> |           | standard deviation | beta |
> | --------- |:------------------:|:----:|
> | Target    | 20%                | 1.25 |
...
> Q4. If both stocks have the same expected return, which one will you buy?
>
> |            | standard deviation | beta |
> | ---------- |:------------------:|:----:|
> | Rackspace  | 40%                | 1.4  |
...
>
> - solution: {@{1}@}
> - explanation: {@{Same expected return means they have the same price. \(Higher expected return means lower price.\) If we assume they are wrongly priced, then Rackspace is underpriced, SolarWinds is overpriced, or both. <p> Alternatively, if we assume they are correctly priced, then Rackspace has a higher risk-free return rate. <p> Both cases yield an arbitrage opportunity.}@} <!--SR:!2028-04-12,855,452!2028-03-25,839,452-->

<!-- markdownlint MD028 -->

> Q5. Suppose the risk-free return is 3% and you measure the market risk premium to be 6%. Apple has a beta of 1.6.
>
> According to the CAPM, if the ___market risk premium___ decreases by 1%, what will be the change in Apple's expected return?
>
> ---
>
> 1. decrease by 1%
...
> Q6. Consider the asset with a beta of 1.5. The risk-free rate is 6% and market risk premium is 9.5%. The asset has an expected return of 15% given its current price.
>
> What can we say about the current price of the asset?
>
> ---
>
> 1. fairly priced
...
> Q1. The weighted average cost of capital \(WACC\) of a firm is based on all its investors' required rate of return on the firm's assets.
>
> ---
>
> 1. yes
...
> Q2. The long-term debt of your firm is currently selling for 95% of its face value. The issue matures in 10 years and pays an annual coupon of 6%, yielding 6.7%. The firm's marginal tax rate is 30%.
>
...
> Q3. The WACC valuation method assumes that the investment opportunity being evaluated has average risk as the overall firm.
>
> ---
>
> 1. yes
> 2. no
>
> - solution: {@{1}@} <!--SR:!2028-05-28,893,452-->

<!-- markdownlint MD028 -->

> Q4. A conglomerate company should evaluate all its projects based on its WACC and take on the project with the highest rate of return.
>
> ---
>
> 1. yes
...
> Q5. The WACC of your firm is 12%. It is evaluating a new project which is more risky than its average assets. What is likely to happen if the WACC is used as the discount rate for this project?
>
> ---
>
> 1. Correctly evaluate the project as WACC accounts for both riskiness of the project and target capital structure of the firm.
...
> Q6. Pepsi is considering to invest in an aerospace project. Assume Pepsi and Boeing's target capital structure is the same.
>
> - Pepsi \(soft drink and snack\)'s WACC = 8%
> - Boeing \(aerospace business\)'s WACC = 10%
> - with discount rate 8% → NPV = \$500&nbsp;000
> - with discount rate 10% → NPV = –\$1&nbsp;000&nbsp;000
>
> Should Pepsi invest in the aerospace project?
>
> ---
>
> 1. yes
