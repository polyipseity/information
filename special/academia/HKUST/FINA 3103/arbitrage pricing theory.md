...
- $r_{M,t}=r_{SP,t}-r_{F,t}$ ::@:: is the market excess return (e.g. using S&P&nbsp;500),
- $r_{SMB,t}=r_{S,t}-r_{B,t}$ ::@:: captures the small‑minus‑big size effect (by market capitalization), and
- $r_{HML,t}=r_{H,t}-r_{L,t}$ ::@:: measures high‑minus‑low book‑to‑market.
