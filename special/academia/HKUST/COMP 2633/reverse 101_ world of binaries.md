...
- `.text` ::@:: It contains the code of our program. It has read and execute permissions. For C, this corresponds to functions. <!--SR:!2027-10-22,873,357!2025-06-16,215,330-->
...
- `dw <data>` ::@:: Define word (2 bytes). Represents `<data>` on a granular level of 2 bytes. <!--SR:!2027-11-29,917,357!2025-06-26,225,337-->
