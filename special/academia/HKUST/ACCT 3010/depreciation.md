...
- _Nearest fraction of a year_ ::@:: – the period is rounded to the nearest whole fraction (e.g., 6⅔ months for 10 June), using that proportion of the annual charge; <!--SR:!2026-01-18,14,290!2026-01-20,16,290-->
...
- _Half‑year rule_ ::@:: – the asset is treated as if it had been in service for exactly six months regardless of the actual acquisition date, simplifying calculation but potentially overstating or understating depreciation; <!--SR:!2026-01-19,15,290!2026-01-18,14,290-->
- _Full year in acquisition, none in disposal_ ::@:: – a new asset receives a full yearly charge even though it was only owned part‑time, while an asset sold before year’s end receives no depreciation for that period; <!--SR:!2026-01-18,14,290!2026-01-18,14,290-->
- _None in acquisition, full year in disposal_ ::@:: – the reverse of rule 4: the newly acquired asset is not depreciated until the next fiscal year, but a disposed asset still accrues a full yearly charge for the period it was held. <!--SR:!2026-01-20,16,290!2026-01-20,16,290-->
