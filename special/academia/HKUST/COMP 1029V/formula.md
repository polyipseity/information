...
- _(begin)_→:::←`=` <!--SR:!2024-03-15,18,270!2024-03-01,8,270-->
...
- `SUBSTITUTE(string, old, new)`→:::←`UPPER(string)` <!--SR:!2024-02-29,18,230!2024-02-28,1,130-->
...
- `MIN(numbers...)`→:::←`RANK(number, numbers...)` <!--SR:!2024-02-28,5,210!2024-03-18,30,250-->
