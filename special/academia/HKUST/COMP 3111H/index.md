...
- [source lines of code](../../../../general/source%20lines%20of%20code.md) \(SLOC\) ::@:: It is a software metric used to measure the size of a computer program by counting the number of lines in the text of the program's source code. <!--SR:!2025-12-02,56,310!2025-12-10,62,310-->
  ...
  - source lines of code / examples ::@:: Rome: Total War &lt; Boeing 787 &lt; F-35 Fighter Jet &lt; Windows 7 &lt; Windows 10 &lt; Facebook &lt; Mac OS X &lt; luxury passenger car <!--SR:!2026-03-13,126,290!2025-11-19,38,250-->
...
- project management
  - project management / organization ::@:: number of people, roles and responsibilities, teams, etc. <!--SR:!2026-01-31,93,363!2026-01-23,87,363-->
    - project management / organization / good practices ::@:: experience, modularity, person in charge \(PIC\) <!--SR:!2025-11-23,20,381!2025-11-29,26,401-->
...
- [requirements elicitation](../../../../general/requirements%20elicitation.md) ::@:: It is the practice of researching and discovering the requirements of a system from users, customers, and other stakeholders. <!--SR:!2026-03-12,127,402!2026-01-12,77,382-->
  ...
  - requirements elicitation / importance ::@:: We are overly optimistic. If we do not research requirements, we may think we know every detail, until when we actually develop the system at which point you discover ambiguous, forgotten, or undefined details. <p> This increases error. So researching requirements _reduces error_. <!--SR:!2026-03-26,139,402!2026-03-22,135,402-->
    - requirements elicitation / importance / failures ::@:: Major causes of software development failures or problems: changing requirements, incomplete requirements, unneeded system, unrealistic expectations, user involvement lacking, etc. <!--SR:!2026-03-21,134,402!2025-11-20,13,362-->
...
- [assertion](../../../../general/assertion%20(software%20development).md) ::@:: In computer programming, specifically when using the imperative programming paradigm, an assertion is a predicate (a Boolean-valued function over the state space, usually expressed as a logical proposition using the variables of a program) connected to a point in the program, that always should evaluate to true at that point in code execution. <!--SR:!2025-11-30,27,401!2025-11-30,27,401-->
  ...
  - assertion / vs. error handling ::@:: eserve error‑handling mechanisms for recoverable faults; assertions are for impossible or programmer errors that should crash the program. <!--SR:!2025-11-23,20,381!2025-11-29,26,401-->
...
- [code review](../../../../general/code%20review.md) ::@:: It is a software quality assurance activity in which one or more people examine the source code of a computer program, either after implementation or during the development process. <p> It is kinda like an _offline_ version of _pair programming_. <!--SR:!2025-11-29,26,401!2025-11-29,26,401-->
  ...
  - code review / techniques ::@:: Walkthroughs where the author presents the artifact; defect discovery only or fix brainstorming; targeted checks for known defect patterns; use of checklists (e.g., "Are all public methods documented?"). <!--SR:!2025-11-30,27,401!2025-11-21,18,381-->
