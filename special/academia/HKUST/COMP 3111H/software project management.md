...
For {@{effective monitoring}@} the WBS must satisfy: {@{_plannability_}@}: tasks have {@{defined durations}@}; {@{_assignability_}@}: each task can be {@{allocated to an individual or team}@}; {@{_trackability_}@}: progress is {@{measurable against a schedule and cost baseline}@}; and {@{_appropriate granularity_}@}: neither {@{too fine (unmanageable) nor too coarse (inaccurate)}@}. <!--SR:!2026-04-20,80,343!2026-04-18,78,343!2026-04-20,80,343!2026-04-20,80,343!2026-04-20,80,343!2026-04-22,82,343!2026-04-10,70,326!2026-04-18,78,343!2026-11-25,253,330-->  
