...
{@{Best practices}@}: \(annotation: 5 items: {@{action/operation, implementation, irrelevant}@}; {@{vague; redundant; dependent; role}@}\) <!--SR:!2025-11-29,26,387!2026-04-12,135,407!2025-11-29,26,387-->
...
6. __Postconditions__ \(if any\) ::@:: the state that must hold after completion if it matters to stakeholders or for subsequent use cases. <!--SR:!2026-04-09,132,407!2025-11-29,26,387-->
...
- Variant behavior ::@:: – A different sequence of steps that can _replace_ part of the normal flow under certain conditions. <p> example: If a schedule already exists when creating one, a pop-up informs the user and jumps to "SelectCourse". <!--SR:!2026-04-11,134,407!2025-11-29,26,387-->
...
{@{An _extension point_}@} is {@{a _named_ location in the flow}@} where {@{additional behaviour may be inserted}@}. They come in three forms: \(annotation: 3 items: {@{single location, set of discrete locations, region}@}\) <!--SR:!2026-04-10,133,407!2025-11-29,26,387!2026-04-01,125,407!2026-04-09,132,407-->
