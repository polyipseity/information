...
{@{_Aggregation_}@} represents {@{a _possible_ "part-of" relationship}@}. {@{The component object \(child\)}@} {@{_may_ belong to an aggregate object \(parent\)}@}, and {@{_can_ exist _independently_ of the aggregate object}@}. <!--SR:!2026-10-28,297,342!2026-11-06,306,342!2026-01-21,85,350!2027-02-14,392,361!2027-02-22,400,370-->

Often, the association name is {@{"Has", but can be other names as appropriate for the application domain}@}. We can {@{omit the name as well}@}. Conversely, however, {@{an association with the name "Has"}@} {@{does not imply composition}@}. Aggregation or composition should have {@{intrinsic _asymmetry_ to the association}@}. <!--SR:!2026-01-20,84,350!2026-10-29,298,342!2027-02-23,401,370!2026-10-28,297,342!2026-01-22,86,353-->
...
{@{Generalization}@} can be characterized by {@{2 main properties \(and possibly more\)}@}: {@{_completeness_ and _disjointness_}@}. These two are also called {@{_coverage constraints_}@}. These depend on {@{the semantics of the superclass and subclasses}@} and {@{the _application domain_}@} \(e.g. {@{the exact same generalization in different domains may have different properties}@}\). <!--SR:!2026-01-19,83,341!2027-02-10,388,361!2026-01-21,85,350!2027-02-09,387,361!2027-02-02,381,361!2026-11-04,304,342!2026-10-17,275,341-->
...
An {@{_operation constraint_}@} constrains {@{an _operation_ of a class}@}. It can be indicated by {@{`{<boolean expr>}` next to the operation}@} or {@{on a _note_ linked with the class by a _dashed_ line}@}, which represents {@{an expression that must always be true}@}, e.g. {@{`balance(): money {balance() >= 100}`}@}. <!--SR:!2026-10-30,299,342!2026-01-20,84,350!2026-09-15,254,341!2027-02-12,390,361!2027-02-14,392,361!2026-04-16,138,407-->
...
{@{A _dependency_}@} relates {@{classes whose behavior or implementation affect other classes}@}. It is indicated by {@{a _dashed arrow_}@}. Some example dependencies are: {@{_flow_ and _usage_}@}. <!--SR:!2026-11-13,313,342!2026-01-19,83,341!2027-02-12,390,361!2026-11-15,305,342-->
...
{@{A _realization_}@} relates {@{an _implementation_ to its _specification_}@}, e.g. {@{relating an class implementing an interface to the interface}@}. It is indicated by {@{a _dashed arrow_ with a _hollow_ triangle as the arrow head}@}. It points from {@{the implementation to the specification}@}. <!--SR:!2027-02-12,390,361!2026-12-03,323,342!2026-01-20,84,350!2027-02-09,387,361!2027-01-29,377,361-->
...
- redundant class ::@:: Eliminate the least descriptive classes. <!--SR:!2026-01-25,87,374!2027-03-15,421,394-->
...
- course registration system, instructor ::@:: — declares teaching assignments, views enrollments. <!--SR:!2027-03-12,418,394!2026-02-02,94,374-->
...
{@{A _use case diagram_ \(_context_ diagram\)}@} is {@{a graphical depiction of a user's possible interactions with a system}@}. Its main elements are {@{_actors_ and \(groupings of\) _use cases_}@}. <!--SR:!2026-01-23,86,374!2026-01-23,86,374!2027-03-12,418,394-->
