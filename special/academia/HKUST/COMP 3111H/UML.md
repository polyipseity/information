...
{@{The syntax}@} to {@{describe an attribute}@} is {@{`<visibility> <name> : <type> <multiplicity> <mutability> = <initial value>`}@}, e.g. {@{`+ accounts: Account [0..10] {readOnly} = []`}@}. <!--SR:!2026-11-14,314,342!2027-01-30,378,361!2027-02-10,388,361!2026-04-01,110,412-->
...
{@{Best practices}@}: \(annotation: 4 items: {@{irrelevant; independent}@}; {@{association; identifier}@}\) <!--SR:!2026-04-01,125,407!2026-04-18,140,407!2028-02-16,687,427-->
