...
3. __Actors__ ::@:: the participants initiating the use case; it may be listed or illustrated with a use case diagram fragment showing the actor and the use case. <!--SR:!2025-11-27,24,387!2025-11-29,26,387-->
...
- _single location_ ::@:: occurs at a single place (e.g., `{Validate Term}` in a course registration system) <!--SR:!2025-11-29,26,387!2025-11-27,24,387-->
...
- _region_ ::@:: a matched pair of points that delimit a set of positions, which are suitably named to make clear that they are matched (e.g., from `{Begin Editing Schedule}` to `{End Editing Schedule}` in a course registration system) <!--SR:!2025-11-27,24,387!2025-11-28,25,387-->
