...
2. [UML § events](UML.md#events) / handling ::@:: Events in a state machine are handled _sequentially_: each event is examined one at a time and, if no transition matches it, the event is simply _ignored_. <!--SR:!2026-11-19,251,330!2026-03-22,66,310-->
