...
2. software / types / uses / custom ::@:: copies in use: low <br/> development effort: high <br/> source of user requirements: client needs <!--SR:!2025-12-30,65,310!2026-08-27,250,330-->
...
4. project management / steps ::@:: scope → risks → schedule \(e.g. deliverables\) → implement <!--SR:!2026-08-12,237,330!2026-04-28,152,310-->
5. project management / 4Ps ::@:: A _project_ involves _people_ \(input\) using _processes_ \(input\) to produce _products_ \(output\) according to requirements from the application domain \(input\). <!--SR:!2026-01-01,67,310!2025-12-23,59,310-->
