...
- 本課評核三大部分及比重是甚麼？ ::@:: 學術報告 40%、期末考試 40%、出席與課堂參與 20%。
- 本課評核屬於哪種評分方式？ ::@:: 準則參照評分（criterion-referenced），即按既定準則評定表現。
- 準則參照評分與拉 curve 的主要分別是甚麼？ ::@:: 準則參照評分按達標程度評分，不是按同學之間相對排名拉曲線。
- 本課對 A 級表現的描述是甚麼？ ::@:: 對核心內容有全面掌握，具強解難能力、創造力、學術素養與協作表現，整體超越基本要求。
- 本課對 B 級表現的描述是甚麼？ ::@:: 對主要內容有良好掌握，並展現分析、評估、學習動機與有效協作能力。
- 本課對 C 級表現的描述是甚麼？ ::@:: 對核心內容有足夠掌握，能處理熟悉問題，並具一定分析或批判能力。
- 本課對 D 級表現的描述是甚麼？ ::@:: 僅達最低門檻，具基礎知識與基本判斷，仍有待進一步發展。
- 本課對 F 級表現的描述是甚麼？ ::@:: 未達門檻要求，理解、解難與分析能力不足。
...
- [莊子 § 〈養生主〉](莊子.md#養生主)
- 初稿的基本內容是甚麼？ ::@:: 題目加大綱（重點是先定題與結構）。
- 初稿不交會怎樣？ ::@:: 會扣分；交了本身不加分（屬進度檢查）。
- 第二稿的截止提醒是甚麼？ ::@:: 2026-04-09 課上提醒明天（4/10）12點前提交。
- 第二稿是否計入最終分數？ ::@:: 不計分；主要用作檢視進度與給回饋。
- 哪一稿才正式計分？ ::@:: 終稿（Final Draft）才計分。
- 終稿的截止時段如何表述？ ::@:: 2026-05-07 課上提醒為翌日晚上12點前（5/8 截止）。
- 遲交或不交草稿的共同後果是甚麼？ ::@:: 會扣分（尤其不交／遲交）。
- 此課加退選後的出席規則是甚麼？ ::@:: 加退選後開始點名（含抽點）。
- 此課考試題型與時間是甚麼？ ::@:: 問答題，4題選3題，2小時。
- 此課考試可否用英文作答？ ::@:: 不可；需中文作答（簡體或繁體均可）。
- 課堂曾公告過的停課安排是甚麼？ ::@:: 有「下個禮拜放假、停一星期」的安排。
- 報告可否使用人工智能工具？ ::@:: 可作參考，但不可照抄；照抄屬抄襲。
