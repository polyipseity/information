...
> - explanation: {@{60/3 = 20 customers per hour}@} <!--SR:!2027-08-16,651,330!2029-07-13,1208,350-->
...
>
> - solution: {@{1.2}@}
> - explanation: {@{Consider one machine and its queue. The average number of customers in the system = 0.375/\(1–0.375\) = 0.6. There are two machines, so the answer is 0.6\*2 = 1.2.}@} <!--SR:!2029-09-11,1256,350!2029-09-03,1250,350-->
...
>
> - solution: {@{3}@}
> - explanation: {@{Arrival rate is 5 customers per hour. Service rate per seat is 2 customers per hour. So you need 5/2 = 2.5&nbsp;seats at least. Round it up to 3.}@} <!--SR:!2029-06-28,1195,350!2029-07-04,1200,350-->
