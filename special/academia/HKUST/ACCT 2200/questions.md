...
- profitability by job ::@:: You can calculate the operating profit _separately_ for each job. <!--SR:!2026-05-15,254,330!2025-09-08,57,310-->
...
- explanatory power ::@:: We use "R square" \(not "multiple R" or "adjusted R square"\) to say how much a model explains the output variable. Higher is considered better, but you also need to consider if it is easy to get the input variables. <!--SR:!2026-05-11,251,330!2026-05-13,252,330-->
...
- high—low method: suitability ::@:: Consider the vertical errors for data points in between. If the errors are high, it is not suitable. Otherwise, it is suitable. <!--SR:!2025-09-08,57,310!2026-05-15,254,330-->
...
- rounding ::@:: In general, no need to round answers to integers unless explicitly told to do so. <!--SR:!2026-05-14,253,330!2025-09-08,57,310-->

## incremental analysis for short-term decision making

- opportunity cost due to full capacity ::@:: Use unit contribution margins to find the opportunity cost due to lost production. <!--SR:!2026-05-15,254,330!2025-09-08,57,310-->
...
- budgeting uncollectible sales ::@:: Consider uncollectible sales occurring in the subperiod after the last sales collection subperiod. Accounts receivable \(AR\) balance also reflects this. <!--SR:!2026-05-04,245,330!2025-09-09,58,310-->
- current loan balance ::@:: The instructor handles the current loan balance by adding an extra row showing the current loan balance after the ending cash balance. <!--SR:!2026-05-16,255,330!2026-05-16,255,330-->
...
- preliminary cash balance ::@:: The instructor uses this cash balance to include everything \(including interest expense\) except for cash borrowed or \(repaid\). <!--SR:!2026-05-13,252,330!2025-09-08,57,310-->
...
- actual vs. standard ::@:: Actual is actual... pretty easy. Standard can be considered how many direct materials or direct labor hours should have been used given the _actual_ units produced. <!--SR:!2025-09-12,61,310!2026-05-16,255,330-->
...
- multiple performance measures ::@:: Different performance measures may give different rankings. State the rankings for each performance measure _separately_. <!--SR:!2025-09-18,67,310!2026-04-24,236,330-->
- mutually beneficial transfer price ::@:: This means the price is halfway in between the floor \(_variable_ cost\) and the ceiling \(market price\). <!--SR:!2025-09-08,57,310!2026-05-16,255,330-->
...
- suitable transfer pricing ::@:: If there is no excess capacity, market price is the only suitable transfer price. Otherwise, anything in between the variable cost and the market price is suitable. The final price would depend on the relative bargaining power between the divisions. <!--SR:!2025-09-13,62,310!2026-05-15,254,330-->

## capital budgeting

- decision making ::@:: You can say a decision needs to be made carefully if the NPV is relatively small, the NPV is negative using an alternative discount rate, the accounting rate of return is relatively low, the payback period is long, etc. <!--SR:!2025-09-09,58,310!2026-04-25,237,330-->
- internal rate of return \(IRR\) approximation ::@:: There is no closed formula for IRR. But you can guess two IRRs and calculate the NPVs \(one negative, one positive\), and then give an IRR range such that it can answer the question. <!--SR:!2025-09-09,58,310!2026-05-03,244,330-->
