...
- job cost
  - job cost / transactions
    ...
    - job cost / transactions / applying overheads to projects estimated using POHR ::@:: T-entry: work in process inventory ← manufacturing overhead (using _estimated_ values from POHR, not _actual_ values) <!--SR:!2025-10-02,168,337!2026-12-27,507,337-->
