...
- special order ::@:: It is an one-time order that is outside the scope of normal sales. <p> When performing cost—benefit analysis, we only account for the _incremental_ costs and benefits. That is, the change in costs and benefits between accepting and rejecting it. \(Considering the _incremental_ costs and benefits will automatically consider the opportunity costs.\) <!--SR:!2027-09-01,710,430!2027-08-30,708,429-->
  - special order / relevant costs ::@:: For products, they include contribution margin lost on regular sales \(due to full capacity\), direct labor, direct materials, _variable_ manufacturing overhead, etc. <!--SR:!2026-04-05,282,389!2027-12-22,798,430-->
