...
- variance analysis
  ...
  - variance analysis / spending variance ::@:: It is the sum of price variance and quantity variance. It is also the difference between the actual budget and the flexible budget. <p> It is computed as: $$\text{spending variance} = \text{price variance} + \text{quantity variance} = \text{SQ} \cdot \text{SP} - \text{AQ} \cdot \text{AP} \,.$$ <!--SR:!2026-12-03,421,401!2025-11-09,136,425-->
