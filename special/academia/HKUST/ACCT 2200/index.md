...
- activity-based costing
  ...
  - activity-based costing / activity classification ::@:: (largest to smallest) facility-level, product/service-level, batch-level, unit-level <!--SR:!2026-10-04,465,388!2026-09-15,455,388-->
    ...
    - activity-based costing / activity classification / batch-level ::@:: They support a batch (group of units/group of customers) at once, e.g. machine setup (one setup per batch), ordering materials, shipping a batch, etc. <!--SR:!2026-04-08,317,368!2030-07-30,1578,388-->
