...
- Keep this course scaffold logistics-heavy until lecture PDFs, tutorial sheets, or worked solutions are actually ingested; do not invent transform derivations or topic notes from chapter titles alone.
...
- When scaffolding course logistics from partial LMS material, create minimal `index.md` pages for foreseeable assignment, tutorial, and lab items evidenced by the provided materials; keep any agent-only guidance here in the course-root `AGENTS.md`, not in child note pages.
