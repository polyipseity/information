...
- What does $\delta(t-\tau)$ represent in the impulse decomposition integral? ::@:: It represents a unit impulse placed at source time $\tau$ and observed at time $t$. <!--SR:!fsrs,2027-07-08T00:00:00.000Z,351,350.70809524,1,2,7,0,0,2026-07-22T00:00:00.000Z!fsrs,2027-07-20T00:00:00.000Z,360,359.78905058,1,2,7,0,0,2026-07-25T00:00:00.000Z-->
...
- What is the commutative property of convolution? ::@:: It is $f_1*f_2=f_2*f_1$. <!--SR:!fsrs,2027-07-20T00:00:00.000Z,360,359.78905058,1,2,7,0,0,2026-07-25T00:00:00.000Z!fsrs,2027-04-14T00:00:00.000Z,278,278.46760619,1,2,7,0,0,2026-07-10T00:00:00.000Z-->
...
- What does convolution with $\delta(t-t_0)$ do to a signal? ::@:: It delays the signal by $t_0$, giving $f(t-t_0)$. <!--SR:!2026-08-11,70,330!fsrs,2027-07-20T00:00:00.000Z,360,359.78905058,1,2,7,0,0,2026-07-25T00:00:00.000Z-->
...
- How do you derive $g'=f*h'$ by differentiating under the integral sign? ::@:: Differentiate under the integral sign: if $g(t)=\int f(\tau)h(t-\tau)\,d\tau$, then $g'(t)=\int f(\tau)h'(t-\tau)\,d\tau=(f*h')(t)$. <!--SR:!fsrs,2027-07-20T00:00:00.000Z,360,359.78905058,1,2,7,0,0,2026-07-25T00:00:00.000Z!fsrs,2027-04-30T00:00:00.000Z,291,291.42724554,1,2,7,0,0,2026-07-13T00:00:00.000Z-->
...
- What is usually the hardest part of analytical convolution in practice? ::@:: It is usually determining the correct overlap interval on which both factors are nonzero, not performing the final antiderivative. <!--SR:!fsrs,2027-07-20T00:00:00.000Z,360,359.78905058,1,2,7,0,0,2026-07-25T00:00:00.000Z!2026-08-16,75,330-->
...
- Worked example: Given $e(t)=u(t)-u(t-t_0)$ with $t_0>0$ and $h(t)=e^{-t}u(t)$, what overlap interval is used for $r_2(t)=u(t-t_0)*h(t)$ and what result follows? ::@:: Step 1: require $u(\tau-t_0)\neq 0$, so $\tau>t_0$. <br/> Step 2: require $u(t-\tau)\neq 0$, so $\tau<t$. <br/> Step 3: therefore the overlap interval is $t_0<\tau<t$ for $t>t_0$. <br/> Step 4: compute $r_2(t)=\int_{t_0}^{t} e^{-(t-\tau)}\,d\tau=e^{-t}\int_{t_0}^{t} e^{\tau}\,d\tau=1-e^{-(t-t_0)}$. <br/> Step 5: attach support as $r_2(t)=\bigl(1-e^{-(t-t_0)}\bigr)u(t-t_0)$. <!--SR:!fsrs,2027-07-20T00:00:00.000Z,360,359.78905058,1,2,7,0,0,2026-07-25T00:00:00.000Z!2026-07-28,72,330-->
