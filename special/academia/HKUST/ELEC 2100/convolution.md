...
- In the convolution integral, what does the variable $\tau$ represent? ::@:: It represents the source time at which a small piece of the input occurs. <!--SR:!2026-07-16,61,310!fsrs,2027-04-20T00:00:00.000Z,283,282.79716409,1,2,7,0,0,2026-07-11T00:00:00.000Z-->
...
- How can $f*h$ be rewritten as $f^{(-1)}*h'=f'*h^{(-1)}$ when zero-state antiderivatives exist? ::@:: It can be rewritten as $f*h=f^{(-1)}*h'=f'*h^{(-1)}$ whenever the relevant zero-state derivatives and antiderivatives exist. <!--SR:!2026-07-26,76,330!2026-07-16,61,310-->
...
- Worked example: Given $f(t)=u(t)-u(t-1)$, when does $s(t)=f(t)*f(t)$ reach its maximum value, and why? ::@:: Step 1: the output equals the overlap length of two unit-width pulses. <br/> Step 2: that overlap increases as $t$ moves from $0$ to $1$. <br/> Step 3: at $t=1$ the two pulses overlap fully, so the overlap is maximal. <br/> Step 4: after $t=1$ the overlap shrinks again, so the maximum occurs at $t=1$. <!--SR:!2026-08-12,71,330!2026-07-16,61,310-->
