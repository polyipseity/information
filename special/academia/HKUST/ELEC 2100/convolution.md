...
- What role does convolution play in computing the zero-state response of an LTI system? ::@:: It is the central time-domain operation for computing zero-state response of linear time-invariant systems. <!--SR:!2026-07-12,58,310!2026-08-11,70,330-->
...
- How does 2D convolution generalize the 1D slide-weight-sum procedure from time signals to images? ::@:: It is the same convolution logic generalized from one time axis to two spatial coordinates: slide the kernel, weight nearby values, and sum the local contributions. <!--SR:!2026-07-12,58,310!fsrs,2027-04-14T00:00:00.000Z,278,278.46760619,1,2,7,0,0,2026-07-10T00:00:00.000Z-->
- What are the mechanical steps of 2D convolution: flip the kernel, shift it, multiply on the overlap, and sum? ::@:: Flip the kernel in both coordinates, shift it to the output location of interest, multiply pointwise over the overlap region, and sum the overlapping products. <!--SR:!2026-07-12,58,310!2026-08-13,72,330-->
...
- In the convolution integral, what does $e(\tau)$ represent? ::@:: It represents the strength of the input at source time $\tau$. <!--SR:!2026-08-11,70,330!2026-07-12,58,310-->
...
- Why does convolution mix source time $\tau$ and observation time $t$? ::@:: Because it tracks how each earlier input event contributes later when the output is observed at time $t$. <!--SR:!2026-07-11,57,310!2026-07-20,65,330-->
...
- Which change of variables proves that convolution is commutative? ::@:: Use the substitution $\lambda=t-\tau$ in $(f_1*f_2)(t)=\int f_1(\tau)f_2(t-\tau)\,d\tau$ to rewrite it as $\int f_2(\lambda)f_1(t-\lambda)\,d\lambda=(f_2*f_1)(t)$. <!--SR:!2026-07-27,71,330!2026-07-12,57,310-->
...
- How does distributivity model two parallel LTI systems with impulse responses $h_1$ and $h_2$? ::@:: If the same input is fed into two parallel subsystems with impulse responses $h_1$ and $h_2$ and their outputs are added, the overall impulse response is $h=h_1+h_2$. <!--SR:!2026-07-12,57,310!2026-08-21,80,343-->
- What is the associative property of convolution? ::@:: It is $(f*h_1)*h_2=f*(h_1*h_2)$. <!--SR:!2026-07-12,58,310!2026-07-22,67,330-->
...
- What delay identity does convolution satisfy when one factor is shifted by $t_0$? ::@:: If $g(t)=f_1(t)*f_2(t)$, then delaying either factor by $t_0$ delays the output by the same amount, so $f_1(t-t_0)*f_2(t)=g(t-t_0)$ and $f_1(t)*f_2(t-t_0)=g(t-t_0)$. <!--SR:!2026-07-12,58,310!2026-07-14,59,310-->
- Why does delaying one convolution factor simply delay the output of an LTI system? ::@:: Because delaying the excitation before the system should simply delay the response, and convolution preserves exactly that behaviour. <!--SR:!2026-07-11,57,310!2026-07-20,65,330-->
...
- How do you derive $g'=f*h'$ by differentiating under the integral sign? ::@:: Differentiate under the integral sign: if $g(t)=\int f(\tau)h(t-\tau)\,d\tau$, then $g'(t)=\int f(\tau)h'(t-\tau)\,d\tau=(f*h')(t)$. <!--SR:!2026-07-24,68,330!2026-07-12,58,310-->
...
- Why does the rectangular-rectangle graphical example produce a trapezoidal output? ::@:: Because the overlap area first grows linearly, then stays constant during full overlap, and finally shrinks linearly as the rectangles separate. <!--SR:!2026-08-14,73,330!2026-07-11,57,310-->
...
- What compact notation is used for the discrete convolution sum? ::@:: It is written as $y[n]=(x*h)[n]$. <!--SR:!2026-08-15,74,330!2026-07-11,57,310-->
...
- Worked example: Given $f(t)=u(t)-u(t-1)$, what is $s(t)=f(t)*f(t)$? ::@:: Step 1: write $s(t)=\int_{\max(0,t-1)}^{\min(1,t)}1\,d\tau$. <br/> Step 2: for $t<0$, the overlap is empty, so $s(t)=0$. <br/> Step 3: for $0<t<1$, the overlap length is $t$, so $s(t)=t$. <br/> Step 4: for $1<t<2$, the overlap length is $2-t$, so $s(t)=2-t$. <br/> Step 5: for $t>2$, the overlap is empty again, so $s(t)=0$. <!--SR:!2026-07-21,66,330!2026-07-11,57,310-->
- What compact overlap formula produces the triangular self-convolution of $f(t)=u(t)-u(t-1)$? ::@:: It is $s(t)=\int_{\max(0,t-1)}^{\min(1,t)}1\,d\tau=\min(1,t)-\max(0,t-1)$ whenever the overlap interval is nonempty. <!--SR:!2026-07-12,58,310!2026-08-17,76,330-->
