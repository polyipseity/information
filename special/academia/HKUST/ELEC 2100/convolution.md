...
- How does time invariance turn a unit impulse at time $\tau$ into an output signal? ::@:: It turns the impulse at time $\tau$ into the shifted impulse response $h(t-\tau)$. <!--SR:!2026-04-12,4,290!2026-04-12,4,303-->
...
- Why is convolution the natural tool for zero-state response of an LTI system? ::@:: Because it is exactly the formal sum of all shifted-impulse responses produced by decomposing the input into weighted impulses. <!--SR:!2026-04-12,4,290!2026-04-12,4,303-->
...
- What is the overlapping impulse-response copies intuition for convolution? ::@:: Each input slice launches a shifted copy of the impulse response, and the output at time $t$ is the total overlap of all those weighted copies at that instant. <!--SR:!2026-04-12,4,290!2026-04-12,4,303-->
...
- How does the distributive property explain parallel LTI systems? ::@:: If the same input is fed into two parallel subsystems with impulse responses $h_1$ and $h_2$ and their outputs are added, the overall impulse response is $h=h_1+h_2$. <!--SR:!2026-04-12,4,270!2026-04-12,4,303-->
...
- Why can the impulse response of an ideal conductor be identified with $\delta(t)$? ::@:: Because convolving with $\delta(t)$ leaves the signal unchanged, which is exactly the behaviour of an ideal through connection. <!--SR:!2026-04-12,4,290!2026-04-12,4,303-->
...
- What is the result of convolving a signal with $\delta'(t)$ or more generally with $\delta^{(k)}(t)$? ::@:: It differentiates the signal, giving $f(t)*\delta'(t)=f'(t)$ and $f(t)*\delta^{(k)}(t)=f^{(k)}(t)$. <!--SR:!2026-04-12,4,303!2026-04-12,4,290-->
...
- How can discrete-time convolution be viewed as continuous-time convolution of impulse trains? ::@:: Embed the sequences as $x_\delta(t)=\sum_n x[n]\delta(t-n)$ and $h_\delta(t)=\sum_n h[n]\delta(t-n)$; then the coefficient of $\delta(t-k)$ in $x_\delta*h_\delta$ is $\sum_m x[m]h[k-m]=(x*h)[k]$. <!--SR:!2026-04-12,4,303!2026-04-12,4,270-->
- What is the discrete convolution sum for zero-state response? ::@:: It is $y[n]=\sum_{m=-\infty}^{\infty}x[m]h[n-m]$. <!--SR:!2026-04-12,4,303!2026-04-12,4,290-->
...
- Why is the discrete convolution sum the natural zero-state formula for an LTI system? ::@:: Because each shifted unit sample produces a shifted copy of $h[n]$, and linearity says the total output is the sum of all those weighted copies. <!--SR:!2026-04-12,4,290!2026-04-12,4,303-->
