...
- If the inductor voltage is $v_L(t)=B\delta(t)$, what jump does the inductor current undergo? ::@:: Integrating $v_L(t)=L\frac{di_L}{dt}$ gives $L\bigl(i_L(0^+)-i_L(0^-)\bigr)=B$, so $i_L(0^+)-i_L(0^-)=B/L$. <!--SR:!2026-07-15,65,310!2026-07-24,73,330-->
...
- What family resemblance should be remembered across the standard impulse-response examples? ::@:: Scaling changes impulse weight, differentiation raises singular order, integration accumulates impulse area into a step, and delay shifts the impulse in time without reshaping it. <!--SR:!2026-07-15,65,310!2026-07-23,70,330-->
