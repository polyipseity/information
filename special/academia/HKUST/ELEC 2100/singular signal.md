...
- What does the graph of an impulse represent? ::@:: It represents location, sign, and area rather than an ordinary pointwise height. <!--SR:!2026-07-14,62,310!2026-07-18,66,310-->
...
- Why is the phrase "infinitely tall narrow pulse" only heuristic? ::@:: It is useful limiting intuition, but the generalized impulse is defined by its action under integration rather than by ordinary pointwise height. <!--SR:!2026-07-25,72,330!2026-07-14,62,310-->
...
- How do you draw $r(t-t_0)$? ::@:: Keep the graph at $0$ until $t=t_0$, then start a line of slope $1$ measured from that switching time. <!--SR:!2026-07-15,63,310!2026-07-14,62,310-->
...
- What is the signum function? ::@:: It is $-1$ for negative time, $+1$ for positive time, and usually $0$ at the origin by convention. <!--SR:!2026-07-14,62,310!2026-07-29,76,330-->
...
- Why does the double-sided exponential delta sequence have unit area? ::@:: Symmetry gives $2\int_0^{\infty}\frac{1}{2\varepsilon}e^{-t/\varepsilon}dt=1$. <!--SR:!2026-07-14,62,310!2026-07-28,75,330-->
...
- Why do test functions need smoothness and compact support? ::@:: Smoothness makes derivative rules legitimate, and compact support removes boundary terms in integration-by-parts arguments. <!--SR:!2026-07-25,72,330!2026-07-14,62,310-->
...
- What is the derivative of the unit ramp? ::@:: It is the unit step: $\frac{d}{dt}r(t)=u(t)$. <!--SR:!2026-07-14,62,310!2026-07-16,64,310-->
...
- Why does a differentiated gate produce a positive and a negative impulse? ::@:: The rising edge contributes a positive impulse, while the falling edge contributes a negative impulse. <!--SR:!2026-07-14,62,310!2026-07-19,67,310-->
...
- What does convolution with the doublet do? ::@:: It differentiates the signal: $f*\delta'=f'$. <!--SR:!2026-07-28,75,330!2026-07-14,62,310-->
