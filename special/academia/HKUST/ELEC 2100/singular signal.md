...
- What is the main singular-signal chain introduced in the early ELEC 2100 signal material? ::@:: It is $r(t) \to u(t) \to \delta(t) \to \delta'(t)$. <!--SR:!2026-07-16,64,310!2026-07-25,72,330-->
...
- Why does a gate differentiate to an impulse pair while a step differentiates to one impulse? ::@:: A step has one switching edge, whereas a gate has two switching edges. <!--SR:!2026-07-17,65,310!2026-07-16,64,310-->
...
- Why does the rectangular delta sequence have unit area? ::@:: Because $\int_{-\varepsilon/2}^{\varepsilon/2}(1/\varepsilon)dt=1$. <!--SR:!2026-07-16,64,310!2026-07-24,71,330-->
...
- What is a triangular delta sequence? ::@:: One choice is $\delta_\varepsilon(t)=\frac{1}{\varepsilon}(1-|t|/\varepsilon)$ for $|t|<\varepsilon$ and $0$ otherwise. <!--SR:!2026-07-16,64,310!2026-07-27,74,330-->
...
- What is the derivative of the unit ramp? ::@:: It is the unit step: $\frac{d}{dt}r(t)=u(t)$. <!--SR:!fsrs,2027-05-20T00:00:00.000Z,309,308.57643926,1,2,7,0,0,2026-07-15T00:00:00.000Z!2026-07-16,64,310-->
...
- Why do switched signals acquire impulse terms when differentiated? ::@:: Differentiation gives the ordinary derivative on smooth intervals plus an impulse at the switching instant. <!--SR:!2026-07-16,64,310!2026-07-29,76,330-->
- How should this course differentiate a piecewise-smooth signal with jump discontinuities? ::@:: Differentiate each smooth piece normally, then add a Dirac impulse at each jump with weight equal to the jump size $x(t_0^+)-x(t_0^-)$. <!--SR:!2026-07-16,64,310!2026-07-28,75,330-->
