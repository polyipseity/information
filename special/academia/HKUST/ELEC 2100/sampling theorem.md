...
- Why can too low a sampling frequency be visually or physically harmful? ::@:: Because it can miss important changes in the signal and create distortion such as flicker, judder, or aliasing. <!--SR:!2026-07-20,66,310!2026-07-17,64,310-->
- How does motion-picture playback illustrate sampling-frequency selection? ::@:: Human persistence of vision lets about $24$ frames per second create an illusion of smooth motion for ordinary scenes, so the frame rate is chosen to match the temporal characteristics that viewers need to perceive. <!--SR:!2026-07-28,75,337!2026-07-17,63,310-->
