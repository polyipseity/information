...
- What impulse train models ideal uniform sampling? ::@:: It is $p_T(t)=\sum_{n=-\infty}^{\infty}\delta(t-nT)$. <!--SR:!2026-07-16,63,310!2026-08-01,78,340-->
...
- Why does the factor $2$ appear in the Nyquist condition? ::@:: Because the baseband spectrum extends over both positive and negative frequencies, so adjacent replicas avoid overlap only when the copy spacing is at least twice the highest baseband frequency. <!--SR:!2026-07-20,67,310!2026-07-16,62,310-->
