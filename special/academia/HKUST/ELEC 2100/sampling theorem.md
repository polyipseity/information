...
- How are the sampling frequency and angular sampling frequency related to $T$? ::@:: They are $f_s=1/T$ and $\omega_s=2\pi/T$. <!--SR:!2026-07-18,64,310!2026-07-21,67,310-->
...
- Why do engineers often sample above the exact Nyquist limit instead of exactly at it? ::@:: Because practical spectra are rarely perfectly sharp and practical filters are not ideal brick walls, so extra margin reduces aliasing risk and eases implementation. <!--SR:!2026-07-18,65,310!2026-07-25,72,329-->
...
- How should you draw the block diagram of a zero-order hold implementation? ::@:: Draw the sample sequence $x[n]$ entering a block labeled _zero-order hold_ and show a staircase continuous-time output. In a more structural version, draw $x[n] \to$ ideal impulse DAC $\to h_{\mathrm{ZOH}}(t)$. <!--SR:!2026-07-21,67,310!2026-07-18,65,310-->
- What is the impulse response of a first-order hold, and what waveform does it produce? ::@:: A convenient causal description is $h_{\mathrm{FOH}}(t)=\Lambda((t-T)/T)$, a delayed triangular kernel of width $2T$. It produces piecewise linear segments connecting adjacent sample values. <!--SR:!2026-07-25,72,337!2026-07-18,64,310-->
...
- How should you draw the anti-aliasing block diagram? ::@:: Draw $x(t)$ entering a block labeled _LPF (anti-aliasing filter)_, then a sampler block, and finally the discrete-time output $x_d[n]$. The LPF must appear before sampling. <!--SR:!2026-07-27,74,329!2026-07-18,64,310-->
