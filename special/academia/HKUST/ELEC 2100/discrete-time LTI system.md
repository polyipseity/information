...
- How is zero-state response mapped to difference-equation solution pieces? ::@:: Zero-state response is obtained by solving the forced difference equation with zero initial samples, so it is the response caused only by the external input. <!--SR:!fsrs,2027-07-25T00:00:00.000Z,368,368.01119375,1,2,7,0,0,2026-07-22T00:00:00.000Z!2026-07-28,78,344-->
...
- How is the running-sum term computed in the interconnected system with $h_1[n]=(1/2)^n u[n+2]$ and $u[n-1]$? ::@:: For $n\ge -1$, one gets $(h_1*u[n-1])[n]=\sum_{m=-2}^{n-1}(1/2)^m=8-2^{-(n-1)}$ by evaluating a finite geometric series. <!--SR:!2026-08-10,69,326!2026-07-28,56,319-->
