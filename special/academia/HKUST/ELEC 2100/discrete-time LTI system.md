...
- How is the initial sample $h[0]$ found in the impulse-response equation $h[n]-0.8h[n-1]=\delta[n]$? ::@:: Set $n=0$ to get $h[0]-0.8h[-1]=1$; zero state gives $h[-1]=0$, so $h[0]=1$. <!--SR:!2026-07-16,61,310!2026-08-22,81,339-->
