...
- Worked example: For the causal system $y[n]-0.8y[n-1]=x[n]$, what is the unit impulse response? ::@:: Step 1: set $x[n]=\delta[n]$ to get $h[n]-0.8h[n-1]=\delta[n]$. <br/> Step 2: at $n=0$, zero state gives $h[-1]=0$, so $h[0]=1$. <br/> Step 3: for $n>0$, the recursion becomes homogeneous: $h[n]-0.8h[n-1]=0$. <br/> Step 4: solve the homogeneous part with $h_h[n]=r^n$, giving $r-0.8=0$ and hence $h_h[n]=C(0.8)^n$. <br/> Step 5: by substituting the initial condition $h[0]=1$, this becomes $h[n]=(0.8)^n$ for $n\ge 0$; for $n<0$ we already know the zero-state response is $0$, so finally $h[n]=(0.8)^n u[n]$. <!--SR:!2026-08-10,69,326!2026-07-18,63,310-->
- In the first-order recursion example, what does the impulse $\delta[n]$ do conceptually? ::@:: It acts only at the single sample $n=0$, where it creates the initial sample of the impulse response; after that, the later samples evolve under the homogeneous recursion alone. <!--SR:!2026-07-18,68,326!fsrs,2027-01-09T00:00:00.000Z,204,203.8494622,1.98030797,2,6,0,0,2026-06-19T00:00:00.000Z-->
