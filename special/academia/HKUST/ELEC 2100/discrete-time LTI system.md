...
- Worked example: Given $y[n]=0.9y[n-1]+u[n]$ with $y[-1]=0$, what are the first four output samples $y[0]$, $y[1]$, $y[2]$, and $y[3]$? ::@:: Step 1: $y[0]=0.9y[-1]+u[0]=0.9(0)+1=1$. <br/> Step 2: $y[1]=0.9y[0]+u[1]=0.9(1)+1=1.9$. <br/> Step 3: $y[2]=0.9y[1]+u[2]=0.9(1.9)+1=2.71$. <br/> Step 4: $y[3]=0.9y[2]+u[3]=0.9(2.71)+1=3.439$. <!--SR:!2026-07-20,70,326!fsrs,2027-05-20T00:00:00.000Z,313,312.84164192,1,2,7,0,0,2026-07-11T00:00:00.000Z-->
