...
- Why is the sign of $a$ important in a one-sided exponential sequence? ::@:: A negative base causes the sample sign to flip at every index, not just once. <!--SR:!2026-04-10,4,270!2026-04-10,4,270-->
...
- What is decimation of a discrete-time sequence? ::@:: For a positive integer $N$, decimation keeps the samples whose original indices are multiples of $N$, producing the sequence $x[Nn]$. <!--SR:!2026-04-10,4,270!2026-04-10,4,270-->
- What does decimation by a factor of $2$ do? ::@:: It keeps only the even-indexed samples of the original sequence. <!--SR:!2026-04-10,4,270!2026-04-10,4,270-->
- What is interpolation in the zero-insertion sense? ::@:: It places the original sample values at indices that are multiples of the interpolation factor and fills the new intermediate indices with zeros. <!--SR:!2026-04-09,3,250!2026-04-10,4,270-->
- Why are decimation and interpolation different from ordinary shifting or scaling? ::@:: They alter the sampling pattern itself rather than merely changing sample values or moving already existing sample positions. <!--SR:!2026-04-10,4,270!2026-04-10,4,270-->
- In zero-insertion interpolation by factor $2$, where do the original samples go? ::@:: They stay at the even indices of the new sequence, while the odd indices are filled with zeros. <!--SR:!2026-04-09,3,250!2026-04-10,4,270-->
