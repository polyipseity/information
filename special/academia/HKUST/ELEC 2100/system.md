...
- Why are the telegraph, telephone, and later communication-technology examples more than decorative history? ::@:: They show that systems theory is motivated by real engineered mechanisms whose performance depends on how signals are encoded, transmitted, filtered, and recovered. <!--SR:!fsrs,2027-05-16T00:00:00.000Z,304,304.30256839,1,2,7,0,0,2026-07-16T00:00:00.000Z!2026-07-19,65,310-->
...
- Which example systems are causal? ::@:: $y(t)=2x(t-1)+1$ (affine delay), $y(t)=\cos(x(t))$ (pointwise cosine), and $y[n]=\max\{x[n],x[n-1]\}$ (windowed maximum) are all causal because they use only present or past samples. <!--SR:!2026-07-19,65,310!fsrs,2027-05-05T00:00:00.000Z,296,295.72812302,1,2,7,0,0,2026-07-13T00:00:00.000Z-->
...
- What is the LTI impulse-response test for BIBO stability? ::@:: For an LTI system, a key sufficient and standard recognition test is absolute integrability of the impulse response: if $\int_{-\infty}^{\infty}|h(t)|\,dt<\infty$, then bounded inputs stay bounded. <!--SR:!2026-07-20,66,310!2026-07-19,65,310-->
