...
- Why is the backward form $y[n]=x[n]+ay[n-1]$ preferred over the forward form $y[n+1]=x[n+1]+ay[n]$ for implementation? ::@:: The two forms are mathematically equivalent, because the forward form is obtained from the backward form by replacing $n$ with $n+1$. But $y[n]=x[n]+ay[n-1]$ is preferred for implementation because it computes the present output directly from the present input and the previously stored output, so it is already in the most convenient causal real-time form. <!--SR:!fsrs,2027-07-11T00:00:00.000Z,355,355.25290839,1,2,7,0,0,2026-07-21T00:00:00.000Z!2026-07-28,73,330-->
