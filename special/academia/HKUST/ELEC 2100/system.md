...
- Why is the systems viewpoint central in ELEC 2100? ::@:: It connects signal descriptions to later transform-based analysis of linear time-invariant systems. <!--SR:!2026-07-15,62,310!2026-07-08,56,310-->
...
- What do block diagrams contribute beyond equations? ::@:: They show the structural interconnection of elementary operations inside the system. <!--SR:!2026-07-10,58,310!2026-07-14,61,310-->
...
- What are standard examples of lumped and distributed systems? ::@:: A low-frequency RLC circuit is a standard lumped example, whereas a transmission line or waveguide is a standard distributed example. <!--SR:!2026-07-15,61,310!2026-07-10,58,310-->
...
- What is invertibility? ::@:: A system is invertible if different inputs produce different outputs, so an inverse system can recover the original input from the output. <!--SR:!2026-07-08,56,310!2026-07-09,57,310-->
...
- Which example systems are linear despite other failures? ::@:: $y(t)=\tfrac12(x(t)+x(-t))$ (even-part operator) and $y[n]=n\,x[2n]$ (scaled-index rule) are linear because averaging, fixed scaling, and reindexing still preserve superposition even though other system properties fail. <!--SR:!2026-07-15,62,310!2026-07-06,54,310-->
...
- What do causality and boundedness ask? ::@:: Causality asks whether future input is needed, whereas boundedness asks whether bounded input always produces bounded output. <!--SR:!2026-07-10,58,310!2026-07-12,59,310-->
...
- What is causality? ::@:: A system is causal if the output at time $t$ depends only on input values at times $\tau\le t$ and never on future input values. <!--SR:!2026-07-16,63,310!2026-07-10,58,310-->
- What is the impulse-response test for causality? ::@:: In a linear kernel description, causality means $h(t,\tau)=0$ for $\tau>t$; for an LTI system this becomes $h(t)=0$ for negative time. <!--SR:!2026-07-08,56,310!2026-07-14,61,310-->
...
- What is the noncausal counterexample in input-output and impulse-response form? ::@:: Counterexample: $y(t)=x(t+2)$. Impulse-response form: $h(t)=\delta(t+2)$. The negative-time support means the output depends on future input. <!--SR:!2026-07-08,56,310!2026-07-12,59,310-->
...
- What is the rigorous definition of BIBO stability? ::@:: A system is BIBO stable if whenever there exists a finite constant $M_x$ with $|x(t)|\le M_x$ for all $t$ or $|x[n]|\le M_x$ for all $n$, there also exists a finite constant $M_y$ such that $|y(t)|\le M_y$ for all $t$ or $|y[n]|\le M_y$ for all $n$. <!--SR:!2026-07-10,58,310!2026-07-13,60,310-->
...
- What is the stable example in input-output and impulse-response form? ::@:: Example: $y(t)=\int_{-\infty}^{t} e^{-(t-\tau)}x(\tau)\,d\tau$. Impulse-response form: $h(t)=e^{-t}u(t)$. Its total impulse-response area is finite, so bounded inputs give bounded outputs. <!--SR:!2026-07-16,63,310!2026-07-06,54,310-->
- What is the unstable counterexample in input-output and impulse-response form? ::@:: Counterexample: $y(t)=\int_{-\infty}^{t}x(\tau)\,d\tau$. Impulse-response form: $h(t)=u(t)$. The bounded input $x(t)=u(t)$ produces the unbounded ramp $y(t)=tu(t)$, so the system is not BIBO stable. <!--SR:!2026-07-20,66,310!2026-07-10,58,310-->
- What is the rigorous intuition behind BIBO stability? ::@:: BIBO stability means every finite-amplitude input cage is sent into some finite-amplitude output cage; the output bound may change with the input, but it must remain finite. <!--SR:!2026-07-10,58,310!2026-07-14,61,310-->
...
- What is the time-varying unstable example? ::@:: The non-LTI system $y[n]=(n+1)x[n]$ is not BIBO stable because the bounded input $x[n]\equiv 1$ gives $y[n]=n+1$, which is unbounded. <!--SR:!2026-07-14,61,310!2026-07-08,56,310-->
- Which systems are BIBO stable in the comparison set? (affine delay, bounded cosine, averaging, windowed maximum, bounded exponential, integrator, $(n+1) \cdot$) ::@:: $y(t)=2x(t-1)+1$ (affine delay), $y(t)=\cos(x(t))$ (bounded cosine), $\tfrac12(x(t)+x(-t))$ (averaging), $\max\{x[n],x[n-1]\}$ (windowed maximum), and $y[n]=e^{x[n]}$ (bounded exponential when bounded inputs given) are all BIBO stable. <!--SR:!2026-07-10,58,310!2026-07-16,63,310-->
...
- What is the response-transfer principle for an LTI system? ::@:: If an LTI system maps $x_1$ to $y_1$, then shifted and linearly combined versions of $x_1$ map to the corresponding shifted and linearly combined versions of $y_1$. <!--SR:!2026-07-15,62,310!2026-07-06,54,310-->
...
- What is the state-variable viewpoint? ::@:: It tracks both the overall response and internal variables such as capacitor voltages or inductor currents. <!--SR:!2026-07-06,54,310!2026-07-09,57,310-->
...
- What part of the response is the natural target of convolution in both continuous and discrete time? ::@:: The zero-state part, because it isolates the externally driven response under zero stored initial state. <!--SR:!2026-07-06,54,310!2026-07-13,60,310-->
- How should the main response topics be distributed across the ELEC 2100 notes? ::@:: `system.md` keeps the vocabulary and modelling roadmap, `continuous-time LTI system.md` and `discrete-time LTI system.md` carry the detailed response logic, and `convolution.md` carries the zero-state assembly method. <!--SR:!2026-07-09,57,310!2026-07-08,56,310-->
