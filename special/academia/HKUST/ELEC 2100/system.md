...
- What is the standard mathematical model for many discrete-time systems? ::@:: A difference equation. <!--SR:!2026-07-20,66,310!fsrs,2027-05-26T00:00:00.000Z,313,312.84164192,1,2,7,0,0,2026-07-17T00:00:00.000Z-->
...
- What is the LTI impulse-response test for BIBO stability? ::@:: For an LTI system, a key sufficient and standard recognition test is absolute integrability of the impulse response: if $\int_{-\infty}^{\infty}|h(t)|\,dt<\infty$, then bounded inputs stay bounded. <!--SR:!2026-07-20,66,310!fsrs,2027-06-06T00:00:00.000Z,321,321.346657,1,2,7,0,0,2026-07-20T00:00:00.000Z-->
...
- What is the unstable counterexample in input-output and impulse-response form? ::@:: Counterexample: $y(t)=\int_{-\infty}^{t}x(\tau)\,d\tau$. Impulse-response form: $h(t)=u(t)$. The bounded input $x(t)=u(t)$ produces the unbounded ramp $y(t)=tu(t)$, so the system is not BIBO stable. <!--SR:!2026-07-20,66,310!fsrs,2027-04-28T00:00:00.000Z,291,291.42724554,1,2,7,0,0,2026-07-11T00:00:00.000Z-->
...
- What are the main ways to represent an LTI system when trying to obtain its response? ::@:: The main representations are differential equations, system functions via Laplace transformation, unit impulse responses, and structural descriptions such as block diagrams. <!--SR:!2026-07-20,67,330!2026-07-20,67,330-->
