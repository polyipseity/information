...
- How are $y[n]=x[n]+ay[n-1]$ and $y[n+1]=x[n+1]+ay[n]$ related? ::@:: They are the same first-order recursion written with different time indices. Replacing $n$ by $n+1$ in $y[n]=x[n]+ay[n-1]$ gives $y[n+1]=x[n+1]+ay[n]$, so the two equations are mathematically equivalent. <!--SR:!fsrs,2027-07-11T00:00:00.000Z,355,355.25290839,1,2,7,0,0,2026-07-21T00:00:00.000Z!2026-07-31,76,330-->
