...
- What is the lumped-versus-distributed distinction? ::@:: Lumped systems depend only on time and are usually modeled by ordinary differential equations, whereas distributed systems depend on both time and space and are usually modeled by partial differential equations. <!--SR:!2026-07-21,67,310!2026-07-18,64,310-->
...
- What is the time-varying counterexample in input-output and impulse-response form? ::@:: Counterexample: $y(t)=\cos(\omega_0 t)x(t)$. Kernel form: $h(t,\tau)=\cos(\omega_0 t)\delta(t-\tau)$. Because the coefficient depends on absolute time, the system law changes with the clock and the shift test fails. <!--SR:!2026-07-18,64,310!fsrs,2027-05-26T00:00:00.000Z,313,312.84164192,1,2,7,0,0,2026-07-17T00:00:00.000Z-->
...
- Which example systems are time invariant? ::@:: $y(t)=2x(t-1)+1$ (affine delay), $y(t)=\cos(x(t))$ (pointwise cosine), and $y[n]=\max\{x[n],x[n-1]\}$ (windowed maximum) are all time invariant because the same algebraic rule applies at every absolute time. <!--SR:!2026-07-18,64,310!fsrs,2027-05-10T00:00:00.000Z,300,300.01984473,1,2,7,0,0,2026-07-14T00:00:00.000Z-->
...
- What is the intuition behind causality? ::@:: Causal means the system can react only after information arrives; noncausal means some part of the rule reaches into the future. <!--SR:!fsrs,2027-05-15T00:00:00.000Z,304,304.30256839,1,2,7,0,0,2026-07-15T00:00:00.000Z!2026-07-18,64,310-->
