...
- How do you derive $\sin a\cos b=\frac12[\sin(a+b)+\sin(a-b)]$ step by step? ::@:: Replace $\sin a$ by $\frac{1}{2j}(e^{ja}-e^{-ja})$ and $\cos b$ by $\frac12(e^{jb}+e^{-jb})$, expand, group the $\pm(a+b)$ and $\pm(a-b)$ pairs, and convert each pair back into a sine. The result is $\frac12[\sin(a+b)+\sin(a-b)]$. <!--SR:!2026-08-18,76,330!2026-07-18,63,310-->
