...
- What is the most important geometric picture to remember for AM-SC in frequency? ::@:: The baseband spectrum is copied twice and shifted to be centered at $+\omega_0$ and $-\omega_0$, with each copy scaled by $1/2$.
...
- Why is the BPF an essential extra block in demultiplexing? ::@:: Because before demodulation the receiver must first isolate one channel band from the multiplexed composite spectrum; otherwise the product detector would mix several channels at once.
...
- What is the big engineering lesson of modulation in one sentence? ::@:: Modulation is not just multiplication by a carrier; it is frequency translation plus filtering plus spectral shaping so information fits a crowded channel cleanly.
