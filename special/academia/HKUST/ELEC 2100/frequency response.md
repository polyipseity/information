...
- How are the time-domain and frequency-domain zero-state viewpoints related? ::@:: Same law, different coordinates: $y(t)=x*h$ versus $Y(\omega)=H(\omega)X(\omega)$.
- When is convolution more natural, when is frequency response more natural? ::@:: Convolution for support, overlap, delays, and transients; frequency response for amplification, attenuation, and phase shift of each component.
- What bridges convolution and frequency response? ::@:: $H(\omega)=\mathcal{F}\{h(t)\}$.
