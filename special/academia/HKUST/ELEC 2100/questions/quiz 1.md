...
4. Among a time-scaled CT rule, a running sum, an even-part operator, and a one-sample delay, which option has the usual causal-and-stable signature? ::@:: The one-sample delay is the standard safe choice because it uses only a past input value and preserves boundedness. <!--SR:!fsrs,2027-04-13T00:00:00.000Z,278,278.46760619,1,2,7,0,0,2026-07-09T00:00:00.000Z!2026-07-13,58,310-->
5. For a unit-area pulse with width $\varepsilon$ and height $1/\varepsilon$, what energy trend should you expect? ::@:: Its energy scales like $1/\varepsilon$, so it blows up as the pulse approaches a CT impulse. <!--SR:!2026-07-22,67,310!2026-07-09,56,310-->
