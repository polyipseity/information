...
- What is a random signal? ::@:: A random signal is described statistically and cannot be predicted pointwise in advance. <!--SR:!2026-05-19,17,316!2026-07-17,61,314-->
...
- What is the difference between a discrete-time signal and a digital signal? ::@:: A discrete-time signal becomes digital only when its amplitude is also quantized, so discrete-time and digital are not synonymous. <!--SR:!2026-07-20,64,314!2026-05-19,17,316-->
...
- Why are signal classifications called parallel rather than hierarchical? ::@:: Labels such as deterministic, continuous-time, periodic, and one-dimensional answer different questions and may all apply to the same signal simultaneously. <!--SR:!2026-05-19,17,316!2026-07-17,61,314-->
...
- Worked example (method: ramp-sum identification): Given $x(t)=\cos 10t+\cos 30t$, what is the fundamental period? ::@:: Step 1: compute the component periods $T_1=2\pi/10=\pi/5$ and $T_2=2\pi/30=\pi/15$. <br/> Step 2: look for the smallest common positive multiple. <br/> Step 3: since $\pi/5=3(\pi/15)$, the common fundamental period is $\pi/5$. <!--SR:!2026-07-18,62,314!2026-05-18,16,294-->
...
- Worked example (method: irrationality proof): Why is $x(t)=\cos\!\bigl((2\pi/4)t\bigr)+\sin\!\bigl((2/3)t\bigr)$ aperiodic? ::@:: Step 1: the component periods are $4$ and $3\pi$. <br/> Step 2: a common period would need to be a common positive multiple of both. <br/> Step 3: because $4/(3\pi)$ is irrational, no finite common positive multiple exists. <br/> Step 4: therefore the sum is aperiodic. <!--SR:!2026-07-13,57,310!2026-05-19,17,316-->
- What is the continuous-time energy formula for a signal $x(t)$? ::@:: It is $E=\int_{-\infty}^{\infty}|x(t)|^2\,dt$. <!--SR:!2026-07-15,59,314!2026-05-19,17,314-->
...
- Given the real exponential family $x(t)=Ae^{\alpha t}$, how does the sign of $\alpha$ affect its behavior? ::@:: It decays when $\alpha<0$, grows when $\alpha>0$, and becomes a constant when $\alpha=0$. <!--SR:!2026-05-18,16,294!2026-07-20,64,314-->
...
- Given a sinusoid such as $A\sin(\omega t+\theta)$ or $A\cos(\omega t+\theta)$, what parameters characterize it? ::@:: It is characterized by amplitude, angular frequency, and initial phase. <!--SR:!2026-07-20,64,314!2026-05-18,16,294-->
- Given a sinusoid with angular frequency $\omega>0$, how are its ordinary frequency and period related to $\omega$? ::@:: They satisfy $f=\omega/(2\pi)$ and $T=2\pi/\omega$. <!--SR:!2026-07-14,58,314!2026-05-18,16,294-->
...
- Given the signal family $Ke^{st}$ with $s=\sigma+j\omega$, what kind of object is it? ::@:: It is a complex exponential with complex frequency $s=\sigma+j\omega$. <!--SR:!2026-07-20,64,314!2026-07-12,59,314-->
- In the complex exponential $Ke^{(\sigma+j\omega)t}$, what do $\sigma$ and $\omega$ control? ::@:: $\sigma$ controls growth or decay, while $\omega$ controls oscillation. <!--SR:!2026-05-19,17,316!2026-07-16,60,314-->
...
- What are the main qualitative properties of $\operatorname{Sa}(t)$? ::@:: It is even, has zeros at $\pm n\pi$ for integers $n\ge 1$, and decays toward $0$ as $|t|\to\infty$. <!--SR:!2026-07-16,60,314!2026-07-12,59,314-->
...
- Why is the sampling signal a natural interpolation kernel? ::@:: Its shifted copies can be large at one sampling location while vanishing at neighboring ideal zero locations. <!--SR:!2026-05-18,17,316!2026-07-24,68,314-->
...
- What is the substitution trick for input transformations? ::@:: Introduce one substitution at a time and interpret each intermediate expression literally until the desired transformed argument is reached. <!--SR:!2026-05-18,16,294!2026-07-16,60,314-->
...
- How is $\operatorname{atan2}$ interpreted geometrically in complex-number language? ::@:: It is the directed angle from the positive real axis to the vector ending at $(x,y)$, i.e., the phase of $x+jy$. <!--SR:!2026-07-18,62,314!2026-05-18,16,294-->
- For a Fourier transform written as $F(\omega)=R(\omega)+jX(\omega)$, what is the robust phase-extraction formula? ::@:: $\phi(\omega)=\operatorname{atan2}(X(\omega),R(\omega))=\operatorname{atan2}(\Im\{F(\omega)\},\Re\{F(\omega)\})$. <!--SR:!2026-07-24,68,314!2026-05-19,17,316-->
...
- How may a complex number be written in rectangular and polar forms? ::@:: It may be written as $z=x+jy$ in rectangular form or $z=re^{j\theta}$ in polar form. <!--SR:!2026-05-18,16,294!2026-07-21,65,310-->
- In the polar form $z=re^{j\theta}$, what do $r$ and $\theta$ represent? ::@:: $r=|z|$ is the magnitude and $\theta=\arg z$ is the phase. <!--SR:!2026-07-18,62,314!2026-05-19,17,316-->
- What is Euler's relation? ::@:: It is $e^{j\theta}=\cos\theta+j\sin\theta$. <!--SR:!2026-05-19,17,316!2026-05-19,17,316-->
- How can $\cos(\omega t)$ be written using complex exponentials? ::@:: $\cos(\omega t)=\frac{e^{j\omega t}+e^{-j\omega t}}{2}$. <!--SR:!2026-07-19,63,314!2026-05-19,17,316-->
...
- For a periodic sequence, what makes the period fundamental? ::@:: The fundamental period is the smallest positive integer sample-index shift that reproduces the sequence. <!--SR:!2026-07-20,64,314!2026-05-18,16,294-->
