...
- In the MATLAB fragment `freq = f(A, B); t_idx = t0:dt:t1; x = 3 .* exp(-2j*pi*freq*t_idx);`, why do parameter digits such as $A$ and $B$ matter? ::@:: Because they determine quantities such as the oscillation frequency and therefore affect the sampled waveform and the meaningful plotting interval rather than merely renaming a fixed example. <!--SR:!fsrs,2027-05-31T00:00:00.000Z,304,304.30256839,1,2,7,0,0,2026-07-31T00:00:00.000Z!fsrs,2027-05-18T00:00:00.000Z,304,304.30256839,1,2,7,0,0,2026-07-18T00:00:00.000Z-->
- In the MATLAB fragment `freq = f(A, B); t_idx = t0:dt:t1; x = 3 .* exp(-2j*pi*freq*t_idx);`, which quantities in that setup must be settled before any plot is meaningful? ::@:: The parameter-controlled frequency and the sampled time grid must be settled first, because they determine how the complex exponential is sampled and interpreted. <!--SR:!fsrs,2027-05-13T00:00:00.000Z,300,300.01984473,1,2,7,0,0,2026-07-17T00:00:00.000Z!fsrs,2027-04-26T00:00:00.000Z,287,287.11697064,1,2,7,0,0,2026-07-13T00:00:00.000Z-->
- In the MATLAB fragment `x = 3 .* exp(-2j*pi*freq*t_idx)`, why is `exp(-2j*pi*freq*t_idx)` a natural form for the complex waveform? ::@:: Because it keeps the oscillation frequency and the complex phase rotation in one expression, so real part, imaginary part, magnitude, and phase can all be read from the same sampled array. <!--SR:!fsrs,2027-04-10T00:00:00.000Z,274,274.1280869,1,2,7,0,0,2026-07-10T00:00:00.000Z!fsrs,2027-04-15T00:00:00.000Z,278,278.46760619,1,2,7,0,0,2026-07-11T00:00:00.000Z-->
- After the MATLAB code plots `real(x)`, `imag(x)`, `abs(x)`, and `angle(x)` for the same array `x`, why must those four views be read together? ::@:: Because they are coordinated descriptions of the same parameter-dependent complex waveform, so none of the plots alone tells the whole story about the sampled signal. <!--SR:!fsrs,2027-07-04T00:00:00.000Z,330,329.81882824,1,2,7,0,0,2026-08-08T00:00:00.000Z!fsrs,2027-07-02T00:00:00.000Z,330,329.81882824,1,2,7,0,0,2026-08-06T00:00:00.000Z-->
...
- In the MATLAB fragment `roi = img(r1:r2, c1:c2, :)`, what must a geometric rule become before the image region can be extracted correctly? ::@:: It must become the correct row and column index ranges on the image array, because those ranges specify which sampled pixels belong to the chosen region. <!--SR:!fsrs,2027-05-13T00:00:00.000Z,300,300.01984473,1,2,7,0,0,2026-07-17T00:00:00.000Z!fsrs,2027-04-15T00:00:00.000Z,278,278.46760619,1,2,7,0,0,2026-07-11T00:00:00.000Z-->
- In the MATLAB fragment `roi = img(r1:r2, c1:c2, :)`, why are the row limits `r1:r2` and column limits `c1:c2` part of the mathematics rather than just coding syntax? ::@:: Because they specify the actual support of the chosen image region, so changing them changes which sampled data belong to the extracted patch. <!--SR:!fsrs,2027-06-02T00:00:00.000Z,304,304.30256839,1,2,7,0,0,2026-08-02T00:00:00.000Z!fsrs,2027-04-15T00:00:00.000Z,278,278.46760619,1,2,7,0,0,2026-07-11T00:00:00.000Z-->
- In MATLAB, why does `red(:,:,2:3) = 0` isolate the red component? ::@:: Because the second and third slices are the green and blue channels, so zeroing them leaves only the first-channel red contribution visible. <!--SR:!fsrs,2027-04-21T00:00:00.000Z,283,282.79716409,1,2,7,0,0,2026-07-12T00:00:00.000Z!fsrs,2027-05-08T00:00:00.000Z,296,295.72812302,1,2,7,0,0,2026-07-16T00:00:00.000Z-->
- Once the MATLAB code has formed `roi = img(r1:r2, c1:c2, :)` and then `red(:,:,2:3) = 0`, why does region indexing naturally lead to RGB inspection and red-channel extraction? ::@:: Because once the image is treated as sampled array data on a chosen support, channel values can be measured and separated directly instead of being treated as undifferentiated picture content. <!--SR:!fsrs,2027-05-13T00:00:00.000Z,300,300.01984473,1,2,7,0,0,2026-07-17T00:00:00.000Z!fsrs,2027-06-18T00:00:00.000Z,317,317.09832588,1,2,7,0,0,2026-08-05T00:00:00.000Z-->
