...
- In the MATLAB fragment `roi = img(r1:r2, c1:c2, :)`, what must a geometric rule become before the image region can be extracted correctly? ::@:: It must become the correct row and column index ranges on the image array, because those ranges specify which sampled pixels belong to the chosen region. <!--SR:!2026-05-17,15,290!2026-07-10,55,310-->
...
- In MATLAB, why does `red(:,:,2:3) = 0` isolate the red component? ::@:: Because the second and third slices are the green and blue channels, so zeroing them leaves only the first-channel red contribution visible. <!--SR:!2026-07-11,56,310!2026-05-17,15,290-->
