...
- In the MATLAB fragment `roi = img(r1:r2, c1:c2, :)`, what must a geometric rule become before the image region can be extracted correctly? ::@:: It must become the correct row and column index ranges on the image array, because those ranges specify which sampled pixels belong to the chosen region. <!--SR:!2026-07-16,60,310!2026-07-10,55,310-->
- In the MATLAB fragment `roi = img(r1:r2, c1:c2, :)`, why are the row limits `r1:r2` and column limits `c1:c2` part of the mathematics rather than just coding syntax? ::@:: Because they specify the actual support of the chosen image region, so changing them changes which sampled data belong to the extracted patch. <!--SR:!2026-08-01,61,310!2026-07-10,55,310-->
