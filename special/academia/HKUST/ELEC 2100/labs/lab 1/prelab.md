...
- In the MATLAB fragment `img = imread('image1.jpg'); pixel = img(r, c, :); patch = img(r1:r2, c1:c2, :)`, how should the color image be modeled mathematically? ::@:: It should be modeled as a sampled multidimensional signal whose indices are row, column, and color channel. <!--SR:!2026-07-09,56,310!2026-07-17,62,310-->
