...
- Why place datatips on the frequency response exactly at the tone frequencies present in the input spectrum? ::@:: Because the frequency-response plot becomes most useful when it is read at the exact tone frequencies present in the input, so the gain applied to each actual spectral line can be interpreted directly. <!--SR:!2026-07-09,60,310!fsrs,2027-04-20T00:00:00.000Z,287,287.11697064,1,2,7,0,0,2026-07-07T00:00:00.000Z-->
...
- Why is a one-cosine output a good sanity check after the response analysis predicts that only one in-band tone survives? ::@:: Because the response analysis predicted that only the in-band spectral line should remain, so the time-domain waveform should collapse from a three-tone mixture to one dominant sinusoid. <!--SR:!fsrs,2027-04-02T00:00:00.000Z,274,274.1280869,1,2,7,0,0,2026-07-02T00:00:00.000Z!2026-07-09,60,310-->
