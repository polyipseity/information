...
- If a centered DFT frequency axis is built as `((0:N-1) - floor(N/2)) .* fs ./ N` and a record has $f_s = N = 100000$, why are the spectral peaks readable directly in hertz? ::@:: Because the bin spacing is $f_s/N = 1\,\text{Hz}$, so each shifted DFT bin already lines up with an integer-hertz frequency label. <!--SR:!2026-07-14,67,310!fsrs,2027-04-25T00:00:00.000Z,291,291.42724554,1,2,7,0,0,2026-07-08T00:00:00.000Z-->
