...
- Why does MATLAB's `butter` call use cutoff frequencies in the form `2f_c/fs` rather than raw hertz? ::@:: Because MATLAB's digital Butterworth design expects frequencies normalized by the Nyquist frequency, so multiplying by `2 / fs` converts hertz into that normalized scale. <!--SR:!2026-07-16,67,310!2026-07-13,66,310-->
