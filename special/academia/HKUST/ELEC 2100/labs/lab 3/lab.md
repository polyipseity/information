...
- If the original three-tone mixture contains $400\,\text{Hz}$, $5000\,\text{Hz}$, and $16000\,\text{Hz}$, why does the filtered output collapse to one dominant cosine when only the middle tone lies inside the passband? ::@:: Because the designed band-pass keeps the middle $5000\,\text{Hz}$ component while strongly attenuating the lower $400\,\text{Hz}$ and higher $16000\,\text{Hz}$ components. <!--SR:!2026-07-12,65,310!fsrs,2027-05-01T00:00:00.000Z,296,295.72812302,1,2,7,0,0,2026-07-09T00:00:00.000Z-->
