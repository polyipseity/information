...
- A spectrum has visible positive-frequency lines at $400\,\text{Hz}$, $5000\,\text{Hz}$, and $16000\,\text{Hz}$. Why can the fundamental still be $200\,\text{Hz}$ even though $200\,\text{Hz}$ is absent? ::@:: Because the three visible lines are all integer multiples of $200\,\text{Hz}$, so $200\,\text{Hz}$ is their greatest common divisor and therefore the true fundamental spacing even though that line itself is missing. <!--SR:!2026-07-11,62,310!2026-07-15,66,310-->
...
- Why inspect both magnitude and phase datatips instead of magnitude alone when predicting a filtered sinusoid? ::@:: Because one needs both the attenuation information and the phase-shift information to explain the final filtered waveform in the time domain. <!--SR:!2026-07-11,62,310!2026-07-16,67,310-->
