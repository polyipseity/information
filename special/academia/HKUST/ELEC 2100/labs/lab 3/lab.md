...
- Why is a one-cosine output a good sanity check after the response analysis predicts that only one in-band tone survives? ::@:: Because the response analysis predicted that only the in-band spectral line should remain, so the time-domain waveform should collapse from a three-tone mixture to one dominant sinusoid. <!--SR:!2026-07-01,54,310!2026-07-09,60,310-->
