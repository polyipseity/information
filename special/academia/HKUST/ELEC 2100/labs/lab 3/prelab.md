...
- In the Lab 3 MATLAB normalization `Wlow = flow * 2 / fs`, why is the physical cutoff multiplied by `2 / fs` before being passed to `butter`? ::@:: Because MATLAB expects the cutoff in units normalized by the Nyquist frequency, so multiplying by `2 / fs` converts a cutoff expressed in hertz into the digital frequency scale required by the design function. <!--SR:!2026-07-30,76,329!2026-07-28,74,329-->
