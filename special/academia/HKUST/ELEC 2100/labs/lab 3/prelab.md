...
- When the MATLAB code plots `fftshift(abs(Xk))`, what frequency grid must be paired with it for an even-length record? ::@:: It must be paired with a centered grid such as `(-N/2:N/2-1) * fs/N`, so each shifted FFT bin is shown at its correct physical frequency. <!--SR:!2026-07-21,68,317!2026-07-22,69,317-->
- In the MATLAB fragment `f_shift = (-N/2:N/2-1) * fs/N`, why does the factor `fs/N` convert bin numbers into physical frequency? ::@:: Because adjacent DFT bins are separated by one cycle per record, which equals `fs/N` hertz for a record of `N` samples taken at sampling rate `fs`. <!--SR:!fsrs,2027-06-11T00:00:00.000Z,326,325.58679272,1,2,7,0,0,2026-07-20T00:00:00.000Z!2026-07-21,68,317-->
