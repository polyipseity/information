...
- In this Lab 2 sequence example, what does the sparse-impulse pattern determine before any numeric computation is performed? ::@:: It determines how many shifted copies of the rectangle appear and where they overlap, so the support geometry of the final impulse response is understood before numerical evaluation. <!--SR:!2026-07-11,61,310!2026-07-13,63,310-->
...
- Before the MATLAB code filters the image with `H`, what can the sign pattern and weight distribution of that composite mask already tell you? ::@:: They can already suggest whether the filter should behave more like averaging, differencing, or local contrast emphasis, so the visible effect should not be a surprise. <!--SR:!2026-07-13,63,310!2026-07-11,61,310-->
