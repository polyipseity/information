...
- In the MATLAB fragment `convn(double(img), H, 'same')`, why is `'same'` a natural choice for the image part of the lab? ::@:: Because the filtered array has to remain on the same image grid as the original if the visual effect is going to be compared directly pixel by pixel. <!--SR:!2026-07-08,58,310!2026-07-04,54,310-->
