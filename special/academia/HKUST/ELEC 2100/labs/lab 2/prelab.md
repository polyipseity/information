...
- Why does the MATLAB code convert the filtered array with `uint8(y_box)` before display? ::@:: Because convolution often produces a floating-point array, while ordinary image display and storage usually expect standard image-valued integer data. <!--SR:!2026-07-21,48,290!2026-07-12,58,310-->
