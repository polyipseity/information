...
- [descriptive statistics](../../../../general/descriptive%20statistics.md)
  ...
  - percentile, quantile (not quartile) ::: percentile, quantile: the number for which a specified portion of the population is _equal to or less than_ (e.g. 90th percentile = 0.90 quantile, which means the number 90% of the population is equal to or less than)
...
- [data presentation](../../../../general/data%20and%20information%20visualization.md)
  ...
  - frequency table (qualitative) ::: Categorical data is already pre-grouped. Then a _summary table_ is drawn based on the categories. This condenses the data and allows for quicker data interpretation.
    - frequency table (qualitative) / table headers ::: \<variable name\>, count, cumulative count (if ordinal), percent. cumulative percent (if ordinal)
...
- [sampling](../../../../general/sampling%20(statistics).md) ::: The act of creating a _sample_ from a _population_. It can be mainly classified into _probability sampling_ and _non-probability sampling_.
  - sampling / [errors](../../../../general/sampling%20(statistics).md#errors%20in%20sample%20surveys) ::: It is very important to sample correctly. Some biases include survivorship bias (as demonstration, unlikely related in most statistics), selection bias, non-response bias (participation bias), and voluntary response bias.
    ...
    - sampling / errors / selection bias ::: A sample of convenience that makes it more likely to sample certain subjects than other.
  ...
  - [non-probability sampling](../../../../general/sampling%20(statistics).md#nonprobability%20sampling) ::: It supports a weaker statistical inferences from a sample to the population. The advantage is that non-probability sampling may be more convenient in many contexts.
