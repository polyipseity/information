...
- [simple linear regression](../../../../general/simple%20linear%20regression.md)
  ...
  - simple linear estimator / intercept estimator
    - simple linear estimator / intercept estimator / known error variance ::@:: $$\begin{aligned} \hat \beta_0 & \sim \mathcal N\left(\beta_0, \overline {x^2} \sigma_\varepsilon^2 / S_{XX}\right) \\ (\hat \beta_0 - \beta_0) \sqrt{S_{XX} / \overline {x^2} \sigma_\varepsilon^2} & \sim \mathcal N(0, 1) \end{aligned}$$ <!--SR:!2026-09-11,445,337!2025-08-16,179,357-->
