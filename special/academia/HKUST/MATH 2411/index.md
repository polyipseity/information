...
- [simple linear regression](../../../../general/simple%20linear%20regression.md)
  ...
  - simple linear regression / slope estimator
    - simple linear regression / slope estimator / known error variance ::@:: $$\begin{aligned} \hat \beta_1 & \sim \mathcal N\left(\beta_1, \sigma_\varepsilon^2 / S_{XX}\right) \\ (\hat \beta_1 - \beta_1) \sqrt{S_{XX} / \sigma_\varepsilon^2} & \sim \mathcal N(0, 1) \end{aligned}$$ <!--SR:!2028-05-19,978,377!2025-09-15,199,357-->
