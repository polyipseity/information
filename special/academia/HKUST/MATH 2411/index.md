...
- [descriptive statistics](../../../../general/descriptive%20statistics.md)
  ...
  - [skewness](../../../../general/skewness.md) ::: Intuitively for graphs, a distribution is left-skewed if its tail is on the left, and vice versa for right-skewed. Otherwise, it is unskewed. Intuitively for numbers, a distribution is left-skewed if its mean is smaller than its median, and vice versa for right-skewed. Otherwise, it is unskewed. (But actually, said intuition is very very wrong sometimes... See the item below.)
