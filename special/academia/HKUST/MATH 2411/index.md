...
- [simple linear regression](../../../../general/simple%20linear%20regression.md)
  - simple linear regression / interpretation ::@:: $\beta_1$ can be interpreted as the average increase of $y$ per $x$. Also, the regression line passes through the _center of mass_ point $(\overline x, \overline y)$. <!--SR:!2025-01-14,24,377!2025-04-15,96,377-->
...
- [Fisher transformation](../../../../general/Fisher%20transformation.md) (optional) ::@:: (optional) $$z={1 \over 2}\ln \left({1+r \over 1-r}\right)=\operatorname {artanh} (r) \,,$$ where $r$ is the sample Pearson correlation coefficient. <!--SR:!2025-03-16,67,357!2025-01-14,24,377-->
...
- [simple linear regression](../../../../general/simple%20linear%20regression.md)
  ...
  - simple linear estimator / _R_: hypothesis testing of estimators ::@:: `summary(<model>)`, where `<model>` can be obtained by `lm(<y>~<x>[, data=<dataframe>])`. But note that the null hypothesis are respectively $\beta_0 = 0$ and $\beta_1 = 0$. <!--SR:!2025-01-14,24,377!2025-04-07,89,377-->
