...
- [data presentation](../../../../general/data%20and%20information%20visualization.md) ::@:: A graphical summary can communicate information better as people prefers to look at them rather than numbers. The method of presentation depends on the data _nature_ and visualization _goals_. <!--SR:!2025-04-09,167,310!2026-08-18,536,310-->
  - data presentation / quantitative data ::@:: box plot, frequency table, histogram, line chart, scatter plot, ... <!--SR:!2025-03-27,141,290!2026-05-21,462,310-->
...
- [sampling](../../../../general/sampling%20(statistics).md) ::@:: The act of creating a _sample_ from a _population_. It can be mainly classified into _probability sampling_ and _non-probability sampling_. <!--SR:!2025-04-26,172,310!2025-04-13,166,310-->
  ...
  - [non-probability sampling](../../../../general/sampling%20(statistics).md#nonprobability%20sampling) ::@:: It supports weaker statistical inferences from a sample to the population. The advantage is that non-probability sampling may be more convenient in many contexts. <!--SR:!2025-06-14,211,310!2025-05-30,205,310-->
    ...
    - non-probability sampling / voluntary response sampling ::@:: Individuals in a population are made known of your sample and voluntarily decides to participate or not. <!--SR:!2026-02-14,395,310!2025-03-26,152,310-->
...
- [statistical population](../../../../general/statistical%20population.md) ::@:: It is a set of similar items or events which is of interest for some question or experiment. <p> A statistical population can be a group of existing objects (e.g. the set of all stars within the Milky Way galaxy) or a hypothetical and potentially infinite group of objects conceived as a generalization from experience (e.g. the set of all possible hands in a game of poker). <!--SR:!2025-04-07,90,376!2025-04-12,95,376-->
...
- [interval estimation](../../../../general/interval%20estimation.md)
  ...
  - interval estimation / terminology ::@:: __Random interval__ is the methodology. <p> Given a sample, the calculated random interval is a __confidence interval__ (or if using other methods, it could be __credible interval__, __likelihood interval__, etc. but we will not touch these). <!--SR:!2025-04-06,88,377!2025-05-23,128,397-->
...
- [chi-squared distribution](../../../../general/chi-squared%20distribution.md) ::@:: It with $k$ _degrees of freedom_ is the distribution of a sum of the _squares_ of $k$ _independent standard normal random variables_. It is denoted $\chi^2(k)$ (in this course) or $\chi_k^2$. <!--SR:!2025-04-03,85,377!2025-06-01,136,397-->
  ...
  - chi-squared distribution / statistics ::@:: Let $Y \sim \chi^2(k)$. Then $\operatorname E[Y] = k$ and $\operatorname{Var}(Y) = 2k$. <!--SR:!2025-04-24,98,377!2025-04-08,15,317-->
...
- [simple linear regression](../../../../general/simple%20linear%20regression.md)
  ...
  - simple linear regression / _R_ ::@:: `lm(<y>~<x>)`, `abline(a=<b0>, b=<b1>)`, `abline(lm(<y>~<x>))` <!--SR:!2025-04-04,86,377!2025-04-22,97,377-->
...
- [total sum of squares](../../../../general/total%20sum%20of%20squares.md) (TSS, SST (use in this course)) ::@:: For a set of observations, $y_{i},i\leq n$, it is defined as the sum over all squared differences between the observations and their overall [mean](mean.md) ${\bar {y} }$: $$\sum _{i=1}^{n}\left(y_{i}-{\bar {y} }\right)^{2} \,.$$ <!--SR:!2025-05-27,132,397!2025-05-28,132,397-->
  - total sum of squares / linear regression ::@:: For wide classes of linear models, the total sum of squares equals the _explained sum of squares_ plus the _residual sum of squares_. <!--SR:!2025-06-02,137,397!2025-04-03,85,377-->
...
- [coefficient of determination](../../../../general/coefficient%20of%20determination.md) ::@:: It, denoted _R_<sup>2</sup> or _r_<sup>2</sup> and pronounced "R squared", is the proportion (thus between 0 and 1) of the variation in the dependent variable that is predictable from the independent variable(s). <p> It is calculated as: $$\frac {\text{RSS} } {\text{SST} } = 1 - \frac {\text{SSE} } {\text{SST} } \,.$$ <!--SR:!2025-05-16,122,397!2025-05-29,133,397-->
  - coefficient of determination / _R_ ::@:: `summary(<model>)`, where `<model>` can be obtained by `lm(<y>~<x>[, data=<dataframe>])`. "Multiple R-squared" gives the result. <!--SR:!2025-04-22,97,377!2025-04-05,87,377-->
