...
- [confidence interval](../../../../general/confidence%20interval.md) ::@:: It is an interval which is expected to typically contain the parameter being estimated. More specifically, given a __confidence level__ $\gamma$ (95% and 99% are typical values), a CI is a random interval which contains the parameter being estimated $100\gamma$% of the time. <p> Note: This course uses $100(1 - \alpha)$% instead of $\gamma$%. So $\alpha$ is the probability that a random interval from a theoretical sample does not contain the population parameter. <!--SR:!2025-04-06,88,377!2025-05-19,125,397-->
  - confidence interval / definition ::@:: Wikipedia uses $$P(T_1 < \theta < T_2) \ge \gamma \,,$$, with equality replacing $\ge$ when the distribution is continuous. This course uses $$P(T_1 \le \theta \le T_2) \ge 1 - \alpha \,,$$ with equality replacing $\ge$ when the distribution is continuous. <!--SR:!2025-03-20,76,377!2025-05-31,135,397-->
...
- [chi-squared distribution](../../../../general/chi-squared%20distribution.md) ::@:: It with $k$ _degrees of freedom_ is the distribution of a sum of the _squares_ of $k$ _independent standard normal random variables_. It is denoted $\chi^2(k)$ (in this course) or $\chi_k^2$. <!--SR:!2025-04-03,85,377!2025-06-01,136,397-->
  ...
  - chi-squared distribution / shape ::@:: It looks like a right-skewed (left-leaning) hill. The higher the $k$, the lower the peak and the fatter the hill. Note that for $k = 1, 2$, the peak is at $x = 0$. <!--SR:!2025-05-28,132,397!2025-03-20,70,357-->
...
- [Student's t-distribution](../../../../general/Student's%20t-distribution.md) ::@:: It is continuous probability distribution that generalizes the standard normal distribution. Like the latter, it is symmetric around zero and bell-shaped. (This course denotes it by $t(\nu)$ instead of $t_\nu$.) <p> However, it has heavier tails and the amount of probability mass in the tails is controlled by the parameter $\nu$. For $\ \nu =1\ {}$ the Student's _t_ distribution $t_{\nu }$ becomes the standard [Cauchy distribution](../../../../general/Cauchy%20distribution.md), which has very ["fat" tails](../../../../general/fat-tailed%20distribution.md); whereas for $\ \nu \rightarrow \infty \ {}$ it becomes the standard normal distribution $\ {\mathcal {N} }(0,1)\,$ which has very "thin" tails. <!--SR:!2025-04-15,96,377!2025-09-02,189,357-->
  ...
  - Student's t-distribution / probability density function (PDF) ::@:: (Probably no need to memorize this...) $$f(w) = \frac {\Gamma((n + 1) / 2)} {\sqrt{\pi n} \Gamma(n / 2)} \left(1 + \frac {w^2} n\right)^{-(n + 1) / 2}$$ <!--SR:!2025-06-11,126,337!2025-03-20,70,357-->
...
- [normal distribution](../../../../general/normal%20distribution.md)
  - normal distribution / sample mean ::@:: For _n_ samples of a population $X \sim \mathcal N\left(\mu_X, \sigma_X^2\right)$, we have $$\begin{aligned} \overline X & \sim \mathcal N\left(\mu_X, \sigma_X^2 / n\right) \\ (\overline X - \mu_X)\sqrt{n / \sigma_X^2} & \sim \mathcal N(0, 1) \,. \end{aligned}$$ <!--SR:!2025-04-21,96,377!2025-03-20,76,377-->
...
- [Student's t-distribution](../../../../general/Student's%20t-distribution.md)
  - Student's t-distribution / _R_ ::@:: To find $t_{\mathrm{df}, \alpha}$, use: `qt(<alpha>, df=<df>, lower.tail=F)`. <p> If you want to do t-test, use `t.test(<sample>, conf.level=<confidence level>)$conf.int`. <!--SR:!2025-04-27,101,377!2025-03-20,70,357-->
  - Student's t-distribution / table ::@:: To find $t_{\mathrm{df}, \alpha}$, look up $\nu = \mathrm{df}$ and $\alpha$ (be mindful of if the area is the lower or upper area), and find its corresponding value. <!--SR:!2025-05-25,130,397!2025-03-20,76,377-->
...
- [chi-squared distribution](../../../../general/chi-squared%20distribution.md)
  - chi-squared distribution / _R_ ::@:: To find $\chi^2_{\mathrm{df}, \alpha}$, use: `qchisq(<alpha>, df=<df>, lower.tail=F)`. <p> If you want to do chi-squared-test, use `VarCI(<sample>, conf.level=<confidence level>)` from the package `DescTools` (install using `install.packages("DescTools")`). <!--SR:!2025-06-14,128,337!2025-03-20,70,357-->
...
- [power](../../../../general/power%20(statistics).md) ::@:: It is a measure of the ability of an experimental design and hypothesis testing setup to detect a particular effect if it is truly present. <p> For hypothesis testing, this is the probability of rejecting $H_0$ given $H_0$ is false. Thus it is calculated as $1 - \beta$. <!--SR:!2025-03-20,76,377!2025-06-01,136,397-->
...
- [Fisher transformation](../../../../general/Fisher%20transformation.md) (optional) ::@:: (optional) $$z={1 \over 2}\ln \left({1+r \over 1-r}\right)=\operatorname {artanh} (r) \,,$$ where $r$ is the sample Pearson correlation coefficient. <!--SR:!2025-04-18,33,337!2025-04-14,90,377-->
  ...
  - Fisher transformation / back-transformation ::@:: $$r = \frac {\exp(2z) - 1} {\exp(2z) + 1} = \tanh(z)$$ <!--SR:!2025-03-20,76,377!2025-04-14,95,377-->
...
- [simple linear regression](../../../../general/simple%20linear%20regression.md)
  ...
  - simple linear regression / error variance estimator ::@:: The estimator (the slides use $S^2$) is $$S_{\varepsilon, n - 2}^2 := \frac {\sum_{i = 1}^n (Y_i - \hat Y_i)^2} {n - 2} \,. $$ Its actual value (the slides use $s^2$) can be calculated by: $$s_{\varepsilon, n - 2}^2 = \frac {\sum_{i = 1}^n (y_i - \hat y_i)^2} {n - 2} = \frac {S_{YY} - b S_{XY} } {n - 2} = \frac {\mathrm{SSE} } {n - 2} \,.$$ <!--SR:!2025-05-24,101,337!2025-03-27,62,317-->
    - simple linear regression / error variance estimator / properties ::@:: The following holds: $$\frac {(n - 2)s_{\varepsilon, n - 2}^2} {\sigma_{\varepsilon}^2} \sim \chi^2(n - 2) \,.$$ <p> It is an unbiased estimator of $\sigma_\varepsilon^2$. <!--SR:!2025-09-11,197,357!2025-03-20,76,377-->
