...
- [statistical population](../../../../general/statistical%20population.md) ::@:: It is a set of similar items or events which is of interest for some question or experiment. <p> A statistical population can be a group of existing objects (e.g. the set of all stars within the Milky Way galaxy) or a hypothetical and potentially infinite group of objects conceived as a generalization from experience (e.g. the set of all possible hands in a game of poker). <!--SR:!fsrs,2032-05-31T00:00:00.000Z,2146,2145.97655349,1,2,10,0,0,2026-07-16T00:00:00.000Z!2026-08-15,488,396-->
