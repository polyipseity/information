...
- DC supply and reference node safety ::@:: After measurements or before rewiring, turn off or disable the DC supply output and rely on the current limit to protect circuits; in ELEC 1100 labs use the circuit's GND node as the common reference for negative leads rather than the bench supply's chassis GND terminal. <!--SR:!2026-06-05,61,310!2026-06-06,62,310-->
