...
- ELEC 1100
  ...
  - ELEC 1100 / lab 1 preparation (logistics only; topic content in [lab equipment](lab%20equipment.md))
    ...
    - ELEC 1100 / lab 1 preparation / lab workflow and bonus ::@:: Before lab, attend tutorial and read the lab manual and summary sheet so you know the required checks.<br/>During lab, demonstrate to the TA for a record; a bonus mark is awarded if all TA checks are completed within roughly the first two hours of the lab. <!--SR:!2026-07-06,89,368!2026-04-09,19,348-->
...
- ELEC 1100
  - ELEC 1100 / [electronic component](electronic%20component.md#electrical%20fundamentals)
    ...
    - [§ atoms and charge](electronic%20component.md#atoms%20and%20charge) ::@:: outer electrons are weakly held and participate in conduction <!--SR:!2026-04-09,19,348!2026-07-06,89,368-->
    ...
    - [§ current](electronic%20component.md#current) $I=\Delta q/\Delta t$ ::@:: current $I=\Delta q/\Delta t$ and conventional direction <!--SR:!2026-06-30,84,368!2026-04-09,19,348-->
    - [§ voltage and potential difference](electronic%20component.md#voltage%20and%20potential%20difference) ::@:: voltage is energy per charge between two points <!--SR:!2026-04-09,19,348!2026-07-06,89,368-->
    ...
    - [§ capacitors](electronic%20component.md#capacitors) ::@:: two plates store charge, discharge provides transient power <!--SR:!2026-04-09,19,348!2026-06-30,84,368-->
    - [§ energy and power](electronic%20component.md#energy%20and%20power) $E=qV$, $P=IV$ ::@:: $E=qV$, $P=IV=I^{2}R=V^{2}/R$ <p> Human/robot energy analogy; DC vs AC sources; lab gear (bench supply, function generator, breadboard, battery monitor, LiPo); human body energy comparison; Galileo $v=\sqrt{2gh}$; resistor heating/short‑circuit hazard and worked numerical examples. <!--SR:!2026-06-30,84,368!2026-04-09,19,348-->
    - [§ resistor networks](electronic%20component.md#resistor%20networks) $R_{\text{eq}}$ ::@:: series add, parallel combine via reciprocal conductance <!--SR:!2026-06-29,83,368!2026-04-09,19,348-->
...
- ELEC 1100
  - ELEC 1100 / [Kirchhoff's circuit laws](Kirchhoff%27s%20circuit%20laws.md) ::@:: Two fundamental relations (KCL and KVL) <!--SR:!2026-07-04,87,368!2026-07-03,86,368-->
    ...
    - [§ circuit analysis using Kirchhoff's laws](Kirchhoff%27s%20circuit%20laws.md#circuit%20analysis%20using%20kirchhoff%27s%20laws) ::@:: Procedure combining KCL and KVL to solve networks <!--SR:!2026-07-05,88,368!2026-04-09,19,348-->
    - [§ integrated numerical calculations](Kirchhoff%27s%20circuit%20laws.md#integrated%20numerical%20calculations) ::@:: Worked calculations using KCL and KVL for simple and bridge circuits <!--SR:!2026-07-04,87,368!2026-04-09,19,348-->
    - [§ equivalence and application](Kirchhoff%27s%20circuit%20laws.md#equivalence%20and%20application) ::@:: When to apply KCL and KVL laws and how to compute equivalent resistance <!--SR:!2026-04-09,19,348!2026-06-26,80,368-->
...
- topic: DC motors
- ELEC 1100
  - ELEC 1100 / [brushed DC electric motor](brushed%20DC%20electric%20motor.md) ::@:: Motor converts electrical to mechanical energy; commutator and brushes; direction via H-bridge, speed via voltage (PWM next) <!--SR:!2026-04-13,5,362!2026-04-13,5,362-->
    - [§ what are motors and classification](brushed%20DC%20electric%20motor.md#what%20are%20motors%20and%20classification) ::@:: Motor definition, applications; DC (brushed, brushless, stepper) vs AC; we use brushed in labs <!--SR:!2026-04-13,5,362!2026-04-13,5,362-->
    - [§ origin and history](brushed%20DC%20electric%20motor.md#origin%20and%20history) ::@:: Ørsted showed that electric current produces magnetism, and Faraday's 1821 work demonstrated electromagnetic rotation, giving the key physical basis of the DC motor. Much later, Tesla's work helped establish AC motor systems, so the history contrasts early DC-motor ideas with later AC-motor development. <!--SR:!2026-04-13,5,362!2026-04-13,5,362-->
    - [§ magnetic basics](brushed%20DC%20electric%20motor.md#magnetic%20basics) ::@:: Poles and forces, monopoles, Earth's field; permanent magnet vs electromagnet; right-hand rule <!--SR:!2026-04-13,5,362!2026-04-13,5,362-->
    - [§ stator and rotor interaction](brushed%20DC%20electric%20motor.md#stator%20and%20rotor%20interaction) ::@:: Stator and rotor roles; attraction, repulsion, and continuous rotation (inertia, reversing polarity) <!--SR:!2026-04-13,5,362!2026-04-13,5,362-->
    - [§ commutation and brushed construction](brushed%20DC%20electric%20motor.md#commutation%20and%20brushed%20construction) ::@:: Commutation and commutator + brushes; current path at brushes vs inside motor <!--SR:!2026-04-13,5,362!2026-04-13,5,362-->
    - [§ direction control with H-bridge](brushed%20DC%20electric%20motor.md#direction%20control%20with%20H-bridge) ::@:: Reverse current to reverse direction; H-bridge and DIR signal ( $5\text{ V}$ / $0\text{ V}$ ) for reversible control <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-04-13,5,362!2026-04-13,5,362-->
    - [§ speed control and limitations of variable resistor](brushed%20DC%20electric%20motor.md#speed%20control%20and%20limitations%20of%20variable%20resistor) ::@:: Factors affecting speed; variable resistor, drawbacks, and PWM <!--SR:!2026-04-13,5,362!2026-04-13,5,362-->
