...
- why load regulation uses output current ::@:: Load regulation studies stability against output-side demand changes. Since the regulator is supposed to keep output voltage approximately constant, the varying quantity is naturally the output _current_ drawn by the load, while the response of interest is the small resulting change in output voltage. <!--SR:!2026-08-14,93,363!fsrs,2028-01-05T00:00:00.000Z,511,511.16471615,1,2,8,0,0,2026-08-12T00:00:00.000Z-->
- line vs load regulation: what does each one test? ::@:: Line regulation tests stability of $V_O$ against _input-voltage_ changes from the source side. Load regulation tests stability of $V_O$ against _output-current_ changes from the load side. <!--SR:!2026-08-14,93,363!fsrs,2028-01-11T00:00:00.000Z,516,516.02453913,1,2,8,0,0,2026-08-13T00:00:00.000Z-->
