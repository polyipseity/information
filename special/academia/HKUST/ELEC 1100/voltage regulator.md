...
- line vs load regulation: what does each one test? ::@:: Line regulation tests stability of $V_O$ against _input-voltage_ changes from the source side. Load regulation tests stability of $V_O$ against _output-current_ changes from the load side. <!-- check: ignore-line[two_sided_calc_warning]: conceptual -->
