...
- charge attraction/repulsion ::@:: Opposite charges attract; like charges repel. <!--SR:!2026-10-18,170,310!2026-05-15,57,310-->
...
- infinite ladder concept: Given an infinite resistor ladder built by repeating a small series/parallel cell, how can you model the resistance of the "tail" of the network in terms of an unknown $R_{\text{eq}}$? ::@:: Because the part of the ladder to the right of any cell looks identical to the whole, you can replace the infinite tail by a single unknown equivalent resistance $R_{\text{eq}}$ and solve for it. <!--SR:!2026-07-31,93,363!2026-06-27,81,363-->
