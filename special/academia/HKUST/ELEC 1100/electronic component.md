...
- course context ::@:: In ELEC 1100, electronic components also includes basic electrical concepts needed to understand how components operate.
...
- elementary charge ::@:: The smallest amount of electric charge is the charge of one proton or electron, q = 1.6×10⁻¹⁹ C.
...
- current definition ::@:: Current is the orderly movement of charged particles; I = Δq/Δt, measured in amperes (1 A = 1 C/s).
...
- current example heater ::@:: A heater draws 8.5×10²⁰ electrons in 10 s; the current is approximately 13.6 A.
- battery example ::@:: A 50 A start current for 4 s delivers 200 C of charge, about 1.25×10²¹ electrons.
...
- unit of resistance ::@:: The unit of resistance is the ohm (Ω), symbol R.
- resistivity formula ::@:: R = ρ·(L/A) for a wire of length L and area A.
...
- Ohm's law ::@:: V = I·R; an I–V plot for a resistor is a straight line with slope 1/R.
- Ohm's law example ::@:: With V = 5 V and R = 200 Ω, the current is I = 25 mA.
- multimeter use ::@:: Digital multimeters may be used to measure resistance, voltage, or current in laboratory circuits.
- metric prefixes ::@:: Prefixes such as kilo (k = 10³) and milli (m = 10⁻³) are applied to ohms and amperes (e.g. 10 kΩ = 10000 Ω; 50 mA = 0.05 A).
