...
- origin of laws ::@:: Gustav Kirchhoff (1824–1887) formulated the current and voltage laws now bearing his name. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- purpose of laws ::@:: Provide a systematic way to relate currents and voltages when a network cannot be reduced by simple series or parallel combinations. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- series resistance formula <p> ![resistors in series](attachments/series.svg) ::@:: For resistors in series, $R_{\text{eq}} = R_1 + R_2 + \cdots$ because the same current flows through each element. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- parallel resistance formula <p> ![resistors in parallel](attachments/parallel.svg) ::@:: For resistors in parallel, $1/R_{\text{eq}} = 1/R_1 + 1/R_2 + \cdots$ since each branch has the same voltage and conductances sum. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- complex network definition ::@:: A circuit whose interconnections are neither purely series nor purely parallel, requiring general analysis using Kirchhoff's laws. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- applicability domain ::@:: Kirchhoff's laws apply to any network by writing equations for nodes (junctions) and closed loops. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
...
- KCL alternative name ::@:: Kirchhoff's current law is also called the junction rule. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KCL statement ::@:: At any node, the algebraic sum of currents is zero. <p> ![KCL](attachments/kcl.svg) <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KCL entering vs leaving ::@:: The sum of currents entering a junction equals the sum leaving. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KCL algebraic form ::@:: $\sum I_{\text{in}} = \sum I_{\text{out}}$; bringing all to one side gives equations like $I_1+I_2-I_3-I_4=0$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KCL sign convention ::@:: Currents assumed leaving may be taken as negative so a single summation suffices. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KCL rationale ::@:: It follows from conservation of charge; no net charge accumulates at a point, discrete analogue of the continuity equation. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
...
- KVL alternative name ::@:: Kirchhoff's voltage law is also known as the loop rule. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KVL statement ::@:: Around any closed path, the algebraic sum of potential differences is zero. <p> ![KVL](attachments/kvl.svg) <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KVL traversal rule ::@:: When traversing a loop, add voltage drops (positive in direction of current) and subtract rises; orientation of sources matters. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KVL example equation ::@:: For a loop with a source and two resistors: $-v + v_1 + v_2 = 0$, giving $v = v_1 + v_2$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- KVL justification ::@:: Because electrostatic fields are conservative, no net work is done completing a closed circuit. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
...
- analysis overview ::@:: Circuit analysis combines KCL and KVL systematically. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- step 1 choose nodes/loops ::@:: Select a reference node (ground) and identify independent loops covering the network without redundancy. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- step 2 assign directions ::@:: Arbitrary current arrows are drawn; negative solutions indicate actual flow is opposite. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- step 3 write KCL ::@:: Form equations at nodes with chosen sign conventions, set algebraic sum to zero. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- step 4 write KVL ::@:: Form loop equations by summing drops and rises in traversal direction, set to zero. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- step 5 solve system ::@:: Solve the resulting linear equations for unknown currents, voltages, or resistances. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- method flexibility ::@:: Either KCL or KVL may be used preferentially depending on topology; the choice of current directions is immaterial. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
...
- independence principle ::@:: A sufficient number of independent KCL/KVL equations uniquely determines circuit unknowns. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- when to apply ::@:: Use Kirchhoff's laws when series/parallel simplification fails, as in bridge circuits. <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
- equivalent resistance technique ::@:: Attach a test voltage source $V$, compute total current $I$ by KCL/KVL, then $R_{\text{eq}} = V/I$. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-03-16,4,270!2026-03-16,4,270-->
