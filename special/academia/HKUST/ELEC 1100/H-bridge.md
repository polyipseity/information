...
- H-bridge base voltages (Va, Vb, Vc, Vd) for one direction vs opposite: what pattern? ($5\text{ V}$ / $0\text{ V}$) ::@:: One direction: Va and Vd HIGH ($5\text{ V}$), Vb and Vc LOW ($0\text{ V}$). Opposite direction: Vb and Vc HIGH, Va and Vd LOW. <!--SR:!2026-04-05,15,290!2026-04-06,16,290-->
- H-bridge complementary pairs: What do the four bases need? ::@:: Two complementary pairs of signals: one pair at $5\text{ V}$ / $0\text{ V}$ and the other at $0\text{ V}$ / $5\text{ V}$, so one diagonal is on and the other off. <!-- check: ignore-line[two_sided_calc_warning]: conceptual --> <!--SR:!2026-04-05,15,290!2026-04-06,16,290-->
...
- L293 two supplies: What are VS and VCC on the L293? (pin 8, pin 16; $12\text{ V}$, $5\text{ V}$) ::@:: VS (e.g. pin 8) is the motor supply (e.g. $12\text{ V}$); VCC (e.g. pin 16) is the logic supply (e.g. $5\text{ V}$). Both must be connected for the IC to work. <!--SR:!2026-04-06,16,290!2026-04-05,15,290-->
- L293 bypass capacitors: Why use capacitors (e.g. $0.1\,\mu\text{F}$) near the L293? ::@:: For stable operation; they help filter supply noise and provide local charge when the motors draw current. <!--SR:!2026-04-05,15,290!2026-04-06,16,290-->
...
- breadboard pin counts: How many pins does the L293 have on each side? The 74HC14? ::@:: L293: 8 pins on each side (16 total). 74HC14: 7 pins on each side (14 total). <!--SR:!2026-04-05,15,290!2026-04-05,15,290-->
