...
- feature rescaling and L1 penalty / $x_j'=s x_j$, $w_j'=w_j/s$ ::@:: If $x_j'=s x_j$ and $w_j'=w_j/s$, then the L1 term becomes $\lambda|w_j'|=\lambda\frac{|w_j|}{|s|}$, so L1 regularization also depends on feature scale. <!--SR:!2026-08-11,71,336!2026-06-07,24,296-->
