...
- sigmoid logarithm identities used in the logistic-surrogate derivation ::@:: For $\sigma(z)=\frac{1}{1+e^{-z}}$, one has $\log\sigma(z)=-\log(1+e^{-z})$ and $\log(1-\sigma(z))=\log\sigma(-z)=-\log(1+e^{z})$. <!--SR:!fsrs,2028-01-08T00:00:00.000Z,499,499.46479977,1,2,7,0,0,2026-08-27T00:00:00.000Z!2026-09-02,93,368-->
