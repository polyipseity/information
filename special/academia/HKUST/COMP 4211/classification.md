...
- error versus loss as a core theme with formulas ::@:: In classification one ultimately cares about error rates such as $\frac{1}{N}\sum_i \mathbf{1}[\hat y_i\ne y_i]$, but training usually minimizes a smoother surrogate loss such as cross entropy or $\frac{1}{N}\sum_i \phi(y_if(x_i))$. <!--SR:!fsrs,2027-06-24T00:00:00.000Z,343,343.17170448,1,2,7,0,0,2026-07-16T00:00:00.000Z!2026-07-27,72,324-->
...
- role of regularization in classification ::@:: Regularization can improve test loss and test error by reducing overfitting to peculiarities of the training data. <!--SR:!fsrs,2027-07-16T00:00:00.000Z,356,356.49943311,1,2,7,0,0,2026-07-25T00:00:00.000Z!2026-07-27,72,324-->
...
- macro averaging definition with meaning ::@:: Macro metrics compute unweighted class averages: $\text{macro }F_1=\frac{1}{C}\sum_c F1_c$, so each class contributes equally regardless of size. <!--SR:!2026-08-09,84,345!2026-07-27,72,324-->
...
- notation reminder: feature vector and class label ::@:: In Naive Bayes, $x=(x_1,\ldots,x_D)$ is a feature vector with $D$ components, each $x_j$ is the value of the $j$-th feature, and $y$ is a class label such as spam or not-spam. <!--SR:!2026-08-05,84,345!2026-07-27,72,324-->
...
- worked Naive Bayes prediction decision with derivation: Given scores $s_1=0.288$ and $s_0=0.126$, what class is predicted? ::@:: Since $s_1=0.288>s_0=0.126$, predict class $1$ by the argmax rule $\hat y=\arg\max_c\,P(y=c)\prod_j P(x_j\mid y=c)$. <!--SR:!2026-07-27,72,324!fsrs,2027-07-05T00:00:00.000Z,352,352.06522277,1,2,7,0,0,2026-07-18T00:00:00.000Z-->
...
- why unnormalized-score comparison works ::@:: Posterior class prediction uses unnormalized scores $P(y=c)P(x\mid y=c)$ because the normalization constant $P(x)$ is identical across candidate classes and cancels in pairwise comparisons. <!--SR:!2026-07-27,72,324!fsrs,2027-07-27T00:00:00.000Z,365,365.34342854,1,2,7,0,0,2026-07-27T00:00:00.000Z-->
