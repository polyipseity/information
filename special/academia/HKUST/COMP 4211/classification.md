...
- visual intuition for convexity ::@:: Visually, a function is convex when every straight chord between two points on its graph lies above or on the graph, so the curve has a bowl-like rather than arching-upward shape. <!--SR:!2026-08-07,82,343!fsrs,2027-07-10T00:00:00.000Z,352,352.06522277,1,2,7,0,0,2026-07-23T00:00:00.000Z-->
...
- why the normalizing constant $P(x)$ can be ignored and what rule remains ::@:: $P(x)$ is identical for every candidate class, so it cancels in pairwise comparisons; therefore prediction can use unnormalized scores and the argmax rule simplifies to $\hat y=\arg\max_c\,P(y=c)\,P(x\mid y=c)$. <!--SR:!fsrs,2027-09-22T00:00:00.000Z,419,418.78487918,1,2,7,0,0,2026-07-30T00:00:00.000Z!2026-08-07,82,343-->
