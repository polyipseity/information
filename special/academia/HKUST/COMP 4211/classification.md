...
- why the same posterior can yield different actions ::@:: A fixed posterior model can produce different optimal class decisions when the threshold or cost structure changes, because decision-making is separate from probability estimation. <!--SR:!2026-08-04,83,343!2026-07-26,71,324-->
...
- why direct error minimization is hard ::@:: Zero-one error is the right task-level quantity, but it is too discontinuous and too flat to optimize conveniently by gradient descent. <!--SR:!fsrs,2027-07-22T00:00:00.000Z,365,365.34342854,1,2,7,0,0,2026-07-22T00:00:00.000Z!2026-07-26,71,324-->
...
- multiclass accuracy formula with interpretation ::@:: Multiclass accuracy is $\frac{\sum_{c=1}^C M_{c,c}}{\sum_{a=1}^C\sum_{b=1}^C M_{a,b}}$ because the numerator sums all correct diagonal counts and the denominator sums all examples in the confusion matrix. <!--SR:!fsrs,2027-07-28T00:00:00.000Z,370,369.75349055,1,2,7,0,0,2026-07-23T00:00:00.000Z!2026-07-26,71,324-->
- why accuracy may be misleading ::@:: Accuracy can look high on imbalanced data even when minority-class detection is poor. <!--SR:!fsrs,2027-05-29T00:00:00.000Z,321,320.78435528,1,2,7,0,0,2026-07-12T00:00:00.000Z!2026-07-26,71,324-->
...
- F1 formula from confusion counts with notation ::@:: In binary classification, $F_1=\frac{2TP}{2TP+FP+FN}$, where $TP$ is true positives, $FP$ false positives, and $FN$ false negatives. <!--SR:!2026-08-03,82,345!2026-07-26,71,324-->
...
- why smoothing helps Naive Bayes ::@:: Smoothing avoids brittle zero probabilities, introduces a small bias toward uniformity, and usually improves robustness on sparse or limited training data. <!--SR:!fsrs,2027-08-02T00:00:00.000Z,374,374.15574843,1,2,7,0,0,2026-07-24T00:00:00.000Z!2026-07-26,71,324-->
...
- why unnormalized-score comparison works ::@:: Posterior class prediction uses unnormalized scores $P(y=c)P(x\mid y=c)$ because the normalization constant $P(x)$ is identical across candidate classes and cancels in pairwise comparisons. <!--SR:!2026-07-27,72,324!2026-07-26,71,324-->
