...
- estimation layer versus decision layer in probabilistic classification ::@:: The estimation layer learns posterior probabilities $Q(y\mid x)$, while the decision layer converts them into actions according to the chosen threshold or loss structure. <!--SR:!2026-07-30,78,343!2026-07-20,70,324-->
- why probabilistic classification is useful ::@:: Probabilistic classification is useful because posterior scores can be interpreted, thresholded, calibrated, and adapted to different cost structures without retraining the model. <!--SR:!2026-07-20,70,324!fsrs,2027-06-30T00:00:00.000Z,348,347.62268435,1,2,7,0,0,2026-07-17T00:00:00.000Z-->
...
- why surrogates are needed ::@:: Surrogate losses are needed because the zero-one loss is too flat for gradient-based optimization. <!--SR:!2026-07-28,73,324!2026-07-20,70,324-->
...
- binary worked-metrics example with full givens: If $TP=5$, $FN=5$, $FP=0$, and $TN=90$, compute accuracy, precision, recall, and $F_1$ ::@:: Accuracy $=\frac{TP+TN}{TP+TN+FP+FN}=\frac{95}{100}=0.95$; precision $=\frac{TP}{TP+FP}=\frac{5}{5}=1$; recall $=\frac{TP}{TP+FN}=\frac{5}{10}=0.5$; and $F_1=\frac{2PR}{P+R}=\frac{2\cdot 1\cdot 0.5}{1+0.5}=\frac{2}{3}\approx 0.667$. <!--SR:!2026-07-24,74,324!2026-07-20,70,324-->
...
- why log-scores avoid numerical underflow ::@:: Multiplying many small probabilities can underflow to zero, but summing their logs keeps values in a manageable range. <!--SR:!2026-07-20,70,324!2026-07-22,68,324-->
