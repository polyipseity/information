...
- multiclass posterior decision rule ::@:: In probabilistic multiclass classification, prediction is $\hat y=\arg\max_y Q(y\mid x)$, meaning choose the class with largest posterior probability. <!--SR:!2026-07-29,74,324!fsrs,2027-07-22T00:00:00.000Z,361,360.92544943,1,2,7,0,0,2026-07-26T00:00:00.000Z-->
...
- surrogate loss idea ::@:: A surrogate loss replaces the zero-one loss with an objective of the form $L_\phi(w,b)=\frac{1}{N}\sum_i \phi\bigl(y_i(w^\top x_i+b)\bigr)$ that is easier to optimize while still encouraging correct classification. <!--SR:!2026-07-29,74,324!2026-08-02,81,344-->
...
- counterexample where loss improves but error worsens ::@:: Using scaled logistic loss, margins can move from $(10,-10)$ to $(-0.01,-0.01)$, changing error from $\frac12$ to $1$ while decreasing average loss because the surrogate heavily rewards removing an extreme negative margin even though both points become slightly wrong. <!--SR:!fsrs,2027-07-22T00:00:00.000Z,365,365.34342854,1,2,7,0,0,2026-07-22T00:00:00.000Z!2026-07-29,74,324-->
...
- why threshold tuning matters ::@:: Different decision thresholds on the same score model can trade precision against recall, especially under class imbalance. <!--SR:!fsrs,2027-07-22T00:00:00.000Z,361,360.92544943,1,2,7,0,0,2026-07-26T00:00:00.000Z!2026-07-29,74,324-->
...
- training loss versus evaluation metric ::@:: A classifier is often trained by minimizing cross entropy but evaluated by metrics such as accuracy, precision, recall, and $F_1$, so training objective and evaluation summary are distinct. <!--SR:!2026-07-29,77,344!fsrs,2027-06-25T00:00:00.000Z,343,343.17170448,1,2,7,0,0,2026-07-17T00:00:00.000Z-->
...
- multiclass worked macro/micro relation with full givens: Given $M=\begin{bmatrix}40&2&3\\4&30&6\\1&5&29\end{bmatrix}$ with single-label classes, what are macro $F_1$ (approx) and micro $F_1$? ::@:: Per-class $F_1$ values are about $0.889,0.779,0.795$, so macro $F_1\approx\frac{0.889+0.779+0.795}{3}=0.821$; micro $F_1$ equals accuracy in single-label multiclass, so micro $F_1=0.825$. <!--SR:!2026-07-29,74,324!fsrs,2027-07-28T00:00:00.000Z,370,369.75349055,1,2,7,0,0,2026-07-23T00:00:00.000Z-->
