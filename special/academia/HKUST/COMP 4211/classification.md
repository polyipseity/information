...
- sigmoid logarithm identities used in the logistic-surrogate derivation ::@:: For $\sigma(z)=\frac{1}{1+e^{-z}}$, one has $\log\sigma(z)=-\log(1+e^{-z})$ and $\log(1-\sigma(z))=\log\sigma(-z)=-\log(1+e^{z})$. <!--SR:!2026-08-26,86,368!2026-09-02,93,368-->
