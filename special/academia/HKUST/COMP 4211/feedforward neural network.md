...
- alternative name for feedforward neural networks ::@:: Feedforward neural networks are also commonly called multilayer perceptrons (MLPs).  The name "multilayer" refers to having at least one hidden layer between input and output, and "perceptron" echoes the historical single-unit predecessor; despite the name, modern MLPs use smooth differentiable activations rather than the original threshold step function. <!--SR:!2026-05-21,18,324!2026-07-14,58,310-->
...
- binary cross entropy from sigmoid output ::@:: From the Bernoulli model $p(y\mid z)=\sigma(z)^y(1-\sigma(z))^{1-y}$, the negative log-likelihood becomes $-\bigl(y\log \sigma(z)+(1-y)\log(1-\sigma(z))\bigr)$. <!--SR:!2026-05-21,18,327!2026-07-22,66,310-->
...
- output-layer weight gradient ::@:: If $u_j$ feeds output unit $k$, then $\frac{\partial L}{\partial W_{kj}} = u_j\delta_k$. <!--SR:!2026-05-22,18,327!2026-07-12,56,310-->
...
- why SGD naturally pairs with backpropagation ::@:: Backpropagation provides the gradients needed by gradient-descent and stochastic-gradient-descent updates of network parameters. <!--SR:!2026-05-22,18,324!2026-07-10,54,310-->
...
- tensors in deep-learning frameworks ::@:: Deep-learning frameworks store parameters and activations in tensors, meaning multidimensional arrays with shapes such as $(B,D)$, $(B,C,H,W)$, or $(B,T,D)$, so forward and backward computations can be carried out efficiently in bulk. <!--SR:!2026-05-18,15,290!2026-07-11,55,310-->
...
- backpropagation interpretation ::@:: Backpropagation can be interpreted as systematic blame assignment: compare prediction with target at the output, assign local blame to each unit, and convert that blame into parameter gradients. <!--SR:!2026-07-13,57,310!2026-05-20,17,309-->
