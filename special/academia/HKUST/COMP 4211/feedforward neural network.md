...
- normal versus uniform initialization intuition ::@:: The normal variant directly sets a target variance $\sigma^2$. For $X\sim\operatorname{Unif}[-r,r]$, $\operatorname{Var}(X)=\frac{(2r)^2}{12}=\frac{r^2}{3}$, so matching the same target variance means choosing $r=\sqrt{3}\,\sigma$. That is why the Xavier normal variance $\sigma^2=\frac{2}{n_{\mathrm{in}}+n_{\mathrm{out}}}$ becomes the Xavier uniform bounds $\pm\sqrt{\frac{6}{n_{\mathrm{in}}+n_{\mathrm{out}}}}$, and the He normal variance $\sigma^2=\frac{2}{n_{\mathrm{in}}}$ becomes the He uniform bounds $\pm\sqrt{\frac{6}{n_{\mathrm{in}}}}$.
- initialization distributions to remember ::@:: The four standard formulas in this note are Xavier normal $\mathcal N\bigl(0,\frac{2}{n_{\mathrm{in}}+n_{\mathrm{out}}}\bigr)$, Xavier uniform $\operatorname{Unif}\bigl[-\sqrt{\frac{6}{n_{\mathrm{in}}+n_{\mathrm{out}}}},\sqrt{\frac{6}{n_{\mathrm{in}}+n_{\mathrm{out}}}}\bigr]$, He normal $\mathcal N\bigl(0,\frac{2}{n_{\mathrm{in}}}\bigr)$, and He uniform $\operatorname{Unif}\bigl[-\sqrt{\frac{6}{n_{\mathrm{in}}}},\sqrt{\frac{6}{n_{\mathrm{in}}}}\bigr]$.
- normal-form versus bounded-uniform intuition for Xavier and He ::@:: For both Xavier and He, the normal form states the target variance directly; the uniform form is a variance-matched bounded surrogate. The conversion factor is always $r=\sqrt{3}\,\sigma$ because $\operatorname{Var}(\operatorname{Unif}[-r,r])=r^2/3$. One can then interpret the bounded version as keeping the same variance while excluding very large normal-style tail draws.
