...
- tiny normal-equation computation: For $X=\begin{bmatrix}1&2\\1&4\\1&6\end{bmatrix}$ and $y=\begin{bmatrix}2\\3\\4\end{bmatrix}$, what are $X^\top X$ and $X^\top y$? ::@:: $X^\top X = \begin{bmatrix}3&12\\12&56\end{bmatrix}$ and $X^\top y = \begin{bmatrix}9\\40\end{bmatrix}$. <!--SR:!2026-08-05,85,353!2026-08-11,86,353-->
...
- ordinary vector projection onto a nonunit vector ::@:: The projection of $y$ onto the line spanned by a nonzero vector $a$ is $\operatorname{proj}_{a}(y)=\frac{a^\top y}{a^\top a}a$. <!--SR:!2026-08-05,85,353!fsrs,2027-08-18T00:00:00.000Z,383,382.93736419,1,2,7,0,0,2026-07-31T00:00:00.000Z-->
...
- when $X^\top X$ is singular ::@:: $X^\top X$ is singular when the columns of $X$ are linearly dependent, so the inverse formula cannot be used directly. <!--SR:!fsrs,2027-11-09T00:00:00.000Z,462,461.77133783,1,2,7,0,0,2026-08-04T00:00:00.000Z!2026-08-05,81,353-->
...
- why the pseudoinverse is not just $(X^\top X)^{-1}$ ::@:: The pseudoinverse used in least squares is the pseudoinverse of $X$, not of $X^\top X$ alone, so in the full-column-rank case it is $(X^\top X)^{-1}X^\top$. <!--SR:!2026-08-11,86,353!2026-08-05,85,353-->
...
- why a single hold-out split wastes data ::@:: A single hold-out split leaves some labeled examples out of training, so parameter estimation is based on less data than necessary. <!--SR:!2026-08-05,85,353!fsrs,2027-08-18T00:00:00.000Z,383,382.93736419,1,2,7,0,0,2026-07-31T00:00:00.000Z-->
...
- practical consequence of ridge versus LASSO geometry ::@:: Ridge is usually better thought of as smooth shrinkage, whereas LASSO is shrinkage plus built-in feature selection. <!--SR:!fsrs,2027-09-28T00:00:00.000Z,421,420.5570126,1,2,7,0,0,2026-08-03T00:00:00.000Z!2026-08-05,81,353-->
...
- $R^2$ score formula ::@:: The coefficient of determination is $R^2 = 1 - \frac{\sum_{i=1}^N (y_i - \hat y_i)^2}{\sum_{i=1}^N (y_i - \bar y)^2}$, where $\bar y$ is the sample mean. <!--SR:!fsrs,2027-10-22T00:00:00.000Z,444,443.56603989,1,2,7,0,0,2026-08-04T00:00:00.000Z!2026-08-05,80,341-->
...
- why fixed $\sigma$ recovers least squares ::@:: If $\sigma$ is fixed, then $\arg\min_w\bigl[c + a\cdot \frac{1}{N}\sum_i (y_i-w^\top x_i)^2\bigr] = \arg\min_w \frac{1}{N}\sum_i (y_i-w^\top x_i)^2$ for constants $c$ and $a>0$, so Gaussian negative log-likelihood has the same minimizer as MSE. <!--SR:!2026-08-11,86,353!2026-08-05,80,341-->
