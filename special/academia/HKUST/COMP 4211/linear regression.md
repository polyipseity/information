...
- pseudoinverse solution $\hat w = X^{+}y$ ::@:: When $X^\top X$ is not invertible, the Moore-Penrose pseudoinverse gives the minimum-norm least-squares solution $\hat w = X^{+}y$. <!--SR:!2026-08-04,84,353!2026-08-11,86,353-->
...
- linear regression as a special case of polynomial regression ::@:: Ordinary linear regression is the degree-$1$ special case of polynomial regression, because the allowed monomials are only $1,x_1,\ldots,x_p$. <!--SR:!fsrs,2027-09-29T00:00:00.000Z,425,425.17371081,1,2,7,0,0,2026-07-31T00:00:00.000Z!2026-08-04,84,353-->
...
- model selection by validation ::@:: To choose a hyperparameter, train candidate models on the training subset and pick the value with the smallest validation error. <!--SR:!2026-08-29,91,362!2026-08-04,84,353-->
...
- relation between OLS residuals and regressors ::@:: OLS residuals are orthogonal to all included regressors because the normal equation gives $X^\top(y-\hat y)=0$, regardless of whether an intercept is present. <!--SR:!fsrs,2027-09-29T00:00:00.000Z,421,420.5570126,1,2,7,0,0,2026-08-04T00:00:00.000Z!2026-08-04,84,353-->
...
- random variable in probabilistic linear regression ::@:: A random variable is a numerical quantity determined by the random data-generating process; in probabilistic linear regression, the response $Y$ is modeled as a random variable conditioned on the input $X$. <!--SR:!2026-08-11,86,353!2026-08-04,79,341-->
