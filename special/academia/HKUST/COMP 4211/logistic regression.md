...
- score-sign flip effect ::@:: Replacing $z$ by $-z$ replaces $p$ by $1-p$ and inverts the odds, so a score-sign flip swaps class preference. <!--SR:!2026-07-24,74,343!2026-08-07,85,351-->
...
- threshold conventions at $0.5$ ::@:: In this course, the equal-cost convention is predict class $1$ when $P(y=1\mid x,w)>0.5$; many texts instead use $P(y=1\mid x,w)\ge 0.5$, so the only difference is how the exact tie case $P(y=1\mid x,w)=0.5$ is resolved. <!--SR:!fsrs,2027-08-09T00:00:00.000Z,383,382.68390242,1,2,7,0,0,2026-07-22T00:00:00.000Z!2026-07-24,74,343-->
...
- intercept regularization and class imbalance ::@:: Over-penalizing the intercept can distort baseline class probabilities, especially when the true positive rate is far from $50\%$. <!--SR:!fsrs,2027-04-10T00:00:00.000Z,278,278.46760619,1,2,7,0,0,2026-07-06T00:00:00.000Z!2026-07-24,74,329-->
