...
- overview ::@:: Logistic regression is a discriminative probabilistic classifier that models $P(y\mid x)$ for binary labels by applying a sigmoid to an affine score. <!--SR:!2026-07-15,65,329!2026-08-03,81,351-->
...
- anti-swap memory cue for conditional form ::@:: In $\mathbb{E}_{(X,Y)\sim P}[-\log Q(Y\mid X)]$, data are always sampled from true $P$ and model quality is always evaluated through $Q$ inside the logarithm. <!--SR:!2026-07-26,76,329!2026-07-15,65,310-->
...
- thumbtack second-order check ::@:: Since $\frac{d^2\ell}{d\theta^2}=-\frac{m_H}{\theta^2}-\frac{m_T}{(1-\theta)^2}<0$ on $(0,1)$, the stationary point is a maximum. <!--SR:!2026-08-02,82,351!2026-07-15,65,329-->
...
- stochastic gradient descent and minibatches ::@:: Stochastic gradient descent updates parameters using randomly chosen data rather than the whole dataset; the single-example case uses one training pair, and the minibatch case uses a small random subset $B$ with update $\frac{1}{|B|}\sum_{i\in B}(y_i-p_i)x_{i,j}$. <!--SR:!fsrs,2027-04-21T00:00:00.000Z,287,287.11697064,1,2,7,0,0,2026-07-08T00:00:00.000Z!2026-07-15,65,310-->
...
- softmax score-shift invariance with index meanings ::@:: Adding the same vector to every class weight vector $w_c$ shifts every score $z_c$ by the same amount, so softmax probabilities stay unchanged because only relative score differences matter. <!--SR:!2026-07-15,65,310!2026-08-04,85,351-->
