...
- why direction in KL matters ::@:: Generally $D_{\mathrm{KL}}(P\Vert Q)\ne D_{\mathrm{KL}}(Q\Vert P)$ because swapping changes the expectation weights and therefore what kinds of mismatch are emphasized. <!--SR:!2026-07-22,72,337!2026-08-04,85,351-->
...
- why the score-level gradient simplifies so cleanly ::@:: The expression being simplified is $-\Bigl(y_i\frac{1}{p_i}p_i(1-p_i)-(1-y_i)\frac{1}{1-p_i}p_i(1-p_i)\Bigr)$. <br/> The reciprocal factors $1/p_i$ and $1/(1-p_i)$ cancel the matching pieces of the sigmoid derivative $p_i(1-p_i)$, leaving $-\bigl(y_i(1-p_i)-(1-y_i)p_i\bigr)$. <br/> That inner expression simplifies to $-(y_i-p_i)=p_i-y_i$, so the long chain-rule formula collapses to the clean residual form prediction minus target. <!--SR:!2026-07-22,72,337!2026-08-01,82,343-->
- residual-form interpretation after score differentiation ::@:: Once $\frac{\partial \ell_i}{\partial z_i}=p_i-y_i$ is known, using $\frac{\partial z_i}{\partial w}=x_i$ gives $\nabla_w\ell_i=(p_i-y_i)x_i$, so the residual tells how much the model overpredicts or underpredicts the positive class and $x_i$ converts that scalar correction into a parameter-space direction. <!--SR:!2026-07-22,72,343!fsrs,2027-07-28T00:00:00.000Z,373,373.43671089,1,2,7,0,0,2026-07-20T00:00:00.000Z-->
