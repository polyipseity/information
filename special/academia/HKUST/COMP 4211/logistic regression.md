...
- cost-sensitive Bayes threshold ::@:: If false-positive cost is $C_{FP}$ and false-negative cost is $C_{FN}$, then predict class $1$ when $C_{FP}P(y=0\mid x)<C_{FN}P(y=1\mid x)$, equivalently when $P(y=1\mid x)>\frac{C_{FP}}{C_{FP}+C_{FN}}$. <!--SR:!2026-07-21,71,329!2026-07-06,56,310-->
...
- sigmoid derivative: With $\sigma(z)=\frac{1}{1+e^{-z}}$, what is $\sigma'(z)$ and what convenient factored form does it take? ::@:: The sigmoid derivative is $\sigma'(z)=\sigma(z)(1-\sigma(z))$.  Derivation sketch: $\sigma'(z)=\frac{e^{-z}}{(1+e^{-z})^2}=\frac{1}{1+e^{-z}}\cdot\frac{e^{-z}}{1+e^{-z}}=\sigma(z)(1-\sigma(z))$, where $(1-\sigma(z))=\frac{e^{-z}}{1+e^{-z}}$. This factored form is numerically convenient because, once $p=\sigma(z)$ is computed in the forward pass, the derivative is free as $p(1-p)$. <!--SR:!2026-08-01,82,343!2026-07-06,56,310-->
...
- relative-odds interpretation in softmax with index meanings ::@:: In $\frac{P(y=c\mid x,W)}{P(y=d\mid x,W)}=e^{z_c-z_d}$, the indices $c$ and $d$ denote two specific classes being compared, so the formula says that pairwise class odds depend only on score differences. <!--SR:!2026-07-06,56,310!2026-07-30,80,351-->
