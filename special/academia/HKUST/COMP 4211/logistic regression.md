...
- empirical approximation of conditional cross entropy ::@:: In practice, conditional cross entropy is estimated by $\mathbb{E}_{\hat P_N}[-\log Q(Y\mid X)] = \frac{1}{N}\sum_{i=1}^N -\log Q(y_i\mid x_i)$. <!--SR:!2026-07-08,58,310!2026-07-27,77,337-->
...
- why gradient descent is used in logistic regression ::@:: Logistic regression is trained numerically because its likelihood-based objective does not reduce to the simple normal-equation solution used in ordinary least squares. <!--SR:!2026-07-29,79,343!2026-07-08,58,310-->
