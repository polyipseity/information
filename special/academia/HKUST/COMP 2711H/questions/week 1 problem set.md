...
1. definitions ::: For all natural numbers $a$ and $b$, $$\begin{aligned} a + 0 & = a && \text{definition 1} \\ a + S(b) & = S(a + b) && \text{definition 2} \\ a \cdot 0 & = a && \text{definition 3} \\ a \cdot S(b) & = a + a \cdot b && \text{definition 4} \end{aligned}$$. <!--SR:!2024-11-25,55,300!2024-12-16,75,320-->
...
- strategy ::: Prove by contradiction via infinite descent. Some properties of prime numbers should be important in the proof. <!--SR:!2024-10-24,30,280!2024-12-20,79,320-->
