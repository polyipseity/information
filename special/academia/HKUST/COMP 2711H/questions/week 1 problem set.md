...
- strategy / existence ::: Use induction, as it is usually more suitable for proving existence. <!--SR:!2024-10-29,36,290!2024-10-01,17,300-->
...
3. conclusion ::: That $n$ CAN be written as sa product of prime numbers contradicts that $n$ belongs to the set of natural numbers $A$ that CANNOT be written as a product of prime numbers. By contradiction, the set $A$ must be empty, so every natural number $n \ge 2$ can be written as a product of prime numbers. <!--SR:!2024-09-30,16,300!2024-10-26,33,300-->
