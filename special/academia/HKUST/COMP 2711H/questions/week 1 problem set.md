...
- strategy ::: Apply induction to prove commutativity for more specific cases. Then apply induction again to generalize the results. <!--SR:!2024-10-07,18,250!2024-10-30,36,300-->
...
1. base case ::: Without loss of generality, fix $a \in \mathbb N$. When $b = 1$. then $$a \cdot b = a \cdot 1 = a \cdot S(0) = a + a \cdot 0 = a + 0 = a$$. Thus the theorem is proved when $b = 1$. <!--SR:!2024-10-22,28,280!2024-09-30,16,300-->
