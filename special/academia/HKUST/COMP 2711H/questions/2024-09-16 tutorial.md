...
How many {@{routes are there in a _n_-by-_m_ grid from the bottom-left corner to the top-right corner}@}, assuming we can {@{only either walk up or right}@}? \(Use {@{the method of stars and bars}@}.\) <!--SR:!2026-03-26,146,310-->
