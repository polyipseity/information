...
2. construction ::@:: Consider the predicate $$P(n) := (\forall i \in \mathbb N_0) (a_i \ne n)$$, which states every element of the infinite sequence cannot be $n$. We can prove the above predicate holds for all $n \in \mathbb N_0$ by (strong) induction. <!--SR:!2025-11-07,317,356!2029-09-24,1442,375-->
