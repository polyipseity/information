...
- note<!-- flashcard 6ba8c155-6f06-42cc-a831-59c4fa17a01f --> ::: Induction, well-ordering principle, and infinite descent are logically equivalent, so it is possible to prove any one of them from any other.
...
3. base case ::: Consider $P(0)$. This predicate is true because if $a_i = 0$, then $a_{S(i)}$ cannot exist as $0$ is the least element of $\mathbb N_0$. Yet, this contradicts that the sequence is infinite.
