...
1. base case ::: The statement obviously holds when $n = 0$. <!--SR:!2024-09-28,14,290!2024-09-24,10,280-->
2. induction ::: Assume $$\sum_{k = 1}^n k = \frac {n (n + 1)} 2$$ is true. Then $$\sum_{k = 1}^{n + 1} k = \sum_{k = 1}^n k + (n + 1) = \frac {n(n + 1)} 2 + (n + 1) = \frac{(n + 2)(n + 1)} 2$$. By induction, this holds for all natural numbers $\mathbb N_0$. <!--SR:!2024-09-24,10,280!2024-09-23,9,280-->
...
Prove that {{in a tournament where each player plays against another player exactly once and every game has exactly one winner, we can always rank the $n$ players $p_1, \ldots, p_n$ such that $p_k$ has lost to $p_{k + 1}$ for all $1 \le k \le n - 1$}}. <!--SR:!2024-09-24,10,270-->
...
- strategy ::: Prove by contradiction. Think of ways to relate the well-ordering principle to natural numbers. One way they are related is that the well-ordering principle says any _nonempty_ set of natural numbers has a least natural number. So assume that the well-ordering principle does not hold, and there is an _nonempty_ set of natural numbers that does not have a least natural number. <!--SR:!2024-09-24,10,280!2024-10-02,18,300-->
...
- strategy ::: Prove by contradiction. Assume induction fails by assuming there is a set that satisfies the induction conditions but not its conclusion. <!--SR:!2024-09-20,8,250!2024-10-01,17,300-->
