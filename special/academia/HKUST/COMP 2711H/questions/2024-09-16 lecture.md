...
- number of derangements ::@:: This is known as a derangement. The number of derangements of _n_ distinct elements is also known as the subfactorial of _n_, !_n_, which is related to the factorial of _n_, _n_!, by $$!n = \begin{cases}1 \,, & n = 0 \\ \lfloor n! / e \rceil \,, & n > 0 && \lfloor * \rceil\text{ denotes the nearest integer} \,. \end{cases}$$ <!--SR:!2025-10-29,288,330!2028-04-26,967,330-->
