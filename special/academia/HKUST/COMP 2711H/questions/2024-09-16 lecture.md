...
How many ways are there to {@{arrange _n_ people in _r_ circles if person 1 and 2 cannot be next to each other}@}, where {@{_n_ ≥ 2 and _r_ ≥ 1}@}? ($s(n, r)$ from previous questions may be used. The solution uses summation.) <!--SR:!2028-09-18,1025,330!2025-12-29,20,365-->

- strategy ::@:: Use the exclusion principle. Treat person 1 and 2 as 1 person. Beware of the case of person 1 and 2 in a circle by themselves. <!--SR:!2026-01-08,351,349!2028-09-12,1105,349-->
...
We have _n_ students and {@{none of them want to sit in their own chairs}@}. How many {@{ways are there to arrange that}@}? (Recurrence relation is accepted.) <!--SR:!2029-11-08,1438,350!2025-12-29,20,365-->
