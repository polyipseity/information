...
- strategy ::@:: Identify the holes. In this case, the holes are splitting up the 3-by-3 square into 9 1-by-1 squares. <!--SR:!2029-04-01,1266,350!2029-05-03,1290,350-->
...
Prove that there exists $x, y \in \mathbb N$ such that {@{$2024 \mid (9^x - 9^y)$}@}. <!--SR:!2028-04-26,920,330-->

- strategy ::@:: First, convert the problem into a form using modular arithmetic: There exists $x, y \in \mathbb N$ such that $9^x \equiv 9^y \pmod {2024}$. Then realize that since $\gcd(9, 2024) = 1$, so $9^n \pmod {2024}$ will loop through all possible values from 0 to 2023 as _n_ increases. The holes are the 2024 possible natural numbers modulus 2024. <!--SR:!2029-04-28,1286,350!2029-03-02,1242,350-->
...
Let $X \subseteq \set{1, 2, \ldots, 99}$ and |_X_| = 10. Show that {@{there are two disjoint nonempty subsets of _X_ with the same sum}@}. <!--SR:!2029-05-12,1297,350-->

- strategy ::@:: The holes are the possible sums, 1 to 855. The pigeons are elements of the power set of _X_, which have 2<sup>10</sup> = 1024 elements. <!--SR:!2029-06-10,1320,350!2029-03-19,1256,350-->
