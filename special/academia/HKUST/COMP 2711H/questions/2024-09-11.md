...
- solution ::@:: For each element in the set, we can choose to exclude or include it in the subset. So there are $2^n$ possible choices, and thus $2^n$ subsets. <!--SR:!2028-11-28,1172,350!2025-09-15,259,330-->
