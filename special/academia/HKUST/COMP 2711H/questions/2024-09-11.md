...
- solution ::@:: Since the subset must have the element $a$, there is only one choice for whether to include said element. However, everything else is unchanged, so there are $2^{n - 1}$ possible subsets. <!--SR:!2028-12-30,1199,350!2025-09-19,263,330-->
