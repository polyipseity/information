...
Find the number of integer solutions to {@{$$x_1 + x_2 + x_3 = 10$$ subject to the following constraints $$0 \le x_1 \le 5, 0 \le x_2 \le 8, 0 \le x_3 \le 7$$}@}. <!--SR:!2028-02-09,909,330-->
