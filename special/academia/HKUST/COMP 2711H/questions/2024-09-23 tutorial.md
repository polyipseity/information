...
How many {@{prime numbers are less than 50}@}? <!--SR:!2029-10-16,1421,350-->
...
Find the number of integer solutions to {@{$$x_1 + x_2 + x_3 = 10$$}@} subject to {@{the following constraints $$0 \le x_1 \le 5, 0 \le x_2 \le 8, 0 \le x_3 \le 7$$}@}. <!--SR:!2028-02-09,909,330!2027-01-27,422,379-->

- strategy ::@:: Define the subsets $A_1, A_2, A_3$ to be the number of integers violating each of the constraint above. The inclusion–exclusion principle may then be applied to said subsets. <p> Additionally, observe that two or more constraints cannot be violated at the same time to save work. <!--SR:!2029-10-13,1418,350!2027-01-27,605,310-->
...
How many paths {@{pass through exactly 3 marked paths}@}? <!--SR:!2029-10-06,1410,350-->
