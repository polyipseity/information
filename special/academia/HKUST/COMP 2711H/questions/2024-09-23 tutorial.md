...
- strategy ::@:: The prime numbers that are relevant for this question must not exceed $\lfloor \sqrt 50 \rfloor = 7$. Then define the subsets $A_1, A_2, A_3, A_4$ to be the set of numbers divisible by respectively 2, 3, 5, 7. The inclusion–exclusion principle may then be applied to said subsets. <!--SR:!2025-10-28,287,330!2028-04-19,962,330-->

## integer sum with constraints

Find the number of integer solutions to {@{$$x_1 + x_2 + x_3 = 10$$}@} subject to {@{the following constraints $$0 \le x_1 \le 5, 0 \le x_2 \le 8, 0 \le x_3 \le 7$$}@}. <!--SR:!2028-02-09,909,330!2025-09-06,19,339-->
