...
A set $A$ is a subset of $B$ iff {@{every element of $A$ is in $B$}@}. In particular, {@{the empty set $\varnothing$ and the set $B$ itself}@} are {@{both subsets of $B$}@}. <!--SR:!2028-04-19,921,330!2027-11-28,635,410!2026-03-04,120,390-->
