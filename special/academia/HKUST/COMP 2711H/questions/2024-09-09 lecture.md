...
A set $A$ is a subset of $B$ iff {@{every element of $A$ is in $B$}@}. In particular, {@{the empty set $\varnothing$ and the set $B$ itself}@} are {@{both subsets of $B$}@}. <!--SR:!2028-04-19,921,330!2025-09-30,5,350!2025-09-30,5,350-->
...
1. If $a = b$, then player 1 eventually cannot take any more objects and loses. ::@:: Base case: If $(a, b) = (0, 0)$, player 1 cannot take any more objects. Induction step: Prove that $(a, b) = (n + 1, n + 1)$ must lead to a game state of $(a, b) = (m, m)$ for some $m \le n$, and invoke the strong induction hypothesis. <!--SR:!2028-03-28,903,330!2025-10-12,279,330-->
