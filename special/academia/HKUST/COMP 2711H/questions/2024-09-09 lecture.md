...
{@{The Fibonacci numbers}@} are defined by: {@{$$F_n = \begin{cases} 0, & n = 0 \\ 1, & n = 1 \\ F_{n - 1} + F_{n - 2} & n \ge 2 \end{cases} \,.$$}@} <!--SR:!2029-03-11,1250,350!2025-11-07,5,359-->
...
Prove {@{the sum of sequence of cubes}@}: {@{$$\forall n \in \mathbb N_0 \qquad \sum_{i = 0}^n i^3 = \left(\sum_{i = 0}^n i \right)^2 = \frac {n^2 (n + 1)^2} 4 \,.$$}@} <!--SR:!2028-02-01,815,290!2025-11-07,5,359-->
