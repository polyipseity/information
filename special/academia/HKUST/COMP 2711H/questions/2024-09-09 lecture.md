...
1. Prove the sum of Fibonacci numbers: $$\forall n \in \mathbb N_0 \qquad \sum_{i = 0}^n F_i = F_{n + 2} - 1$$ ::@:: Apply induction. <!--SR:!2029-04-22,1285,350!2025-10-17,284,330-->
...
- strategy ::@:: Apply induction. For the induction set, consider the effect of adding a new element. <!--SR:!2029-03-17,1255,350!2025-10-17,284,330-->
