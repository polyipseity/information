...
Prove {@{the sum of sequence of cubes}@}: {@{$$\forall n \in \mathbb N_0 \qquad \sum_{i = 0}^n i^3 = \left(\sum_{i = 0}^n i \right)^2 = \frac {n^2 (n + 1)^2} 4 \,.$$}@} <!--SR:!2028-02-01,815,290!2025-12-07,25,379-->
