...
2. Prove the sum of odd Fibonacci numbers: $$\forall n \in \mathbb N_0 \qquad \sum_{i = 1}^n F_{2i - 1} = F_{2n}$$ ::@:: Apply induction. Or prove using the sum of even Fibonacci numbers (3) (but remember to avoid circular reasoning). <!--SR:!2025-11-04,257,290!2029-03-22,1259,350-->
...
A set $A$ is a subset of $B$ iff {@{every element of $A$ is in $B$}@}. In particular, {@{the empty set $\varnothing$ and the set $B$ itself}@} are {@{both subsets of $B$}@}. <!--SR:!2028-04-19,921,330!2025-11-04,23,370!2025-11-04,23,370-->
