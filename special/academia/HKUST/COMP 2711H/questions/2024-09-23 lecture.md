...
What is the {@{number of derangement of _n_ elements}@} without {@{using the inclusion–exclusion principle}@}? <!--SR:!2028-06-03,950,330!2025-10-21,5,353-->
...
How many {@{onto functions \(every element in the co-domain has at least one element in the domain mapped to it\)}@} are there from {@{a domain of _n_ elements to a co-domain of _m_ elements}@}? \(No need to {@{care about base cases}@}.\) <!--SR:!2029-04-07,1271,350!2025-11-03,19,365!2025-11-03,19,365-->
...
How many paths {@{do not go through any of the marked segments}@}? How many paths {@{go through exactly 2 of the marked segments}@}? \({@{A recurrence relation}@} is accepted.\) <!--SR:!2029-02-21,1236,350!2029-04-23,1284,350!2025-10-21,5,353-->
