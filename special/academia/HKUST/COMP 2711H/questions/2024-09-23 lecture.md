...
What is the {@{number of permutations of _n_ elements with exactly _k_ ≤ _n_ fixed points}@}, i.e. {@{exactly _k_ elements are mapped to their original positions}@}? \(You are allowed to use {@{the number of derangements of _n_ elements, denoted $d_n$}@}.\) <!--SR:!2029-03-21,1256,350!2026-02-15,103,385!2026-02-15,103,385-->
