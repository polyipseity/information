...
How many {@{onto functions \(every element in the co-domain has at least one element in the domain mapped to it\)}@} are there from {@{a domain of _n_ elements to a co-domain of _m_ elements}@}? \(No need to {@{care about base cases}@}.\) <!--SR:!2029-04-07,1271,350!2026-02-09,98,385!2026-02-06,95,385-->
