...
What is the {@{number of derangement of _n_ elements without using the inclusion–exclusion principle}@}? <!--SR:!2025-10-27,288,330-->
...
How many paths {@{do not go through any of the marked segments}@}? How many paths {@{go through exactly 2 of the marked segments}@}? (A recurrence relation is accepted.) <!--SR:!2029-02-21,1236,350!2029-04-23,1284,350-->
