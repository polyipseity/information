...
What is the {@{number of permutations of _n_ elements with exactly _k_ ≤ _n_ fixed points}@}, i.e. {@{exactly _k_ elements are mapped to their original positions}@}? \(You are allowed to use {@{the number of derangements of _n_ elements, denoted $d_n$}@}.\) <!--SR:!2029-03-21,1256,350!2025-10-01,4,345!2025-10-01,4,345-->
...
How many {@{onto functions \(every element in the co-domain has at least one element in the domain mapped to it\)}@} are there from {@{a domain of _n_ elements to a co-domain of _m_ elements}@}? \(No need to {@{care about base cases}@}.\) <!--SR:!2029-04-07,1271,350!2025-10-01,4,345!2025-10-01,4,345-->
...
2. divisible by 2 ::@:: How many natural numbers not greater than 1000 are divisible by 2? <!--SR:!2025-10-15,279,330!2025-10-26,287,330-->
