...
- solution ::@:: Let $d_n$ be the number of derangement of _n_ elements. As we have derived before, $d_n = (n - 1) (d_{n - 1} + d_{n - 2})$. The base cases are $d_0 = 1$ and $d_1 = 0$. <!--SR:!2025-10-02,268,330!2025-07-26,198,310-->
...
- strategy ::@:: Without the inclusion–exclusion principle, we would usually try to find recurrence relations. When considering recurrence relations, we try to find how the additional or removal of an element would preserve the property we desire (in this case, onto functions). In this case, we can add/remove an element in the domain, in the co-domain, or reinterpret the problem. <!--SR:!2025-10-05,271,330!2025-07-27,199,310-->
- solution
