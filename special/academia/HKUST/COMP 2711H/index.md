...
- [graph theory](../../../../general/graph%20theory.md)
  ...
  - graph theory / trail ::: A __trail__ is a walk with no repeated edges. <!--SR:!2024-10-28,8,317!2024-10-21,4,337-->
...
- theorem: minimum number of connected components (CC) ::: A graph has at least |_V_| - |_E_| connected components. <p> To prove this, consider the |_V_| vertices without any edges. There are _V_ CCs, by definition. Now consider the effect of adding an edge. This decreases the number of CCs by at most 1. After adding |_E_| edges, the number of CCs has decreased by at most |_E_|. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
  - theorem: minimum number of connected components (CC) / corollary: connected graph ::: Every connected graph has |_E_| ≥ |_V_| - 1. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
...
- theorem: even degree, cycle ::: If every vertex has an even degree, the edge set is a disjoint union of cycles. <p> To prove this, we can apply induction on the number of edges. The base cases are 0 and 1 edges. The induction step can be proved by starting from a vertex and show that it eventually ends at the same vertex; remove that cycle and the induction hypothesis can be applied. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
- graph theory
...
- theorem: directed simple graph, cycle, strongly connected component ::: A directed simple graph (no self-loops) has no cycles iff every vertex is a strongly connected component by itself. <p> To prove this and its converse, use contradiction. <!--SR:!2024-10-22,4,349!2024-10-21,3,329-->
- graph theory
...
- theorem: directed acyclic graph, topological ordering ::: A directed graph is a directed acyclic graph (DAG) iff the graph has a topological ordering. <p> To prove this and is converse, use contradiction. Two lemmas below and depth-first search (DFS) are useful here. <!--SR:!2024-10-21,3,328!2024-10-22,4,349-->
...
- theorem: tree, center ::: A tree either has one center or two _neighboring_ centers. <p> This can be proven using strong induction. Prove the base case for |_V_| = 1 and |_V_| = 2. Then realize that any tree can be transformed into a smaller one by removing all of its leaves so that we can apply the induction hypothesis. After applying the hypothesis, re-adding the leaves preserves the centers. Consider the smaller tree with its centers as the roots to figure out why re-adding the leaves preserves the centers. <!--SR:!2024-10-21,3,329!2024-10-23,5,348-->
...
- theorem: minimal vertex cover, maximal matching ::: In every graph, the minimal vertex cover has a size of at least that of maximal matching. <p> To prove this, consider a maximal matching. For every edge in the maximal matching, one point must be in the vertex cover. <!--SR:!2024-10-22,4,349!2024-10-22,4,349-->
- theorem: minimal vertex cover, maximal matching, bipartite graph ::: In every bipartite graph, the minimal vertex cover has a size equals that of maximal matching. <p> To prove this, we can prove the minimal vertex cover has a size smaller or equal to that of maximal matching. Consider a maximal matching in a bipartite graph. Then consider a minimal vertex cover and split the two bipartition sets into two separate bipartitions depending on if the element is in the minimal vertex cover. Show that the minimal vertex cover implies the existence of a maximal matching on both bipartitions, which can be merged back to get a maximal matching on the original bipartition. <p> Combining with the previous theorem gives us the equality result. <!--SR:!2024-10-21,3,329!2024-10-22,4,349-->
