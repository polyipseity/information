...
- graph theory
  ...
  - graph theory / tree ::: A __tree__ is (1) a connected graph, (2) has _n_ - 1 edges, and (3) has no cycles. The definition actually only requires two properties out of the properties (1), (2), (3), since the third property can be proven from any other 2. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
...
- [Prüfer sequence](../../../../general/Prüfer%20sequence.md) ::: A sequence of |_V_| - 2 nodes to uniquely encode all possible trees on |_V_| vertices. This means encoding a Prüfer sequence from a tree in the domain of all possible trees is a bijection. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
  - theorem: number of possible trees ::: There are $\lvert V \rvert^{\lvert V \rvert - 2}$ possible trees. <p> To prove this, we can use the Prüfer sequence, which can uniquely encode all possible trees. The length of a Prüfer sequence is _n_ - 2 and there are _n_ possible choice for each element. <p> The Prüfer sequence also provides a way to find the number of possible trees with restrictions. For example, the number of possible trees on a complete bipartite graph, with _x_ and _y_ vertices in the two partitions, is $x^{y - 1} y^{x - 1}$. <!--SR:!2024-10-20,3,317!2024-10-21,4,337-->
    - [combinatorial proof § the difference between bijective and double counting proofs](../../../../general/combinatorial%20proof.md#the%20difference%20between%20bijective%20and%20double%20counting%20proofs) ::: We can also use a combinatorial proof to prove the above identity. See the linked section. <!--SR:!2024-10-21,4,337!2024-10-20,3,317-->
  - Prüfer sequence / encoding ::: Assume the nodes are labelled from 1 to |_V_|. Find the leaf with the smallest node. Add the node of the leaf's neighbor. Remove the leaf. Repeat until there is only 1 edge (or 2 vertices) left. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
...
- theorem: connected graph and one-vertex cut-set (different from the edge-based cut-set above) ::: Every connected graph with |_V_| ≥ has at least two non-cut vertices (vertices that when removed from the graph, will not result in two separate connected graphs). <p> To prove this, use the extremal principle on the possible paths in a tree. In particular, assert the existence of a longest path. Then show that vertices at the path ends cannot be removed and lead to any two neighbors of them being disconnected, which proves the theorem. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
- graph theory
  - graph theory / even cycle ::: A cycle with an even number of vertices. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
  - graph theory / odd cycle ::: A cycle with an odd number of vertices. <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
...
- graph theory
  - graph theory / degree sequence ::: It is the non-increasing sequence of an undirected graph's vertex degrees. (Amir uses non-decreasing for some reason... but it should be equivalent). <!--SR:!2024-10-21,4,337!2024-10-21,4,337-->
