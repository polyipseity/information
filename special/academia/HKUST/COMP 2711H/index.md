...
- [first-order logic](../../../../general/first-order%20logic.md)
  ...
  - [predicate](../../../../general/predicate%20(mathematical%20logic).md) ::@:: A statement that becomes a proposition when the one or more unknowns are replaced by specified values from the universe. The universe is the set of all possible values for the unknowns. <!--SR:!2024-11-24,55,310!2025-05-27,193,323-->
