...
- theorem: connected graph, one-edge cut-set, cycle ::: If a cut-set of a connected graph consists of one edge only, the edge is not part of any cycle. The converse also holds: If an edge is not part of any cycle, it can be a cut-set. <p> To prove theorem and its converse, prove by contradiction.
...
- theorem: directed simple graph, cycle, strongly connected component ::: A directed simple graph (no self-loops) has no cycles iff every vertex is a strongly connected component by itself. <p> To prove this and its converse, use contradiction.
- graph theory
