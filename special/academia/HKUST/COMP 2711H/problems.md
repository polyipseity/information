...
- strategy ::: Induction, obviously. <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
...
2. manipulation ::: $$\begin{aligned} \sqrt 2 & = \frac a b \\ 2 & = \frac {a^2} {b^2} \\ 2b^2 & = a^2 \\ & \implies 2 \mid a \\ a & := 2c && c \in \mathbb N_0 \\ \\ 2b^2 & = 4c^2 \\ b^2 & = 2c^2 \\ & \implies 2 \mid b \\ b & := 2d && d \in \mathbb N_0 \\ \\ \sqrt 2 & = \frac a b = \frac {2c} {2d} = \frac c d \end{aligned}$$ <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
...
- strategy ::: Assume there are finitely many prime numbers. Consider the product of all prime numbers plus 1. Prove the opposite by constructing an infinite descent, and thus contradiction. <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
...
1. base case ::: When $n = 1$, there are 2 or more "pigeons". There is only 1 "hole" to put them into. <!--SR:!2024-09-12,3,250!2024-09-13,4,280-->
...
- strategy ::: Consider $n = 2$. <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->

1. solution ::: The induction argument fails prove the above proposition for $n = 2$. When $n = 2$, we say the first $n - 1 = 1$ car have the same color, and the last $1$ car also have the same color. But they have $0$ cars in common, so we cannot say the two sets of cars have the same colors. <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->

### ranking players in a tournament

Prove that {{in a tournament where each player plays against another player exactly once and every game has exactly one winner, we can always rank the $n$ players $p_1, \ldots, p_n$ such that $p_i$ has lost to $p_{k + 1}$ for all $1 \le k \le n + 1$}}. <!--SR:!2024-09-13,4,270-->
...
- note ::: Induction, well-ordering principle, and infinite descent are logically equivalent, so it is possible to prove any one of them from any other. <!--SR:!2024-09-13,4,298!2024-09-13,4,298-->
...
- strategy ::: Apply induction several times. Also, prove commutativity for more specific cases. Then apply induction to generalize it. <!--SR:!2024-09-12,3,250!2024-09-13,4,280-->
...
6. commutativity of multiplication / lemma 4 ::: Lemma 4: $$S(a) \cdot b = b + a \cdot b$$ for all $a, b \in \mathbb N_0$. Without loss of generality, fix $a$. When $b = 0$, $$\begin{aligned} S(a) \cdot 0 & = 0 && \text{definition 3} \\ & = 0 + 0 && \text{definition 1} \\ & = 0 + a \cdot 0 && \text{definition 3} \end{aligned}$$. So the lemma is true for $0$. Assume the lemma is true for $b$. Consider $S(b)$: $$\begin{aligned} S(a) \cdot S(b) & = S(a) + S(a) \cdot b && \text{definition 4} \\ & = S(a) + (b + a \cdot b) && \text{assumption} \\ & = S(a) + b + a \cdot b && \text{addition associates} \\ & = a + S(b) + a \cdot b && \text{lemma 2, definition 2} \\ <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
...
- strategy / existence ::: For existence, use induction (induction is usually more suitable for existence). <!--SR:!2024-09-13,4,270!2024-09-13,4,280-->
...
- strategy ::: Since the Fibonacci sequence is recursively defined, it is likely best to use induction. But proving the induction can use contradiction. <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
...
1. assumption ::: Assume there exists a nonempty set of natural number at least 2 $A$ that cannot be written as a product of prime numbers. Then by the well-ordering principle, there exists a least natural number $n \ge 2$ that cannot be written as a product of prime numbers. <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
...
3. conclusion ::: That $n$ CAN be written as sa product of prime numbers contradicts that $n$ belongs to the set of natural numbmers $A$ that cannot be written as a product of prime numbers. By contradiction, the set $A$ must be empty, so every natural number $n \ge 2$ can be written as a product of prime numbers. <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
...
- possibility of knight's tours ::: Let there be a _m_ × _n_ board with _m_ ≤ _n_. A knight's tour (possibly _open_) is always possible unless _m_ = 1 or 2; _m_ = 3 and _n_ = 3, 5, or 6; and _m_ = 4 and _n_ = 4. <!--SR:!2024-09-13,4,280!2024-09-12,3,250-->
...
- strategy ::: Prove by induction. Use the defintion of $\ge$. <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
...
- strategy ::: A trivial application of the pigeonhole principle. Of course, if Amir wants you to prove the slightly more generealized pigeonhole principle, just use induction (which will not be shown here). <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->

1. solution ::: There are at most 31 days in a month. By the pigeonhole principle, there is at least a day with $\lceil 64 / 31 \rceil = 3$ students whose birthdays are on that day (ignoring the month). <!--SR:!2024-09-13,4,280!2024-09-13,4,280-->
