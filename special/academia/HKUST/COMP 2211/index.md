...
- [NumPy](../../../../general/NumPy.md) ::@:: __NumPy__ (__Numerical Python__, but no one uses this...) is a Python library supporting _high-performance, large, multi-dimensional arrays and matrices_, along with high-level mathematical functions to operate on these arrays. It is used for _numeric and scientific computing_. <!--SR:!2026-01-01,335,350!2025-12-24,327,350-->
  ...
  - NumPy / tensor ::@:: _N_-dimensional array of numbers (in general, elements of a field) for _N_ ≥ 0 <!--SR:!2027-11-28,847,332!2025-08-18,219,330-->
...
- [ReLU](../../../../general/rectifier%20(neural%20networks).md) ::@:: $$f(x) = \max(0, x)$$ <!--SR:!2026-07-02,456,399!2026-07-19,471,401-->
  ...
  - ReLU / initialization ::@:: Good to scale input data to \[0, 1\] before training \(as the range of the activation function is \[0, +∞\)\). Good to use "He Normal" or "He Uniform" weight initialization. <p> Code: `kernel_initializer=tf.keras.initializers.HeNormal()`, `kernel_initializer=tf.keras.initializers.HeUniform()`. <!--SR:!2026-04-11,383,386!2025-11-16,249,362-->
    - `tf.keras.initializers.HeNormal()` ::@:: It draws samples from a truncated normal distribution centered on 0 with `stddev = sqrt(2 / fan_in)` where `fan_in` is the number of input units in the weight tensor. <!--SR:!2025-10-14,223,359!2027-02-20,566,339-->
...
- reference materials: Self-reading, but err... maybe tested?
  ...
  - image histogram ::@:: An image histogram is a graphical representation of _the number of pixels in an image as a function of their intensity_. <p> In OpenCV, you can use `cv2.calcHist(...)`. <!--SR:!2026-07-29,477,398!2025-10-09,218,359-->
    - `cv2.calcHist(images, channels, mask, histSize, ranges[, hist[, accumulate]])` ::@:: For example: `hist = cv2.calcHist([imgUint], [0], None, [256], [0, 256])`. <!--SR:!2027-09-26,784,361!2025-08-25,182,345-->
