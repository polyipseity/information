...
- [_k_-nearest neighbors algorithm](../../../../general/k-nearest%20neighbors%20algorithm.md)
  - _k_-nearest neighbors algorithm / tie-breaking ::@:: Decrease _k_ by 1 until we break the tie. <p> Or, put more weight for training points that are closer, such as weighing by 1/_d_, where _d_ is the distance between the training point and the test point. <!--SR:!2026-01-06,338,350!2028-10-15,1107,350-->
...
- [_k_-means clustering](../../../../general/k-means%20clustering.md)
  ...
  - _k_-means clustering / advantages ::@:: easy to understand and implement, efficient given _k_ and the number of iterations are small <!--SR:!2029-01-06,1191,352!2025-10-11,228,290-->
