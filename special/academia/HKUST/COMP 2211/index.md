...
- supplementary notes
  ...
  - [F1-score](../../../../general/F-score.md) ::@:: $$\frac {2 \times \text{precision} \times \text{recall} } {\text{precision} + \text{recall} } = \frac {2\text{TP} } {2\text{TP} + \text{FP} + \text{FN} }$$ <p> In a perfect world, we want a model that has a precision of 1 and a recall of 1. That means a F1-score of 1, i.e., a 100% accuracy which is often not the case for a machine learning model. <!--SR:!2029-07-20,1229,369!2026-10-13,499,389-->
    ...
    - weighted F1 ::@:: It calculates metrics for each class individually and then take weighted mean of the measures, weighted by numbers of samples of each class. <!--SR:!fsrs,2032-05-09T00:00:00.000Z,2126,2125.84414965,1,2,10,0,0,2026-07-14T00:00:00.000Z!2026-07-21,464,389-->
...
- image operations
  - image operations / point
    ...
    - contrast stretching ::@:: Adjust the contrast of images. It attempts to improve an image by _stretching the range of intensity values_. <!--SR:!2026-08-09,489,405!2026-10-22,551,406-->
      - contrast stretching / algorithm ::@:: Basically expanding the range of intensity from \[min, max\] to the full \[0, 255\] (or \[0, 1\] or some other ranges): $$I_{\text{new} } = \frac {I - I_{\text{min} } } {I_{\text{max} } - I_{\text{min} } } \times 255 \,.$$ In general, this is known as _normalization_. <!--SR:!2026-07-21,473,405!fsrs,2032-04-25T00:00:00.000Z,2122,2121.81441071,1,2,10,0,0,2026-07-04T00:00:00.000Z-->
