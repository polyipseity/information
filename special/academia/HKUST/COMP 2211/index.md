...
- [naive Bayes classifier](../../../../general/naive%20Bayes%20classifier.md)
  ...
  - naive Bayes classifier / applications ::@:: multi-class prediction, recommendation system, real-time prediction (fast algorithm), text classification (good at this; sentient analysis, spam filtering) <!--SR:!2026-09-05,461,290!2025-09-19,206,272-->
...
- [_k_-nearest neighbors algorithm](../../../../general/k-nearest%20neighbors%20algorithm.md)
  ...
  - _k_-nearest neighbors algorithm / applications ::@:: fast content-based image retrieval, fault detection for semiconductor manufacturing processes, handwritten character classification, intrusion detection <!--SR:!2025-06-12,155,310!2027-01-05,583,330-->
- supplementary notes
...
- [_k_-means clustering](../../../../general/k-means%20clustering.md) ::@:: __<!-- markdown separator -->_k_-means clustering__ is a method of vector quantization, originally from signal processing, that aims to partition _n_ observations into _k_ clusters in which each observation belongs to the cluster with the nearest mean (cluster centers or cluster centroid), serving as a prototype of the cluster. <!--SR:!2026-10-01,511,312!2025-12-18,322,350-->
  - _k_-means clustering / characteristics ::@:: does not require data to be labeled, hyperparameter _k_, parametric (centroid locations), unsupervised <!--SR:!2025-06-27,164,310!2027-02-06,615,330-->
...
- report
  ...
  - perceptron and multilayer perceptron
    ...
    - forward propagation, prediction (-2) ::@:: Forward propagation takes more memory than prediction because intermediate values needs to be stored for backward propagation later. <!--SR:!2025-06-06,135,399!2027-05-27,722,419-->
  ...
  - minimax and alpha–beta pruning
    - alpha–beta pruning (-1) ::@:: I did not check carefully on each exploration of a new branch. <!--SR:!2025-06-07,136,399!2027-05-30,725,419-->
  - AI ethics
    ...
    - ways to identify and resolve model biases (-1) ::@:: I need to write 2 answers. However, I have crossed out one that I had found unsatisfactory but have not added back a new one. Maybe time issue? <!--SR:!2025-06-09,138,399!2027-05-14,712,419-->
  - incident (0) ::@:: They suddenly changed score almost a week after after the total scores had been calculated. <!--SR:!2025-06-13,132,402!2027-04-15,680,422-->
    - incident / question (0) ::@:: The question asked us to write down 3 properties of ReLU. The solution was "continuous, linear, piecewise". <p> They had changed the marking scheme to such that if we did not answer the above 3 properties but gave other reasonable properties, 0.5 marks out of 1.5 marks were deducted. <p> (I don't remember answering the above 3 properties exactly, but probably something like "continuous, differentiable almost everywhere, ???" but somehow didn't have change in my score... Hehe) <!--SR:!2025-06-21,139,402!2026-11-05,522,402-->
- check
