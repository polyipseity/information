...
- [Bayes' theorem](../../../../general/Bayes'%20theorem.md#statement%20of%20the%20theorem)
  ...
  - Bayes' theorem / continuous features ::@:: It works with continuous features, which are described by probability distribution functions (PDFs) instead of probability mass functions (PMFs). Intuitively, this is because the infinitesimals cancel out. <!--SR:!2032-05-09,2190,409!2026-06-22,440,389-->
