...
- reference materials: Self-reading, but err... maybe tested?
  ...
  - brightness adjustment
    - brightness adjustment / OpenCV ::@:: You can use `cv2.convertScaleAbs(...)`. <!--SR:!2025-04-05,91,386!2025-04-05,91,385-->
      - `cv2.convertScaleAbs(image[, alpha = 1][, beta = 0])` ::@:: $$\operatorname{dst}(I)=\operatorname{saturate\_cast<uchar>}(\lvert \operatorname{src}(I) \times \alpha + \beta \rvert)$$ <!--SR:!2025-02-19,50,342!2025-07-24,160,342-->
  - gamma correction
