...
- [identity (activation)](../../../../general/identity%20function.md) ::@:: $$f(x) = x$$ <!--SR:!2026-09-13,518,406!fsrs,2032-09-27T00:00:00.000Z,2242,2242.24024358,1,2,10,0,0,2026-08-08T00:00:00.000Z-->
...
- [digital image](../../../../general/digital%20image.md)
    ...
    - `matplotlib.image.imsave(fname, arr)` ::@:: __`fname`__: a path or a file-like object to store the image in. <p> __`arr`__: The image data. The shape can be one of M×N (luminance), M × N × 3 (RGB) or M × N × 4 (RGBA). The first two dimensions (M,N) define the rows (height) and columns (width) of the image. <!--SR:!2031-10-24,2011,405!2026-09-13,469,361-->
