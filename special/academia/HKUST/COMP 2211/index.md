...
- kernel
    ...
    - kernel / edge handling
        - kernel / edge handling / Keras ::@:: Many layers support `padding=valid` and `padding=same`. The former means no padding, while the latter _zero_ pads such that the output size is the same as the input size, _assuming stride is 1_ (even if it is not). <!--SR:!2026-10-17,546,405!fsrs,2032-03-16T00:00:00.000Z,2090,2089.53617638,1,2,10,0,0,2026-06-26T00:00:00.000Z-->
- [convolutional neural network](../../../../general/convolutional%20neural%20network.md)
