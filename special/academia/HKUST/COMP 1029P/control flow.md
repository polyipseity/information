...
If {{there are no statements to be executed in an iteration}}, you {{must still put a properly indented `pass` statement, which does nothing, for that iteration}}. For example: <!--SR:!2024-10-19,19,345!2024-10-18,18,345-->
...
You can of course {{put branches and loops}} inside loops. <!--SR:!2024-10-17,17,345-->
