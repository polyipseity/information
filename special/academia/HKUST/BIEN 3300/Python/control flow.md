...
If there are {@{no statements to be executed in a branch}@}, you {@{must still put a properly indented `pass` statement}@}, which {@{does nothing, for that branch}@}. This is also {@{true for other control flow constructs introduced below}@}. For example: <!--SR:!2025-12-31,66,310!2025-12-31,66,310!2025-12-18,55,310!2025-12-08,4,330-->
...
If there are {@{no statements to be executed in an iteration}@}, you {@{must still put a properly indented `pass` statement}@}, which {@{does nothing, for that iteration}@}. For example: <!--SR:!2025-12-30,65,310!2025-12-27,63,310!2025-12-08,4,330-->
