...
- `<`→::@::←`<=` <!--SR:!2026-08-27,250,330!2025-12-24,60,310-->
...
- `and`→::@::←`or` <!--SR:!2026-08-26,249,330!2025-12-31,66,310-->
- `or`→::@::←_(end)_ <!--SR:!2025-12-30,65,310!2026-08-25,248,330-->
...
In particular, {@{`and` has a higher precedence than `or`}@}. This implies {@{`True or False and False` is `True or (False and False)`}@} instead of {@{`(True or False) and False`}@}. The former \(the correct one\) {@{is `True` while the latter \(the wrong one\) is `False`}@}. <!--SR:!2025-12-26,62,310!2026-04-08,122,290!2025-12-25,61,310!2025-12-27,18,355-->
