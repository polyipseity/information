...
To open a file in reading mode, use {@{`open(path, "r")` or `open(path)`}@}. To open the file in writing mode, use {@{`open(path, "w")`}@}. <!--SR:!fsrs,2030-04-09T00:00:00.000Z,1260,1259.53358194,1,2,9,0,0,2026-10-27T00:00:00.000Z!fsrs,2029-12-01T00:00:00.000Z,1157,1156.92457827,1,2,9,0,0,2026-10-01T00:00:00.000Z-->
