...
In Python, comments start {@{with `#` and end at end of line}@}: <!--SR:!2025-09-25,4,270-->
...
If you want multiline comments, you can use {@{multiline strings to emulate it}@}: <!--SR:!2025-09-25,4,270-->
...
Docstrings {@{are documentations for classes and functions}@}. To add a docstring, {@{add a multiline comment right below the start of the class or function}@}: <!--SR:!2025-09-25,4,270!2025-09-25,4,270-->
