...
- `<str>.rfind(<substr>)` ::@:: Get the index of the _last_ occurrence of `<substr>` in `<str>`, or raise `ValueError` if not found. <!--SR:!2026-10-19,282,330!fsrs,2030-02-15T00:00:00.000Z,1218,1217.87747351,1,2,9,0,0,2026-10-16T00:00:00.000Z-->
