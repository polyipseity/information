...
app.get("/query", // Whenever we GET /query, ...
  (req, res) => {
    res.json({
      query: req.query,
...
app.post("/body-parser/json", // Whenever we POST /body-parser/json, ...
...
app.post("/body-parser/urlencoded", // Whenever we POST /body-parser/urlencoded
...
app.post("/body-parser/urlencoded/unextended", // Whenever we POST /body-parser/urlencoded-unextended
  bodyParser.urlencoded({
