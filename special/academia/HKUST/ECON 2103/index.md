...
- [supply and demand](../../../../general/supply%20and%20demand.md) ::: An economic model of price determination in a market.
  - supply and demand / demand ::: It describes how much buyers are willing to buy given a price level. It can also be interpreted as the _maximum_ price buyers are willing to pay (willingness to pay, WTP) for a marginal unit given the buyers have already bought a certain quantity of units.
    - supply and demand / demand / factors ::: income, preference, _law of diminishing utility_, price of _related_ goods
  ...
  - supply and demand / supply ::: It describes how much sellers are willing to sell given a price level. It ca also be interpreted as the _minimum_ (not _maximum_) price sellers are willing to sell for a marginal unit given the sellers have already sold a certain quantity of units.
...
- [economic equilibrium](../../../../general/economic%20equilibrium.md)
  - market equilibrium ::: A condition where a market price is established through competition such that the amount of goods or services sought by buyers is equal to the amount of goods or services produced by sellers.
    ...
    - market equilibrium / cause ::: It is caused by "bargaining" between buyers and sellers. The number of buyers and sellers affect the bargaining power of respectively buyers and sellers, thus affecting the market equilibrium.
    - [market structure](../../../../general/market%20structure.md) ::: It depicts how firms are differentiated and categorized based on the types of goods they sell (homogeneous/heterogeneous) and how their operations are affected by external factors and element.
      ...
      - [perfect competition](../../../../general/perfect%20competition.md) ::: A __perfect market__, also known as an __atomistic market__, is defined by several idealizing conditions, collectively called __perfect competition__, or __atomistic competition__. <p> It is usually used as a benchmark against other market structures for comparison. Perfect competition are _efficient_: They provide both _allocative efficiency_ and _productive efficiency_.
        ...
        - perfect competition / examples ::: There are no real life examples that exactly matches the model. However, some are close, such as electronic markets (e.g. Amazon), which spreads information quickly.
        ...
        - [market clearing](../../../../general/market%20clearing.md) ::: It is the process by which, in an economic market, the supply of whatever is traded is equated to the demand so that there is no excess supply or demand, ensuring that there is neither a surplus nor a shortage.
          - market clearing / price is higher than equilibrium ::: There will be excess supply, and inventory builds us. So most sellers would lower price to try to clear its inventory. As a result, market price decreases and approaches the equilibrium.
  ...
  - [demand](../../../../general/demand.md)
    ...
    - change in demand ::: change in the relation between quantity demanded at each price
      ...
      - change in demand / factors ::: They are _non-price determinants_ of demand: consumer preferences, expectation about the future, income, number of buyers (e.g. population growth), prices of _related_ goods.
        ...
        - change in demand / factors / income ::: What consumers buys respond to their incomes. Examples include normal good, inferior good, etc.
- types of goods ::: normal good, inferior good, ... (there are some more)
  - [normal good](../../../../general/normal%20good.md) ::: It is a type of a good which experiences an increase in demand due to an increase in income. For you, they are goods that you want more as you have more money.
  - [inferior good](../../../../general/inferior%20good.md) ::: It is goods the demand for which falls with increase in income of the consumer. For you, they are bad goods that you will substitute with better goods as you have more money.
- related goods ::: complementary good, substitute good, independent good
  ...
  - [supply](../../../../general/supply%20(economics).md)a
    ...
    - change in supply ::: change in the relation between quantity supplied at each price
      ...
      - change in supply / factors ::: They are _non-price determinants_ of supply: expectation about the future, number of sellers, price of inputs (factors of production), price of _related_ goods, technology.
        - change in supply / factors / price of inputs, technology ::: Price of factors of production (inputs) directly affect the production cost. Advance in technology can improve the efficiency of using factors of production.
...
- related goods in production ::: complementary good in production, substitute good in production, independent good in production
  - substitute good in production ::: Two goods are substitutes in production if their production rely on the same inputs. Examples: land to grow vegetable or fruit.
  - complementary good in production ::: Two goods are complements in production if they are produced together (joint products). Examples: gasoline, diesel, kerosene from refining crude oil; beef and leather.
...
- [price elasticity of demand](../../../../general/price%20elasticity%20of%20demand.md)
  - price elasticity of demand / factors ::: In general, the easier a consumer can "escape" from consuming a good, the higher the price elasticity of demand. Four major factors are: broadness of definition, substitution effect, time frame, and type of goods.
    ...
    - price elasticity of demand / factors / type of goods ::: If a good is _luxurious_, its elasticity is higher. If a good is _necessary_, its elasticity is lower. <p> An example is even if water price is high, you will still try to buy water.
