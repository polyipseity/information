...
The semantics of `if` is obvious: {@{If the condition is `true`, then the statement block is executed. Otherwise, it is not executed. Note that the condition itself is always executed.}@} <!--SR:!fsrs,2033-10-14T00:00:00.000Z,2639,2639.46974993,1,2,10,0,0,2026-07-24T00:00:00.000Z-->
...
Alternatively, a `switch` statement can be used if {@{the conditions are checking if a value equals some constant values}@}: <!--SR:!fsrs,2034-01-26T00:00:00.000Z,2711,2711.00900149,1,2,10,0,0,2026-08-25T00:00:00.000Z-->
...
One can use a `for` statement to iterate through {@{an interval}@}. More advanced stuff are possible but they are not mentioned here: <!--SR:!fsrs,2034-07-24T00:00:00.000Z,2840,2839.82517353,1,2,11,0,0,2026-10-14T00:00:00.000Z-->
