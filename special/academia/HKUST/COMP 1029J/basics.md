...
- `boolean`→::@::←`char` <!--SR:!2028-08-05,1279,350!2028-10-29,1346,350-->
- `char`→::@::←`double` <!--SR:!2029-08-26,1474,310!2027-01-18,812,330-->
- `double`→::@::←`float` <!--SR:!2031-07-30,2069,330!2026-09-05,711,330-->
- `float`→::@::←`int` <!--SR:!2028-07-04,1161,310!2027-05-27,910,330-->
- `int`→::@::←_(end)_ <!--SR:!2028-04-21,1201,350!2031-08-04,2038,330-->
...
Below are common arithmetic operators. {@{Round brackets \(`()`\)}@} have {@{the highest precedence \(very intuitive\)}@}. Operators higher in the list {@{have higher precedence}@}: <!--SR:!2026-03-14,130,393!2026-03-08,125,393!2026-02-28,118,393-->
...
- `*` <br/> `/` <br/> `%`→::@::←`+` <br/> `-` <!--SR:!2026-03-03,121,393!2026-03-14,130,393-->
...
- _(begin)_→::@::←`<` <!--SR:!2028-03-22,881,230!2027-11-04,1031,330-->
- `<`→::@::←`>` <!--SR:!2028-10-26,1347,350!2028-07-02,1251,350-->
- `>`→::@::←`<=` <!--SR:!2032-03-10,2204,330!2027-03-22,845,310-->
- `<=`→::@::←`>=` <!--SR:!2026-12-22,796,330!2028-10-16,1233,310-->
- `>=`→::@::←`==` <!--SR:!2030-10-03,1765,330!2026-03-05,344,190-->
- `==`→::@::←`!=` <!--SR:!2028-07-24,1274,350!2026-07-04,625,330-->
- `!=`→::@::←_(end)_ <!--SR:!2028-07-26,1274,350!2028-12-23,1389,350-->
...
- `>=`:@:greater than or equal to <!--SR:!2028-07-04,1258,350-->
- `==`:@:equal to <!--SR:!2028-07-24,1269,350-->
...
Below are common logic operators, all of which {@{accept two booleans and return a boolean}@}. {@{Round brackets \(`()`\)}@} have {@{the highest precedence \(very intuitive\)}@}. Operators higher in the list {@{have higher precedence}@}: <!--SR:!2026-09-01,707,330!2026-02-28,118,393!2026-03-15,131,393!2026-03-09,126,393-->
...
- _(begin)_→::@::←`!` <!--SR:!2028-06-14,1241,350!2033-03-28,2594,350-->
- `!`→::@::←`&&` <!--SR:!2026-08-12,635,310!2026-12-22,796,330-->
- `&&`→::@::←<code>&#124;&#124;</code> <!--SR:!2028-07-06,1259,350!2028-05-16,1220,350-->
