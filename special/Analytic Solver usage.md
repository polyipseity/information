...
- success probability cutoff ::: The minimum percentage of values being the "success" value for a set of values to be considered as "success" overall. The cutoff is `>=`, so the percentage equalling the threshold means the set is considered as "success". <!--SR:!2024-06-18,4,295!2024-06-17,3,275-->
...
XLMiner can partition the dataset into {{3 datasets}}: {{training set, validation set, and test set}}. <!--SR:!2024-06-18,4,295!2024-06-17,3,275-->
