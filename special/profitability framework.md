...
{@{The profitability framework}@} is {@{an (extreme) abstraction of an _[income statement](../general/income%20statement.md)_}@} \(also known as {@{_profit and loss statement_}@}\). <!--SR:!2029-11-02,1430,310!2026-03-20,75,345!2027-02-27,346,365-->
...
{@{The variable profit and variable cost}@} of profitability framework can be visualized {@{using a table}@}. {@{The table}@} list out {@{a product segment for each row}@} with {@{the total as the final additional row}@}, and {@{the columns}@} are {@{revenue, units, revenue per unit}@}, {@{cost per unit, profit per unit, and net profit}@}. <!--SR:!2028-09-11,1197,350!2028-03-02,817,250!2026-03-19,74,345!2026-03-19,74,345!2026-03-20,75,345!2026-03-20,75,345!2026-03-19,74,345!2027-03-01,348,365-->
