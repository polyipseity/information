...
There are 5 "modes" to design thinking. Note that the "mode" order is {{only recommended and does not need to be followed. In fact, the process is nonlinear}}.
...
Empathy is {{the foundation of human-centered design}}. To empathize, {{observe, view users and their behaviors in their lives; engage, interact and interview users in scheduled or short intercept counters; and immerse, experience users for some time}}.
...
- (empathize/define) story share-and-capture: after interviews, exchange stories with the team to gain further insights→:::←(define) 2×2 matrix: plot a xy graph to reveal relations and for visualization
- (define) 2×2 matrix: plot a xy graph to reveal relations and for visualization→:::←(define) design guidelines: a strategy to solve your design challenge, abstract enough to allow for multiple solutions
