...
- inspecting "Let $f(x)=\frac{\lvert{x}\rvert}{g(x)}$. If $f$ is [differentiable](../../general/differential%20function.md) on 0, find the constraints on $g(x)$." :@: Use the derivative definition and limit definition. <!--SR:!2026-07-16,507,310-->
