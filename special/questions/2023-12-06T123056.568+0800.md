...
- inspecting "Let $f(x)=\frac{\lvert{x}\rvert}{g(x)}$. If $f$ is [differentiable](../../general/differential%20function.md) on 0, find the constrains on $g(x)$." :: Use the derivative definition and limit definition.
