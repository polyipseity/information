...
- inspecting "$$\lim_{x\to+\infty}\left(\sqrt{x^2+3x+1}-x\right)$$" :@: Convert the expression into a fraction by multiplying both numerator and denominator by $\sqrt{x^2 + 3x + 1} + x$. <!--SR:!2026-03-11,459,310-->
