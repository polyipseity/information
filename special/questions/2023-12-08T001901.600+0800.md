...
tags:
  - date/2023/12/08
  - flashcard/special/questions/2023-12-08T001901_600_0800
  - language/in/English
...
- inspecting "$$\int_0^5 \! \lvert{f'(x)}\rvert (f(x))^2 \, \mathrm{d}x$$" :: Substitute $u = f(x)$. This removes $f'(x)$ (after considering the absolute operator) and turns $(f(x))^2$ into $u^2$. <!--SR:!2024-07-20,13,290-->
