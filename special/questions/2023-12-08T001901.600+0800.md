...
- inspecting "$$\int_0^5 \! \lvert{f'(x)}\rvert (f(x))^2 \, \mathrm{d}x$$" :@: Substitute $u = f(x)$. This removes $f'(x)$ (after handling the absolute operator) and turns $(f(x))^2$ into $u^2$. <!--SR:!fsrs,2031-07-02T08:29:16.172Z,1851,1851.28966624,1,2,10,0,0,2026-06-07T08:29:16.172Z-->
