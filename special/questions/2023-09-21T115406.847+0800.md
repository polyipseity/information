...
- inspecting "If $\frac{\mathrm{d} }{\mathrm{d}x}\left(f\left(3x^4\right)\right)=6x^4$, find $f'(x)$." :@: For the first equation, let $g(x) = 3x^4$ to avoid confusion. Apply the chain rule on the left hand side. <!--SR:!2024-11-15,85,270-->
