...
- inspecting "Let $F(x)=\int_a^x\!f(x)\,\mathrm{d}x$, where $a$ is in $\mathbb{R}$ and $f(x)>0$ for every $x$ in $\mathbb{R}$. Find the constraints on $F^{-1}(x)$." :@: Produce $F^{-1}$ from $F(x)$ by letting $x = F^{-1}(y)$. <!--SR:!fsrs,2030-12-13T00:00:00.000Z,1581,1581.15079824,2.98092302,2,10,0,0,2026-08-15T00:00:00.000Z-->
