...
- inspecting "Hence, prove $\tan^2\frac\pi5=5-2\sqrt5$ and $\tan^2\frac{2\pi}5=5+2\sqrt5$." after expressing $\tan 3x$ in terms of $\tan x$ :: Realize that $\tan^2 \frac {2\pi} 5 = \tan^2 \frac {3\pi} 5$. Let $x = \frac \pi 5$ to setup an equation using the expression for $\tan 3x$ to find $\tan^2 \frac \pi 5$. Then find $\tan^2 \frac {2\pi} 5$. <!--SR:!2024-07-14,9,270-->
