...
- inspecting "Express $\tan3x$ in terms of $\tan{x}$." :: Apply the angle sum formula ($\tan(a \pm b) = \frac {\tan a \pm \tan b} {1 \mp \tan a \tan b}$) twice. <!--SR:!2024-07-06,4,270-->
- inspecting "Hence, prove $\tan^2\frac\pi5=5-2\sqrt5$ and $\tan^2\frac{2\pi}5=5+2\sqrt5$." :: Realize that $\tan^2 \frac {2\pi} 5 = \tan^2 \frac {3\pi} 5$. Let $x = \frac \pi 5$ to setup an equation to find $\tan^2 \frac \pi 5$. Then find $\tan^2 \frac {2\pi} 5$. <!--SR:!2024-07-05,3,250-->
