...
- inspecting "$$\lim_{x\to4}\frac{8\sqrt{x}-x^2}{2-\sqrt{x} }$$" :: Extract, from the numerator, the factor $\sqrt x$, then apply the cube formula ($a^3 \pm b^3 = (a \pm b) \left( a^2 \mp ab + b^2 \right)$) on the numerator to extract the factor $2 - \sqrt x$. <!--SR:!2024-08-24,34,270-->
