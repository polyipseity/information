...
- inspecting "$$\lim_{x\to3}\frac{\sqrt{x+1}-2}{\sqrt{2x+3}-3}$$" :@: Rationalize the denominator by multiplying both numerator and denominator by $\sqrt{2x + 3} + 3$. <!--SR:!2026-05-24,445,270-->
