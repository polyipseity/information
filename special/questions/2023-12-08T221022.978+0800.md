...
- inspecting "$$\lim_{x \to 0}\frac{\cos(\sin x) - \cos x}{x^4}$$" :@: Apply mean value theorem once and L'Hôpital's rule several times. Or use the Taylor series expansion. <!--SR:!2025-11-10,319,270-->
