...
- inspecting "Find the derivative of $f(x)=\frac{1+\sqrt{x} }{1+x}$ by using limits." :: By first principle: $$f'(x) = \lim_{h \to 0} \frac {f(x + h) - f(x)} h$$. Rationalizing some surd terms is likely required in th process to produce a factor $h$. <!--SR:!2024-07-13,8,250-->
