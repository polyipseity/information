...
- inspecting "$$\tan75\degree=\frac{\sqrt{A}+1}{\sqrt{B}-1}$$" :@: Realize that $\tan 75 \degree = \frac 1 {\tan 15 \degree}$. Then the half-angle formula (or the angle difference formula by setting up an equation) can be used to find $\tan 15\degree$ from $\tan 30\degree$. <!--SR:!2025-05-12,197,270-->
- rewriting $\frac 1 {2 - \sqrt 3}$ as $\frac {\sqrt A + 1} {\sqrt B - 1}$ :@: Force the answer by doing: $$\begin{aligned} \frac 1 {2 - \sqrt 3} & = \frac {\sqrt A + 1} {\left(2 - \sqrt 3\right) \left(\sqrt A + 1\right)} \\ & = \frac {\sqrt A + 1} {2 \sqrt A + 2 - \sqrt 3 \sqrt A - \sqrt 3} \\ & = \frac {\sqrt A + 1} {2 \sqrt A - \sqrt 3 \sqrt A - \sqrt 3 + 3 - 1} \\ & = \frac {\sqrt A + 1} {2 \sqrt A - \sqrt 3 \sqrt A - \sqrt 3 + \sqrt 3 \sqrt 3 - 1} \end{aligned}$$. Then somehow see $A = 3$ in order to produce a surd. Or memorize it... <!--SR:!2025-04-14,196,270-->
