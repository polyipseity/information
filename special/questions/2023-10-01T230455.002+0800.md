...
- inspecting "$$\tan75\degree=\frac{\sqrt{A}+1}{\sqrt{B}-1}$$" :: Realize that $\tan 75 \degree = \frac 1 {\tan 15 \degree}$. Then the half-angle formula (or the angle difference formula by setting up an equation) can be used to find $\tan 15\degree$ from $\tan 30\degree$. <!--SR:!2024-08-17,27,270-->
