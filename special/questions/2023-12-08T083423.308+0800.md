...
- inspecting "$\cos x \le \cos x^2$ for $0 \le x \le 1$" :: Intuition is that, restricted to $[0, 1]$, the left hand side function is less convex than the right hand side function, with both having the same values at the endpoints. <!--SR:!2024-07-06,4,270-->
