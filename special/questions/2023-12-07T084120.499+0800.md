...
- inspecting "Given a [twice-differentiable](../../general/differentiable%20function.md) $f$, prove that if $f(-x)=-f(x)$, then $f''(-x)=-f''(x)$." :@: Use the derivative definition twice. <!--SR:!2025-01-12,136,290-->
