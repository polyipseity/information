...
- inspecting "Given a [twice-differentiable](../../general/differentiable%20function.md) $f$, prove that if $f(-x)=-f(x)$, then $f''(-x)=-f''(x)$." :: Use the derivative definition twice. <!--SR:!2024-07-18,13,270-->
