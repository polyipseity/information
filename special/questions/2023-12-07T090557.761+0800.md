...
- inspecting "Given a [thrice-continuously differentiable](differentiable%20function.md) $f$, prove that if $f''(0)=0$ and $f'''(0)>0$, then $f$ has an inflection point at $x=0$." :: Use the derivative definition and the inflection point definition.
