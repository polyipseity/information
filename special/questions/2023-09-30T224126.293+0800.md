...
- inspecting "A force is defined by the potential energy function $U(x)=-2.5x^2+0.3x^3$." and "Also, find the maximum $x$ reached." :@: Using intuition on potential energy, the next $x > 0$ such that $U(0) = U(x)$ is the maximum $x$ reached. <!--SR:!2024-11-18,91,270-->
