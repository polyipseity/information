...
- inspecting "Find the $x$-coordinate of the vertical tangent of the curve $x^3+y^3-3axy=0$ that does not pass through the origin for arbitrary [real](../../general/real%20number.md) $a$ not equal to 0." :: Use implicit differentiation. <!--SR:!2024-08-31,41,290-->
