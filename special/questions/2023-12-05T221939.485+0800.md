...
- inspecting "$$\lim_{x\to+\infty}\frac{x-\sqrt{e^x-1} }{x+\sqrt{e^x+2} }$$" :: Know your growth rates! If you know that $e^x > x$ for large enough $x$, then simply divide both numerator and denominator by $e^{\frac x 2}$. <!--SR:!2024-07-15,10,270-->
