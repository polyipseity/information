...
- making a sequence that diverges while satisfying $\lim_{n \to +\infty} n a_n = 0$ :: Try multiplying $1 / n$ by $\frac 1 {\ln n}$, which increases the denominator so slowly that it does not affect the divergence while satisfying the limit.
