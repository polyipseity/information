...
- inspecting "A right circular cone is inscribed in another right circular cone of volume $V$ and altitude $H$, with the same axis and the vertex of the inner cone touching the base of the outer cone. Find the altitude $h$ of the inner cone such that it has the maximum possible volume." :: Parameterize the smaller right circular cone in terms of either its height or radius. Then differentiate its volume with respect to the selected parameter. <!--SR:!2024-07-05,3,250-->
