...
- inspecting "$$\lim_{x\to\infty}\frac{x-\cos{x} }{x+\cos{x} }$$" :@: Use squeeze theorem, considering $\lvert \cos x \rvert \le 1$ and $\lvert \cos x \rvert \ll \lvert x \rvert$ as $x \to \infty$. <!--SR:!2024-12-14,119,290-->
