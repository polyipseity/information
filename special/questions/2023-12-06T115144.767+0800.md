...
- inspecting "find the number of distinct real roots" :: Existence theorems suffice, such as intermediate value theorem and monotonic properties. This may be easier then finding the real roots. <!--SR:!2024-07-06,4,270-->
- inspecting "$$x^4-x\lvert{x}\rvert-2x-2=0$$" :: Consider nonnegative $x$ and negative $x$ as 2 separate cases in order to remove the absolute operator. <!--SR:!2024-07-06,4,270-->
