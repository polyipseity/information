...
- inspecting "$$x^4-x\lvert{x}\rvert-2x-2=0$$" :@: Consider nonnegative $x$ and negative $x$ as 2 separate cases in order to remove the absolute operator. <!--SR:!2028-01-08,996,350-->
