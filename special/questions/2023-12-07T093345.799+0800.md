...
- inspecting "$$\frac{x}{1+x^2}<\arctan{x}\qquad\forall{x}>0$$" :: Transform the inequality to $$\frac x {1 + x^2} - \arctan x < 0 \qquad \forall x > 0$$. Then use differentiation to prove that the left hand side is strictly decreasing. <!--SR:!2024-09-18,59,310-->
