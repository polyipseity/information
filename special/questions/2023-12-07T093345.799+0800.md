...
- inspecting "$$\frac{x}{1+x^2}<\arctan{x}\qquad\forall{x}>0$$" :@: Transform the inequality to $$\frac x {1 + x^2} - \arctan x < 0 \qquad \forall x > 0$$. Then use differentiation to prove that the left hand side is strictly decreasing. <!--SR:!fsrs,2032-09-16T00:00:00.000Z,2153,2153.22392388,1,2,10,0,0,2026-10-25T00:00:00.000Z-->
