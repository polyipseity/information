...
- inspecting "$$\int\!\frac1{\sqrt{x+42}+\sqrt{x+69} }\,\mathrm{d}x$$" :: Rationalize the denominator by multiplying both numerator and denominator by $\sqrt{x + 42} - \sqrt{x + 69}$. <!--SR:!2024-07-23,16,290-->
