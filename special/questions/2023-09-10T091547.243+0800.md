...
- inspecting "$$\int\!\frac1{\sqrt{x+42}+\sqrt{x+69} }\,\mathrm{d}x$$" :@: Rationalize the denominator by multiplying both numerator and denominator by $\sqrt{x + 42} - \sqrt{x + 69}$. <!--SR:!2029-02-22,1315,350-->
