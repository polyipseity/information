...
Customer gains can be separated into four levels: {@{required, required by customers; expected, expected by customers}@}; {@{desired gains, wanted by customers; and unexpected gains, wanted by customers but customers do not know}@}. Make gains {@{concrete}@}. Like customer pains, note that gains {@{can have different severity}@}. <!--SR:!2029-09-08,1335,269!2027-02-02,794,349!2028-07-01,1206,350!2026-01-22,4,336-->
