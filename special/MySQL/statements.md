...
- `CREATE DATABASE database_name` ::@:: Create a database named `database_name`. <!--SR:!2029-09-19,1702,350!2025-02-17,397,330-->
...
- `USE database_name` ::@:: Use the database named `database_name` as the default database for sequent statements. <!--SR:!2025-02-18,400,339!2030-03-28,1867,359-->
