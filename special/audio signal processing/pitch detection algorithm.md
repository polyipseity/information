...
Intuitively, when {@{the lag time is an integer multiple of the pitch}@}, {@{the original time signal $x[n]$ is very similar to the lagged time signal $x[n + l]$}@}, so {@{the autocorrelation \(their dot product\) will be large}@}. So {@{finding peaks in the resulting autocorrelation function}@} is a good pitch detection algorithm, especially for {@{monophonic sources but not polyphonic sources}@}. <!--SR:!2026-07-20,299,332!2026-07-21,300,332!2026-07-20,299,332!fsrs,2030-01-24T00:00:00.000Z,1287,1287.08106182,1,2,9,0,0,2026-07-17T00:00:00.000Z!2029-09-10,1196,352-->
