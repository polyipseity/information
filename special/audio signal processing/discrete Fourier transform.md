...
{@{Shifting the signal in the time domain to the right by $n_0$ samples}@} corresponds to {@{multiplying the signal in the frequency domain by $e^{-\frac{j 2\pi} N kn_0}$}@}. This can be shown {@{directly from the definition}@}. <!--SR:!2027-08-25,787,346!2026-08-09,382,326!2025-09-28,319,366-->
