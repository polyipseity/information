...
The discrete Fourier transform (DFT) {{transforms a sequence of length $N$ into another sequence of length $N$}}. It is defined by: {{$$X[k] := \sum_{n = 0}^{N - 1} x[n] \cdot e^{-j 2\pi (k / N) n} = \sum_{n = 0}^{N - 1} x[n] \left(\cos(2 \pi (k / N) n) - j \sin(2 \pi (k / N) n) \right)$$}}. <!--SR:!2024-10-26,58,310!2025-02-18,124,290-->
