...
The other variant is {@{the _causal_ variant}@}, which {@{adds an arbitrary number of zero values to a signal in the time or frequency domain at the end, assuming the indices are from $0$ to $N - 1$}@}. <!--SR:!2024-12-11,85,353!2025-09-06,277,353-->
