...
{@{Convoluting two signals in the time domain}@} corresponds to {@{multiplying the two signals in the frequency domain}@}. That is, {@{$$\mathcal{F}(x * y) = XY \qquad x * y = \mathcal{F}^{-1}(XY)$$}@}. This is also easily shown {@{from the definition}@}. <!--SR:!2025-09-22,315,366!2025-11-14,356,366!2029-12-08,1546,386!2025-10-06,324,366-->
