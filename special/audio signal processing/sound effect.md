...
{@{_Amplitude scaling_}@} is done by {@{simply multiplying \(or adding if in logarithmic scale, e.g. dB\) the amplitude}@} by {@{a factor \(or as a function of time\)}@} for {@{each STFT frame}@}. <!--SR:!2026-04-27,229,330!2026-03-16,140,310!2028-01-20,683,409!2027-11-12,626,409-->
