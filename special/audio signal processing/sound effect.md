...
{@{_Amplitude scaling_}@} is done by {@{simply multiplying \(or adding if in logarithmic scale, e.g. dB\) the amplitude}@} by {@{a function \(or use a amplitude scaling envelope that maps old amplitudes to new amplitudes\)}@} for {@{each STFT frame}@}. <!--SR:!2026-04-27,229,330!2025-10-27,34,290!2025-09-22,5,349!2025-09-22,5,349-->
