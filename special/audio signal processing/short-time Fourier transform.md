...
- Hanning window ::@:: about 4 bins; about −31.5&nbsp;dB <!--SR:!2026-05-08,239,330!2029-03-26,1059,350-->
...
There are {@{many factors}@} affecting the result of STFT: {@{window function, window size, FFT size, hop size, etc.}@} <!--SR:!2026-05-09,240,330!2029-03-11,1047,350-->
...
- FFT size ::@:: We are effectively zero-padding the window evenly on both sides if the FFT size exceeds the window size, since the window function is zero outside the window size. Remember this simply makes the resulting frequency signal have more bins, i.e. the frequency signal produced by a _continuous_ FT is sampled more often. <!--SR:!2026-05-26,254,330!2029-03-01,1037,350-->
