...
There are also many ways to {@{characterize a spectrogram of a STFT frame}@}. {@{_Spectral centroid_}@} describes {@{the center of a spectrogram}@} and is defined as {@{$$C = \frac {\sum_{k = 0}^{N / 2} k \lvert X[k] \rvert } {\sum_{k = 0}^{N / 2} \lvert X[k] \rvert } \,,$$}@} i.e. its {@{weighted average frequency \(bin\) weighted by magnitude or _center of mass_}@}. Note {@{only the _nonnegative_ frequency bins \(from 0 to $N / 2$; both ends inclusive\) are used}@} since {@{for a real signal, the magnitude of a frequency equals that of its negative frequency \(conjugate-even\)}@}; including them {@{would always result in a centroid at the zero frequency bin, which is not useful}@}. <!--SR:!2029-07-20,1148,350!2029-05-02,1090,350!2029-07-17,1145,350!fsrs,2029-09-20T00:00:00.000Z,1191,1191.26470738,1,2,9,0,0,2026-06-17T00:00:00.000Z!2029-08-04,1163,350!2026-07-09,290,330!2026-06-29,281,330!2026-06-24,277,330-->
