...
{@{Timbre features}@} describe {@{the quality of a sound to the ears}@}, e.g. {@{high-frequency content, spectral centroid, spectral flux, etc.}@} <!--SR:!2026-05-31,258,330!2025-09-21,65,310!2026-06-28,281,330-->

{@{Dynamic features}@} describe {@{the energy of a sound}@}, e.g. {@{average level, loudness, etc.}@} <!--SR:!2026-06-23,276,330!2026-06-08,264,330!2025-09-21,65,310-->
