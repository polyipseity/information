...
- `help [<topic>]` ::@:: find information about topic; if topic is not specified, then prints general help <!--SR:!2031-12-28,2117,385!2028-08-07,1111,365-->
...
- `set <storage> = <value>` ::@:: set storage to value <!--SR:!2032-01-08,2126,385!2031-11-24,2089,385-->
...
- `starti [<args>...]` ::@:: start program and stop at its first instruction <!--SR:!2028-06-24,997,330!fsrs,2032-06-05T00:00:00.000Z,2072,2071.58751979,1,2,10,0,0,2026-10-03T00:00:00.000Z-->
- `step` ::@:: go to the next (source) line stepping into functions <!--SR:!2027-04-25,717,330!fsrs,2031-07-07T02:44:27.198Z,1847,1847.31118877,1,2,10,0,0,2026-06-16T02:44:27.198Z-->
...
- `rc` ::@:: reverse continue <!--SR:!2031-12-16,2107,385!2032-01-05,2124,385-->
...
- `rs` ::@:: rewind to the previous (source) line stepping into functions <!--SR:!2031-04-06,1804,345!2029-04-07,1285,365-->
...
- `stack <count> <offset>` ::@:: prints stack data with the specified count and offset <!--SR:!2031-12-05,2098,385!fsrs,2029-08-01T00:00:00.000Z,1052,1052.34443849,5.13085011,2,10,0,0,2026-09-14T00:00:00.000Z-->
- `stackf <count> <offset>` ::@:: prints entire stack frame with the specified count and offset <!--SR:!fsrs,2030-12-01T04:41:52.822Z,1631,1630.79170023,1.22984669,2,10,0,0,2026-06-14T04:41:52.822Z!fsrs,2032-02-28T00:00:00.000Z,2033,2033.09427512,1,2,10,0,0,2026-08-05T00:00:00.000Z-->

## miscellaneous

- getting `glibc` version ::@:: Run the library itself, e.g. `/lib/libc.so.6`. Or run the linker with `--version`, e.g. `ldd --version`. Or in a program, use the string returned from `gnu_get_libc_version()` in `<gnu/libc-version.h>`. <!--SR:!2027-07-27,793,330!fsrs,2030-04-02T00:00:00.000Z,1289,1289.25976817,3.24197837,2,10,0,0,2026-09-21T00:00:00.000Z-->
