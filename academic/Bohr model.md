...
The __Bohr model__ or __{{Rutherford–Bohr}} model__ is {{an [atom](atom.md) model}} where {{a small, dense [nucleus](nucleus.md) is orbited by [electrons](electron.md)}}. They are attracted by {{electrostatic forces}}. It was presented by {{[Niels Bohr](Niels%20Bohr.md)}} and {{[Ernest Rutherford](Ernest%20Rutherford.md)}} in {{1913}}. <!--SR:!2023-06-15,68,250!2023-10-14,225,310!2023-07-05,75,170!2023-07-06,140,290!2023-05-24,76,232!2023-11-07,249,332!2023-05-29,54,192-->

The model gives almost exact results only when {{two charged points orbit each other much slower than light}}, like {{an atom where one electron is far away from everything else}}. <!--SR:!2023-05-05,13,270!2023-05-01,88,272-->
...
{{$$E_n=-\frac12m_\mathrm{e}v^2=-\frac{Zk_\mathrm{e}\mathrm{e}^2}{2r_n}=-\frac{Z^2k_\mathrm{e}^2\mathrm{e}^4m_\mathrm{e} }{2\hbar^2n^2}\approx\frac{-13.6Z^2}{n^2}~\mathrm{eV}$$}} <!--SR:!2023-09-07,183,294!2023-09-30,198,294!2023-05-23,42,254!2023-07-04,133,294!2023-06-03,107,274!2023-07-17,80,254!2023-11-01,203,274!2023-04-30,32,194!2023-07-30,140,274-->
...
{{$$\frac1\lambda=R_\infty\left(\frac1{n_f^2}-\frac1{n_i^2}\right)$$}} The constant is {{$R_\infty=\frac{R_\mathrm{E} }{hc}=10\,973\,731.568\,160(21)~\mathrm{m}^{-1}$}}. <!--SR:!2023-05-17,41,282!2023-09-04,188,302!2023-10-11,200,302!2023-09-24,189,302!2023-08-06,163,302!2023-05-04,44,202-->
