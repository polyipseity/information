...
text = gen.TextCode.compile(
	f"""{{{gen.Tag.MEMORIZE}:_（開始）_}}{{mem sep:}}__<u>岳陽樓</u>記__{{{gen.Tag.TEXT}: }}{{mem sep:}}<u>范仲淹</u>{{{gen.Tag.TEXT}:

}}{{mem sep:}}{{{gen.Tag.MEMORIZE}:_（第一段）_}}{{mem sep:}}<u>慶曆</u>四年{notes.embed('<u>慶曆</u>四年', '即公元1044年。<u>慶曆</u>：<u>宋仁宗</u>年號。當時正值<u>慶曆</u>新政。')}春，{hard(f"<u>滕子京</u>{notes.embed('<u>滕子京</u>', '名<u>宗諒</u>，字<u>子京</u>。')}")}{hard(f"謫{notes.embed('謫', '貶謫、貶官。')}")}守{notes.embed('守', '太守之簡稱，文中指出任為太守。')}{hard(f"<u>巴陵郡</u>{notes.embed('<u>巴陵郡</u>', '即<u>岳州</u>，今<u>岳陽市</u>。')}")}。{{mem sep:}}越明年{notes.embed('越明年', '過了第二年。越︰過了。')}，政通人和{notes.embed('政通人和', '政事通達，人民和樂。')}，百廢{hard(f"具{notes.embed('具', '通「俱」，全部。')}")}興。{{mem sep:}}乃重修<u>岳陽樓</u>，增其舊制，{{mem sep:}}刻<u>唐</u>賢{notes.embed('<u>唐</u>賢', '<u>唐</u>代先賢如<u>張九齡</u>、<u>杜甫</u>、<u>韓愈</u>等。')}、今人{notes.embed('今人', '當世名人如<u>呂端</u>、<u>夏竦</u>等。')}詩賦於其上；{{mem sep:}}屬{notes.embed('屬', '通「囑」，囑咐。')}予作文以記之。{{{gen.Tag.TEXT}:

}}{{mem sep:}}{{{gen.Tag.MEMORIZE}:_（第二段）_}}{{mem sep:}}予觀夫<u>巴陵</u>勝狀{notes.embed('勝狀', '美景。勝︰美。狀︰狀貌、形勢。')}，在<u>洞庭</u>一湖。{{mem sep:}}{hard("銜")}遠山{notes.embed('銜遠山', '像張開口含着與岳陽樓遙遙相對的君山。銜：即「啣」。')}，吞<u>長江</u>，{{mem sep:}}浩浩{hard(f"湯湯{notes.embed('湯湯', '形容水勢浩瀚。粵[商]，[soeng1]；普[shɑ̄nɡ]。')}")}，橫無際涯；{{mem sep:}}朝暉夕陰，氣象萬千。{{mem sep:}}此則<u>岳陽樓</u>之大觀{notes.embed('大觀', '盛大壯觀的景象，或謂指景觀的大概情況。')}也，前人之述備{notes.embed('備', '完備、詳盡。')}矣。{{mem sep:}}然則北通{hard(f"<u>巫峽</u>{notes.embed('<u>巫峽</u>', '<u>長江</u>三峽之一，位於<u>四川省</u>&nbsp;<u>巫山縣</u>。<u>長江</u>水經<u>巫峽</u>由西北方注入<u>洞庭湖</u>。')}")}，南極{hard("<u>瀟</u>")}&nbsp;{hard("<u>湘</u>")}{notes.embed('<u>瀟</u>&nbsp;<u>湘</u>', '於<u>湖南</u>境內的<u>瀟水</u>和<u>湘水</u>，向北流入<u>洞庭湖</u>。<u>瀟</u>︰<u>瀟水</u>。<u>湘</u>︰<u>湘水</u>。')}，{{mem sep:}}遷客{hard("騷")}人{notes.embed('遷客騷人', '指貶謫流放的官吏和失意的文人雅士。遷客：被貶謫的官吏。騷人︰即詩人。因為<u>屈原</u>憂愁憂思而作《離騷》，故稱<u>屈原</u>或《楚辭》作者為「騷人」。')}，多會於此，{{mem sep:}}覽物之情，得無異乎？{{{gen.Tag.TEXT}:

}}{{mem sep:}}{{{gen.Tag.MEMORIZE}:_（第三段）_}}{{mem sep:}}若夫{hard("霪")}雨{notes.embed('霪雨', '久雨。霪︰通「淫」，過量。')}{hard(f"霏霏{notes.embed('霏霏', '形容雨絲細密。')}")}，連月不開{notes.embed('開', '放晴，天色開朗。')}；{{mem sep:}}陰{notes.embed('陰', '陰冷。')}風怒號{notes.embed('怒號', '形容風聲激越。號︰呼嘯。粵[豪]，[hou4]；普[hɑ́o]。')}，濁浪排空{notes.embed('排空', '指浪濤洶湧，直上雲霄。')}；{{mem sep:}}日星隱耀，山岳潛形；{{mem sep:}}商旅不行，{hard("檣")}傾{hard("楫")}摧{notes.embed('檣傾楫摧', '船隻翻覆沉沒。檣︰船的桅杆。粵[牆]，[coeng4]；普[qiɑ́nɡ]。傾：倒下。楫︰船槳。粵[接]，[zip3]；普[jí]。摧︰摧毀。')}；{{mem sep:}}薄{notes.embed('薄', '通「迫」，迫近。')}暮冥{notes.embed('冥', '昏暗、陰沉。粵[名]，[ming4]；普 [mínɡ]。')}冥，虎嘯猿啼。{{mem sep:}}登斯樓也，則有去國{notes.embed('去國', '離開京城，指被貶謫遠方。去︰離開。國︰指國都，即京師。')}懷鄉，憂{hard("讒")}畏{hard("譏")}，{{mem sep:}}滿目{hard("蕭")}然{notes.embed('蕭然', '蕭條冷落的景況。')}，感極而悲者矣。{{{gen.Tag.TEXT}:

}}{{mem sep:}}{{{gen.Tag.MEMORIZE}:_（第四段）_}}{{mem sep:}}至若春和景明{notes.embed('景明', '陽光燦爛。景︰日光。')}，波{hard("瀾")}不驚{notes.embed('波瀾不驚', '風平浪靜，沒有泛起半點波瀾。')}，{{mem sep:}}上下天光，一{hard("碧")}萬{hard ("頃")}；{{mem sep:}}沙鷗{hard(f"翔{notes.embed('翔', '飛翔。')}")}集{notes.embed('集', '聚集、棲息。')}，錦鱗游泳，{{mem sep:}}岸芷汀{notes.embed('汀', '小洲。')}蘭{notes.embed('（岸）芷（汀）蘭', '指白芷與蘭草一類的香草。')}，{hard(f"郁郁{notes.embed('郁郁', '形容色彩爛漫、香氣馥郁。')}")}青青{notes.embed('青青', '形容花葉茂盛。')}。{{mem sep:}}而或長煙一空{notes.embed('長煙一空', '瀰漫的霧靄頓時全部消散。長煙︰漫天的霧氣。一：全部。空︰消散。')}'，皓月千里，{{mem sep:}}浮光躍金{notes.embed('浮光躍金', '微風吹過，月影盪漾，金光閃爍的景致。浮光︰浮於水面的月影。躍金︰金光閃爍。躍︰跳動。一作「耀」。')}，靜影沉璧{notes.embed('靜影沉璧', '風平浪靜，月光的倒影明靜如白玉，沉於湖中。影︰月影。璧︰圓形而中間有孔的玉器。')}；{{mem sep:}}漁歌互答，此樂何極！{{mem sep:}}登斯樓也，則有心曠神怡，寵辱皆忘{notes.embed('寵辱皆忘', '把寵辱都豁出去。寵︰得寵。辱︰受辱。《老子‧十三章》︰「何謂寵辱若驚？寵為下，得之若驚，失之若驚，是謂寵辱若驚。」本句反用《老子》之意。')}，{{mem sep:}}把{notes.embed('把', '持。')}酒臨{notes.embed('臨', '對、迎。')}風，其喜洋洋者矣。{{{gen.Tag.TEXT}:

}}{{mem sep:}}{{{gen.Tag.MEMORIZE}:_（第五段）_}}{{mem sep:}}{hard("嗟夫")}！予嘗求古仁人之心{notes.embed('古仁人之心', '古代那些品德高尚、憂國憂民的賢人之心境。')}，或{notes.embed('或', '或許，以示謙虛。')}異{notes.embed('異', '不同。')}二者之為{notes.embed('二者之為', '指因景色慘淡「感極而悲」和因景色秀美而「其喜洋洋」兩種表現。')}。{{mem sep:}}何哉？不以物喜，不以己悲{notes.embed('不以物喜，不以己悲', '不因外物變化或一己際遇而悲喜。')}。{{mem sep:}}居廟堂之高{notes.embed('居廟堂之高', '意謂在朝廷任官。廟堂︰朝廷。')}，則憂其民；{{mem sep:}}處江湖{notes.embed('江湖', '指民間或遠離朝廷的地方。')}之遠，則憂其君。{{mem sep:}}是進亦憂，退亦憂，然則何時而樂耶？{{mem sep:}}其必曰：「先天下之憂而憂，後天下之樂而樂{notes.embed('先天下之憂而憂，後天下之樂而樂', '在天下人面對危機而擔憂之前，憂心忡忡地籌謀解決之道；待天下人都活得樂也融融之後，才引以為樂。')}」{{mem sep:}}{hard("歟")}！{hard("噫")}！微{notes.embed('微', '無、沒有。')}斯人{notes.embed('斯人', '這樣的人，指前文所說的「古仁人」，「先天下之憂而憂，後天下之樂而樂」者。')}，吾誰與歸{notes.embed('吾誰與歸', '即「吾與誰歸」的倒裝句。歸︰效法、依歸。')}！{{mem sep:}}{{{gen.Tag.MEMORIZE}:_（完成）_}}"""
)
