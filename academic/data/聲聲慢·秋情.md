...
text = gen.TextCode.compile(
	f"""{{{gen.Tag.MEMORIZE}:_（開始）_}}{{sep:}}__聲聲慢·秋情__{{{gen.Tag.TEXT}: }}{{sep:}}<u>李清照</u>{{{gen.Tag.TEXT}:

}}{{sep:}}{{{gen.Tag.MEMORIZE}:_（上片）_}}{{sep:}}尋尋覓覓，冷冷清清，{{sep:}}{hard("悽悽")}{hard("慘慘")}戚戚。{{sep:}}{hard("乍煖")}還寒{notes.embed('乍煖還寒', '剛剛還很暖和，很快又變冷，指深秋天氣變化無常。煖：同「暖」。')}時候，最難將息{notes.embed('（最難）將息', '調養、休息。')}。{{sep:}}三杯兩{hard("盞")}淡酒，怎敵他晚來{notes.embed('晚來（風急）', '一作「曉來」。')}風急！{{sep:}}{hard("雁")}過也，正傷心，卻是舊時相識。{{{gen.Tag.TEXT}:

}}{{sep:}}{{{gen.Tag.MEMORIZE}:_（下片）_}}{{sep:}}滿地黃花堆積，{{sep:}}{hard("憔悴")}損{notes.embed('憔悴損', '指黃花凋謝枯萎。')}，如今有誰堪摘？{{sep:}}守着窗兒，獨自怎生得黑！{{sep:}}{hard("梧桐")}更兼細雨，{{sep:}}到黃昏、點點滴滴。{{sep:}}這次第{notes.embed('（這）次第', '一連串光景、情形。')}，怎一{hard("箇")}愁字了得{notes.embed('（一箇愁字）了得', '概括得了。')}！{{sep:}}{{{gen.Tag.MEMORIZE}:_（完成）_}}"""
)
