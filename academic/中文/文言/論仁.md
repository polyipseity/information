...
text: gen.TextCode = gen.TextCode.compile(
	f"""{{mem:（《里仁》第四）}}{{text:1. }}{{sep:}}子曰：「不仁者，{{sep:}}不可以久處約，不可以長處樂。{{sep:}}仁者安仁，知者利仁。」{{text:（《里仁》第四）}}{{sep:}}{{mem:（《里仁》第四）}}"""
)
...
import typing
text: gen.TextCode = gen.TextCode.compile(
	f"""{{mem:（《里仁》第四）}}{{text:2. }}{{sep:}}子曰：「富與貴，是人之所欲也；不以其道得之，不處也。{{sep:}}貧與賤，是人之所惡也；不以其道得之，不去也。{{sep:}}君子去仁，惡乎成名？{{sep:}}君子無終食之間違仁。{{sep:}}造次必於是，{hard("顛沛")}必於是。」{{text:（《里仁》第四）}}{{sep:}}{{mem:（《里仁》第四）}}"""
)
...
<!--08e5b0a3-f78a-46af-bf50-eb9b12f7fa1e generate section="623e89"--><!-- The following content is generated at 2023-03-05T12:59:51.254815+08:00. Any edits will be overridden! -->

> 2. 子曰：「富與貴，是人之所欲也；不以其道得之，不處也。貧與賤，是人之所惡也；不以其道得之，不去也。君子去仁，惡乎成名？君子無終食之間違仁。造次必於是，{{顛沛}}必於是。」（《里仁》第四）
...
import typing
text: gen.TextCode = gen.TextCode.compile(
	f"""{{mem:（《顏淵》第十二）}}{{text:3. }}{{sep:}}<u>顏淵</u>問仁。{{sep:}}子曰：「克己復禮為仁。{{sep:}}一日克己復禮，天下歸仁焉。{{sep:}}為仁由己，而由人乎哉？」{{text:<p/>}}{{sep:}}<u>顏淵</u>曰：「請問其目。」{{sep:}}子曰：「非禮勿視，非禮勿聽，非禮勿言，非禮勿動。」{{text:<p/>}}{{sep:}}<u>顏淵</u>曰：「<u>回</u>雖不敏，請事斯語矣。」{{text:（《顏淵》第十二）}}{{sep:}}{{mem:（《顏淵》第十二）}}"""
)
...
import typing
text: gen.TextCode = gen.TextCode.compile(
	f"""{{mem:（《衛靈公》第十五）}}{{text:4. }}{{sep:}}子曰：「志士仁人，{{sep:}}無求生以害仁，有殺身以成仁。」{{text:（《衛靈公》第十五）}}{{sep:}}{{mem:（《衛靈公》第十五）}}"""
)
