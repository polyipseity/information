...
static inline void stopAllMotors()
{
     ...
     */
    DJIMotor::getMotor(0x205).setOutputCurrent(0);
    DJIMotor::getMotor(0x206).setOutputCurrent(0);
    DJIMotor::getMotor(0x207).setOutputCurrent(0);
    DJIMotor::getMotor(0x208).setOutputCurrent(0);
