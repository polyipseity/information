...
public class GlobalAnnotationDataTest {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        if (ENABLE) {
            Set<ASMDataTable.ASMData> asmDataSet = event.getAsmData()
                    .getAll(AnnotationTest.TestAnnotation.class.getName());
            String message = "\n--------------------" + AnnotationTest.TestAnnotation.class.getName()
                    + " Debug Message--------------------\n";
    ...
    public static class AnnotationTest<A, B, C, D, E, F, G, H, I, J, K, L> {
        public static final class TypeAnnotationTest<@TestAnnotation TEST_TYPE extends Map<AnnotationTest, AnnotationTest>, TEST2 extends Annotation, @AnnotationTest.TestAnnotation TEST3 extends Annotation> {
            ...
            public static Class<@TestAnnotation ? extends Map<@TestAnnotation ? extends Annotation, @TestAnnotation ? extends Annotation>> typeAnnotationTest(
                    @TestAnnotation Class<@TestAnnotation ? extends Class<@TestAnnotation ? extends Annotation>> typeTestParameter) {
                return null;
            }
        }

        public static final class MethodAnnotationTest extends AnnotationTest {
            public static Class<@TestAnnotation ? extends Annotation> methodAnnotationTest(
                    @TestAnnotation Object object, @TestAnnotation Object object2) {
